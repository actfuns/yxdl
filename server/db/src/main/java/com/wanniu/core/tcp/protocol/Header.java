...
/*  86 */         if (type.equals("byte")) {
/*  87 */           bits += 8;
/*  88 */         } else if (type.equals("short")) {
/*  89 */           bits += 16;
/*  90 */         } else if (type.equals("int")) {
/*  91 */           bits += 32;
/*  92 */         } else if (type.equals("long")) {
/*  93 */           bits += 64;
/*  94 */         } else if (type.equals("char")) {
/*  95 */           bits += 16;
/*  96 */         } else if (type.equals("float")) {
/*  97 */           bits += 32;
/*  98 */         } else if (type.equals("double")) {
/*  99 */           bits += 64;
/*     */         } else {
...
/* Location:              D:\Yxdl\xmds-db\xmds-db.jar!\com\wanniu\core\tcp\protocol\Header.class
