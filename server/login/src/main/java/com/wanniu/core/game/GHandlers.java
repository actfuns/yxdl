...
public final class GHandlers {
    public static void init(String pakName) {
        Out.info(
                ...
                new Object[]{"搜索客户端处理句柄路径 -> ", pakName});
        try {
                        ...
                        while (jarEntries.hasMoreElements()) {
                            ...
                            if (jarEntryName.endsWith(".class")) {
                                ...
                                if (className.startsWith(pakName)) {
                                    ...
                                    if (cls.isAnnotationPresent((Class) GClientEvent.class))
    ...
    private static String getClassName(String pakName, String fileName) {
        ...
        if (!isEmpty(pakName)) {
            className = String.valueOf(pakName) + "." + className;
        }
        return className;
    }
    ...
    private static String getSubPackagePath(String pakPath, String filePath) {
        ...
        if (!isEmpty(pakPath)) {
            subPakPath = String.valueOf(pakPath) + "/" + subPakPath;
        }
        return subPakPath;
    }
    ...
    private static String getSubPackageName(String pakName, String filePath) {
        ...
        if (!isEmpty(pakName)) {
            subPakName = String.valueOf(pakName) + "." + subPakName;
        }
        return subPakName;
    }
