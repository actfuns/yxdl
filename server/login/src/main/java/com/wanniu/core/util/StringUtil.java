...
/*  58 */     return !(param != null && param.length() != 0 && !param.trim().equals("") && !param.trim().equals("null"));
/*     */   }
/*     */   
...
/*  99 */     if (ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS || 
/* 100 */       ub == Character.UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS || 
/* 101 */       ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A || 
/* 102 */       ub == Character.UnicodeBlock.GENERAL_PUNCTUATION || 
/* 103 */       ub == Character.UnicodeBlock.CJK_SYMBOLS_AND_PUNCTUATION || 
/* 104 */       ub == Character.UnicodeBlock.HALFWIDTH_AND_FULLWIDTH_FORMS) {
/* 105 */       return true;
/*     */     }
/* 107 */     return false;
/*     */   }
...
/* Location:              D:\Yxdl\xmds-login\xmds-login.jar!\com\wanniu\cor\\util\StringUtil.class
