...
/* 360 */     long time = format(dateTime).getTime();
/* 361 */     if (now == time)
/* 362 */       return 1; 
/* 363 */     if (now > time) {
/* 364 */       return 2;
...
/* 375 */     long start = format(startStr).getTime();
/* 376 */     long end = format(endStr).getTime();
/*     */     
/* 378 */     return isOutDate(start, end);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 403 */     long now = format(time).getTime();
/* 404 */     long start = format(startStr).getTime();
/* 405 */     long end = format(endStr).getTime();
/* 406 */     if (now > start && now < end)
/* 407 */       return 1; 
/* 408 */     if (now > end) {
/* 409 */       return 2;
/*     */     }
...
/* 419 */     if (startHour.indexOf(":") == startHour.lastIndexOf(":")) {
/* 420 */       startHour = String.valueOf(startHour) + ":00";
/*     */     }
/* 422 */     if (endHour.indexOf(":") == endHour.lastIndexOf(":")) {
/* 423 */       endHour = String.valueOf(endHour) + ":00";
/*     */     }
/* 425 */     return isOutDate(startHour, endHour);
/*     */   }
/*     */   
/*     */   public static void main(String[] args) {
/* 429 */     System.out.println(formatUTF("31 "));
/* 430 */     System.out.println(formatUTF("1:31"));
/* 431 */     System.out.println(formatUTF("12:31.31"));
/* 432 */     System.out.println(formatUTF("2010.8.30 "));
/* 433 */     System.out.println(formatUTF("2010.08.3 11"));
/* 434 */     System.out.println(formatUTF("13 13:00:00"));
/* 435 */     System.out.println(formatUTF("11"));
/* 436 */     System.out.println(formatUTF("11:11"));
/* 437 */     System.out.println(formatUTF("11:11:11"));
/* 438 */     System.out.println(formatUTF("11:11:11.111"));
/* 439 */     System.out.println(isInTime("8:00", "12:00"));
/*     */   }
/*     */ }


/* Location:              D:\Yxdl\xmds-login\xmds-login.jar!\com\wanniu\cor\\util\DateUtil.class
