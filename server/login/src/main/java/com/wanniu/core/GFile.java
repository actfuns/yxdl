...
/*    */ 
/*    */   
/* 35 */   public static final String DIR_LANGUAGE = GConfig.getInstance().get("dir.language", String.valueOf(DIR_COMMON) + "language" + File.separator);
/*    */ 
/*    */   
/* 38 */   public static final String FILE_CONF_DS = String.valueOf(DIR_CONF_SERVER) + "conf.ds.xml";
/*    */ 
/*    */   
/* 41 */   public static final String DIR_LOG = GConfig.getInstance().get("log.dir", String.valueOf(System.getProperty("user.dir")) + File.separator + "logs");
/*    */ }


/* Location:              D:\Yxdl\xmds-login\xmds-login.jar!\com\wanniu\core\GFile.class
