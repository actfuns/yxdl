...
/*  51 */       if (number >= low[i])
/*     */       {
/*  53 */         if ((i == 0) ? (number <= hight[i]) : (number < hight[i])) {
/*  54 */           return name[i];
/*     */         }
/*     */       }
/*     */     } 
...
/*     */       
/*  85 */       int toIndex = flag ? 
/*  86 */         newArea[i].indexOf("<", fromIndex) : 
/*  87 */         newArea[i].indexOf(">", fromIndex);
/*     */       
...
/* Location:              D:\Yxdl\xmds-login\xmds-login.jar!\com\wanniu\cor\\util\NumberUtil.class
