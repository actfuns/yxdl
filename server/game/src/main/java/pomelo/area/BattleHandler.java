...
/*       */   {
/*   574 */     private static final ItemNormal defaultInstance = new ItemNormal(true); private final UnknownFieldSet unknownFields; private ItemNormal(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ItemNormal(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ItemNormal getDefaultInstance() { return defaultInstance; } public ItemNormal getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ItemNormal(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.itemCode_ = bs; break;case 16: this.bitField0_ |= 0x2; this.itemNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ItemNormal_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ItemNormal_fieldAccessorTable.ensureFieldAccessorsInitialized(ItemNormal.class, Builder.class); } public static Parser<ItemNormal> PARSER = (Parser<ItemNormal>)new AbstractParser<ItemNormal>() { public BattleHandler.ItemNormal parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ItemNormal(input, extensionRegistry); } }
/*   575 */     ; private int bitField0_; public static final int ITEMCODE_FIELD_NUMBER = 1; private Object itemCode_; public static final int ITEMNUM_FIELD_NUMBER = 2; private int itemNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ItemNormal> getParserForType() { return PARSER; } public boolean hasItemCode() { return ((this.bitField0_ & 0x1) == 1); } public String getItemCode() { Object ref = this.itemCode_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.itemCode_ = s;  return s; } public ByteString getItemCodeBytes() { Object ref = this.itemCode_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.itemCode_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  1098 */     private static final ThrowPointRequest defaultInstance = new ThrowPointRequest(true); private final UnknownFieldSet unknownFields; private ThrowPointRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ThrowPointRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ThrowPointRequest getDefaultInstance() { return defaultInstance; } public ThrowPointRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ThrowPointRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.id_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ThrowPointRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ThrowPointRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ThrowPointRequest.class, Builder.class); } public static Parser<ThrowPointRequest> PARSER = (Parser<ThrowPointRequest>)new AbstractParser<ThrowPointRequest>() { public BattleHandler.ThrowPointRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ThrowPointRequest(input, extensionRegistry); } }
/*  1099 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private Object id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ThrowPointRequest> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public String getId() { Object ref = this.id_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.id_ = s;  return s; } public ByteString getIdBytes() { Object ref = this.id_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  1770 */     private static final ThrowPointResponse defaultInstance = new ThrowPointResponse(true); private final UnknownFieldSet unknownFields; private ThrowPointResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ThrowPointResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ThrowPointResponse getDefaultInstance() { return defaultInstance; } public ThrowPointResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ThrowPointResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.point_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ThrowPointResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ThrowPointResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ThrowPointResponse.class, Builder.class); } public static Parser<ThrowPointResponse> PARSER = (Parser<ThrowPointResponse>)new AbstractParser<ThrowPointResponse>() { public BattleHandler.ThrowPointResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ThrowPointResponse(input, extensionRegistry); } }
/*  1771 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int POINT_FIELD_NUMBER = 3; private int point_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ThrowPointResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  3050 */     private static final ThrowPointResultPush defaultInstance = new ThrowPointResultPush(true); private final UnknownFieldSet unknownFields; private ThrowPointResultPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ThrowPointResultPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ThrowPointResultPush getDefaultInstance() { return defaultInstance; } public ThrowPointResultPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ThrowPointResultPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.id_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.name_ = bs; break;case 24: this.bitField0_ |= 0x4; this.point_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.s2CCode_ = input.readInt32(); break;case 42: bs = input.readBytes(); this.bitField0_ |= 0x10; this.itemCode_ = bs; break;case 48: this.bitField0_ |= 0x20; this.num_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ThrowPointResultPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ThrowPointResultPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ThrowPointResultPush.class, Builder.class); } public static Parser<ThrowPointResultPush> PARSER = (Parser<ThrowPointResultPush>)new AbstractParser<ThrowPointResultPush>() { public BattleHandler.ThrowPointResultPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ThrowPointResultPush(input, extensionRegistry); } }
/*  3051 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private Object id_; public static final int NAME_FIELD_NUMBER = 2; private Object name_; public static final int POINT_FIELD_NUMBER = 3; private int point_; public static final int S2C_CODE_FIELD_NUMBER = 4; private int s2CCode_; public static final int ITEMCODE_FIELD_NUMBER = 5; private Object itemCode_; public static final int NUM_FIELD_NUMBER = 6; private int num_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ThrowPointResultPush> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public String getId() { Object ref = this.id_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.id_ = s;  return s; } public ByteString getIdBytes() { Object ref = this.id_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b; return b; }  return (ByteString)ref; } public boolean hasName() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  5418 */     private static final FightLevelResultPush defaultInstance = new FightLevelResultPush(true); private final UnknownFieldSet unknownFields; private FightLevelResultPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private FightLevelResultPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static FightLevelResultPush getDefaultInstance() { return defaultInstance; } public FightLevelResultPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private FightLevelResultPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { Common.DemonTowerFloorInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.time_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.level_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.type_ = input.readInt32(); break;case 34: if ((mutable_bitField0_ & 0x8) != 8) { this.itemLine1_ = new ArrayList<>(); mutable_bitField0_ |= 0x8; }  this.itemLine1_.add(input.readMessage(BattleHandler.ItemNormal.PARSER, extensionRegistry)); break;case 50: if ((mutable_bitField0_ & 0x10) != 16) { this.itemLine2_ = new ArrayList<>(); mutable_bitField0_ |= 0x10; }  this.itemLine2_.add(input.readMessage(BattleHandler.ItemNormal.PARSER, extensionRegistry)); break;case 56: this.bitField0_ |= 0x8; this.isMax_ = input.readInt32(); break;case 66: subBuilder = null; if ((this.bitField0_ & 0x10) == 16) subBuilder = this.demonTowerFloorInfo_.toBuilder();  this.demonTowerFloorInfo_ = (Common.DemonTowerFloorInfo)input.readMessage(Common.DemonTowerFloorInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.demonTowerFloorInfo_); this.demonTowerFloorInfo_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x10; break;case 72: this.bitField0_ |= 0x20; this.currentTime_ = input.readInt32(); break;case 80: this.bitField0_ |= 0x40; this.newRecordFloor_ = input.readBool(); break;case 88: this.bitField0_ |= 0x80; this.newRecordTime_ = input.readBool(); break;case 96: this.bitField0_ |= 0x100; this.myMaxFloorId_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x8) == 8) this.itemLine1_ = Collections.unmodifiableList(this.itemLine1_);  if ((mutable_bitField0_ & 0x10) == 16) this.itemLine2_ = Collections.unmodifiableList(this.itemLine2_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_FightLevelResultPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_FightLevelResultPush_fieldAccessorTable.ensureFieldAccessorsInitialized(FightLevelResultPush.class, Builder.class); } public static Parser<FightLevelResultPush> PARSER = (Parser<FightLevelResultPush>)new AbstractParser<FightLevelResultPush>() { public BattleHandler.FightLevelResultPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.FightLevelResultPush(input, extensionRegistry); } }
/*  5419 */     ; private int bitField0_; public static final int TIME_FIELD_NUMBER = 1; private int time_; public static final int LEVEL_FIELD_NUMBER = 2; private int level_; public static final int TYPE_FIELD_NUMBER = 3; private int type_; public static final int ITEMLINE1_FIELD_NUMBER = 4; private List<BattleHandler.ItemNormal> itemLine1_; public static final int ITEMLINE2_FIELD_NUMBER = 6; private List<BattleHandler.ItemNormal> itemLine2_; static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  6897 */     private static final ResourceDungeonResultPush defaultInstance = new ResourceDungeonResultPush(true); private final UnknownFieldSet unknownFields; private ResourceDungeonResultPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ResourceDungeonResultPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ResourceDungeonResultPush getDefaultInstance() { return defaultInstance; } public ResourceDungeonResultPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ResourceDungeonResultPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.dungeonId_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.killMonster_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.doubleCost_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.exp_ = input.readInt32(); break;case 40: this.bitField0_ |= 0x10; this.gold_ = input.readInt32(); break;case 50: if ((mutable_bitField0_ & 0x20) != 32) { this.itemLine1_ = new ArrayList<>(); mutable_bitField0_ |= 0x20; }  this.itemLine1_.add(input.readMessage(BattleHandler.ItemNormal.PARSER, extensionRegistry)); break;case 56: this.bitField0_ |= 0x20; this.succ_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x20) == 32) this.itemLine1_ = Collections.unmodifiableList(this.itemLine1_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ResourceDungeonResultPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ResourceDungeonResultPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ResourceDungeonResultPush.class, Builder.class); } public static Parser<ResourceDungeonResultPush> PARSER = (Parser<ResourceDungeonResultPush>)new AbstractParser<ResourceDungeonResultPush>() { public BattleHandler.ResourceDungeonResultPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ResourceDungeonResultPush(input, extensionRegistry); } }
/*  6898 */     ; private int bitField0_; public static final int DUNGEONID_FIELD_NUMBER = 1; private int dungeonId_; public static final int KILLMONSTER_FIELD_NUMBER = 2; private int killMonster_; public static final int DOUBLECOST_FIELD_NUMBER = 3; private int doubleCost_; public static final int EXP_FIELD_NUMBER = 4; private int exp_; public static final int GOLD_FIELD_NUMBER = 5; private int gold_; public static final int ITEMLINE1_FIELD_NUMBER = 6; private List<BattleHandler.ItemNormal> itemLine1_; public static final int SUCC_FIELD_NUMBER = 7; private int succ_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ResourceDungeonResultPush> getParserForType() { return PARSER; } public boolean hasDungeonId() { return ((this.bitField0_ & 0x1) == 1); } public int getDungeonId() { return this.dungeonId_; } public boolean hasKillMonster() { return ((this.bitField0_ & 0x2) == 2); } public int getKillMonster() { return this.killMonster_; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  8352 */     private static final ItemDrop defaultInstance = new ItemDrop(true); private final UnknownFieldSet unknownFields; private ItemDrop(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ItemDrop(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ItemDrop getDefaultInstance() { return defaultInstance; } public ItemDrop getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ItemDrop(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.id_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.name_ = bs; break;case 26: bs = input.readBytes(); this.bitField0_ |= 0x4; this.showId_ = bs; break;case 32: this.bitField0_ |= 0x8; this.groupCount_ = input.readInt32(); break;case 40: this.bitField0_ |= 0x10; this.qColor_ = input.readInt32(); break;case 48: this.bitField0_ |= 0x20; this.itemTypeId_ = input.readInt32(); break;case 58: bs = input.readBytes(); this.bitField0_ |= 0x40; this.iconName_ = bs; break;case 64: this.bitField0_ |= 0x80; this.freezeTime_ = input.readInt32(); break;case 72: this.bitField0_ |= 0x100; this.protectTime_ = input.readInt32(); break;case 80: this.bitField0_ |= 0x200; this.lifeTime_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ItemDrop_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ItemDrop_fieldAccessorTable.ensureFieldAccessorsInitialized(ItemDrop.class, Builder.class); } public static Parser<ItemDrop> PARSER = (Parser<ItemDrop>)new AbstractParser<ItemDrop>() { public BattleHandler.ItemDrop parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ItemDrop(input, extensionRegistry); } }
/*  8353 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private Object id_; public static final int NAME_FIELD_NUMBER = 2; private Object name_; public static final int SHOWID_FIELD_NUMBER = 3; private Object showId_; public static final int GROUPCOUNT_FIELD_NUMBER = 4; private int groupCount_; public static final int QCOLOR_FIELD_NUMBER = 5; static { defaultInstance.initFields(); }
/*       */     
/*       */     private int qColor_; public static final int ITEMTYPEID_FIELD_NUMBER = 6; private int itemTypeId_; public static final int ICONNAME_FIELD_NUMBER = 7; private Object iconName_; public static final int FREEZETIME_FIELD_NUMBER = 8; private int freezeTime_; public static final int PROTECTTIME_FIELD_NUMBER = 9; private int protectTime_; public static final int LIFETIME_FIELD_NUMBER = 10; private int lifeTime_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L;
...
/*       */     }
/*       */     
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements BattleHandler.ItemDropOrBuilder { private int bitField0_;
/*       */       private Object id_;
/*       */       private Object name_;
...
/*       */       } } }
/*       */   
/*  9207 */   public static final class ItemDropPush extends GeneratedMessage implements ItemDropPushOrBuilder { private static final ItemDropPush defaultInstance = new ItemDropPush(true); private final UnknownFieldSet unknownFields; private ItemDropPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ItemDropPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ItemDropPush getDefaultInstance() { return defaultInstance; } public ItemDropPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ItemDropPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.x_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.y_ = input.readInt32(); break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.items_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.items_.add(input.readMessage(BattleHandler.ItemDrop.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.items_ = Collections.unmodifiableList(this.items_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ItemDropPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ItemDropPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ItemDropPush.class, Builder.class); } public static Parser<ItemDropPush> PARSER = (Parser<ItemDropPush>)new AbstractParser<ItemDropPush>() { public BattleHandler.ItemDropPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ItemDropPush(input, extensionRegistry); } }
/*  9208 */     ; private int bitField0_; public static final int X_FIELD_NUMBER = 1; private int x_; public static final int Y_FIELD_NUMBER = 2; private int y_; public static final int ITEMS_FIELD_NUMBER = 3; private List<BattleHandler.ItemDrop> items_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ItemDropPush> getParserForType() { return PARSER; } public boolean hasX() { return ((this.bitField0_ & 0x1) == 1); } public int getX() { return this.x_; } public boolean hasY() { return ((this.bitField0_ & 0x2) == 2); } public int getY() { return this.y_; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/* 10070 */     private static final PointItemView defaultInstance = new PointItemView(true); private final UnknownFieldSet unknownFields; private PointItemView(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private PointItemView(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static PointItemView getDefaultInstance() { return defaultInstance; } public PointItemView getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private PointItemView(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.id_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.itemCode_ = bs; break;case 24: this.bitField0_ |= 0x4; this.num_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_PointItemView_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_PointItemView_fieldAccessorTable.ensureFieldAccessorsInitialized(PointItemView.class, Builder.class); } public static Parser<PointItemView> PARSER = (Parser<PointItemView>)new AbstractParser<PointItemView>() { public BattleHandler.PointItemView parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.PointItemView(input, extensionRegistry); } }
/* 10071 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private Object id_; public static final int ITEMCODE_FIELD_NUMBER = 2; private Object itemCode_; public static final int NUM_FIELD_NUMBER = 3; private int num_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<PointItemView> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public String getId() { Object ref = this.id_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.id_ = s;  return s; } public ByteString getIdBytes() { Object ref = this.id_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b; return b; }  return (ByteString)ref; } public boolean hasItemCode() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/* 11069 */     private static final ThrowPointItemListPush defaultInstance = new ThrowPointItemListPush(true); private final UnknownFieldSet unknownFields; private ThrowPointItemListPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ThrowPointItemListPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ThrowPointItemListPush getDefaultInstance() { return defaultInstance; } public ThrowPointItemListPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ThrowPointItemListPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.time_ = input.readInt32(); break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.items_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.items_.add(input.readMessage(BattleHandler.PointItemView.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.items_ = Collections.unmodifiableList(this.items_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_ThrowPointItemListPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_ThrowPointItemListPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ThrowPointItemListPush.class, Builder.class); } public static Parser<ThrowPointItemListPush> PARSER = (Parser<ThrowPointItemListPush>)new AbstractParser<ThrowPointItemListPush>() { public BattleHandler.ThrowPointItemListPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BattleHandler.ThrowPointItemListPush(input, extensionRegistry); } }
/* 11070 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int TIME_FIELD_NUMBER = 2; private int time_; public static final int ITEMS_FIELD_NUMBER = 3; private List<BattleHandler.PointItemView> items_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ThrowPointItemListPush> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasTime() { return ((this.bitField0_ & 0x2) == 2); } public int getTime() { return this.time_; } static { defaultInstance.initFields(); }
...
/*       */       return builder;
/*       */     }
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements BattleHandler.ThrowPointItemListPushOrBuilder { private int bitField0_; private int s2CCode_; private int time_; private List<BattleHandler.PointItemView> items_; private RepeatedFieldBuilder<BattleHandler.PointItemView, BattleHandler.PointItemView.Builder, BattleHandler.PointItemViewOrBuilder> itemsBuilder_;
/*       */       public static final Descriptors.Descriptor getDescriptor() {
...
/*       */       } }
/*       */   }
/*       */   public static final class SceneNamePush extends GeneratedMessage implements SceneNamePushOrBuilder { private final UnknownFieldSet unknownFields;
...
/*       */     }
/*       */     public static Parser<SceneNamePush> PARSER = (Parser<SceneNamePush>)new AbstractParser<SceneNamePush>() { public BattleHandler.SceneNamePush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
/*       */           return new BattleHandler.SceneNamePush(input, extensionRegistry);
/*       */         } }
/*       */     ;
/* 11553 */     private int bitField0_; public static final int SCENE_NAME_FIELD_NUMBER = 1; private Object sceneName_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; private static final SceneNamePush defaultInstance = new SceneNamePush(true);
/* 11554 */     public Parser<SceneNamePush> getParserForType() { return PARSER; } public boolean hasSceneName() { return ((this.bitField0_ & 0x1) == 1); } public String getSceneName() { Object ref = this.sceneName_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.sceneName_ = s;  return s; } public ByteString getSceneNameBytes() { Object ref = this.sceneName_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.sceneName_ = b; return b; }  return (ByteString)ref; } private void initFields() { this.sceneName_ = ""; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasSceneName()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeBytes(1, getSceneNameBytes());  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeBytesSize(1, getSceneNameBytes());  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static SceneNamePush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (SceneNamePush)PARSER.parseFrom(data); } public static SceneNamePush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (SceneNamePush)PARSER.parseFrom(data, extensionRegistry); } public static SceneNamePush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (SceneNamePush)PARSER.parseFrom(data); } public static SceneNamePush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (SceneNamePush)PARSER.parseFrom(data, extensionRegistry); } public static SceneNamePush parseFrom(InputStream input) throws IOException { return (SceneNamePush)PARSER.parseFrom(input); } public static SceneNamePush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (SceneNamePush)PARSER.parseFrom(input, extensionRegistry); } static { defaultInstance.initFields(); } public static SceneNamePush parseDelimitedFrom(InputStream input) throws IOException { return (SceneNamePush)PARSER.parseDelimitedFrom(input); } public static SceneNamePush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (SceneNamePush)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*       */     public static SceneNamePush parseFrom(CodedInputStream input) throws IOException { return (SceneNamePush)PARSER.parseFrom(input); }
/*       */     public static SceneNamePush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (SceneNamePush)PARSER.parseFrom(input, extensionRegistry); }
/*       */     public static Builder newBuilder() { return Builder.create(); }
/*       */     public Builder newBuilderForType() { return newBuilder(); }
/*       */     public static Builder newBuilder(SceneNamePush prototype) { return newBuilder().mergeFrom(prototype); }
...
/*       */       private int bitField0_; private Object sceneName_;
/*       */       public static final Descriptors.Descriptor getDescriptor() { return BattleHandler.internal_static_pomelo_area_SceneNamePush_descriptor; }
/*       */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BattleHandler.internal_static_pomelo_area_SceneNamePush_fieldAccessorTable.ensureFieldAccessorsInitialized(BattleHandler.SceneNamePush.class, Builder.class); }
/*       */       private Builder() { this.sceneName_ = ""; maybeForceBuilderInitialization(); }
/*       */       private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.sceneName_ = ""; maybeForceBuilderInitialization(); }
/*       */       private void maybeForceBuilderInitialization() { if (BattleHandler.SceneNamePush.alwaysUseFieldBuilders); }
/*       */       private static Builder create() { return new Builder(); }
/*       */       public Builder clear() { super.clear(); this.sceneName_ = ""; this.bitField0_ &= 0xFFFFFFFE; return this; }
/*       */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*       */       public Descriptors.Descriptor getDescriptorForType() { return BattleHandler.internal_static_pomelo_area_SceneNamePush_descriptor; }
/*       */       public BattleHandler.SceneNamePush getDefaultInstanceForType() { return BattleHandler.SceneNamePush.getDefaultInstance(); }
/*       */       public BattleHandler.SceneNamePush build() { BattleHandler.SceneNamePush result = buildPartial(); if (!result.isInitialized())
/*       */           throw newUninitializedMessageException(result);  return result; }
/*       */       public BattleHandler.SceneNamePush buildPartial() { BattleHandler.SceneNamePush result = new BattleHandler.SceneNamePush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
/*       */           to_bitField0_ |= 0x1;  result.sceneName_ = this.sceneName_; result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*       */       public Builder mergeFrom(Message other) { if (other instanceof BattleHandler.SceneNamePush)
/*       */           return mergeFrom((BattleHandler.SceneNamePush)other);  super.mergeFrom(other); return this; }
/*       */       public Builder mergeFrom(BattleHandler.SceneNamePush other) { if (other == BattleHandler.SceneNamePush.getDefaultInstance())
/*       */           return this;  if (other.hasSceneName()) {
/*       */           this.bitField0_ |= 0x1; this.sceneName_ = other.sceneName_; onChanged();
/*       */         }  mergeUnknownFields(other.getUnknownFields()); return this; }
/*       */       public final boolean isInitialized() { if (!hasSceneName())
/*       */           return false;  return true; }
/*       */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { BattleHandler.SceneNamePush parsedMessage = null; try {
/*       */           parsedMessage = (BattleHandler.SceneNamePush)BattleHandler.SceneNamePush.PARSER.parsePartialFrom(input, extensionRegistry);
/*       */         } catch (InvalidProtocolBufferException e) {
/*       */           parsedMessage = (BattleHandler.SceneNamePush)e.getUnfinishedMessage(); throw e;
/*       */         } finally {
/*       */           if (parsedMessage != null)
/*       */             mergeFrom(parsedMessage); 
/*       */         }  return this; }
/*       */       public boolean hasSceneName() { return ((this.bitField0_ & 0x1) == 1); }
/*       */       public String getSceneName() { Object ref = this.sceneName_; if (!(ref instanceof String)) {
/*       */           ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8())
/*       */             this.sceneName_ = s;  return s;
/*       */         }  return (String)ref; }
/*       */       public ByteString getSceneNameBytes() { Object ref = this.sceneName_; if (ref instanceof String) {
/*       */           ByteString b = ByteString.copyFromUtf8((String)ref); this.sceneName_ = b; return b;
/*       */         }  return (ByteString)ref; }
/*       */       public Builder setSceneName(String value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x1;
/*       */         this.sceneName_ = value;
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder clearSceneName() { this.bitField0_ &= 0xFFFFFFFE;
/*       */         this.sceneName_ = BattleHandler.SceneNamePush.getDefaultInstance().getSceneName();
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder setSceneNameBytes(ByteString value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x1;
/*       */         this.sceneName_ = value;
/*       */         onChanged();
/*       */         return this; } } }
/* 11618 */   public static Descriptors.FileDescriptor getDescriptor() { return descriptor; }
/*       */ 
/*       */ 
/*       */   
/*       */   static {
/* 11623 */     String[] descriptorData = { "\n\023battleHandler.proto\022\013pomelo.area\032\fcommon.proto\"/\n\nItemNormal\022\020\n\bitemCode\030\001 \002(\t\022\017\n\007itemNum\030\002 \002(\005\"\037\n\021ThrowPointRequest\022\n\n\002id\030\001 \001(\t\"F\n\022ThrowPointResponse\022\020\n\bs2c_code\030\001 \002(\005\022\017\n\007s2c_msg\030\002 \001(\t\022\r\n\005point\030\003 \001(\005\"p\n\024ThrowPointResultPush\022\n\n\002id\030\001 \002(\t\022\f\n\004name\030\002 \002(\t\022\r\n\005point\030\003 \002(\005\022\020\n\bs2c_code\030\004 \002(\005\022\020\n\bitemCode\030\005 \002(\t\022\013\n\003num\030\006 \002(\005\"¼\002\n\024FightLevelResultPush\022\f\n\004time\030\001 \001(\005\022\r\n\005level\030\002 \001(\005\022\f\n\004type\030\003 \001(\005\022*\n\titemLine1\030\004 ", "\003(\0132\027.pomelo.area.ItemNormal\022*\n\titemLine2\030\006 \003(\0132\027.pomelo.area.ItemNormal\022\r\n\005isMax\030\007 \001(\005\0228\n\023demonTowerFloorInfo\030\b \001(\0132\033.pomelo.DemonTowerFloorInfo\022\023\n\013currentTime\030\t \001(\005\022\026\n\016newRecordFloor\030\n \001(\b\022\025\n\rnewRecordTime\030\013 \001(\b\022\024\n\fmyMaxFloorId\030\f \001(\005\"¬\001\n\031ResourceDungeonResultPush\022\021\n\tdungeonId\030\001 \002(\005\022\023\n\013killMonster\030\002 \001(\005\022\022\n\ndoubleCost\030\003 \001(\005\022\013\n\003exp\030\004 \001(\005\022\f\n\004gold\030\005 \001(\005\022*\n\titemLine1\030\006 \003(\0132\027.pomelo.area.ItemNormal\022\f\n\004", "succ\030\007 \001(\005\"¹\001\n\bItemDrop\022\n\n\002id\030\001 \001(\t\022\f\n\004name\030\002 \002(\t\022\016\n\006showId\030\003 \002(\t\022\022\n\ngroupCount\030\004 \001(\005\022\016\n\006qColor\030\005 \002(\005\022\022\n\nitemTypeId\030\006 \002(\005\022\020\n\biconName\030\007 \002(\t\022\022\n\nfreezeTime\030\b \001(\005\022\023\n\013protectTime\030\t \001(\005\022\020\n\blifeTime\030\n \001(\005\"J\n\fItemDropPush\022\t\n\001x\030\001 \001(\005\022\t\n\001y\030\002 \002(\005\022$\n\005items\030\003 \003(\0132\025.pomelo.area.ItemDrop\":\n\rPointItemView\022\n\n\002id\030\001 \002(\t\022\020\n\bitemCode\030\002 \002(\t\022\013\n\003num\030\003 \002(\005\"c\n\026ThrowPointItemListPush\022\020\n\bs2c_code\030\001 \002(\005\022\f\n\004time\030\002 \001(\005\022)\n\005item", "s\030\003 \003(\0132\032.pomelo.area.PointItemView\"#\n\rSceneNamePush\022\022\n\nscene_name\030\001 \002(\t2e\n\rbattleHandler\022T\n\021throwPointRequest\022\036.pomelo.area.ThrowPointRequest\032\037.pomelo.area.ThrowPointResponse2²\003\n\nbattlePush\022K\n\026throwPointItemListPush\022#.pomelo.area.ThrowPointItemListPush\032\f.pomelo.Void\022G\n\024throwPointResultPush\022!.pomelo.area.ThrowPointResultPush\032\f.pomelo.Void\022G\n\024fightLevelResultPush\022!.pomelo.area.FightLevelResultPush\032", "\f.pomelo.Void\0227\n\fitemDropPush\022\031.pomelo.area.ItemDropPush\032\f.pomelo.Void\0229\n\rsceneNamePush\022\032.pomelo.area.SceneNamePush\032\f.pomelo.Void\022Q\n\031resourceDungeonResultPush\022&.pomelo.area.ResourceDungeonResultPush\032\f.pomelo.Void" };
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */ 
/*       */     
/* 11671 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*       */       {
/*       */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*       */         {
/* 11675 */           BattleHandler.descriptor = root;
/* 11676 */           return null;
/*       */         }
/*       */       };
/*       */     
/* 11680 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*       */           
/* 11682 */           Common.getDescriptor() }, assigner);
/*       */   }
/*       */   
/* 11685 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ItemNormal_descriptor = getDescriptor().getMessageTypes().get(0);
/* 11686 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ItemNormal_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ItemNormal_descriptor, new String[] { "ItemCode", "ItemNum" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11691 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ThrowPointRequest_descriptor = getDescriptor().getMessageTypes().get(1);
/* 11692 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ThrowPointRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ThrowPointRequest_descriptor, new String[] { "Id" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11697 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ThrowPointResponse_descriptor = getDescriptor().getMessageTypes().get(2);
/* 11698 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ThrowPointResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ThrowPointResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "Point" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11703 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ThrowPointResultPush_descriptor = getDescriptor().getMessageTypes().get(3);
/* 11704 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ThrowPointResultPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ThrowPointResultPush_descriptor, new String[] { "Id", "Name", "Point", "S2CCode", "ItemCode", "Num" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11709 */   private static final Descriptors.Descriptor internal_static_pomelo_area_FightLevelResultPush_descriptor = getDescriptor().getMessageTypes().get(4);
/* 11710 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_FightLevelResultPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_FightLevelResultPush_descriptor, new String[] { "Time", "Level", "Type", "ItemLine1", "ItemLine2", "IsMax", "DemonTowerFloorInfo", "CurrentTime", "NewRecordFloor", "NewRecordTime", "MyMaxFloorId" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11715 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ResourceDungeonResultPush_descriptor = getDescriptor().getMessageTypes().get(5);
/* 11716 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ResourceDungeonResultPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ResourceDungeonResultPush_descriptor, new String[] { "DungeonId", "KillMonster", "DoubleCost", "Exp", "Gold", "ItemLine1", "Succ" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11721 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ItemDrop_descriptor = getDescriptor().getMessageTypes().get(6);
/* 11722 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ItemDrop_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ItemDrop_descriptor, new String[] { "Id", "Name", "ShowId", "GroupCount", "QColor", "ItemTypeId", "IconName", "FreezeTime", "ProtectTime", "LifeTime" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11727 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ItemDropPush_descriptor = getDescriptor().getMessageTypes().get(7);
/* 11728 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ItemDropPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ItemDropPush_descriptor, new String[] { "X", "Y", "Items" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11733 */   private static final Descriptors.Descriptor internal_static_pomelo_area_PointItemView_descriptor = getDescriptor().getMessageTypes().get(8);
/* 11734 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_PointItemView_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_PointItemView_descriptor, new String[] { "Id", "ItemCode", "Num" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11739 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ThrowPointItemListPush_descriptor = getDescriptor().getMessageTypes().get(9);
/* 11740 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ThrowPointItemListPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ThrowPointItemListPush_descriptor, new String[] { "S2CCode", "Time", "Items" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 11745 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SceneNamePush_descriptor = getDescriptor().getMessageTypes().get(10);
/* 11746 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SceneNamePush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SceneNamePush_descriptor, new String[] { "SceneName" });
/*       */   private static Descriptors.FileDescriptor descriptor;
/*       */   
/*       */   static {
/* 11750 */     Common.getDescriptor();
/*       */   }
/*       */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\BattleHandler.class
