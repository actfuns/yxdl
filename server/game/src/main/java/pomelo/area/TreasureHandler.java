...
/*      */ 
/*      */     
/*   51 */     private static Internal.EnumLiteMap<OpenType> internalValueMap = new Internal.EnumLiteMap<OpenType>()
/*      */       {
/*      */         public TreasureHandler.OpenType findValueByNumber(int number) {
/*   54 */           return TreasureHandler.OpenType.valueOf(number);
/*      */         }
/*      */       };
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*   71 */     private static final OpenType[] VALUES = values(); private final int index; private final int value; public final int getNumber() {
/*      */       return this.value;
...
/*      */   {
/*  876 */     private static final TreasureItem defaultInstance = new TreasureItem(true); private final UnknownFieldSet unknownFields; private TreasureItem(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private TreasureItem(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static TreasureItem getDefaultInstance() { return defaultInstance; } public TreasureItem getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private TreasureItem(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.itemCode_ = bs; break;case 16: this.bitField0_ |= 0x2; this.itemNum_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.isBind_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.score_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_TreasureItem_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_TreasureItem_fieldAccessorTable.ensureFieldAccessorsInitialized(TreasureItem.class, Builder.class); } public static Parser<TreasureItem> PARSER = (Parser<TreasureItem>)new AbstractParser<TreasureItem>() { public TreasureHandler.TreasureItem parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.TreasureItem(input, extensionRegistry); } }
/*  877 */     ; private int bitField0_; public static final int ITEMCODE_FIELD_NUMBER = 1; private Object itemCode_; public static final int ITEMNUM_FIELD_NUMBER = 2; private int itemNum_; public static final int ISBIND_FIELD_NUMBER = 3; private int isBind_; public static final int SCORE_FIELD_NUMBER = 4; private int score_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<TreasureItem> getParserForType() { return PARSER; } public boolean hasItemCode() { return ((this.bitField0_ & 0x1) == 1); } public String getItemCode() { Object ref = this.itemCode_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.itemCode_ = s;  return s; } public ByteString getItemCodeBytes() { Object ref = this.itemCode_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.itemCode_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */     
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements TreasureHandler.TreasureItemOrBuilder { private int bitField0_; private Object itemCode_; private int itemNum_; private int isBind_; private int score_;
...
/*      */       } } }
/*      */   
/*      */   public static final class GetTreasureInfoRequest extends GeneratedMessage implements GetTreasureInfoRequestOrBuilder { private final UnknownFieldSet unknownFields;
/*      */     
...
/*      */     }
/*      */     
/*      */     public static Parser<GetTreasureInfoRequest> PARSER = (Parser<GetTreasureInfoRequest>)new AbstractParser<GetTreasureInfoRequest>() { public TreasureHandler.GetTreasureInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
...
/*      */     }
/*      */     
/* 1321 */     private static final GetTreasureInfoRequest defaultInstance = new GetTreasureInfoRequest(true); public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasC2STreasureMsg()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.c2STreasureMsg_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.c2STreasureMsg_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static GetTreasureInfoRequest parseFrom(ByteString data) throws InvalidProtocolBufferException { return (GetTreasureInfoRequest)PARSER.parseFrom(data); } public static GetTreasureInfoRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (GetTreasureInfoRequest)PARSER.parseFrom(data, extensionRegistry); } public static GetTreasureInfoRequest parseFrom(byte[] data) throws InvalidProtocolBufferException { return (GetTreasureInfoRequest)PARSER.parseFrom(data); } public static GetTreasureInfoRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (GetTreasureInfoRequest)PARSER.parseFrom(data, extensionRegistry); } public static GetTreasureInfoRequest parseFrom(InputStream input) throws IOException { return (GetTreasureInfoRequest)PARSER.parseFrom(input); } public static GetTreasureInfoRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (GetTreasureInfoRequest)PARSER.parseFrom(input, extensionRegistry); }
/* 1322 */     static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2152 */     private static final GetTreasureInfoResponse defaultInstance = new GetTreasureInfoResponse(true); private final UnknownFieldSet unknownFields; private GetTreasureInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetTreasureInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetTreasureInfoResponse getDefaultInstance() { return defaultInstance; } public GetTreasureInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetTreasureInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.s2CTreasureBagSize_ = input.readInt32(); break;case 34: bs = input.readBytes(); if ((mutable_bitField0_ & 0x8) != 8) { this.s2CTreasureMsg_ = (LazyStringList)new LazyStringArrayList(); mutable_bitField0_ |= 0x8; }  this.s2CTreasureMsg_.add(bs); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x8) == 8) this.s2CTreasureMsg_ = this.s2CTreasureMsg_.getUnmodifiableView();  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_GetTreasureInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_GetTreasureInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetTreasureInfoResponse.class, Builder.class); } public static Parser<GetTreasureInfoResponse> PARSER = (Parser<GetTreasureInfoResponse>)new AbstractParser<GetTreasureInfoResponse>() { public TreasureHandler.GetTreasureInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.GetTreasureInfoResponse(input, extensionRegistry); } }
/* 2153 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TREASUREBAGSIZE_FIELD_NUMBER = 3; private int s2CTreasureBagSize_; public static final int S2C_TREASUREMSG_FIELD_NUMBER = 4; private LazyStringList s2CTreasureMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetTreasureInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String) {
/*      */         ByteString b = ByteString.copyFromUtf8((String)ref);
/*      */         this.s2CMsg_ = b;
/*      */         return b;
/*      */       } 
/*      */       return (ByteString)ref; } public boolean hasS2CTreasureBagSize() { return ((this.bitField0_ & 0x4) == 4); } public int getS2CTreasureBagSize() { return this.s2CTreasureBagSize_; } public ProtocolStringList getS2CTreasureMsgList() {
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements TreasureHandler.GetTreasureInfoResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int s2CTreasureBagSize_; private LazyStringList s2CTreasureMsg_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */         return this;
/*      */       } } }
/* 2473 */   public static final class GetTreasureBagInfoRequest extends GeneratedMessage implements GetTreasureBagInfoRequestOrBuilder { private static final GetTreasureBagInfoRequest defaultInstance = new GetTreasureBagInfoRequest(true); private final UnknownFieldSet unknownFields; private GetTreasureBagInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetTreasureBagInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetTreasureBagInfoRequest getDefaultInstance() { return defaultInstance; } public GetTreasureBagInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetTreasureBagInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_GetTreasureBagInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_GetTreasureBagInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetTreasureBagInfoRequest.class, Builder.class); } public static Parser<GetTreasureBagInfoRequest> PARSER = (Parser<GetTreasureBagInfoRequest>)new AbstractParser<GetTreasureBagInfoRequest>() { public TreasureHandler.GetTreasureBagInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.GetTreasureBagInfoRequest(input, extensionRegistry); } }
/* 2474 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetTreasureBagInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 3407 */     private static final GetTreasureBagInfoResponse defaultInstance = new GetTreasureBagInfoResponse(true); private final UnknownFieldSet unknownFields; private GetTreasureBagInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetTreasureBagInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetTreasureBagInfoResponse getDefaultInstance() { return defaultInstance; } public GetTreasureBagInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetTreasureBagInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CTreasureBag_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CTreasureBag_.add(input.readMessage(TreasureHandler.TreasureItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CTreasureBag_ = Collections.unmodifiableList(this.s2CTreasureBag_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_GetTreasureBagInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_GetTreasureBagInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetTreasureBagInfoResponse.class, Builder.class); } public static Parser<GetTreasureBagInfoResponse> PARSER = (Parser<GetTreasureBagInfoResponse>)new AbstractParser<GetTreasureBagInfoResponse>() { public TreasureHandler.GetTreasureBagInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.GetTreasureBagInfoResponse(input, extensionRegistry); } }
/* 3408 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TREASUREBAG_FIELD_NUMBER = 3; private List<TreasureHandler.TreasureItem> s2CTreasureBag_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetTreasureBagInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */     
...
/*      */     }
/*      */     
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements TreasureHandler.GetTreasureBagInfoResponseOrBuilder { private int bitField0_;
...
/*      */       } } }
/*      */   
/* 3947 */   public static final class OpenTreasureRequest extends GeneratedMessage implements OpenTreasureRequestOrBuilder { private static final OpenTreasureRequest defaultInstance = new OpenTreasureRequest(true); private final UnknownFieldSet unknownFields; private OpenTreasureRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private OpenTreasureRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static OpenTreasureRequest getDefaultInstance() { return defaultInstance; } public OpenTreasureRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private OpenTreasureRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int rawValue; TreasureHandler.OpenType value; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: rawValue = input.readEnum(); value = TreasureHandler.OpenType.valueOf(rawValue); if (value == null) { unknownFields.mergeVarintField(1, rawValue); break; }  this.bitField0_ |= 0x1; this.c2SOpenType_ = value; break;case 16: this.bitField0_ |= 0x2; this.c2SUseDiamond_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_OpenTreasureRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_OpenTreasureRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(OpenTreasureRequest.class, Builder.class); } public static Parser<OpenTreasureRequest> PARSER = (Parser<OpenTreasureRequest>)new AbstractParser<OpenTreasureRequest>() { public TreasureHandler.OpenTreasureRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.OpenTreasureRequest(input, extensionRegistry); } }
/* 3948 */     ; private int bitField0_; public static final int C2S_OPENTYPE_FIELD_NUMBER = 1; private TreasureHandler.OpenType c2SOpenType_; public static final int C2S_USEDIAMOND_FIELD_NUMBER = 2; private int c2SUseDiamond_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<OpenTreasureRequest> getParserForType() { return PARSER; } public boolean hasC2SOpenType() { return ((this.bitField0_ & 0x1) == 1); } public TreasureHandler.OpenType getC2SOpenType() { return this.c2SOpenType_; } public boolean hasC2SUseDiamond() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4881 */     private static final OpenTreasureResponse defaultInstance = new OpenTreasureResponse(true); private final UnknownFieldSet unknownFields; private OpenTreasureResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private OpenTreasureResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static OpenTreasureResponse getDefaultInstance() { return defaultInstance; } public OpenTreasureResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private OpenTreasureResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CTreasureItem_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CTreasureItem_.add(input.readMessage(TreasureHandler.TreasureItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CTreasureItem_ = Collections.unmodifiableList(this.s2CTreasureItem_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_OpenTreasureResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_OpenTreasureResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(OpenTreasureResponse.class, Builder.class); } public static Parser<OpenTreasureResponse> PARSER = (Parser<OpenTreasureResponse>)new AbstractParser<OpenTreasureResponse>() { public TreasureHandler.OpenTreasureResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.OpenTreasureResponse(input, extensionRegistry); } }
/* 4882 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TREASUREITEM_FIELD_NUMBER = 3; private List<TreasureHandler.TreasureItem> s2CTreasureItem_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<OpenTreasureResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public List<TreasureHandler.TreasureItem> getS2CTreasureItemList() { return this.s2CTreasureItem_; } public List<? extends TreasureHandler.TreasureItemOrBuilder> getS2CTreasureItemOrBuilderList() { return (List)this.s2CTreasureItem_; } public int getS2CTreasureItemCount() { return this.s2CTreasureItem_.size(); } public TreasureHandler.TreasureItem getS2CTreasureItem(int index) { return this.s2CTreasureItem_.get(index); } public TreasureHandler.TreasureItemOrBuilder getS2CTreasureItemOrBuilder(int index) { return this.s2CTreasureItem_.get(index); } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CTreasureItem_ = Collections.emptyList(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  for (int i = 0; i < getS2CTreasureItemCount(); i++) { if (!getS2CTreasureItem(i).isInitialized()) { this.memoizedIsInitialized = 0; return false; }  }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  for (int i = 0; i < this.s2CTreasureItem_.size(); i++) output.writeMessage(3, (MessageLite)this.s2CTreasureItem_.get(i));  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  for (int i = 0; i < this.s2CTreasureItem_.size(); i++) size += CodedOutputStream.computeMessageSize(3, (MessageLite)this.s2CTreasureItem_.get(i));  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static OpenTreasureResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (OpenTreasureResponse)PARSER.parseFrom(data); } public static OpenTreasureResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OpenTreasureResponse)PARSER.parseFrom(data, extensionRegistry); } public static OpenTreasureResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (OpenTreasureResponse)PARSER.parseFrom(data); } static { defaultInstance.initFields(); }
/*      */     public static OpenTreasureResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OpenTreasureResponse)PARSER.parseFrom(data, extensionRegistry); }
/*      */     public static OpenTreasureResponse parseFrom(InputStream input) throws IOException { return (OpenTreasureResponse)PARSER.parseFrom(input); }
/*      */     public static OpenTreasureResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OpenTreasureResponse)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static OpenTreasureResponse parseDelimitedFrom(InputStream input) throws IOException { return (OpenTreasureResponse)PARSER.parseDelimitedFrom(input); }
/*      */     public static OpenTreasureResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OpenTreasureResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static OpenTreasureResponse parseFrom(CodedInputStream input) throws IOException { return (OpenTreasureResponse)PARSER.parseFrom(input); } public static OpenTreasureResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OpenTreasureResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() {
/*      */       return newBuilder();
...
/*      */       private int bitField0_; private int s2CCode_; private Object s2CMsg_; private List<TreasureHandler.TreasureItem> s2CTreasureItem_; private RepeatedFieldBuilder<TreasureHandler.TreasureItem, TreasureHandler.TreasureItem.Builder, TreasureHandler.TreasureItemOrBuilder> s2CTreasureItemBuilder_; public static final Descriptors.Descriptor getDescriptor() {
...
/* 5202 */     private static final ReceiveTreasureBagRequest defaultInstance = new ReceiveTreasureBagRequest(true); private final UnknownFieldSet unknownFields; private ReceiveTreasureBagRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ReceiveTreasureBagRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ReceiveTreasureBagRequest getDefaultInstance() { return defaultInstance; } public ReceiveTreasureBagRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ReceiveTreasureBagRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ReceiveTreasureBagRequest.class, Builder.class); } public static Parser<ReceiveTreasureBagRequest> PARSER = (Parser<ReceiveTreasureBagRequest>)new AbstractParser<ReceiveTreasureBagRequest>() { public TreasureHandler.ReceiveTreasureBagRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.ReceiveTreasureBagRequest(input, extensionRegistry); } }
/* 5203 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ReceiveTreasureBagRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5764 */     private static final ReceiveTreasureBagResponse defaultInstance = new ReceiveTreasureBagResponse(true); private final UnknownFieldSet unknownFields; private ReceiveTreasureBagResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ReceiveTreasureBagResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ReceiveTreasureBagResponse getDefaultInstance() { return defaultInstance; } public ReceiveTreasureBagResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ReceiveTreasureBagResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ReceiveTreasureBagResponse.class, Builder.class); } public static Parser<ReceiveTreasureBagResponse> PARSER = (Parser<ReceiveTreasureBagResponse>)new AbstractParser<ReceiveTreasureBagResponse>() { public TreasureHandler.ReceiveTreasureBagResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new TreasureHandler.ReceiveTreasureBagResponse(input, extensionRegistry); } }
/* 5765 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ReceiveTreasureBagResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static ReceiveTreasureBagResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(data); } public static ReceiveTreasureBagResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(data, extensionRegistry); } public static ReceiveTreasureBagResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(data); } public static ReceiveTreasureBagResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(data, extensionRegistry); } public static ReceiveTreasureBagResponse parseFrom(InputStream input) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(input); } static { defaultInstance.initFields(); } public static ReceiveTreasureBagResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static ReceiveTreasureBagResponse parseDelimitedFrom(InputStream input) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseDelimitedFrom(input); }
/*      */     public static ReceiveTreasureBagResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*      */     public static ReceiveTreasureBagResponse parseFrom(CodedInputStream input) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(input); }
/*      */     public static ReceiveTreasureBagResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ReceiveTreasureBagResponse)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static Builder newBuilder() { return Builder.create(); }
/*      */     public Builder newBuilderForType() { return newBuilder(); }
/*      */     public static Builder newBuilder(ReceiveTreasureBagResponse prototype) { return newBuilder().mergeFrom(prototype); }
...
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements TreasureHandler.ReceiveTreasureBagResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_;
/*      */       public static final Descriptors.Descriptor getDescriptor() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagResponse_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(TreasureHandler.ReceiveTreasureBagResponse.class, Builder.class); }
...
/*      */       private void maybeForceBuilderInitialization() { if (TreasureHandler.ReceiveTreasureBagResponse.alwaysUseFieldBuilders); }
...
/*      */       public Descriptors.Descriptor getDescriptorForType() { return TreasureHandler.internal_static_pomelo_area_ReceiveTreasureBagResponse_descriptor; }
/*      */       public TreasureHandler.ReceiveTreasureBagResponse getDefaultInstanceForType() { return TreasureHandler.ReceiveTreasureBagResponse.getDefaultInstance(); }
/*      */       public TreasureHandler.ReceiveTreasureBagResponse build() { TreasureHandler.ReceiveTreasureBagResponse result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; }
/*      */       public TreasureHandler.ReceiveTreasureBagResponse buildPartial() { TreasureHandler.ReceiveTreasureBagResponse result = new TreasureHandler.ReceiveTreasureBagResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
...
/*      */       public Builder mergeFrom(Message other) { if (other instanceof TreasureHandler.ReceiveTreasureBagResponse)
/*      */           return mergeFrom((TreasureHandler.ReceiveTreasureBagResponse)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(TreasureHandler.ReceiveTreasureBagResponse other) { if (other == TreasureHandler.ReceiveTreasureBagResponse.getDefaultInstance())
...
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { TreasureHandler.ReceiveTreasureBagResponse parsedMessage = null; try { parsedMessage = (TreasureHandler.ReceiveTreasureBagResponse)TreasureHandler.ReceiveTreasureBagResponse.PARSER.parsePartialFrom(input, extensionRegistry); }
/*      */         catch (InvalidProtocolBufferException e) { parsedMessage = (TreasureHandler.ReceiveTreasureBagResponse)e.getUnfinishedMessage(); throw e; }
...
/*      */ 
/*      */     
/* 5857 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 5861 */           TreasureHandler.descriptor = root;
/* 5862 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 5866 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[0], assigner);
/*      */   }
/*      */ 
/*      */   
/* 5870 */   private static final Descriptors.Descriptor internal_static_pomelo_area_TreasureItem_descriptor = getDescriptor().getMessageTypes().get(0);
/* 5871 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_TreasureItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_TreasureItem_descriptor, new String[] { "ItemCode", "ItemNum", "IsBind", "Score" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5876 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetTreasureInfoRequest_descriptor = getDescriptor().getMessageTypes().get(1);
/* 5877 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetTreasureInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetTreasureInfoRequest_descriptor, new String[] { "C2STreasureMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5882 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetTreasureInfoResponse_descriptor = getDescriptor().getMessageTypes().get(2);
/* 5883 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetTreasureInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetTreasureInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CTreasureBagSize", "S2CTreasureMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5888 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetTreasureBagInfoRequest_descriptor = getDescriptor().getMessageTypes().get(3);
/* 5889 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetTreasureBagInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetTreasureBagInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5894 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetTreasureBagInfoResponse_descriptor = getDescriptor().getMessageTypes().get(4);
/* 5895 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetTreasureBagInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetTreasureBagInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CTreasureBag" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5900 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OpenTreasureRequest_descriptor = getDescriptor().getMessageTypes().get(5);
/* 5901 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OpenTreasureRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OpenTreasureRequest_descriptor, new String[] { "C2SOpenType", "C2SUseDiamond" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5906 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OpenTreasureResponse_descriptor = getDescriptor().getMessageTypes().get(6);
/* 5907 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OpenTreasureResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OpenTreasureResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CTreasureItem" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5912 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ReceiveTreasureBagRequest_descriptor = getDescriptor().getMessageTypes().get(7);
/* 5913 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ReceiveTreasureBagRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ReceiveTreasureBagRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5918 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ReceiveTreasureBagResponse_descriptor = getDescriptor().getMessageTypes().get(8);
/* 5919 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ReceiveTreasureBagResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ReceiveTreasureBagResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\TreasureHandler.class
