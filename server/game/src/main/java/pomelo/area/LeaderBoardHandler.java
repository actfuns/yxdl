...
/*      */       }
/*      */     }
/* 1061 */     private static final LeaderBoardData defaultInstance = new LeaderBoardData(true); static {
/* 1062 */       defaultInstance.initFields();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/* 2406 */     private static final RankGuildInfo defaultInstance = new RankGuildInfo(true); private final UnknownFieldSet unknownFields; private RankGuildInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private RankGuildInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static RankGuildInfo getDefaultInstance() { return defaultInstance; } public RankGuildInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private RankGuildInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.guildId_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.guildIcon_ = bs; break;case 26: bs = input.readBytes(); this.bitField0_ |= 0x4; this.guildMaster_ = bs; break;case 32: this.bitField0_ |= 0x8; this.guildLevel_ = input.readInt32(); break;case 40: this.bitField0_ |= 0x10; this.curMember_ = input.readInt32(); break;case 48: this.bitField0_ |= 0x20; this.maxMember_ = input.readInt32(); break;case 56: this.bitField0_ |= 0x40; this.fund_ = input.readInt32(); break;case 66: bs = input.readBytes(); this.bitField0_ |= 0x80; this.notice_ = bs; break;case 72: this.bitField0_ |= 0x100; this.guildMasterPro_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_RankGuildInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_RankGuildInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RankGuildInfo.class, Builder.class); } public static Parser<RankGuildInfo> PARSER = (Parser<RankGuildInfo>)new AbstractParser<RankGuildInfo>() { public LeaderBoardHandler.RankGuildInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.RankGuildInfo(input, extensionRegistry); } }
/* 2407 */     ; private int bitField0_; public static final int GUILDID_FIELD_NUMBER = 1; private Object guildId_; public static final int GUILDICON_FIELD_NUMBER = 2; private Object guildIcon_; public static final int GUILDMASTER_FIELD_NUMBER = 3; private Object guildMaster_; public static final int GUILDLEVEL_FIELD_NUMBER = 4; private int guildLevel_; public static final int CURMEMBER_FIELD_NUMBER = 5; private int curMember_; public static final int MAXMEMBER_FIELD_NUMBER = 6; private int maxMember_; public static final int FUND_FIELD_NUMBER = 7; private int fund_; public static final int NOTICE_FIELD_NUMBER = 8; private Object notice_; public static final int GUILDMASTERPRO_FIELD_NUMBER = 9; private int guildMasterPro_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<RankGuildInfo> getParserForType() { return PARSER; } public boolean hasGuildId() { return ((this.bitField0_ & 0x1) == 1); } public String getGuildId() { Object ref = this.guildId_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.guildId_ = s;  return s; } public ByteString getGuildIdBytes() { Object ref = this.guildId_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.guildId_ = b; return b; }  return (ByteString)ref; } public boolean hasGuildIcon() { return ((this.bitField0_ & 0x2) == 2); } public String getGuildIcon() { Object ref = this.guildIcon_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.guildIcon_ = s;  return s; } static { defaultInstance.initFields(); }
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements LeaderBoardHandler.RankGuildInfoOrBuilder { private int bitField0_; private Object guildId_; private Object guildIcon_; private Object guildMaster_; private int guildLevel_; private int curMember_; private int maxMember_; private int fund_; private Object notice_; private int guildMasterPro_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */         return this;
/*      */       } } }
/* 2961 */   public static final class LeaderBoardRequest extends GeneratedMessage implements LeaderBoardRequestOrBuilder { private static final LeaderBoardRequest defaultInstance = new LeaderBoardRequest(true); private final UnknownFieldSet unknownFields; private LeaderBoardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LeaderBoardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LeaderBoardRequest getDefaultInstance() { return defaultInstance; } public LeaderBoardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LeaderBoardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SKind_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SSeason_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_LeaderBoardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_LeaderBoardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(LeaderBoardRequest.class, Builder.class); } public static Parser<LeaderBoardRequest> PARSER = (Parser<LeaderBoardRequest>)new AbstractParser<LeaderBoardRequest>() { public LeaderBoardHandler.LeaderBoardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.LeaderBoardRequest(input, extensionRegistry); } }
/* 2962 */     ; private int bitField0_; public static final int C2S_KIND_FIELD_NUMBER = 1; private int c2SKind_; public static final int C2S_SEASON_FIELD_NUMBER = 2; private int c2SSeason_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LeaderBoardRequest> getParserForType() { return PARSER; } public boolean hasC2SKind() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SKind() { return this.c2SKind_; } public boolean hasC2SSeason() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4104 */     private static final LeaderBoardResponse defaultInstance = new LeaderBoardResponse(true); private final UnknownFieldSet unknownFields; private LeaderBoardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LeaderBoardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LeaderBoardResponse getDefaultInstance() { return defaultInstance; } public LeaderBoardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LeaderBoardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; LeaderBoardHandler.LeaderBoardData.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CLists_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CLists_.add(input.readMessage(LeaderBoardHandler.LeaderBoardData.PARSER, extensionRegistry)); break;case 34: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CMyData_.toBuilder();  this.s2CMyData_ = (LeaderBoardHandler.LeaderBoardData)input.readMessage(LeaderBoardHandler.LeaderBoardData.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CMyData_); this.s2CMyData_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CLists_ = Collections.unmodifiableList(this.s2CLists_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_LeaderBoardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_LeaderBoardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(LeaderBoardResponse.class, Builder.class); } public static Parser<LeaderBoardResponse> PARSER = (Parser<LeaderBoardResponse>)new AbstractParser<LeaderBoardResponse>() { public LeaderBoardHandler.LeaderBoardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.LeaderBoardResponse(input, extensionRegistry); } }
/* 4105 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_LISTS_FIELD_NUMBER = 3; private List<LeaderBoardHandler.LeaderBoardData> s2CLists_; public static final int S2C_MYDATA_FIELD_NUMBER = 4; private LeaderBoardHandler.LeaderBoardData s2CMyData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LeaderBoardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements LeaderBoardHandler.LeaderBoardResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private List<LeaderBoardHandler.LeaderBoardData> s2CLists_; private RepeatedFieldBuilder<LeaderBoardHandler.LeaderBoardData, LeaderBoardHandler.LeaderBoardData.Builder, LeaderBoardHandler.LeaderBoardDataOrBuilder> s2CListsBuilder_; private LeaderBoardHandler.LeaderBoardData s2CMyData_; private SingleFieldBuilder<LeaderBoardHandler.LeaderBoardData, LeaderBoardHandler.LeaderBoardData.Builder, LeaderBoardHandler.LeaderBoardDataOrBuilder> s2CMyDataBuilder_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/* 4596 */   public static final class GuildInfoRequest extends GeneratedMessage implements GuildInfoRequestOrBuilder { private static final GuildInfoRequest defaultInstance = new GuildInfoRequest(true); private final UnknownFieldSet unknownFields; private GuildInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GuildInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GuildInfoRequest getDefaultInstance() { return defaultInstance; } public GuildInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GuildInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.c2SGuildId_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_GuildInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_GuildInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GuildInfoRequest.class, Builder.class); } public static Parser<GuildInfoRequest> PARSER = (Parser<GuildInfoRequest>)new AbstractParser<GuildInfoRequest>() { public LeaderBoardHandler.GuildInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.GuildInfoRequest(input, extensionRegistry); } }
/* 4597 */     ; private int bitField0_; public static final int C2S_GUILDID_FIELD_NUMBER = 1; private Object c2SGuildId_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GuildInfoRequest> getParserForType() { return PARSER; } public boolean hasC2SGuildId() { return ((this.bitField0_ & 0x1) == 1); } public String getC2SGuildId() { Object ref = this.c2SGuildId_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.c2SGuildId_ = s;  return s; } public ByteString getC2SGuildIdBytes() { Object ref = this.c2SGuildId_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.c2SGuildId_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5355 */     private static final GuildInfoResponse defaultInstance = new GuildInfoResponse(true); private final UnknownFieldSet unknownFields; private GuildInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GuildInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GuildInfoResponse getDefaultInstance() { return defaultInstance; } public GuildInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GuildInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; LeaderBoardHandler.RankGuildInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CData_.toBuilder();  this.s2CData_ = (LeaderBoardHandler.RankGuildInfo)input.readMessage(LeaderBoardHandler.RankGuildInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CData_); this.s2CData_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_GuildInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_GuildInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GuildInfoResponse.class, Builder.class); } public static Parser<GuildInfoResponse> PARSER = (Parser<GuildInfoResponse>)new AbstractParser<GuildInfoResponse>() { public LeaderBoardHandler.GuildInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.GuildInfoResponse(input, extensionRegistry); } }
/* 5356 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_DATA_FIELD_NUMBER = 3; private LeaderBoardHandler.RankGuildInfo s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GuildInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */     
/*      */     public ByteString getS2CMsgBytes() {
/*      */       Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String) {
...
/*      */     }
/*      */     
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements LeaderBoardHandler.GuildInfoResponseOrBuilder { private int bitField0_;
...
/*      */       } } }
/*      */   
/* 5760 */   public static final class WorShipRequest extends GeneratedMessage implements WorShipRequestOrBuilder { private static final WorShipRequest defaultInstance = new WorShipRequest(true); private final UnknownFieldSet unknownFields; private WorShipRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private WorShipRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static WorShipRequest getDefaultInstance() { return defaultInstance; } public WorShipRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private WorShipRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorShipRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorShipRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(WorShipRequest.class, Builder.class); } public static Parser<WorShipRequest> PARSER = (Parser<WorShipRequest>)new AbstractParser<WorShipRequest>() { public LeaderBoardHandler.WorShipRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.WorShipRequest(input, extensionRegistry); } }
/* 5761 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<WorShipRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } private void initFields() { this.c2SType_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 6505 */     private static final WorShipResponse defaultInstance = new WorShipResponse(true); private final UnknownFieldSet unknownFields; private WorShipResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private WorShipResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static WorShipResponse getDefaultInstance() { return defaultInstance; } public WorShipResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private WorShipResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: bs = input.readBytes(); if ((mutable_bitField0_ & 0x4) != 4) { this.s2CAwards_ = (LazyStringList)new LazyStringArrayList(); mutable_bitField0_ |= 0x4; }  this.s2CAwards_.add(bs); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CAwards_ = this.s2CAwards_.getUnmodifiableView();  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorShipResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorShipResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(WorShipResponse.class, Builder.class); } public static Parser<WorShipResponse> PARSER = (Parser<WorShipResponse>)new AbstractParser<WorShipResponse>() { public LeaderBoardHandler.WorShipResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.WorShipResponse(input, extensionRegistry); } }
/* 6506 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_AWARDS_FIELD_NUMBER = 3; private LazyStringList s2CAwards_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<WorShipResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */      public ByteString getS2CMsgBytes() {
/*      */       Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String) {
/*      */         ByteString b = ByteString.copyFromUtf8((String)ref);
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements LeaderBoardHandler.WorShipResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private LazyStringList s2CAwards_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */         return this;
/*      */       } } }
/* 6818 */   public static final class WorldLevelInfoRequest extends GeneratedMessage implements WorldLevelInfoRequestOrBuilder { private static final WorldLevelInfoRequest defaultInstance = new WorldLevelInfoRequest(true); private final UnknownFieldSet unknownFields; private WorldLevelInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private WorldLevelInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static WorldLevelInfoRequest getDefaultInstance() { return defaultInstance; } public WorldLevelInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private WorldLevelInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(WorldLevelInfoRequest.class, Builder.class); } public static Parser<WorldLevelInfoRequest> PARSER = (Parser<WorldLevelInfoRequest>)new AbstractParser<WorldLevelInfoRequest>() { public LeaderBoardHandler.WorldLevelInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.WorldLevelInfoRequest(input, extensionRegistry); } }
/* 6819 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<WorldLevelInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 8670 */     private static final WorldLevelInfo defaultInstance = new WorldLevelInfo(true); private final UnknownFieldSet unknownFields; private WorldLevelInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private WorldLevelInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static WorldLevelInfo getDefaultInstance() { return defaultInstance; } public WorldLevelInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private WorldLevelInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.worldLevelId_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.worldLevelName_ = bs; break;case 24: this.bitField0_ |= 0x4; this.worldLevel_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.worldUpLevel_ = input.readInt32(); break;case 42: if ((mutable_bitField0_ & 0x10) != 16) { this.avatars_ = new ArrayList<>(); mutable_bitField0_ |= 0x10; }  this.avatars_.add(input.readMessage(Common.Avatar.PARSER, extensionRegistry)); break;case 48: this.bitField0_ |= 0x10; this.addExp_ = input.readInt32(); break;case 56: this.bitField0_ |= 0x20; this.worShipTimes_ = input.readInt32(); break;case 64: this.bitField0_ |= 0x40; this.maxWorShipTimes_ = input.readInt32(); break;case 72: this.bitField0_ |= 0x80; this.worldLevelPro_ = input.readInt32(); break;case 82: bs = input.readBytes(); this.bitField0_ |= 0x100; this.rank1StGuildName_ = bs; break;case 88: this.bitField0_ |= 0x200; this.rank1StFight_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x10) == 16) this.avatars_ = Collections.unmodifiableList(this.avatars_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(WorldLevelInfo.class, Builder.class); } public static Parser<WorldLevelInfo> PARSER = (Parser<WorldLevelInfo>)new AbstractParser<WorldLevelInfo>() { public LeaderBoardHandler.WorldLevelInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.WorldLevelInfo(input, extensionRegistry); } }
/* 8671 */     ; private int bitField0_; public static final int WORLDLEVELID_FIELD_NUMBER = 1; private Object worldLevelId_; public static final int WORLDLEVELNAME_FIELD_NUMBER = 2; private Object worldLevelName_; public static final int WORLDLEVEL_FIELD_NUMBER = 3; private int worldLevel_; public static final int WORLDUPLEVEL_FIELD_NUMBER = 4; private int worldUpLevel_; public static final int AVATARS_FIELD_NUMBER = 5; private List<Common.Avatar> avatars_; public static final int ADDEXP_FIELD_NUMBER = 6; private int addExp_; public static final int WORSHIPTIMES_FIELD_NUMBER = 7; private int worShipTimes_; public static final int MAXWORSHIPTIMES_FIELD_NUMBER = 8; private int maxWorShipTimes_; public static final int WORLDLEVELPRO_FIELD_NUMBER = 9; private int worldLevelPro_; public static final int RANK1STGUILDNAME_FIELD_NUMBER = 10; private Object rank1StGuildName_; public static final int RANK1STFIGHT_FIELD_NUMBER = 11; private int rank1StFight_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<WorldLevelInfo> getParserForType() { return PARSER; } public boolean hasWorldLevelId() { return ((this.bitField0_ & 0x1) == 1); } public String getWorldLevelId() { Object ref = this.worldLevelId_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.worldLevelId_ = s;  return s; } public ByteString getWorldLevelIdBytes() { Object ref = this.worldLevelId_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.worldLevelId_ = b; return b; }  return (ByteString)ref; } public boolean hasWorldLevelName() { return ((this.bitField0_ & 0x2) == 2); } public String getWorldLevelName() { Object ref = this.worldLevelName_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.worldLevelName_ = s;  return s; } public ByteString getWorldLevelNameBytes() { Object ref = this.worldLevelName_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.worldLevelName_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements LeaderBoardHandler.WorldLevelInfoOrBuilder { private int bitField0_; private Object worldLevelId_; private Object worldLevelName_; private int worldLevel_; private int worldUpLevel_; private List<Common.Avatar> avatars_; private RepeatedFieldBuilder<Common.Avatar, Common.Avatar.Builder, Common.AvatarOrBuilder> avatarsBuilder_; private int addExp_; private int worShipTimes_; private int maxWorShipTimes_; private int worldLevelPro_; private Object rank1StGuildName_; private int rank1StFight_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */         return this;
/*      */       } } }
/* 9437 */   public static final class WorldLevelInfoResponse extends GeneratedMessage implements WorldLevelInfoResponseOrBuilder { private static final WorldLevelInfoResponse defaultInstance = new WorldLevelInfoResponse(true); private final UnknownFieldSet unknownFields; private WorldLevelInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private WorldLevelInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static WorldLevelInfoResponse getDefaultInstance() { return defaultInstance; } public WorldLevelInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private WorldLevelInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; LeaderBoardHandler.WorldLevelInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CData_.toBuilder();  this.s2CData_ = (LeaderBoardHandler.WorldLevelInfo)input.readMessage(LeaderBoardHandler.WorldLevelInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CData_); this.s2CData_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(WorldLevelInfoResponse.class, Builder.class); } public static Parser<WorldLevelInfoResponse> PARSER = (Parser<WorldLevelInfoResponse>)new AbstractParser<WorldLevelInfoResponse>() { public LeaderBoardHandler.WorldLevelInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new LeaderBoardHandler.WorldLevelInfoResponse(input, extensionRegistry); } }
/* 9438 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_DATA_FIELD_NUMBER = 3; private LeaderBoardHandler.WorldLevelInfo s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<WorldLevelInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasS2CData() { return ((this.bitField0_ & 0x4) == 4); } public LeaderBoardHandler.WorldLevelInfo getS2CData() { return this.s2CData_; } public LeaderBoardHandler.WorldLevelInfoOrBuilder getS2CDataOrBuilder() { return this.s2CData_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CData_ = LeaderBoardHandler.WorldLevelInfo.getDefaultInstance(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  if (!hasS2CData()) { this.memoizedIsInitialized = 0; return false; }  if (!getS2CData().isInitialized()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeMessage(3, (MessageLite)this.s2CData_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeMessageSize(3, (MessageLite)this.s2CData_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static WorldLevelInfoResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (WorldLevelInfoResponse)PARSER.parseFrom(data); } public static WorldLevelInfoResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (WorldLevelInfoResponse)PARSER.parseFrom(data, extensionRegistry); } public static WorldLevelInfoResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (WorldLevelInfoResponse)PARSER.parseFrom(data); } public static WorldLevelInfoResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (WorldLevelInfoResponse)PARSER.parseFrom(data, extensionRegistry); } public static WorldLevelInfoResponse parseFrom(InputStream input) throws IOException { return (WorldLevelInfoResponse)PARSER.parseFrom(input); } public static WorldLevelInfoResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (WorldLevelInfoResponse)PARSER.parseFrom(input, extensionRegistry); } public static WorldLevelInfoResponse parseDelimitedFrom(InputStream input) throws IOException { return (WorldLevelInfoResponse)PARSER.parseDelimitedFrom(input); } public static WorldLevelInfoResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (WorldLevelInfoResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static WorldLevelInfoResponse parseFrom(CodedInputStream input) throws IOException { return (WorldLevelInfoResponse)PARSER.parseFrom(input); } public static WorldLevelInfoResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (WorldLevelInfoResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(WorldLevelInfoResponse prototype) { return newBuilder().mergeFrom(prototype); } static { defaultInstance.initFields(); }
...
/*      */       public static final Descriptors.Descriptor getDescriptor() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoResponse_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(LeaderBoardHandler.WorldLevelInfoResponse.class, Builder.class); }
/*      */       private Builder() { this.s2CMsg_ = ""; this.s2CData_ = LeaderBoardHandler.WorldLevelInfo.getDefaultInstance(); maybeForceBuilderInitialization(); }
/*      */       private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; this.s2CData_ = LeaderBoardHandler.WorldLevelInfo.getDefaultInstance(); maybeForceBuilderInitialization(); }
/*      */       private void maybeForceBuilderInitialization() { if (LeaderBoardHandler.WorldLevelInfoResponse.alwaysUseFieldBuilders)
/*      */           getS2CDataFieldBuilder();  }
/*      */       private static Builder create() { return new Builder(); }
/*      */       public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; if (this.s2CDataBuilder_ == null) { this.s2CData_ = LeaderBoardHandler.WorldLevelInfo.getDefaultInstance(); } else { this.s2CDataBuilder_.clear(); }  this.bitField0_ &= 0xFFFFFFFB; return this; }
/*      */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*      */       public Descriptors.Descriptor getDescriptorForType() { return LeaderBoardHandler.internal_static_pomelo_area_WorldLevelInfoResponse_descriptor; }
/*      */       public LeaderBoardHandler.WorldLevelInfoResponse getDefaultInstanceForType() { return LeaderBoardHandler.WorldLevelInfoResponse.getDefaultInstance(); }
/*      */       public LeaderBoardHandler.WorldLevelInfoResponse build() { LeaderBoardHandler.WorldLevelInfoResponse result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; }
/*      */       public LeaderBoardHandler.WorldLevelInfoResponse buildPartial() { LeaderBoardHandler.WorldLevelInfoResponse result = new LeaderBoardHandler.WorldLevelInfoResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
...
/*      */           to_bitField0_ |= 0x4;  if (this.s2CDataBuilder_ == null) { result.s2CData_ = this.s2CData_; } else { result.s2CData_ = (LeaderBoardHandler.WorldLevelInfo)this.s2CDataBuilder_.build(); }  result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*      */       public Builder mergeFrom(Message other) { if (other instanceof LeaderBoardHandler.WorldLevelInfoResponse)
/*      */           return mergeFrom((LeaderBoardHandler.WorldLevelInfoResponse)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(LeaderBoardHandler.WorldLevelInfoResponse other) { if (other == LeaderBoardHandler.WorldLevelInfoResponse.getDefaultInstance())
/*      */           return this;  if (other.hasS2CCode())
/*      */           setS2CCode(other.getS2CCode());  if (other.hasS2CMsg()) { this.bitField0_ |= 0x2; this.s2CMsg_ = other.s2CMsg_; onChanged(); }  if (other.hasS2CData())
/*      */           mergeS2CData(other.getS2CData());  mergeUnknownFields(other.getUnknownFields()); return this; }
/*      */       public final boolean isInitialized() { if (!hasS2CCode())
/*      */           return false;  if (!hasS2CData())
/*      */           return false;  if (!getS2CData().isInitialized())
/*      */           return false;  return true; }
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { LeaderBoardHandler.WorldLevelInfoResponse parsedMessage = null; try { parsedMessage = (LeaderBoardHandler.WorldLevelInfoResponse)LeaderBoardHandler.WorldLevelInfoResponse.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (LeaderBoardHandler.WorldLevelInfoResponse)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null)
...
/*      */ 
/*      */     
/* 9548 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 9552 */           LeaderBoardHandler.descriptor = root;
/* 9553 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 9557 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 9559 */           Common.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 9562 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LeaderBoardData_descriptor = getDescriptor().getMessageTypes().get(0);
/* 9563 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LeaderBoardData_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LeaderBoardData_descriptor, new String[] { "Contents", "Avatars" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9568 */   private static final Descriptors.Descriptor internal_static_pomelo_area_RankGuildInfo_descriptor = getDescriptor().getMessageTypes().get(1);
/* 9569 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_RankGuildInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_RankGuildInfo_descriptor, new String[] { "GuildId", "GuildIcon", "GuildMaster", "GuildLevel", "CurMember", "MaxMember", "Fund", "Notice", "GuildMasterPro" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9574 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LeaderBoardRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 9575 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LeaderBoardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LeaderBoardRequest_descriptor, new String[] { "C2SKind", "C2SSeason" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9580 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LeaderBoardResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 9581 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LeaderBoardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LeaderBoardResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CLists", "S2CMyData" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9586 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GuildInfoRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 9587 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GuildInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GuildInfoRequest_descriptor, new String[] { "C2SGuildId" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9592 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GuildInfoResponse_descriptor = getDescriptor().getMessageTypes().get(5);
/* 9593 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GuildInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GuildInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CData" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9598 */   private static final Descriptors.Descriptor internal_static_pomelo_area_WorShipRequest_descriptor = getDescriptor().getMessageTypes().get(6);
/* 9599 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_WorShipRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_WorShipRequest_descriptor, new String[] { "C2SType" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9604 */   private static final Descriptors.Descriptor internal_static_pomelo_area_WorShipResponse_descriptor = getDescriptor().getMessageTypes().get(7);
/* 9605 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_WorShipResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_WorShipResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CAwards" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9610 */   private static final Descriptors.Descriptor internal_static_pomelo_area_WorldLevelInfoRequest_descriptor = getDescriptor().getMessageTypes().get(8);
/* 9611 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_WorldLevelInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_WorldLevelInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9616 */   private static final Descriptors.Descriptor internal_static_pomelo_area_WorldLevelInfo_descriptor = getDescriptor().getMessageTypes().get(9);
/* 9617 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_WorldLevelInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_WorldLevelInfo_descriptor, new String[] { "WorldLevelId", "WorldLevelName", "WorldLevel", "WorldUpLevel", "Avatars", "AddExp", "WorShipTimes", "MaxWorShipTimes", "WorldLevelPro", "Rank1StGuildName", "Rank1StFight" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9622 */   private static final Descriptors.Descriptor internal_static_pomelo_area_WorldLevelInfoResponse_descriptor = getDescriptor().getMessageTypes().get(10);
/* 9623 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_WorldLevelInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_WorldLevelInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CData" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 9627 */     Common.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\LeaderBoardHandler.class
