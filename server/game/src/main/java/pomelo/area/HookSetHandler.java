...
public final class HookSetHandler {
    ...
    public static final class HookSetData
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return HookSetHandler.internal_static_pomelo_area_HookSetData_fieldAccessorTable.ensureFieldAccessorsInitialized(HookSetData.class, Builder.class);
        }

        public static Parser<HookSetData> PARSER = (Parser<HookSetData>) new AbstractParser<HookSetData>() {
            public HookSetHandler.HookSetData parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new HookSetHandler.HookSetData(input, extensionRegistry);
            }
        };
    ...
    public static final class ChangeHookSetRequest extends GeneratedMessage implements ChangeHookSetRequestOrBuilder {
        private static final ChangeHookSetRequest defaultInstance = new ChangeHookSetRequest(true);
        private final UnknownFieldSet unknownFields;

        private ChangeHookSetRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private ChangeHookSetRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private ChangeHookSetRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                boolean done = false;
                while (!done) {
                    HookSetHandler.HookSetData.Builder subBuilder;
                    ...
                    switch (tag) {
                        ...
                        case 10:
                            subBuilder = null;
                            if ((this.bitField0_ & 0x1) == 1) subBuilder = this.c2SHookSetData_.toBuilder();
                            this.c2SHookSetData_ = (HookSetHandler.HookSetData) input.readMessage(HookSetHandler.HookSetData.PARSER, extensionRegistry);
                            if (subBuilder != null) {
                                subBuilder.mergeFrom(this.c2SHookSetData_);
                                this.c2SHookSetData_ = subBuilder.buildPartial();
                            }
                            this.bitField0_ |= 0x1;
                            break;
                    }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return HookSetHandler.internal_static_pomelo_area_ChangeHookSetRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ChangeHookSetRequest.class, Builder.class);
        }

        public static Parser<ChangeHookSetRequest> PARSER = (Parser<ChangeHookSetRequest>) new AbstractParser<ChangeHookSetRequest>() {
            public HookSetHandler.ChangeHookSetRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new HookSetHandler.ChangeHookSetRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<ChangeHookSetRequest> getParserForType() {
            return PARSER;
        }
    ...
    public static final class ChangeHookSetResponse
        ...
        private static final ChangeHookSetResponse defaultInstance = new ChangeHookSetResponse(true);
        private final UnknownFieldSet unknownFields;

        private ChangeHookSetResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private ChangeHookSetResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private ChangeHookSetResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return HookSetHandler.internal_static_pomelo_area_ChangeHookSetResponse_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return HookSetHandler.internal_static_pomelo_area_ChangeHookSetResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ChangeHookSetResponse.class, Builder.class);
        }

        public static Parser<ChangeHookSetResponse> PARSER = (Parser<ChangeHookSetResponse>) new AbstractParser<ChangeHookSetResponse>() {
            public HookSetHandler.ChangeHookSetResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new HookSetHandler.ChangeHookSetResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<ChangeHookSetResponse> getParserForType() {
            return PARSER;
        }
        ...
        public static ChangeHookSetResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (ChangeHookSetResponse) PARSER.parseFrom(data);
        }

        public static ChangeHookSetResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (ChangeHookSetResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static ChangeHookSetResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (ChangeHookSetResponse) PARSER.parseFrom(data);
        }

        public static ChangeHookSetResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (ChangeHookSetResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static ChangeHookSetResponse parseFrom(InputStream input) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseFrom(input);
        }
        ...
        public static ChangeHookSetResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static ChangeHookSetResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseDelimitedFrom(input);
        }

        public static ChangeHookSetResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static ChangeHookSetResponse parseFrom(CodedInputStream input) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseFrom(input);
        }

        public static ChangeHookSetResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ChangeHookSetResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(ChangeHookSetResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements HookSetHandler.ChangeHookSetResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return HookSetHandler.internal_static_pomelo_area_ChangeHookSetResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(HookSetHandler.ChangeHookSetResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (HookSetHandler.ChangeHookSetResponse.alwaysUseFieldBuilders) ;
            }
            ...
            public HookSetHandler.ChangeHookSetResponse getDefaultInstanceForType() {
                return HookSetHandler.ChangeHookSetResponse.getDefaultInstance();
            }

            public HookSetHandler.ChangeHookSetResponse build() {
                HookSetHandler.ChangeHookSetResponse result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public HookSetHandler.ChangeHookSetResponse buildPartial() {
                HookSetHandler.ChangeHookSetResponse result = new HookSetHandler.ChangeHookSetResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof HookSetHandler.ChangeHookSetResponse)
                    return mergeFrom((HookSetHandler.ChangeHookSetResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(HookSetHandler.ChangeHookSetResponse other) {
                if (other == HookSetHandler.ChangeHookSetResponse.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                HookSetHandler.ChangeHookSetResponse parsedMessage = null;
                try {
                    parsedMessage = (HookSetHandler.ChangeHookSetResponse) HookSetHandler.ChangeHookSetResponse.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (HookSetHandler.ChangeHookSetResponse) e.getUnfinishedMessage();
                    throw e;
                } finally {
            ...
            public Builder clearS2CMsg() {
                this.bitField0_ &= 0xFFFFFFFD;
                this.s2CMsg_ = HookSetHandler.ChangeHookSetResponse.getDefaultInstance().getS2CMsg();
                onChanged();
                return this;
            }
    ...
    static {
        ...
        Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
            public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root) {
                HookSetHandler.descriptor = root;
                return null;
            }
        };
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_area_HookSetData_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_HookSetData_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_HookSetData_descriptor, new String[]{"HpPercent", "MpPercent", "HpItemCode", "MpItemCode", "PkSet", "MeltQcolor", "AutoBuyHpItem", "AutoBuyMpItem", "FieldMaphook", "AreaMaphook"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_ChangeHookSetRequest_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ChangeHookSetRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ChangeHookSetRequest_descriptor, new String[]{"C2SHookSetData"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_ChangeHookSetResponse_descriptor = getDescriptor().getMessageTypes().get(2);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ChangeHookSetResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ChangeHookSetResponse_descriptor, new String[]{"S2CCode", "S2CMsg"});
