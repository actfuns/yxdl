...
/*      */       }
/*      */     }
/*  794 */     private static final IntergalMallItem defaultInstance = new IntergalMallItem(true); static {
/*  795 */       defaultInstance.initFields();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/* 1825 */     private static final IntergalMallTab defaultInstance = new IntergalMallTab(true); private final UnknownFieldSet unknownFields; private IntergalMallTab(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private IntergalMallTab(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static IntergalMallTab getDefaultInstance() { return defaultInstance; } public IntergalMallTab getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private IntergalMallTab(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.tabId_ = input.readInt32(); break;case 18: if ((mutable_bitField0_ & 0x2) != 2) { this.items_ = new ArrayList<>(); mutable_bitField0_ |= 0x2; }  this.items_.add(input.readMessage(IntergalMallHandler.IntergalMallItem.PARSER, extensionRegistry)); break;case 24: this.bitField0_ |= 0x2; this.currencyNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x2) == 2) this.items_ = Collections.unmodifiableList(this.items_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return IntergalMallHandler.internal_static_pomelo_area_IntergalMallTab_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return IntergalMallHandler.internal_static_pomelo_area_IntergalMallTab_fieldAccessorTable.ensureFieldAccessorsInitialized(IntergalMallTab.class, Builder.class); } public static Parser<IntergalMallTab> PARSER = (Parser<IntergalMallTab>)new AbstractParser<IntergalMallTab>() { public IntergalMallHandler.IntergalMallTab parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new IntergalMallHandler.IntergalMallTab(input, extensionRegistry); } }
/* 1826 */     ; private int bitField0_; public static final int TABID_FIELD_NUMBER = 1; private int tabId_; public static final int ITEMS_FIELD_NUMBER = 2; private List<IntergalMallHandler.IntergalMallItem> items_; public static final int CURRENCYNUM_FIELD_NUMBER = 3; private int currencyNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<IntergalMallTab> getParserForType() { return PARSER; } public boolean hasTabId() { return ((this.bitField0_ & 0x1) == 1); } public int getTabId() { return this.tabId_; } public List<IntergalMallHandler.IntergalMallItem> getItemsList() { return this.items_; } public List<? extends IntergalMallHandler.IntergalMallItemOrBuilder> getItemsOrBuilderList() { return (List)this.items_; } static { defaultInstance.initFields(); }
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements IntergalMallHandler.IntergalMallTabOrBuilder { private int bitField0_; private int tabId_; private List<IntergalMallHandler.IntergalMallItem> items_; private RepeatedFieldBuilder<IntergalMallHandler.IntergalMallItem, IntergalMallHandler.IntergalMallItem.Builder, IntergalMallHandler.IntergalMallItemOrBuilder> itemsBuilder_; private int currencyNum_;
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */         return this;
/*      */       } } }
/* 2254 */   public static final class GetIntergalMallListRequest extends GeneratedMessage implements GetIntergalMallListRequestOrBuilder { private static final GetIntergalMallListRequest defaultInstance = new GetIntergalMallListRequest(true); private final UnknownFieldSet unknownFields; private GetIntergalMallListRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetIntergalMallListRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetIntergalMallListRequest getDefaultInstance() { return defaultInstance; } public GetIntergalMallListRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetIntergalMallListRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return IntergalMallHandler.internal_static_pomelo_area_GetIntergalMallListRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return IntergalMallHandler.internal_static_pomelo_area_GetIntergalMallListRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetIntergalMallListRequest.class, Builder.class); } public static Parser<GetIntergalMallListRequest> PARSER = (Parser<GetIntergalMallListRequest>)new AbstractParser<GetIntergalMallListRequest>() { public IntergalMallHandler.GetIntergalMallListRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new IntergalMallHandler.GetIntergalMallListRequest(input, extensionRegistry); } }
/* 2255 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetIntergalMallListRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } private void initFields() { this.c2SType_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 3188 */     private static final GetIntergalMallListResponse defaultInstance = new GetIntergalMallListResponse(true); private final UnknownFieldSet unknownFields; private GetIntergalMallListResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetIntergalMallListResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetIntergalMallListResponse getDefaultInstance() { return defaultInstance; } public GetIntergalMallListResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetIntergalMallListResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CTabitems_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CTabitems_.add(input.readMessage(IntergalMallHandler.IntergalMallTab.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CTabitems_ = Collections.unmodifiableList(this.s2CTabitems_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return IntergalMallHandler.internal_static_pomelo_area_GetIntergalMallListResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return IntergalMallHandler.internal_static_pomelo_area_GetIntergalMallListResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetIntergalMallListResponse.class, Builder.class); } public static Parser<GetIntergalMallListResponse> PARSER = (Parser<GetIntergalMallListResponse>)new AbstractParser<GetIntergalMallListResponse>() { public IntergalMallHandler.GetIntergalMallListResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new IntergalMallHandler.GetIntergalMallListResponse(input, extensionRegistry); } }
/* 3189 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TABITEMS_FIELD_NUMBER = 3; private List<IntergalMallHandler.IntergalMallTab> s2CTabitems_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetIntergalMallListResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 3813 */     private static final BuyIntergalItemRequest defaultInstance = new BuyIntergalItemRequest(true); private final UnknownFieldSet unknownFields; private BuyIntergalItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BuyIntergalItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BuyIntergalItemRequest getDefaultInstance() { return defaultInstance; } public BuyIntergalItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BuyIntergalItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SItemId_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return IntergalMallHandler.internal_static_pomelo_area_BuyIntergalItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return IntergalMallHandler.internal_static_pomelo_area_BuyIntergalItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BuyIntergalItemRequest.class, Builder.class); } public static Parser<BuyIntergalItemRequest> PARSER = (Parser<BuyIntergalItemRequest>)new AbstractParser<BuyIntergalItemRequest>() { public IntergalMallHandler.BuyIntergalItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new IntergalMallHandler.BuyIntergalItemRequest(input, extensionRegistry); } }
/* 3814 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; public static final int C2S_ITEMID_FIELD_NUMBER = 2; private int c2SItemId_; public static final int C2S_NUM_FIELD_NUMBER = 3; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BuyIntergalItemRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } public boolean hasC2SItemId() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 4705 */     private static final BuyIntergalItemResponse defaultInstance = new BuyIntergalItemResponse(true); public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasLastcount() { return ((this.bitField0_ & 0x4) == 4); } public int getLastcount() { return this.lastcount_; } public boolean hasCurrencyNum() { return ((this.bitField0_ & 0x8) == 8); } public int getCurrencyNum() { return this.currencyNum_; } public boolean hasTotalNum() { return ((this.bitField0_ & 0x10) == 16); } public int getTotalNum() { return this.totalNum_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.lastcount_ = 0; this.currencyNum_ = 0; this.totalNum_ = 0; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.lastcount_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.currencyNum_);  if ((this.bitField0_ & 0x10) == 16) output.writeInt32(5, this.totalNum_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.lastcount_);  if ((this.bitField0_ & 0x8) == 8) size += CodedOutputStream.computeInt32Size(4, this.currencyNum_);  if ((this.bitField0_ & 0x10) == 16) size += CodedOutputStream.computeInt32Size(5, this.totalNum_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static BuyIntergalItemResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (BuyIntergalItemResponse)PARSER.parseFrom(data); } public static BuyIntergalItemResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BuyIntergalItemResponse)PARSER.parseFrom(data, extensionRegistry); } public static BuyIntergalItemResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (BuyIntergalItemResponse)PARSER.parseFrom(data); } public static BuyIntergalItemResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BuyIntergalItemResponse)PARSER.parseFrom(data, extensionRegistry); } public static BuyIntergalItemResponse parseFrom(InputStream input) throws IOException { return (BuyIntergalItemResponse)PARSER.parseFrom(input); } public static BuyIntergalItemResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BuyIntergalItemResponse)PARSER.parseFrom(input, extensionRegistry); } public static BuyIntergalItemResponse parseDelimitedFrom(InputStream input) throws IOException { return (BuyIntergalItemResponse)PARSER.parseDelimitedFrom(input); } public static BuyIntergalItemResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BuyIntergalItemResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static BuyIntergalItemResponse parseFrom(CodedInputStream input) throws IOException { return (BuyIntergalItemResponse)PARSER.parseFrom(input); } public static BuyIntergalItemResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BuyIntergalItemResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(BuyIntergalItemResponse prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements IntergalMallHandler.BuyIntergalItemResponseOrBuilder {
/* 4706 */       private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int lastcount_; private int currencyNum_; private int totalNum_; public static final Descriptors.Descriptor getDescriptor() { return IntergalMallHandler.internal_static_pomelo_area_BuyIntergalItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return IntergalMallHandler.internal_static_pomelo_area_BuyIntergalItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(IntergalMallHandler.BuyIntergalItemResponse.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (IntergalMallHandler.BuyIntergalItemResponse.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; this.lastcount_ = 0; this.bitField0_ &= 0xFFFFFFFB; this.currencyNum_ = 0; this.bitField0_ &= 0xFFFFFFF7; this.totalNum_ = 0; this.bitField0_ &= 0xFFFFFFEF; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return IntergalMallHandler.internal_static_pomelo_area_BuyIntergalItemResponse_descriptor; } public IntergalMallHandler.BuyIntergalItemResponse getDefaultInstanceForType() { return IntergalMallHandler.BuyIntergalItemResponse.getDefaultInstance(); } public IntergalMallHandler.BuyIntergalItemResponse build() { IntergalMallHandler.BuyIntergalItemResponse result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public IntergalMallHandler.BuyIntergalItemResponse buildPartial() { IntergalMallHandler.BuyIntergalItemResponse result = new IntergalMallHandler.BuyIntergalItemResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.s2CCode_ = this.s2CCode_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.s2CMsg_ = this.s2CMsg_; if ((from_bitField0_ & 0x4) == 4) to_bitField0_ |= 0x4;  result.lastcount_ = this.lastcount_; if ((from_bitField0_ & 0x8) == 8) to_bitField0_ |= 0x8;  result.currencyNum_ = this.currencyNum_; if ((from_bitField0_ & 0x10) == 16) to_bitField0_ |= 0x10;  result.totalNum_ = this.totalNum_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof IntergalMallHandler.BuyIntergalItemResponse) return mergeFrom((IntergalMallHandler.BuyIntergalItemResponse)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(IntergalMallHandler.BuyIntergalItemResponse other) { if (other == IntergalMallHandler.BuyIntergalItemResponse.getDefaultInstance()) return this;  if (other.hasS2CCode()) setS2CCode(other.getS2CCode());  if (other.hasS2CMsg()) { this.bitField0_ |= 0x2; this.s2CMsg_ = other.s2CMsg_; onChanged(); }  if (other.hasLastcount()) setLastcount(other.getLastcount());  if (other.hasCurrencyNum()) setCurrencyNum(other.getCurrencyNum());  if (other.hasTotalNum()) setTotalNum(other.getTotalNum());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CCode()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { IntergalMallHandler.BuyIntergalItemResponse parsedMessage = null; try { parsedMessage = (IntergalMallHandler.BuyIntergalItemResponse)IntergalMallHandler.BuyIntergalItemResponse.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (IntergalMallHandler.BuyIntergalItemResponse)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public Builder setS2CCode(int value) { this.bitField0_ |= 0x1; this.s2CCode_ = value; onChanged(); return this; } public Builder clearS2CCode() { this.bitField0_ &= 0xFFFFFFFE; this.s2CCode_ = 0; onChanged(); return this; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (!(ref instanceof String)) { ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; }  return (String)ref; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public Builder setS2CMsg(String value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = IntergalMallHandler.BuyIntergalItemResponse.getDefaultInstance().getS2CMsg(); onChanged(); return this; } public Builder setS2CMsgBytes(ByteString value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public boolean hasLastcount() { return ((this.bitField0_ & 0x4) == 4); } public int getLastcount() { return this.lastcount_; } public Builder setLastcount(int value) { this.bitField0_ |= 0x4; this.lastcount_ = value; onChanged(); return this; } public Builder clearLastcount() { this.bitField0_ &= 0xFFFFFFFB; this.lastcount_ = 0; onChanged(); return this; } public boolean hasCurrencyNum() { return ((this.bitField0_ & 0x8) == 8); } public int getCurrencyNum() { return this.currencyNum_; } public Builder setCurrencyNum(int value) { this.bitField0_ |= 0x8; this.currencyNum_ = value; onChanged(); return this; } public Builder clearCurrencyNum() { this.bitField0_ &= 0xFFFFFFF7; this.currencyNum_ = 0; onChanged(); return this; } public boolean hasTotalNum() { return ((this.bitField0_ & 0x10) == 16); } public int getTotalNum() { return this.totalNum_; } public Builder setTotalNum(int value) { this.bitField0_ |= 0x10; this.totalNum_ = value; onChanged(); return this; } public Builder clearTotalNum() { this.bitField0_ &= 0xFFFFFFEF; this.totalNum_ = 0; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 4773 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 4777 */           IntergalMallHandler.descriptor = root;
/* 4778 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 4782 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[0], assigner);
/*      */   }
/*      */ 
/*      */   
/* 4786 */   private static final Descriptors.Descriptor internal_static_pomelo_area_IntergalMallItem_descriptor = getDescriptor().getMessageTypes().get(0);
/* 4787 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_IntergalMallItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_IntergalMallItem_descriptor, new String[] { "Id", "Code", "Lastcount", "Countdown" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 4792 */   private static final Descriptors.Descriptor internal_static_pomelo_area_IntergalMallTab_descriptor = getDescriptor().getMessageTypes().get(1);
/* 4793 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_IntergalMallTab_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_IntergalMallTab_descriptor, new String[] { "TabId", "Items", "CurrencyNum" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 4798 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetIntergalMallListRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 4799 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetIntergalMallListRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetIntergalMallListRequest_descriptor, new String[] { "C2SType" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 4804 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetIntergalMallListResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 4805 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetIntergalMallListResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetIntergalMallListResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CTabitems" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 4810 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyIntergalItemRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 4811 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyIntergalItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyIntergalItemRequest_descriptor, new String[] { "C2SType", "C2SItemId", "C2SNum" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 4816 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyIntergalItemResponse_descriptor = getDescriptor().getMessageTypes().get(5);
/* 4817 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyIntergalItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyIntergalItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "Lastcount", "CurrencyNum", "TotalNum" });
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\IntergalMallHandler.class
