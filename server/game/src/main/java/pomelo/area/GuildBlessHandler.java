...
/*      */   {
/*  812 */     private static final BlessItem defaultInstance = new BlessItem(true); private final UnknownFieldSet unknownFields; private BlessItem(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BlessItem(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BlessItem getDefaultInstance() { return defaultInstance; } public BlessItem getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BlessItem(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: if ((mutable_bitField0_ & 0x1) != 1) { this.item_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.item_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.item_ = Collections.unmodifiableList(this.item_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_BlessItem_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_BlessItem_fieldAccessorTable.ensureFieldAccessorsInitialized(BlessItem.class, Builder.class); } public static Parser<BlessItem> PARSER = (Parser<BlessItem>)new AbstractParser<BlessItem>() { public GuildBlessHandler.BlessItem parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.BlessItem(input, extensionRegistry); } }
/*  813 */     ; public static final int ITEM_FIELD_NUMBER = 1; private List<ItemOuterClass.MiniItem> item_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BlessItem> getParserForType() { return PARSER; } public List<ItemOuterClass.MiniItem> getItemList() { return this.item_; } public List<? extends ItemOuterClass.MiniItemOrBuilder> getItemOrBuilderList() { return (List)this.item_; } public int getItemCount() { return this.item_.size(); } public ItemOuterClass.MiniItem getItem(int index) { return this.item_.get(index); } public ItemOuterClass.MiniItemOrBuilder getItemOrBuilder(int index) { return (ItemOuterClass.MiniItemOrBuilder)this.item_.get(index); } static { defaultInstance.initFields(); }
...
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements GuildBlessHandler.BlessItemOrBuilder { private int bitField0_; private List<ItemOuterClass.MiniItem> item_; private RepeatedFieldBuilder<ItemOuterClass.MiniItem, ItemOuterClass.MiniItem.Builder, ItemOuterClass.MiniItemOrBuilder> itemBuilder_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/* 1133 */   public static final class GetMyBlessInfoRequest extends GeneratedMessage implements GetMyBlessInfoRequestOrBuilder { private static final GetMyBlessInfoRequest defaultInstance = new GetMyBlessInfoRequest(true); private final UnknownFieldSet unknownFields; private GetMyBlessInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetMyBlessInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetMyBlessInfoRequest getDefaultInstance() { return defaultInstance; } public GetMyBlessInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetMyBlessInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_GetMyBlessInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_GetMyBlessInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetMyBlessInfoRequest.class, Builder.class); } public static Parser<GetMyBlessInfoRequest> PARSER = (Parser<GetMyBlessInfoRequest>)new AbstractParser<GetMyBlessInfoRequest>() { public GuildBlessHandler.GetMyBlessInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.GetMyBlessInfoRequest(input, extensionRegistry); } }
/* 1134 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetMyBlessInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1570 */     private static final BlessActionRequest defaultInstance = new BlessActionRequest(true); private final UnknownFieldSet unknownFields; private BlessActionRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BlessActionRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BlessActionRequest getDefaultInstance() { return defaultInstance; } public BlessActionRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BlessActionRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_BlessActionRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_BlessActionRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BlessActionRequest.class, Builder.class); } public static Parser<BlessActionRequest> PARSER = (Parser<BlessActionRequest>)new AbstractParser<BlessActionRequest>() { public GuildBlessHandler.BlessActionRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.BlessActionRequest(input, extensionRegistry); } }
/* 1571 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BlessActionRequest> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } private void initFields() { this.id_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2015 */     private static final ReceiveBlessGiftRequest defaultInstance = new ReceiveBlessGiftRequest(true); private final UnknownFieldSet unknownFields; private ReceiveBlessGiftRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ReceiveBlessGiftRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ReceiveBlessGiftRequest getDefaultInstance() { return defaultInstance; } public ReceiveBlessGiftRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ReceiveBlessGiftRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.index_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveBlessGiftRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveBlessGiftRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ReceiveBlessGiftRequest.class, Builder.class); } public static Parser<ReceiveBlessGiftRequest> PARSER = (Parser<ReceiveBlessGiftRequest>)new AbstractParser<ReceiveBlessGiftRequest>() { public GuildBlessHandler.ReceiveBlessGiftRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.ReceiveBlessGiftRequest(input, extensionRegistry); } }
/* 2016 */     ; private int bitField0_; public static final int INDEX_FIELD_NUMBER = 1; private int index_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ReceiveBlessGiftRequest> getParserForType() { return PARSER; } public boolean hasIndex() { return ((this.bitField0_ & 0x1) == 1); } public int getIndex() { return this.index_; } private void initFields() { this.index_ = 0; } static { defaultInstance.initFields(); }
/*      */     
/*      */     public final boolean isInitialized() {
/*      */       byte isInitialized = this.memoizedIsInitialized;
/*      */       if (isInitialized == 1)
...
/*      */     }
/*      */     
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements GuildBlessHandler.ReceiveBlessGiftRequestOrBuilder { private int bitField0_;
/*      */       private int index_;
/*      */       
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/*      */   
/*      */   public static final class UpgradeBlessRequest extends GeneratedMessage implements UpgradeBlessRequestOrBuilder { private final UnknownFieldSet unknownFields;
/*      */     
...
/*      */     }
/*      */     
/*      */     public static Parser<UpgradeBlessRequest> PARSER = (Parser<UpgradeBlessRequest>)new AbstractParser<UpgradeBlessRequest>() { public GuildBlessHandler.UpgradeBlessRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
...
/*      */     }
/*      */     
/* 2336 */     private static final UpgradeBlessRequest defaultInstance = new UpgradeBlessRequest(true); protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static UpgradeBlessRequest parseFrom(ByteString data) throws InvalidProtocolBufferException { return (UpgradeBlessRequest)PARSER.parseFrom(data); } public static UpgradeBlessRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (UpgradeBlessRequest)PARSER.parseFrom(data, extensionRegistry); } public static UpgradeBlessRequest parseFrom(byte[] data) throws InvalidProtocolBufferException { return (UpgradeBlessRequest)PARSER.parseFrom(data); } public static UpgradeBlessRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (UpgradeBlessRequest)PARSER.parseFrom(data, extensionRegistry); } public static UpgradeBlessRequest parseFrom(InputStream input) throws IOException { return (UpgradeBlessRequest)PARSER.parseFrom(input); } public static UpgradeBlessRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (UpgradeBlessRequest)PARSER.parseFrom(input, extensionRegistry); } public static UpgradeBlessRequest parseDelimitedFrom(InputStream input) throws IOException { return (UpgradeBlessRequest)PARSER.parseDelimitedFrom(input); } public static UpgradeBlessRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (UpgradeBlessRequest)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static UpgradeBlessRequest parseFrom(CodedInputStream input) throws IOException { return (UpgradeBlessRequest)PARSER.parseFrom(input); } public static UpgradeBlessRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (UpgradeBlessRequest)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(UpgradeBlessRequest prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements GuildBlessHandler.UpgradeBlessRequestOrBuilder {
/* 2337 */       public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_UpgradeBlessRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_UpgradeBlessRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GuildBlessHandler.UpgradeBlessRequest.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (GuildBlessHandler.UpgradeBlessRequest.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return GuildBlessHandler.internal_static_pomelo_area_UpgradeBlessRequest_descriptor; } public GuildBlessHandler.UpgradeBlessRequest getDefaultInstanceForType() { return GuildBlessHandler.UpgradeBlessRequest.getDefaultInstance(); } public GuildBlessHandler.UpgradeBlessRequest build() { GuildBlessHandler.UpgradeBlessRequest result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public GuildBlessHandler.UpgradeBlessRequest buildPartial() { GuildBlessHandler.UpgradeBlessRequest result = new GuildBlessHandler.UpgradeBlessRequest(this); onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof GuildBlessHandler.UpgradeBlessRequest) return mergeFrom((GuildBlessHandler.UpgradeBlessRequest)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(GuildBlessHandler.UpgradeBlessRequest other) { if (other == GuildBlessHandler.UpgradeBlessRequest.getDefaultInstance()) return this;  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { GuildBlessHandler.UpgradeBlessRequest parsedMessage = null; try { parsedMessage = (GuildBlessHandler.UpgradeBlessRequest)GuildBlessHandler.UpgradeBlessRequest.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (GuildBlessHandler.UpgradeBlessRequest)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } } static { defaultInstance.initFields(); }
/*      */      }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4058 */     private static final MyBlessInfo defaultInstance = new MyBlessInfo(true); private final UnknownFieldSet unknownFields; private MyBlessInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private MyBlessInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static MyBlessInfo getDefaultInstance() { return defaultInstance; } public MyBlessInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private MyBlessInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int length, limit, tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.blessCount_ = input.readInt32(); break;case 18: if ((mutable_bitField0_ & 0x2) != 2) { this.blessAttrs_ = new ArrayList<>(); mutable_bitField0_ |= 0x2; }  this.blessAttrs_.add(input.readMessage(Common.AttributeBase.PARSER, extensionRegistry)); break;case 24: this.bitField0_ |= 0x2; this.buffTime_ = input.readInt32(); break;case 32: if ((mutable_bitField0_ & 0x8) != 8) { this.receiveState_ = new ArrayList<>(); mutable_bitField0_ |= 0x8; }  this.receiveState_.add(Integer.valueOf(input.readInt32())); break;case 34: length = input.readRawVarint32(); limit = input.pushLimit(length); if ((mutable_bitField0_ & 0x8) != 8 && input.getBytesUntilLimit() > 0) { this.receiveState_ = new ArrayList<>(); mutable_bitField0_ |= 0x8; }  while (input.getBytesUntilLimit() > 0) this.receiveState_.add(Integer.valueOf(input.readInt32()));  input.popLimit(limit); break;case 42: if ((mutable_bitField0_ & 0x10) != 16) { this.itemList_ = new ArrayList<>(); mutable_bitField0_ |= 0x10; }  this.itemList_.add(input.readMessage(GuildBlessHandler.BlessItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x2) == 2) this.blessAttrs_ = Collections.unmodifiableList(this.blessAttrs_);  if ((mutable_bitField0_ & 0x8) == 8) this.receiveState_ = Collections.unmodifiableList(this.receiveState_);  if ((mutable_bitField0_ & 0x10) == 16) this.itemList_ = Collections.unmodifiableList(this.itemList_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_MyBlessInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_MyBlessInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(MyBlessInfo.class, Builder.class); } public static Parser<MyBlessInfo> PARSER = (Parser<MyBlessInfo>)new AbstractParser<MyBlessInfo>() { public GuildBlessHandler.MyBlessInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.MyBlessInfo(input, extensionRegistry); } }
/* 4059 */     ; private int bitField0_; public static final int BLESSCOUNT_FIELD_NUMBER = 1; private int blessCount_; public static final int BLESSATTRS_FIELD_NUMBER = 2; private List<Common.AttributeBase> blessAttrs_; public static final int BUFFTIME_FIELD_NUMBER = 3; private int buffTime_; public static final int RECEIVESTATE_FIELD_NUMBER = 4; private List<Integer> receiveState_; public static final int ITEMLIST_FIELD_NUMBER = 5; private List<GuildBlessHandler.BlessItem> itemList_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<MyBlessInfo> getParserForType() { return PARSER; } public boolean hasBlessCount() { return ((this.bitField0_ & 0x1) == 1); } public int getBlessCount() { return this.blessCount_; } public List<Common.AttributeBase> getBlessAttrsList() { return this.blessAttrs_; } public List<? extends Common.AttributeBaseOrBuilder> getBlessAttrsOrBuilderList() { return (List)this.blessAttrs_; } public int getBlessAttrsCount() { return this.blessAttrs_.size(); } public Common.AttributeBase getBlessAttrs(int index) { return this.blessAttrs_.get(index); } static { defaultInstance.initFields(); }
/*      */     
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements GuildBlessHandler.MyBlessInfoOrBuilder { private int bitField0_; private int blessCount_; private List<Common.AttributeBase> blessAttrs_; private RepeatedFieldBuilder<Common.AttributeBase, Common.AttributeBase.Builder, Common.AttributeBaseOrBuilder> blessAttrsBuilder_; private int buffTime_; private List<Integer> receiveState_; private List<GuildBlessHandler.BlessItem> itemList_; private RepeatedFieldBuilder<GuildBlessHandler.BlessItem, GuildBlessHandler.BlessItem.Builder, GuildBlessHandler.BlessItemOrBuilder> itemListBuilder_;
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/*      */   
/* 4829 */   public static final class GetMyBlessInfoResponse extends GeneratedMessage implements GetMyBlessInfoResponseOrBuilder { private static final GetMyBlessInfoResponse defaultInstance = new GetMyBlessInfoResponse(true); private final UnknownFieldSet unknownFields; private GetMyBlessInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetMyBlessInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetMyBlessInfoResponse getDefaultInstance() { return defaultInstance; } public GetMyBlessInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetMyBlessInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; GuildBlessHandler.MyBlessInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CBlessInfo_.toBuilder();  this.s2CBlessInfo_ = (GuildBlessHandler.MyBlessInfo)input.readMessage(GuildBlessHandler.MyBlessInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CBlessInfo_); this.s2CBlessInfo_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_GetMyBlessInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_GetMyBlessInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetMyBlessInfoResponse.class, Builder.class); } public static Parser<GetMyBlessInfoResponse> PARSER = (Parser<GetMyBlessInfoResponse>)new AbstractParser<GetMyBlessInfoResponse>() { public GuildBlessHandler.GetMyBlessInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.GetMyBlessInfoResponse(input, extensionRegistry); } }
/* 4830 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_BLESSINFO_FIELD_NUMBER = 3; private GuildBlessHandler.MyBlessInfo s2CBlessInfo_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetMyBlessInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5795 */     private static final BlessResult defaultInstance = new BlessResult(true); private final UnknownFieldSet unknownFields; private BlessResult(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BlessResult(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BlessResult getDefaultInstance() { return defaultInstance; } public BlessResult getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BlessResult(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int length, limit, tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.blessCount_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.blessValue_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.id_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.finishNum_ = input.readInt32(); break;case 40: if ((mutable_bitField0_ & 0x10) != 16) { this.finishState_ = new ArrayList<>(); mutable_bitField0_ |= 0x10; }  this.finishState_.add(Integer.valueOf(input.readInt32())); break;case 42: length = input.readRawVarint32(); limit = input.pushLimit(length); if ((mutable_bitField0_ & 0x10) != 16 && input.getBytesUntilLimit() > 0) { this.finishState_ = new ArrayList<>(); mutable_bitField0_ |= 0x10; }  while (input.getBytesUntilLimit() > 0) this.finishState_.add(Integer.valueOf(input.readInt32()));  input.popLimit(limit); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x10) == 16) this.finishState_ = Collections.unmodifiableList(this.finishState_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_BlessResult_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_BlessResult_fieldAccessorTable.ensureFieldAccessorsInitialized(BlessResult.class, Builder.class); } public static Parser<BlessResult> PARSER = (Parser<BlessResult>)new AbstractParser<BlessResult>() { public GuildBlessHandler.BlessResult parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.BlessResult(input, extensionRegistry); } }
/* 5796 */     ; private int bitField0_; public static final int BLESSCOUNT_FIELD_NUMBER = 1; private int blessCount_; public static final int BLESSVALUE_FIELD_NUMBER = 2; private int blessValue_; public static final int ID_FIELD_NUMBER = 3; private int id_; public static final int FINISHNUM_FIELD_NUMBER = 4; private int finishNum_; public static final int FINISHSTATE_FIELD_NUMBER = 5; private List<Integer> finishState_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BlessResult> getParserForType() { return PARSER; } public boolean hasBlessCount() { return ((this.bitField0_ & 0x1) == 1); } public int getBlessCount() { return this.blessCount_; } public boolean hasBlessValue() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 6546 */     private static final BlessActionResponse defaultInstance = new BlessActionResponse(true); private final UnknownFieldSet unknownFields; private BlessActionResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BlessActionResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BlessActionResponse getDefaultInstance() { return defaultInstance; } public BlessActionResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BlessActionResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; GuildBlessHandler.BlessResult.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CResult_.toBuilder();  this.s2CResult_ = (GuildBlessHandler.BlessResult)input.readMessage(GuildBlessHandler.BlessResult.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CResult_); this.s2CResult_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_BlessActionResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_BlessActionResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(BlessActionResponse.class, Builder.class); } public static Parser<BlessActionResponse> PARSER = (Parser<BlessActionResponse>)new AbstractParser<BlessActionResponse>() { public GuildBlessHandler.BlessActionResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.BlessActionResponse(input, extensionRegistry); } }
/* 6547 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_RESULT_FIELD_NUMBER = 3; private GuildBlessHandler.BlessResult s2CResult_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BlessActionResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */ 
/*      */     
/*      */     public ByteString getS2CMsgBytes() {
/*      */       Object ref = this.s2CMsg_;
...
/* 6975 */     private static final ReceiveResult defaultInstance = new ReceiveResult(true); private final UnknownFieldSet unknownFields; private ReceiveResult(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ReceiveResult(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ReceiveResult getDefaultInstance() { return defaultInstance; } public ReceiveResult getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ReceiveResult(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.receiveState_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveResult_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveResult_fieldAccessorTable.ensureFieldAccessorsInitialized(ReceiveResult.class, Builder.class); } public static Parser<ReceiveResult> PARSER = (Parser<ReceiveResult>)new AbstractParser<ReceiveResult>() { public GuildBlessHandler.ReceiveResult parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.ReceiveResult(input, extensionRegistry); } }
/* 6976 */     ; private int bitField0_; public static final int RECEIVESTATE_FIELD_NUMBER = 1; private int receiveState_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ReceiveResult> getParserForType() { return PARSER; } public boolean hasReceiveState() { return ((this.bitField0_ & 0x1) == 1); } public int getReceiveState() { return this.receiveState_; } private void initFields() { this.receiveState_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 7726 */     private static final ReceiveBlessGiftResponse defaultInstance = new ReceiveBlessGiftResponse(true); private final UnknownFieldSet unknownFields; private ReceiveBlessGiftResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ReceiveBlessGiftResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ReceiveBlessGiftResponse getDefaultInstance() { return defaultInstance; } public ReceiveBlessGiftResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ReceiveBlessGiftResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; GuildBlessHandler.ReceiveResult.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CResult_.toBuilder();  this.s2CResult_ = (GuildBlessHandler.ReceiveResult)input.readMessage(GuildBlessHandler.ReceiveResult.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CResult_); this.s2CResult_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveBlessGiftResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_ReceiveBlessGiftResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ReceiveBlessGiftResponse.class, Builder.class); } public static Parser<ReceiveBlessGiftResponse> PARSER = (Parser<ReceiveBlessGiftResponse>)new AbstractParser<ReceiveBlessGiftResponse>() { public GuildBlessHandler.ReceiveBlessGiftResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildBlessHandler.ReceiveBlessGiftResponse(input, extensionRegistry); } }
/* 7727 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_RESULT_FIELD_NUMBER = 3; private GuildBlessHandler.ReceiveResult s2CResult_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ReceiveBlessGiftResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/* 8444 */     private static final UpgradeBlessResponse defaultInstance = new UpgradeBlessResponse(true); public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasS2CLevel() { return ((this.bitField0_ & 0x4) == 4); } public int getS2CLevel() { return this.s2CLevel_; } public boolean hasS2CFund() { return ((this.bitField0_ & 0x8) == 8); } public int getS2CFund() { return this.s2CFund_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CLevel_ = 0; this.s2CFund_ = 0; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.s2CLevel_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.s2CFund_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.s2CLevel_);  if ((this.bitField0_ & 0x8) == 8) size += CodedOutputStream.computeInt32Size(4, this.s2CFund_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static UpgradeBlessResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (UpgradeBlessResponse)PARSER.parseFrom(data); } public static UpgradeBlessResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (UpgradeBlessResponse)PARSER.parseFrom(data, extensionRegistry); } public static UpgradeBlessResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (UpgradeBlessResponse)PARSER.parseFrom(data); }
/* 8445 */     static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 9433 */     private static final BlessRefreshPush defaultInstance = new BlessRefreshPush(true); public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasType() { return ((this.bitField0_ & 0x4) == 4); } public int getType() { return this.type_; } public boolean hasBlessValue() { return ((this.bitField0_ & 0x8) == 8); } public int getBlessValue() { return this.blessValue_; } public List<Integer> getFinishStateList() { return this.finishState_; } public int getFinishStateCount() { return this.finishState_.size(); } public int getFinishState(int index) { return ((Integer)this.finishState_.get(index)).intValue(); } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.type_ = 0; this.blessValue_ = 0; this.finishState_ = Collections.emptyList(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.type_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.blessValue_);  for (int i = 0; i < this.finishState_.size(); i++) output.writeInt32(5, ((Integer)this.finishState_.get(i)).intValue());  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.type_);  if ((this.bitField0_ & 0x8) == 8) size += CodedOutputStream.computeInt32Size(4, this.blessValue_);  int dataSize = 0; for (int i = 0; i < this.finishState_.size(); i++) dataSize += CodedOutputStream.computeInt32SizeNoTag(((Integer)this.finishState_.get(i)).intValue());  size += dataSize; size += 1 * getFinishStateList().size(); size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static BlessRefreshPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (BlessRefreshPush)PARSER.parseFrom(data); } public static BlessRefreshPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BlessRefreshPush)PARSER.parseFrom(data, extensionRegistry); } public static BlessRefreshPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (BlessRefreshPush)PARSER.parseFrom(data); } public static BlessRefreshPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BlessRefreshPush)PARSER.parseFrom(data, extensionRegistry); } public static BlessRefreshPush parseFrom(InputStream input) throws IOException { return (BlessRefreshPush)PARSER.parseFrom(input); } public static BlessRefreshPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BlessRefreshPush)PARSER.parseFrom(input, extensionRegistry); } public static BlessRefreshPush parseDelimitedFrom(InputStream input) throws IOException { return (BlessRefreshPush)PARSER.parseDelimitedFrom(input); } public static BlessRefreshPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BlessRefreshPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static BlessRefreshPush parseFrom(CodedInputStream input) throws IOException { return (BlessRefreshPush)PARSER.parseFrom(input); } public static BlessRefreshPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BlessRefreshPush)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(BlessRefreshPush prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements GuildBlessHandler.BlessRefreshPushOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int type_; private int blessValue_; private List<Integer> finishState_; public static final Descriptors.Descriptor getDescriptor() { return GuildBlessHandler.internal_static_pomelo_area_BlessRefreshPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildBlessHandler.internal_static_pomelo_area_BlessRefreshPush_fieldAccessorTable.ensureFieldAccessorsInitialized(GuildBlessHandler.BlessRefreshPush.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; this.finishState_ = Collections.emptyList(); maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; this.finishState_ = Collections.emptyList(); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (GuildBlessHandler.BlessRefreshPush.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; this.type_ = 0; this.bitField0_ &= 0xFFFFFFFB; this.blessValue_ = 0; this.bitField0_ &= 0xFFFFFFF7; this.finishState_ = Collections.emptyList(); this.bitField0_ &= 0xFFFFFFEF; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return GuildBlessHandler.internal_static_pomelo_area_BlessRefreshPush_descriptor; } public GuildBlessHandler.BlessRefreshPush getDefaultInstanceForType() { return GuildBlessHandler.BlessRefreshPush.getDefaultInstance(); } public GuildBlessHandler.BlessRefreshPush build() { GuildBlessHandler.BlessRefreshPush result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public GuildBlessHandler.BlessRefreshPush buildPartial() { GuildBlessHandler.BlessRefreshPush result = new GuildBlessHandler.BlessRefreshPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.s2CCode_ = this.s2CCode_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.s2CMsg_ = this.s2CMsg_; if ((from_bitField0_ & 0x4) == 4) to_bitField0_ |= 0x4;  result.type_ = this.type_; if ((from_bitField0_ & 0x8) == 8) to_bitField0_ |= 0x8;  result.blessValue_ = this.blessValue_; if ((this.bitField0_ & 0x10) == 16) { this.finishState_ = Collections.unmodifiableList(this.finishState_); this.bitField0_ &= 0xFFFFFFEF; }  result.finishState_ = this.finishState_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof GuildBlessHandler.BlessRefreshPush) return mergeFrom((GuildBlessHandler.BlessRefreshPush)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(GuildBlessHandler.BlessRefreshPush other) { if (other == GuildBlessHandler.BlessRefreshPush.getDefaultInstance()) return this;  if (other.hasS2CCode()) setS2CCode(other.getS2CCode());  if (other.hasS2CMsg()) { this.bitField0_ |= 0x2; this.s2CMsg_ = other.s2CMsg_; onChanged(); }  if (other.hasType()) setType(other.getType());  if (other.hasBlessValue()) setBlessValue(other.getBlessValue());  if (!other.finishState_.isEmpty()) { if (this.finishState_.isEmpty()) { this.finishState_ = other.finishState_; this.bitField0_ &= 0xFFFFFFEF; } else { ensureFinishStateIsMutable(); this.finishState_.addAll(other.finishState_); }  onChanged(); }  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CCode()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { GuildBlessHandler.BlessRefreshPush parsedMessage = null; try { parsedMessage = (GuildBlessHandler.BlessRefreshPush)GuildBlessHandler.BlessRefreshPush.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (GuildBlessHandler.BlessRefreshPush)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public Builder setS2CCode(int value) { this.bitField0_ |= 0x1; this.s2CCode_ = value; onChanged(); return this; } public Builder clearS2CCode() { this.bitField0_ &= 0xFFFFFFFE; this.s2CCode_ = 0; onChanged(); return this; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (!(ref instanceof String)) { ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; }  return (String)ref; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public Builder setS2CMsg(String value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = GuildBlessHandler.BlessRefreshPush.getDefaultInstance().getS2CMsg(); onChanged(); return this; } public Builder setS2CMsgBytes(ByteString value) { if (value == null)
/* 9434 */           throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public boolean hasType() { return ((this.bitField0_ & 0x4) == 4); } public int getType() { return this.type_; } public Builder setType(int value) { this.bitField0_ |= 0x4; this.type_ = value; onChanged(); return this; } public Builder clearType() { this.bitField0_ &= 0xFFFFFFFB; this.type_ = 0; onChanged(); return this; } public boolean hasBlessValue() { return ((this.bitField0_ & 0x8) == 8); } public int getBlessValue() { return this.blessValue_; } public Builder setBlessValue(int value) { this.bitField0_ |= 0x8; this.blessValue_ = value; onChanged(); return this; } public Builder clearBlessValue() { this.bitField0_ &= 0xFFFFFFF7; this.blessValue_ = 0; onChanged(); return this; } private void ensureFinishStateIsMutable() { if ((this.bitField0_ & 0x10) != 16) { this.finishState_ = new ArrayList<>(this.finishState_); this.bitField0_ |= 0x10; }  } public List<Integer> getFinishStateList() { return Collections.unmodifiableList(this.finishState_); } public int getFinishStateCount() { return this.finishState_.size(); } public int getFinishState(int index) { return ((Integer)this.finishState_.get(index)).intValue(); } public Builder setFinishState(int index, int value) { ensureFinishStateIsMutable(); this.finishState_.set(index, Integer.valueOf(value)); onChanged(); return this; } public Builder addFinishState(int value) { ensureFinishStateIsMutable(); this.finishState_.add(Integer.valueOf(value)); onChanged(); return this; } public Builder addAllFinishState(Iterable<? extends Integer> values) { ensureFinishStateIsMutable(); AbstractMessageLite.Builder.addAll(values, this.finishState_); onChanged(); return this; } public Builder clearFinishState() { this.finishState_ = Collections.emptyList(); this.bitField0_ &= 0xFFFFFFEF; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 9555 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 9559 */           GuildBlessHandler.descriptor = root;
/* 9560 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 9564 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 9566 */           ItemOuterClass.getDescriptor(), 
/* 9567 */           Common.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 9570 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BlessItem_descriptor = getDescriptor().getMessageTypes().get(0);
/* 9571 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BlessItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BlessItem_descriptor, new String[] { "Item" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9576 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetMyBlessInfoRequest_descriptor = getDescriptor().getMessageTypes().get(1);
/* 9577 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetMyBlessInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetMyBlessInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9582 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BlessActionRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 9583 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BlessActionRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BlessActionRequest_descriptor, new String[] { "Id" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9588 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ReceiveBlessGiftRequest_descriptor = getDescriptor().getMessageTypes().get(3);
/* 9589 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ReceiveBlessGiftRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ReceiveBlessGiftRequest_descriptor, new String[] { "Index" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9594 */   private static final Descriptors.Descriptor internal_static_pomelo_area_UpgradeBlessRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 9595 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_UpgradeBlessRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_UpgradeBlessRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9600 */   private static final Descriptors.Descriptor internal_static_pomelo_area_MyBlessInfo_descriptor = getDescriptor().getMessageTypes().get(5);
/* 9601 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_MyBlessInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_MyBlessInfo_descriptor, new String[] { "BlessCount", "BlessAttrs", "BuffTime", "ReceiveState", "ItemList" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9606 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetMyBlessInfoResponse_descriptor = getDescriptor().getMessageTypes().get(6);
/* 9607 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetMyBlessInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetMyBlessInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CBlessInfo" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9612 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BlessResult_descriptor = getDescriptor().getMessageTypes().get(7);
/* 9613 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BlessResult_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BlessResult_descriptor, new String[] { "BlessCount", "BlessValue", "Id", "FinishNum", "FinishState" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9618 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BlessActionResponse_descriptor = getDescriptor().getMessageTypes().get(8);
/* 9619 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BlessActionResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BlessActionResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CResult" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9624 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ReceiveResult_descriptor = getDescriptor().getMessageTypes().get(9);
/* 9625 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ReceiveResult_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ReceiveResult_descriptor, new String[] { "ReceiveState" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9630 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ReceiveBlessGiftResponse_descriptor = getDescriptor().getMessageTypes().get(10);
/* 9631 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ReceiveBlessGiftResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ReceiveBlessGiftResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CResult" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9636 */   private static final Descriptors.Descriptor internal_static_pomelo_area_UpgradeBlessResponse_descriptor = getDescriptor().getMessageTypes().get(11);
/* 9637 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_UpgradeBlessResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_UpgradeBlessResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CLevel", "S2CFund" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 9642 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BlessRefreshPush_descriptor = getDescriptor().getMessageTypes().get(12);
/* 9643 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BlessRefreshPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BlessRefreshPush_descriptor, new String[] { "S2CCode", "S2CMsg", "Type", "BlessValue", "FinishState" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 9647 */     ItemOuterClass.getDescriptor();
/* 9648 */     Common.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\GuildBlessHandler.class
