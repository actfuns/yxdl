...
/*       */     }
/*       */     
/*   441 */     private static final PackUpBagRequest defaultInstance = new PackUpBagRequest(true); public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasC2SType()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.c2SType_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.c2SType_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static PackUpBagRequest parseFrom(ByteString data) throws InvalidProtocolBufferException { return (PackUpBagRequest)PARSER.parseFrom(data); } public static PackUpBagRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (PackUpBagRequest)PARSER.parseFrom(data, extensionRegistry); } public static PackUpBagRequest parseFrom(byte[] data) throws InvalidProtocolBufferException { return (PackUpBagRequest)PARSER.parseFrom(data); } public static PackUpBagRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (PackUpBagRequest)PARSER.parseFrom(data, extensionRegistry); } public static PackUpBagRequest parseFrom(InputStream input) throws IOException { return (PackUpBagRequest)PARSER.parseFrom(input); } public static PackUpBagRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (PackUpBagRequest)PARSER.parseFrom(input, extensionRegistry); } public static PackUpBagRequest parseDelimitedFrom(InputStream input) throws IOException { return (PackUpBagRequest)PARSER.parseDelimitedFrom(input); } public static PackUpBagRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (PackUpBagRequest)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static PackUpBagRequest parseFrom(CodedInputStream input) throws IOException { return (PackUpBagRequest)PARSER.parseFrom(input); } public static PackUpBagRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (PackUpBagRequest)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(PackUpBagRequest prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements BagHandler.PackUpBagRequestOrBuilder {
/*   442 */       private int bitField0_; private int c2SType_; public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_PackUpBagRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_PackUpBagRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BagHandler.PackUpBagRequest.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (BagHandler.PackUpBagRequest.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.c2SType_ = 0; this.bitField0_ &= 0xFFFFFFFE; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return BagHandler.internal_static_pomelo_area_PackUpBagRequest_descriptor; } public BagHandler.PackUpBagRequest getDefaultInstanceForType() { return BagHandler.PackUpBagRequest.getDefaultInstance(); } public BagHandler.PackUpBagRequest build() { BagHandler.PackUpBagRequest result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public BagHandler.PackUpBagRequest buildPartial() { BagHandler.PackUpBagRequest result = new BagHandler.PackUpBagRequest(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.c2SType_ = this.c2SType_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof BagHandler.PackUpBagRequest) return mergeFrom((BagHandler.PackUpBagRequest)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(BagHandler.PackUpBagRequest other) { if (other == BagHandler.PackUpBagRequest.getDefaultInstance()) return this;  if (other.hasC2SType()) setC2SType(other.getC2SType());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasC2SType()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { BagHandler.PackUpBagRequest parsedMessage = null; try { parsedMessage = (BagHandler.PackUpBagRequest)BagHandler.PackUpBagRequest.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (BagHandler.PackUpBagRequest)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } public Builder setC2SType(int value) { this.bitField0_ |= 0x1; this.c2SType_ = value; onChanged(); return this; } public Builder clearC2SType() { this.bitField0_ &= 0xFFFFFFFE; this.c2SType_ = 0; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*       */   
/*       */   }
/*       */ 
/*       */ 
...
/*       */   {
/*  1453 */     private static final PackUpBagResponse defaultInstance = new PackUpBagResponse(true); private final UnknownFieldSet unknownFields; private PackUpBagResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private PackUpBagResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static PackUpBagResponse getDefaultInstance() { return defaultInstance; } public PackUpBagResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private PackUpBagResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.s2CType_ = input.readInt32(); break;case 34: if ((mutable_bitField0_ & 0x8) != 8) { this.s2CBagGrids_ = new ArrayList<>(); mutable_bitField0_ |= 0x8; }  this.s2CBagGrids_.add(input.readMessage(ItemOuterClass.Grid.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x8) == 8) this.s2CBagGrids_ = Collections.unmodifiableList(this.s2CBagGrids_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_PackUpBagResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_PackUpBagResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(PackUpBagResponse.class, Builder.class); } public static Parser<PackUpBagResponse> PARSER = (Parser<PackUpBagResponse>)new AbstractParser<PackUpBagResponse>() { public BagHandler.PackUpBagResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.PackUpBagResponse(input, extensionRegistry); } }
/*  1454 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TYPE_FIELD_NUMBER = 3; private int s2CType_; public static final int S2C_BAGGRIDS_FIELD_NUMBER = 4; private List<ItemOuterClass.Grid> s2CBagGrids_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<PackUpBagResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */     
...
/*       */       return builder;
/*       */     }
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements BagHandler.PackUpBagResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int s2CType_; private List<ItemOuterClass.Grid> s2CBagGrids_; private RepeatedFieldBuilder<ItemOuterClass.Grid, ItemOuterClass.Grid.Builder, ItemOuterClass.GridOrBuilder> s2CBagGridsBuilder_;
/*       */       public static final Descriptors.Descriptor getDescriptor() {
...
/*       */       } } }
/*       */   
/*  1976 */   public static final class OpenBagGridRequest extends GeneratedMessage implements OpenBagGridRequestOrBuilder { private static final OpenBagGridRequest defaultInstance = new OpenBagGridRequest(true); private final UnknownFieldSet unknownFields; private OpenBagGridRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private OpenBagGridRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static OpenBagGridRequest getDefaultInstance() { return defaultInstance; } public OpenBagGridRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private OpenBagGridRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SNumber_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_OpenBagGridRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_OpenBagGridRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(OpenBagGridRequest.class, Builder.class); } public static Parser<OpenBagGridRequest> PARSER = (Parser<OpenBagGridRequest>)new AbstractParser<OpenBagGridRequest>() { public BagHandler.OpenBagGridRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.OpenBagGridRequest(input, extensionRegistry); } }
/*  1977 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; public static final int C2S_NUMBER_FIELD_NUMBER = 2; private int c2SNumber_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<OpenBagGridRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } public boolean hasC2SNumber() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  2694 */     private static final OpenBagGridResponse defaultInstance = new OpenBagGridResponse(true); private final UnknownFieldSet unknownFields; private OpenBagGridResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private OpenBagGridResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static OpenBagGridResponse getDefaultInstance() { return defaultInstance; } public OpenBagGridResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private OpenBagGridResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.s2CType_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.s2CBagGridCount_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_OpenBagGridResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_OpenBagGridResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(OpenBagGridResponse.class, Builder.class); } public static Parser<OpenBagGridResponse> PARSER = (Parser<OpenBagGridResponse>)new AbstractParser<OpenBagGridResponse>() { public BagHandler.OpenBagGridResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.OpenBagGridResponse(input, extensionRegistry); } }
/*  2695 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_TYPE_FIELD_NUMBER = 3; private int s2CType_; public static final int S2C_BAGGRIDCOUNT_FIELD_NUMBER = 4; private int s2CBagGridCount_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<OpenBagGridResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */      public String getS2CMsg() {
/*       */       Object ref = this.s2CMsg_;
/*       */       if (ref instanceof String)
/*       */         return (String)ref; 
...
/*       */       Builder builder = new Builder(parent);
/*       */       return builder;
/*       */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements BagHandler.OpenBagGridResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int s2CType_; private int s2CBagGridCount_;
/*       */       public static final Descriptors.Descriptor getDescriptor() {
...
/*       */         return this;
/*       */       } } }
/*  3007 */   public static final class AddBagItemTestNotify extends GeneratedMessage implements AddBagItemTestNotifyOrBuilder { private static final AddBagItemTestNotify defaultInstance = new AddBagItemTestNotify(true); private final UnknownFieldSet unknownFields; private AddBagItemTestNotify(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AddBagItemTestNotify(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AddBagItemTestNotify getDefaultInstance() { return defaultInstance; } public AddBagItemTestNotify getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AddBagItemTestNotify(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_AddBagItemTestNotify_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_AddBagItemTestNotify_fieldAccessorTable.ensureFieldAccessorsInitialized(AddBagItemTestNotify.class, Builder.class); } public static Parser<AddBagItemTestNotify> PARSER = (Parser<AddBagItemTestNotify>)new AbstractParser<AddBagItemTestNotify>() { public BagHandler.AddBagItemTestNotify parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.AddBagItemTestNotify(input, extensionRegistry); } }
/*  3008 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AddBagItemTestNotify> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  3702 */     private static final TransferItemRequest defaultInstance = new TransferItemRequest(true); private final UnknownFieldSet unknownFields; private TransferItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private TransferItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static TransferItemRequest getDefaultInstance() { return defaultInstance; } public TransferItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private TransferItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SFromType_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SFromIndex_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.c2SToType_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_TransferItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_TransferItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(TransferItemRequest.class, Builder.class); } public static Parser<TransferItemRequest> PARSER = (Parser<TransferItemRequest>)new AbstractParser<TransferItemRequest>() { public BagHandler.TransferItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.TransferItemRequest(input, extensionRegistry); } }
/*  3703 */     ; private int bitField0_; public static final int C2S_FROMTYPE_FIELD_NUMBER = 1; private int c2SFromType_; public static final int C2S_FROMINDEX_FIELD_NUMBER = 2; private int c2SFromIndex_; public static final int C2S_TOTYPE_FIELD_NUMBER = 3; private int c2SToType_; public static final int C2S_NUM_FIELD_NUMBER = 4; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<TransferItemRequest> getParserForType() { return PARSER; } public boolean hasC2SFromType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SFromType() { return this.c2SFromType_; } public boolean hasC2SFromIndex() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  4264 */     private static final TransferItemResponse defaultInstance = new TransferItemResponse(true); private final UnknownFieldSet unknownFields; private TransferItemResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private TransferItemResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static TransferItemResponse getDefaultInstance() { return defaultInstance; } public TransferItemResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private TransferItemResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_TransferItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_TransferItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(TransferItemResponse.class, Builder.class); } public static Parser<TransferItemResponse> PARSER = (Parser<TransferItemResponse>)new AbstractParser<TransferItemResponse>() { public BagHandler.TransferItemResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.TransferItemResponse(input, extensionRegistry); } }
/*  4265 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<TransferItemResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  4755 */     private static final SellItemRequest defaultInstance = new SellItemRequest(true); private final UnknownFieldSet unknownFields; private SellItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SellItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SellItemRequest getDefaultInstance() { return defaultInstance; } public SellItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SellItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SGridIndex_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_SellItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_SellItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(SellItemRequest.class, Builder.class); } public static Parser<SellItemRequest> PARSER = (Parser<SellItemRequest>)new AbstractParser<SellItemRequest>() { public BagHandler.SellItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.SellItemRequest(input, extensionRegistry); } }
/*  4756 */     ; private int bitField0_; public static final int C2S_GRIDINDEX_FIELD_NUMBER = 1; private int c2SGridIndex_; public static final int C2S_NUM_FIELD_NUMBER = 2; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SellItemRequest> getParserForType() { return PARSER; } public boolean hasC2SGridIndex() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SGridIndex() { return this.c2SGridIndex_; } public boolean hasC2SNum() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  5317 */     private static final SellItemResponse defaultInstance = new SellItemResponse(true); private final UnknownFieldSet unknownFields; private SellItemResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SellItemResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SellItemResponse getDefaultInstance() { return defaultInstance; } public SellItemResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SellItemResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_SellItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_SellItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(SellItemResponse.class, Builder.class); } public static Parser<SellItemResponse> PARSER = (Parser<SellItemResponse>)new AbstractParser<SellItemResponse>() { public BagHandler.SellItemResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.SellItemResponse(input, extensionRegistry); } }
/*  5318 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SellItemResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  5808 */     private static final UseItemRequest defaultInstance = new UseItemRequest(true); private final UnknownFieldSet unknownFields; private UseItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private UseItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static UseItemRequest getDefaultInstance() { return defaultInstance; } public UseItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private UseItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SGridIndex_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_UseItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_UseItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(UseItemRequest.class, Builder.class); } public static Parser<UseItemRequest> PARSER = (Parser<UseItemRequest>)new AbstractParser<UseItemRequest>() { public BagHandler.UseItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.UseItemRequest(input, extensionRegistry); } }
/*  5809 */     ; private int bitField0_; public static final int C2S_GRIDINDEX_FIELD_NUMBER = 1; private int c2SGridIndex_; public static final int C2S_NUM_FIELD_NUMBER = 2; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<UseItemRequest> getParserForType() { return PARSER; } public boolean hasC2SGridIndex() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SGridIndex() { return this.c2SGridIndex_; } public boolean hasC2SNum() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  6964 */     private static final UseItemResponse defaultInstance = new UseItemResponse(true); private final UnknownFieldSet unknownFields; private UseItemResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private UseItemResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static UseItemResponse getDefaultInstance() { return defaultInstance; } public UseItemResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private UseItemResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CChest_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CChest_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break;case 32: this.bitField0_ |= 0x4; this.isGain_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CChest_ = Collections.unmodifiableList(this.s2CChest_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_UseItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_UseItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(UseItemResponse.class, Builder.class); } public static Parser<UseItemResponse> PARSER = (Parser<UseItemResponse>)new AbstractParser<UseItemResponse>() { public BagHandler.UseItemResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.UseItemResponse(input, extensionRegistry); } }
/*  6965 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_CHEST_FIELD_NUMBER = 3; private List<ItemOuterClass.MiniItem> s2CChest_; public static final int IS_GAIN_FIELD_NUMBER = 4; private int isGain_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<UseItemResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  7749 */     private static final BagItemUpdatePush defaultInstance = new BagItemUpdatePush(true); private final UnknownFieldSet unknownFields; private BagItemUpdatePush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BagItemUpdatePush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BagItemUpdatePush getDefaultInstance() { return defaultInstance; } public BagItemUpdatePush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BagItemUpdatePush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 16: this.bitField0_ |= 0x1; this.s2CType_ = input.readInt32(); break;case 26: if ((mutable_bitField0_ & 0x2) != 2) { this.s2CData_ = new ArrayList<>(); mutable_bitField0_ |= 0x2; }  this.s2CData_.add(input.readMessage(ItemOuterClass.Grid.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x2) == 2) this.s2CData_ = Collections.unmodifiableList(this.s2CData_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagItemUpdatePush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagItemUpdatePush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagItemUpdatePush.class, Builder.class); } public static Parser<BagItemUpdatePush> PARSER = (Parser<BagItemUpdatePush>)new AbstractParser<BagItemUpdatePush>() { public BagHandler.BagItemUpdatePush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.BagItemUpdatePush(input, extensionRegistry); } }
/*  7750 */     ; private int bitField0_; public static final int S2C_TYPE_FIELD_NUMBER = 2; private int s2CType_; public static final int S2C_DATA_FIELD_NUMBER = 3; private List<ItemOuterClass.Grid> s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BagItemUpdatePush> getParserForType() { return PARSER; } public boolean hasS2CType() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CType() { return this.s2CType_; } public List<ItemOuterClass.Grid> getS2CDataList() { return this.s2CData_; } public List<? extends ItemOuterClass.GridOrBuilder> getS2CDataOrBuilderList() { return (List)this.s2CData_; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  8437 */     private static final BagNewItemPush defaultInstance = new BagNewItemPush(true); private final UnknownFieldSet unknownFields; private BagNewItemPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BagNewItemPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BagNewItemPush getDefaultInstance() { return defaultInstance; } public BagNewItemPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BagNewItemPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 18: if ((mutable_bitField0_ & 0x1) != 1) { this.s2CData_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.s2CData_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.s2CData_ = Collections.unmodifiableList(this.s2CData_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagNewItemPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagNewItemPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagNewItemPush.class, Builder.class); } public static Parser<BagNewItemPush> PARSER = (Parser<BagNewItemPush>)new AbstractParser<BagNewItemPush>() { public BagHandler.BagNewItemPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.BagNewItemPush(input, extensionRegistry); } }
/*  8438 */     ; public static final int S2C_DATA_FIELD_NUMBER = 2; private List<ItemOuterClass.MiniItem> s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BagNewItemPush> getParserForType() { return PARSER; } public List<ItemOuterClass.MiniItem> getS2CDataList() { return this.s2CData_; } public List<? extends ItemOuterClass.MiniItemOrBuilder> getS2CDataOrBuilderList() { return (List)this.s2CData_; } public int getS2CDataCount() { return this.s2CData_.size(); } public ItemOuterClass.MiniItem getS2CData(int index) { return this.s2CData_.get(index); } public ItemOuterClass.MiniItemOrBuilder getS2CDataOrBuilder(int index) { return (ItemOuterClass.MiniItemOrBuilder)this.s2CData_.get(index); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  9004 */     private static final BagNewEquipPush defaultInstance = new BagNewEquipPush(true); private final UnknownFieldSet unknownFields; private BagNewEquipPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BagNewEquipPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BagNewEquipPush getDefaultInstance() { return defaultInstance; } public BagNewEquipPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BagNewEquipPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 18: bs = input.readBytes(); if ((mutable_bitField0_ & 0x1) != 1) { this.s2CData_ = (LazyStringList)new LazyStringArrayList(); mutable_bitField0_ |= 0x1; }  this.s2CData_.add(bs); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.s2CData_ = this.s2CData_.getUnmodifiableView();  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagNewEquipPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagNewEquipPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagNewEquipPush.class, Builder.class); } public static Parser<BagNewEquipPush> PARSER = (Parser<BagNewEquipPush>)new AbstractParser<BagNewEquipPush>() { public BagHandler.BagNewEquipPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.BagNewEquipPush(input, extensionRegistry); } }
/*  9005 */     ; public static final int S2C_DATA_FIELD_NUMBER = 2; private LazyStringList s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BagNewEquipPush> getParserForType() { return PARSER; } public ProtocolStringList getS2CDataList() { return (ProtocolStringList)this.s2CData_; } public int getS2CDataCount() { return this.s2CData_.size(); } public String getS2CData(int index) { return (String)this.s2CData_.get(index); } public ByteString getS2CDataBytes(int index) { return this.s2CData_.getByteString(index); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  9409 */     private static final BagGridFullPush defaultInstance = new BagGridFullPush(true); private final UnknownFieldSet unknownFields; private BagGridFullPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BagGridFullPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BagGridFullPush getDefaultInstance() { return defaultInstance; } public BagGridFullPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BagGridFullPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagGridFullPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagGridFullPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagGridFullPush.class, Builder.class); } public static Parser<BagGridFullPush> PARSER = (Parser<BagGridFullPush>)new AbstractParser<BagGridFullPush>() { public BagHandler.BagGridFullPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.BagGridFullPush(input, extensionRegistry); } }
/*  9410 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BagGridFullPush> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } private void initFields() { this.s2CCode_ = 0; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */     
...
/*       */ 
/*       */     
/*  9964 */     private static final BagGridNumPush defaultInstance = new BagGridNumPush(true); public static BagGridNumPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagGridNumPush)PARSER.parseFrom(input, extensionRegistry); } public static BagGridNumPush parseDelimitedFrom(InputStream input) throws IOException { return (BagGridNumPush)PARSER.parseDelimitedFrom(input); } public static BagGridNumPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagGridNumPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static BagGridNumPush parseFrom(CodedInputStream input) throws IOException { return (BagGridNumPush)PARSER.parseFrom(input); } public static BagGridNumPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagGridNumPush)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(BagGridNumPush prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements BagHandler.BagGridNumPushOrBuilder {
/*  9965 */       private int bitField0_; private int s2CType_; private int gridNum_; public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagGridNumPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagGridNumPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagHandler.BagGridNumPush.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (BagHandler.BagGridNumPush.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CType_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.gridNum_ = 0; this.bitField0_ &= 0xFFFFFFFD; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return BagHandler.internal_static_pomelo_area_BagGridNumPush_descriptor; } public BagHandler.BagGridNumPush getDefaultInstanceForType() { return BagHandler.BagGridNumPush.getDefaultInstance(); } public BagHandler.BagGridNumPush build() { BagHandler.BagGridNumPush result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public BagHandler.BagGridNumPush buildPartial() { BagHandler.BagGridNumPush result = new BagHandler.BagGridNumPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.s2CType_ = this.s2CType_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.gridNum_ = this.gridNum_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof BagHandler.BagGridNumPush) return mergeFrom((BagHandler.BagGridNumPush)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(BagHandler.BagGridNumPush other) { if (other == BagHandler.BagGridNumPush.getDefaultInstance()) return this;  if (other.hasS2CType()) setS2CType(other.getS2CType());  if (other.hasGridNum()) setGridNum(other.getGridNum());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CType()) return false;  if (!hasGridNum()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { BagHandler.BagGridNumPush parsedMessage = null; try { parsedMessage = (BagHandler.BagGridNumPush)BagHandler.BagGridNumPush.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (BagHandler.BagGridNumPush)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasS2CType() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CType() { return this.s2CType_; } public Builder setS2CType(int value) { this.bitField0_ |= 0x1; this.s2CType_ = value; onChanged(); return this; } public Builder clearS2CType() { this.bitField0_ &= 0xFFFFFFFE; this.s2CType_ = 0; onChanged(); return this; } public boolean hasGridNum() { return ((this.bitField0_ & 0x2) == 2); } public int getGridNum() { return this.gridNum_; } public Builder setGridNum(int value) { this.bitField0_ |= 0x2; this.gridNum_ = value; onChanged(); return this; } public Builder clearGridNum() { this.bitField0_ &= 0xFFFFFFFD; this.gridNum_ = 0; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*       */   
/*       */   }
/*       */ 
/*       */ 
...
/*       */   {
/* 10652 */     private static final BagNewItemFromResFubenPush defaultInstance = new BagNewItemFromResFubenPush(true); private final UnknownFieldSet unknownFields; private BagNewItemFromResFubenPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BagNewItemFromResFubenPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BagNewItemFromResFubenPush getDefaultInstance() { return defaultInstance; } public BagNewItemFromResFubenPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BagNewItemFromResFubenPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 18: if ((mutable_bitField0_ & 0x1) != 1) { this.s2CData_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.s2CData_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.s2CData_ = Collections.unmodifiableList(this.s2CData_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagNewItemFromResFubenPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagNewItemFromResFubenPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagNewItemFromResFubenPush.class, Builder.class); } public static Parser<BagNewItemFromResFubenPush> PARSER = (Parser<BagNewItemFromResFubenPush>)new AbstractParser<BagNewItemFromResFubenPush>() { public BagHandler.BagNewItemFromResFubenPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new BagHandler.BagNewItemFromResFubenPush(input, extensionRegistry); } }; public static final int S2C_DATA_FIELD_NUMBER = 2; private List<ItemOuterClass.MiniItem> s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BagNewItemFromResFubenPush> getParserForType() { return PARSER; } public List<ItemOuterClass.MiniItem> getS2CDataList() { return this.s2CData_; } public List<? extends ItemOuterClass.MiniItemOrBuilder> getS2CDataOrBuilderList() { return (List)this.s2CData_; } public int getS2CDataCount() { return this.s2CData_.size(); } public ItemOuterClass.MiniItem getS2CData(int index) { return this.s2CData_.get(index); } public ItemOuterClass.MiniItemOrBuilder getS2CDataOrBuilder(int index) { return (ItemOuterClass.MiniItemOrBuilder)this.s2CData_.get(index); } private void initFields() { this.s2CData_ = Collections.emptyList(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  for (int i = 0; i < getS2CDataCount(); i++) { if (!getS2CData(i).isInitialized()) { this.memoizedIsInitialized = 0; return false; }  }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); for (int i = 0; i < this.s2CData_.size(); i++) output.writeMessage(2, (MessageLite)this.s2CData_.get(i));  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; for (int i = 0; i < this.s2CData_.size(); i++)
/* 10653 */         size += CodedOutputStream.computeMessageSize(2, (MessageLite)this.s2CData_.get(i));  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static BagNewItemFromResFubenPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(data); } public static BagNewItemFromResFubenPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(data, extensionRegistry); } public static BagNewItemFromResFubenPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(data); } public static BagNewItemFromResFubenPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(data, extensionRegistry); } public static BagNewItemFromResFubenPush parseFrom(InputStream input) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(input); } public static BagNewItemFromResFubenPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(input, extensionRegistry); } public static BagNewItemFromResFubenPush parseDelimitedFrom(InputStream input) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseDelimitedFrom(input); } public static BagNewItemFromResFubenPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static BagNewItemFromResFubenPush parseFrom(CodedInputStream input) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(input); } public static BagNewItemFromResFubenPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (BagNewItemFromResFubenPush)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } static { defaultInstance.initFields(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(BagNewItemFromResFubenPush prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements BagHandler.BagNewItemFromResFubenPushOrBuilder { private int bitField0_; private List<ItemOuterClass.MiniItem> s2CData_; private RepeatedFieldBuilder<ItemOuterClass.MiniItem, ItemOuterClass.MiniItem.Builder, ItemOuterClass.MiniItemOrBuilder> s2CDataBuilder_; public static final Descriptors.Descriptor getDescriptor() { return BagHandler.internal_static_pomelo_area_BagNewItemFromResFubenPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return BagHandler.internal_static_pomelo_area_BagNewItemFromResFubenPush_fieldAccessorTable.ensureFieldAccessorsInitialized(BagHandler.BagNewItemFromResFubenPush.class, Builder.class); } private Builder() { this.s2CData_ = Collections.emptyList(); maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CData_ = Collections.emptyList(); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (BagHandler.BagNewItemFromResFubenPush.alwaysUseFieldBuilders)
/*       */           getS2CDataFieldBuilder();  } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); if (this.s2CDataBuilder_ == null) {
/*       */           this.s2CData_ = Collections.emptyList(); this.bitField0_ &= 0xFFFFFFFE;
/*       */         } else {
/*       */           this.s2CDataBuilder_.clear();
/*       */         }  return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return BagHandler.internal_static_pomelo_area_BagNewItemFromResFubenPush_descriptor; } public BagHandler.BagNewItemFromResFubenPush getDefaultInstanceForType() { return BagHandler.BagNewItemFromResFubenPush.getDefaultInstance(); } public BagHandler.BagNewItemFromResFubenPush build() { BagHandler.BagNewItemFromResFubenPush result = buildPartial(); if (!result.isInitialized())
/*       */           throw newUninitializedMessageException(result);  return result; } public BagHandler.BagNewItemFromResFubenPush buildPartial() { BagHandler.BagNewItemFromResFubenPush result = new BagHandler.BagNewItemFromResFubenPush(this); int from_bitField0_ = this.bitField0_; if (this.s2CDataBuilder_ == null) {
/*       */           if ((this.bitField0_ & 0x1) == 1) {
/*       */             this.s2CData_ = Collections.unmodifiableList(this.s2CData_); this.bitField0_ &= 0xFFFFFFFE;
/*       */           }  result.s2CData_ = this.s2CData_;
/*       */         } else {
/*       */           result.s2CData_ = this.s2CDataBuilder_.build();
/*       */         }  onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof BagHandler.BagNewItemFromResFubenPush)
/*       */           return mergeFrom((BagHandler.BagNewItemFromResFubenPush)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(BagHandler.BagNewItemFromResFubenPush other) { if (other == BagHandler.BagNewItemFromResFubenPush.getDefaultInstance())
/*       */           return this;  if (this.s2CDataBuilder_ == null) {
/*       */           if (!other.s2CData_.isEmpty()) {
/*       */             if (this.s2CData_.isEmpty()) {
/*       */               this.s2CData_ = other.s2CData_; this.bitField0_ &= 0xFFFFFFFE;
/*       */             } else {
...
/*       */         } else if (!other.s2CData_.isEmpty()) {
/*       */           if (this.s2CDataBuilder_.isEmpty()) {
/*       */             this.s2CDataBuilder_.dispose(); this.s2CDataBuilder_ = null; this.s2CData_ = other.s2CData_; this.bitField0_ &= 0xFFFFFFFE; this.s2CDataBuilder_ = BagHandler.BagNewItemFromResFubenPush.alwaysUseFieldBuilders ? getS2CDataFieldBuilder() : null;
/*       */           } else {
/*       */             this.s2CDataBuilder_.addAllMessages(other.s2CData_);
/*       */           } 
/*       */         }  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { for (int i = 0; i < getS2CDataCount(); i++) {
/*       */           if (!getS2CData(i).isInitialized())
/*       */             return false; 
/*       */         }  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { BagHandler.BagNewItemFromResFubenPush parsedMessage = null; try {
...
/*       */         } catch (InvalidProtocolBufferException e) {
/*       */           parsedMessage = (BagHandler.BagNewItemFromResFubenPush)e.getUnfinishedMessage(); throw e;
/*       */         } finally {
/*       */           if (parsedMessage != null)
/*       */             mergeFrom(parsedMessage); 
/*       */         }  return this; } private void ensureS2CDataIsMutable() { if ((this.bitField0_ & 0x1) != 1) {
/*       */           this.s2CData_ = new ArrayList<>(this.s2CData_); this.bitField0_ |= 0x1;
/*       */         }  } public List<ItemOuterClass.MiniItem> getS2CDataList() { if (this.s2CDataBuilder_ == null)
/*       */           return Collections.unmodifiableList(this.s2CData_);  return this.s2CDataBuilder_.getMessageList(); } public int getS2CDataCount() { if (this.s2CDataBuilder_ == null)
/*       */           return this.s2CData_.size();  return this.s2CDataBuilder_.getCount(); } public ItemOuterClass.MiniItem getS2CData(int index) { if (this.s2CDataBuilder_ == null)
/*       */           return this.s2CData_.get(index);  return (ItemOuterClass.MiniItem)this.s2CDataBuilder_.getMessage(index); } public Builder setS2CData(int index, ItemOuterClass.MiniItem value) { if (this.s2CDataBuilder_ == null) {
/*       */           if (value == null)
/*       */             throw new NullPointerException();  ensureS2CDataIsMutable(); this.s2CData_.set(index, value); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.setMessage(index, (GeneratedMessage)value);
/*       */         }  return this; } public Builder setS2CData(int index, ItemOuterClass.MiniItem.Builder builderForValue) { if (this.s2CDataBuilder_ == null) {
/*       */           ensureS2CDataIsMutable(); this.s2CData_.set(index, builderForValue.build()); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.setMessage(index, (GeneratedMessage)builderForValue.build());
/*       */         }  return this; } public Builder addS2CData(ItemOuterClass.MiniItem value) { if (this.s2CDataBuilder_ == null) {
/*       */           if (value == null)
/*       */             throw new NullPointerException();  ensureS2CDataIsMutable(); this.s2CData_.add(value); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.addMessage((GeneratedMessage)value);
/*       */         }  return this; } public Builder addS2CData(int index, ItemOuterClass.MiniItem value) { if (this.s2CDataBuilder_ == null) {
/*       */           if (value == null)
/*       */             throw new NullPointerException();  ensureS2CDataIsMutable(); this.s2CData_.add(index, value); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.addMessage(index, (GeneratedMessage)value);
/*       */         }  return this; } public Builder addS2CData(ItemOuterClass.MiniItem.Builder builderForValue) { if (this.s2CDataBuilder_ == null) {
/*       */           ensureS2CDataIsMutable(); this.s2CData_.add(builderForValue.build()); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.addMessage((GeneratedMessage)builderForValue.build());
/*       */         }  return this; } public Builder addS2CData(int index, ItemOuterClass.MiniItem.Builder builderForValue) { if (this.s2CDataBuilder_ == null) {
/*       */           ensureS2CDataIsMutable(); this.s2CData_.add(index, builderForValue.build()); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.addMessage(index, (GeneratedMessage)builderForValue.build());
/*       */         }  return this; } public Builder addAllS2CData(Iterable<? extends ItemOuterClass.MiniItem> values) { if (this.s2CDataBuilder_ == null) {
/*       */           ensureS2CDataIsMutable(); AbstractMessageLite.Builder.addAll(values, this.s2CData_); onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.addAllMessages(values);
/*       */         }  return this; } public Builder clearS2CData() { if (this.s2CDataBuilder_ == null) {
/*       */           this.s2CData_ = Collections.emptyList(); this.bitField0_ &= 0xFFFFFFFE; onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.clear();
/*       */         } 
/*       */         return this; } public Builder removeS2CData(int index) { if (this.s2CDataBuilder_ == null) {
/*       */           ensureS2CDataIsMutable();
/*       */           this.s2CData_.remove(index);
/*       */           onChanged();
/*       */         } else {
/*       */           this.s2CDataBuilder_.remove(index);
/*       */         } 
/*       */         return this; } public ItemOuterClass.MiniItem.Builder getS2CDataBuilder(int index) { return (ItemOuterClass.MiniItem.Builder)getS2CDataFieldBuilder().getBuilder(index); } public ItemOuterClass.MiniItemOrBuilder getS2CDataOrBuilder(int index) { if (this.s2CDataBuilder_ == null)
/*       */           return (ItemOuterClass.MiniItemOrBuilder)this.s2CData_.get(index); 
/*       */         return (ItemOuterClass.MiniItemOrBuilder)this.s2CDataBuilder_.getMessageOrBuilder(index); } public List<? extends ItemOuterClass.MiniItemOrBuilder> getS2CDataOrBuilderList() { if (this.s2CDataBuilder_ != null)
/*       */           return this.s2CDataBuilder_.getMessageOrBuilderList(); 
...
/*       */ 
/*       */     
/* 10807 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*       */       {
/*       */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*       */         {
/* 10811 */           BagHandler.descriptor = root;
/* 10812 */           return null;
/*       */         }
/*       */       };
/*       */     
/* 10816 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*       */           
/* 10818 */           Common.getDescriptor(), 
/* 10819 */           ItemOuterClass.getDescriptor() }, assigner);
/*       */   }
/*       */   
/* 10822 */   private static final Descriptors.Descriptor internal_static_pomelo_area_PackUpBagRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 10823 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_PackUpBagRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_PackUpBagRequest_descriptor, new String[] { "C2SType" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10828 */   private static final Descriptors.Descriptor internal_static_pomelo_area_PackUpBagResponse_descriptor = getDescriptor().getMessageTypes().get(1);
/* 10829 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_PackUpBagResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_PackUpBagResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CType", "S2CBagGrids" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10834 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OpenBagGridRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 10835 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OpenBagGridRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OpenBagGridRequest_descriptor, new String[] { "C2SType", "C2SNumber" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10840 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OpenBagGridResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 10841 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OpenBagGridResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OpenBagGridResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CType", "S2CBagGridCount" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10846 */   private static final Descriptors.Descriptor internal_static_pomelo_area_AddBagItemTestNotify_descriptor = getDescriptor().getMessageTypes().get(4);
/* 10847 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_AddBagItemTestNotify_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_AddBagItemTestNotify_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10852 */   private static final Descriptors.Descriptor internal_static_pomelo_area_TransferItemRequest_descriptor = getDescriptor().getMessageTypes().get(5);
/* 10853 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_TransferItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_TransferItemRequest_descriptor, new String[] { "C2SFromType", "C2SFromIndex", "C2SToType", "C2SNum" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10858 */   private static final Descriptors.Descriptor internal_static_pomelo_area_TransferItemResponse_descriptor = getDescriptor().getMessageTypes().get(6);
/* 10859 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_TransferItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_TransferItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10864 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SellItemRequest_descriptor = getDescriptor().getMessageTypes().get(7);
/* 10865 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SellItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SellItemRequest_descriptor, new String[] { "C2SGridIndex", "C2SNum" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10870 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SellItemResponse_descriptor = getDescriptor().getMessageTypes().get(8);
/* 10871 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SellItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SellItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10876 */   private static final Descriptors.Descriptor internal_static_pomelo_area_UseItemRequest_descriptor = getDescriptor().getMessageTypes().get(9);
/* 10877 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_UseItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_UseItemRequest_descriptor, new String[] { "C2SGridIndex", "C2SNum" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10882 */   private static final Descriptors.Descriptor internal_static_pomelo_area_UseItemResponse_descriptor = getDescriptor().getMessageTypes().get(10);
/* 10883 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_UseItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_UseItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CChest", "IsGain" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10888 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagItemUpdatePush_descriptor = getDescriptor().getMessageTypes().get(11);
/* 10889 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagItemUpdatePush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagItemUpdatePush_descriptor, new String[] { "S2CType", "S2CData" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10894 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagNewItemPush_descriptor = getDescriptor().getMessageTypes().get(12);
/* 10895 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagNewItemPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagNewItemPush_descriptor, new String[] { "S2CData" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10900 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagNewEquipPush_descriptor = getDescriptor().getMessageTypes().get(13);
/* 10901 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagNewEquipPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagNewEquipPush_descriptor, new String[] { "S2CData" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10906 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagGridFullPush_descriptor = getDescriptor().getMessageTypes().get(14);
/* 10907 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagGridFullPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagGridFullPush_descriptor, new String[] { "S2CCode" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10912 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagGridNumPush_descriptor = getDescriptor().getMessageTypes().get(15);
/* 10913 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagGridNumPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagGridNumPush_descriptor, new String[] { "S2CType", "GridNum" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10918 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BagNewItemFromResFubenPush_descriptor = getDescriptor().getMessageTypes().get(16);
/* 10919 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BagNewItemFromResFubenPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BagNewItemFromResFubenPush_descriptor, new String[] { "S2CData" });
/*       */   private static Descriptors.FileDescriptor descriptor;
/*       */   
/*       */   static {
/* 10923 */     Common.getDescriptor();
/* 10924 */     ItemOuterClass.getDescriptor();
/*       */   }
/*       */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\BagHandler.class
