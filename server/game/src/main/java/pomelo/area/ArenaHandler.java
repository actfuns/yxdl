...
/*      */     }
/*      */     
/*  317 */     private static final ArenaInfoRequest defaultInstance = new ArenaInfoRequest(true); protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static ArenaInfoRequest parseFrom(ByteString data) throws InvalidProtocolBufferException { return (ArenaInfoRequest)PARSER.parseFrom(data); } public static ArenaInfoRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ArenaInfoRequest)PARSER.parseFrom(data, extensionRegistry); } public static ArenaInfoRequest parseFrom(byte[] data) throws InvalidProtocolBufferException { return (ArenaInfoRequest)PARSER.parseFrom(data); } public static ArenaInfoRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ArenaInfoRequest)PARSER.parseFrom(data, extensionRegistry); } public static ArenaInfoRequest parseFrom(InputStream input) throws IOException { return (ArenaInfoRequest)PARSER.parseFrom(input); } public static ArenaInfoRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoRequest)PARSER.parseFrom(input, extensionRegistry); } public static ArenaInfoRequest parseDelimitedFrom(InputStream input) throws IOException { return (ArenaInfoRequest)PARSER.parseDelimitedFrom(input); } public static ArenaInfoRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoRequest)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static ArenaInfoRequest parseFrom(CodedInputStream input) throws IOException { return (ArenaInfoRequest)PARSER.parseFrom(input); } public static ArenaInfoRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoRequest)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(ArenaInfoRequest prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements ArenaHandler.ArenaInfoRequestOrBuilder {
/*  318 */       public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaHandler.ArenaInfoRequest.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (ArenaHandler.ArenaInfoRequest.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoRequest_descriptor; } public ArenaHandler.ArenaInfoRequest getDefaultInstanceForType() { return ArenaHandler.ArenaInfoRequest.getDefaultInstance(); } public ArenaHandler.ArenaInfoRequest build() { ArenaHandler.ArenaInfoRequest result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public ArenaHandler.ArenaInfoRequest buildPartial() { ArenaHandler.ArenaInfoRequest result = new ArenaHandler.ArenaInfoRequest(this); onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof ArenaHandler.ArenaInfoRequest) return mergeFrom((ArenaHandler.ArenaInfoRequest)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(ArenaHandler.ArenaInfoRequest other) { if (other == ArenaHandler.ArenaInfoRequest.getDefaultInstance()) return this;  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { ArenaHandler.ArenaInfoRequest parsedMessage = null; try { parsedMessage = (ArenaHandler.ArenaInfoRequest)ArenaHandler.ArenaInfoRequest.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (ArenaHandler.ArenaInfoRequest)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } } static { defaultInstance.initFields(); }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1649 */     private static final ArenaInfoResponse defaultInstance = new ArenaInfoResponse(true); private long s2CSeasonEndTime_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ArenaInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasS2CSingleRank() { return ((this.bitField0_ & 0x4) == 4); } public int getS2CSingleRank() { return this.s2CSingleRank_; } public boolean hasS2CTotalRank() { return ((this.bitField0_ & 0x8) == 8); } public int getS2CTotalRank() { return this.s2CTotalRank_; } public boolean hasS2CSingleReward() { return ((this.bitField0_ & 0x10) == 16); } public int getS2CSingleReward() { return this.s2CSingleReward_; } public boolean hasS2CTotalReward() { return ((this.bitField0_ & 0x20) == 32); } public int getS2CTotalReward() { return this.s2CTotalReward_; } public boolean hasS2CCurrentTotalRank() { return ((this.bitField0_ & 0x40) == 64); } public int getS2CCurrentTotalRank() { return this.s2CCurrentTotalRank_; } public boolean hasS2CCurrentTotalScore() { return ((this.bitField0_ & 0x80) == 128); } public int getS2CCurrentTotalScore() { return this.s2CCurrentTotalScore_; } public boolean hasS2CSeasonEndTime() { return ((this.bitField0_ & 0x100) == 256); } public long getS2CSeasonEndTime() { return this.s2CSeasonEndTime_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CSingleRank_ = 0; this.s2CTotalRank_ = 0; this.s2CSingleReward_ = 0; this.s2CTotalReward_ = 0; this.s2CCurrentTotalRank_ = 0; this.s2CCurrentTotalScore_ = 0; this.s2CSeasonEndTime_ = 0L; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.s2CSingleRank_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.s2CTotalRank_);  if ((this.bitField0_ & 0x10) == 16) output.writeInt32(5, this.s2CSingleReward_);  if ((this.bitField0_ & 0x20) == 32) output.writeInt32(6, this.s2CTotalReward_);  if ((this.bitField0_ & 0x40) == 64) output.writeInt32(7, this.s2CCurrentTotalRank_);  if ((this.bitField0_ & 0x80) == 128) output.writeInt32(8, this.s2CCurrentTotalScore_);  if ((this.bitField0_ & 0x100) == 256) output.writeInt64(9, this.s2CSeasonEndTime_);  getUnknownFields().writeTo(output); }
/* 1650 */     static { defaultInstance.initFields(); } public int getSerializedSize() { int size = this.memoizedSerializedSize;
/*      */       if (size != -1)
/*      */         return size; 
/*      */       size = 0;
...
/*      */       size += getUnknownFields().getSerializedSize();
/*      */       this.memoizedSerializedSize = size;
/*      */       return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static ArenaInfoResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (ArenaInfoResponse)PARSER.parseFrom(data); } public static ArenaInfoResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ArenaInfoResponse)PARSER.parseFrom(data, extensionRegistry); } public static ArenaInfoResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (ArenaInfoResponse)PARSER.parseFrom(data); } public static ArenaInfoResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ArenaInfoResponse)PARSER.parseFrom(data, extensionRegistry); } public static ArenaInfoResponse parseFrom(InputStream input) throws IOException { return (ArenaInfoResponse)PARSER.parseFrom(input); } public static ArenaInfoResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoResponse)PARSER.parseFrom(input, extensionRegistry); } public static ArenaInfoResponse parseDelimitedFrom(InputStream input) throws IOException { return (ArenaInfoResponse)PARSER.parseDelimitedFrom(input); } public static ArenaInfoResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static ArenaInfoResponse parseFrom(CodedInputStream input) throws IOException { return (ArenaInfoResponse)PARSER.parseFrom(input); } public static ArenaInfoResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ArenaInfoResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(ArenaInfoResponse prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent);
/*      */       return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements ArenaHandler.ArenaInfoResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int s2CSingleRank_; private int s2CTotalRank_; private int s2CSingleReward_; private int s2CTotalReward_; private int s2CCurrentTotalRank_; private int s2CCurrentTotalScore_; private long s2CSeasonEndTime_; public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaHandler.ArenaInfoResponse.class, Builder.class); } private Builder() { this.s2CMsg_ = "";
/*      */         maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent);
/*      */         this.s2CMsg_ = "";
/*      */         maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (ArenaHandler.ArenaInfoResponse.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear();
/*      */         this.s2CCode_ = 0;
...
/*      */         return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return ArenaHandler.internal_static_pomelo_area_ArenaInfoResponse_descriptor; } public ArenaHandler.ArenaInfoResponse getDefaultInstanceForType() { return ArenaHandler.ArenaInfoResponse.getDefaultInstance(); } public ArenaHandler.ArenaInfoResponse build() {
...
/*      */         return this;
/*      */       } } }
/* 1962 */   public static final class EnterArenaAreaRequest extends GeneratedMessage implements EnterArenaAreaRequestOrBuilder { private static final EnterArenaAreaRequest defaultInstance = new EnterArenaAreaRequest(true); private final UnknownFieldSet unknownFields; private EnterArenaAreaRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private EnterArenaAreaRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static EnterArenaAreaRequest getDefaultInstance() { return defaultInstance; } public EnterArenaAreaRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private EnterArenaAreaRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_EnterArenaAreaRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_EnterArenaAreaRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(EnterArenaAreaRequest.class, Builder.class); } public static Parser<EnterArenaAreaRequest> PARSER = (Parser<EnterArenaAreaRequest>)new AbstractParser<EnterArenaAreaRequest>() { public ArenaHandler.EnterArenaAreaRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.EnterArenaAreaRequest(input, extensionRegistry); } }
/* 1963 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<EnterArenaAreaRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2524 */     private static final EnterArenaAreaResponse defaultInstance = new EnterArenaAreaResponse(true); private final UnknownFieldSet unknownFields; private EnterArenaAreaResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private EnterArenaAreaResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static EnterArenaAreaResponse getDefaultInstance() { return defaultInstance; } public EnterArenaAreaResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private EnterArenaAreaResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_EnterArenaAreaResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_EnterArenaAreaResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(EnterArenaAreaResponse.class, Builder.class); } public static Parser<EnterArenaAreaResponse> PARSER = (Parser<EnterArenaAreaResponse>)new AbstractParser<EnterArenaAreaResponse>() { public ArenaHandler.EnterArenaAreaResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.EnterArenaAreaResponse(input, extensionRegistry); } }
/* 2525 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<EnterArenaAreaResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */     
/*      */     public String getS2CMsg() {
/*      */       Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String)
...
/*      */     }
/*      */     
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements ArenaHandler.EnterArenaAreaResponseOrBuilder { private int bitField0_;
/*      */       private int s2CCode_;
/*      */       private Object s2CMsg_;
/*      */       
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/*      */   
/* 2837 */   public static final class LeaveArenaAreaRequest extends GeneratedMessage implements LeaveArenaAreaRequestOrBuilder { private static final LeaveArenaAreaRequest defaultInstance = new LeaveArenaAreaRequest(true); private final UnknownFieldSet unknownFields; private LeaveArenaAreaRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LeaveArenaAreaRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LeaveArenaAreaRequest getDefaultInstance() { return defaultInstance; } public LeaveArenaAreaRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LeaveArenaAreaRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_LeaveArenaAreaRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_LeaveArenaAreaRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(LeaveArenaAreaRequest.class, Builder.class); } public static Parser<LeaveArenaAreaRequest> PARSER = (Parser<LeaveArenaAreaRequest>)new AbstractParser<LeaveArenaAreaRequest>() { public ArenaHandler.LeaveArenaAreaRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.LeaveArenaAreaRequest(input, extensionRegistry); } }
/* 2838 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LeaveArenaAreaRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 3399 */     private static final LeaveArenaAreaResponse defaultInstance = new LeaveArenaAreaResponse(true); private final UnknownFieldSet unknownFields; private LeaveArenaAreaResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LeaveArenaAreaResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LeaveArenaAreaResponse getDefaultInstance() { return defaultInstance; } public LeaveArenaAreaResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LeaveArenaAreaResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_LeaveArenaAreaResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_LeaveArenaAreaResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(LeaveArenaAreaResponse.class, Builder.class); } public static Parser<LeaveArenaAreaResponse> PARSER = (Parser<LeaveArenaAreaResponse>)new AbstractParser<LeaveArenaAreaResponse>() { public ArenaHandler.LeaveArenaAreaResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.LeaveArenaAreaResponse(input, extensionRegistry); } }
/* 3400 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LeaveArenaAreaResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 3836 */     private static final ArenaRewardRequest defaultInstance = new ArenaRewardRequest(true); private final UnknownFieldSet unknownFields; private ArenaRewardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ArenaRewardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ArenaRewardRequest getDefaultInstance() { return defaultInstance; } public ArenaRewardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ArenaRewardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_ArenaRewardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_ArenaRewardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaRewardRequest.class, Builder.class); } public static Parser<ArenaRewardRequest> PARSER = (Parser<ArenaRewardRequest>)new AbstractParser<ArenaRewardRequest>() { public ArenaHandler.ArenaRewardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.ArenaRewardRequest(input, extensionRegistry); } }
/* 3837 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ArenaRewardRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } private void initFields() { this.c2SType_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4398 */     private static final ArenaRewardResponse defaultInstance = new ArenaRewardResponse(true); private final UnknownFieldSet unknownFields; private ArenaRewardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ArenaRewardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ArenaRewardResponse getDefaultInstance() { return defaultInstance; } public ArenaRewardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ArenaRewardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_ArenaRewardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_ArenaRewardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaRewardResponse.class, Builder.class); } public static Parser<ArenaRewardResponse> PARSER = (Parser<ArenaRewardResponse>)new AbstractParser<ArenaRewardResponse>() { public ArenaHandler.ArenaRewardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.ArenaRewardResponse(input, extensionRegistry); } }
/* 4399 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ArenaRewardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5371 */     private static final ArenaBattleScore defaultInstance = new ArenaBattleScore(true); private final UnknownFieldSet unknownFields; private ArenaBattleScore(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ArenaBattleScore(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ArenaBattleScore getDefaultInstance() { return defaultInstance; } public ArenaBattleScore getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ArenaBattleScore(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.name_ = bs; break;case 16: this.bitField0_ |= 0x2; this.score_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.pro_ = input.readInt32(); break;case 34: bs = input.readBytes(); this.bitField0_ |= 0x8; this.id_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_ArenaBattleScore_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_ArenaBattleScore_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaBattleScore.class, Builder.class); } public static Parser<ArenaBattleScore> PARSER = (Parser<ArenaBattleScore>)new AbstractParser<ArenaBattleScore>() { public ArenaHandler.ArenaBattleScore parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.ArenaBattleScore(input, extensionRegistry); } }
/* 5372 */     ; private int bitField0_; public static final int NAME_FIELD_NUMBER = 1; private Object name_; public static final int SCORE_FIELD_NUMBER = 2; private int score_; public static final int PRO_FIELD_NUMBER = 3; private int pro_; public static final int ID_FIELD_NUMBER = 4; private Object id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ArenaBattleScore> getParserForType() { return PARSER; } public boolean hasName() { return ((this.bitField0_ & 0x1) == 1); } public String getName() { Object ref = this.name_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.name_ = s;  return s; } public ByteString getNameBytes() { Object ref = this.name_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.name_ = b; return b; }  return (ByteString)ref; } public boolean hasScore() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 7216 */     private static final OnArenaBattleInfoPush defaultInstance = new OnArenaBattleInfoPush(true);
/* 7217 */     private static final long serialVersionUID = 0L; public Parser<OnArenaBattleInfoPush> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CKillCount() { return ((this.bitField0_ & 0x2) == 2); } public int getS2CKillCount() { return this.s2CKillCount_; } public boolean hasS2CIndex() { return ((this.bitField0_ & 0x4) == 4); } public int getS2CIndex() { return this.s2CIndex_; } public boolean hasS2CScore() { return ((this.bitField0_ & 0x8) == 8); } public int getS2CScore() { return this.s2CScore_; } public List<ArenaHandler.ArenaBattleScore> getS2CScoresList() { return this.s2CScores_; } public List<? extends ArenaHandler.ArenaBattleScoreOrBuilder> getS2CScoresOrBuilderList() { return (List)this.s2CScores_; } public int getS2CScoresCount() { return this.s2CScores_.size(); } public ArenaHandler.ArenaBattleScore getS2CScores(int index) { return this.s2CScores_.get(index); } public ArenaHandler.ArenaBattleScoreOrBuilder getS2CScoresOrBuilder(int index) { return this.s2CScores_.get(index); } public boolean hasS2CPlayerCount() { return ((this.bitField0_ & 0x10) == 16); } public int getS2CPlayerCount() { return this.s2CPlayerCount_; } public List<ArenaHandler.ArenaBattleScore> getS2CKillCountListList() { return this.s2CKillCountList_; } public List<? extends ArenaHandler.ArenaBattleScoreOrBuilder> getS2CKillCountListOrBuilderList() { return (List)this.s2CKillCountList_; } public int getS2CKillCountListCount() { return this.s2CKillCountList_.size(); } public ArenaHandler.ArenaBattleScore getS2CKillCountList(int index) { return this.s2CKillCountList_.get(index); } public ArenaHandler.ArenaBattleScoreOrBuilder getS2CKillCountListOrBuilder(int index) { return this.s2CKillCountList_.get(index); } private void initFields() { this.s2CCode_ = 0; this.s2CKillCount_ = 0; this.s2CIndex_ = 0; this.s2CScore_ = 0; this.s2CScores_ = Collections.emptyList(); this.s2CPlayerCount_ = 0; this.s2CKillCountList_ = Collections.emptyList(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  if (!hasS2CKillCount()) { this.memoizedIsInitialized = 0; return false; }  if (!hasS2CIndex()) { this.memoizedIsInitialized = 0; return false; }  if (!hasS2CScore()) { this.memoizedIsInitialized = 0; return false; }  if (!hasS2CPlayerCount()) { this.memoizedIsInitialized = 0; return false; }  int i; for (i = 0; i < getS2CScoresCount(); i++) { if (!getS2CScores(i).isInitialized()) { this.memoizedIsInitialized = 0; return false; }  }  for (i = 0; i < getS2CKillCountListCount(); i++) { if (!getS2CKillCountList(i).isInitialized()) { this.memoizedIsInitialized = 0; return false; }  }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.s2CKillCount_);  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.s2CIndex_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.s2CScore_);  int i; for (i = 0; i < this.s2CScores_.size(); i++) output.writeMessage(5, (MessageLite)this.s2CScores_.get(i));  if ((this.bitField0_ & 0x10) == 16) output.writeInt32(6, this.s2CPlayerCount_);  for (i = 0; i < this.s2CKillCountList_.size(); i++) output.writeMessage(7, (MessageLite)this.s2CKillCountList_.get(i));  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.s2CKillCount_);  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.s2CIndex_);  if ((this.bitField0_ & 0x8) == 8) size += CodedOutputStream.computeInt32Size(4, this.s2CScore_);  int i; for (i = 0; i < this.s2CScores_.size(); i++) size += CodedOutputStream.computeMessageSize(5, (MessageLite)this.s2CScores_.get(i));  if ((this.bitField0_ & 0x10) == 16) size += CodedOutputStream.computeInt32Size(6, this.s2CPlayerCount_);  for (i = 0; i < this.s2CKillCountList_.size(); i++) size += CodedOutputStream.computeMessageSize(7, (MessageLite)this.s2CKillCountList_.get(i));  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static OnArenaBattleInfoPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (OnArenaBattleInfoPush)PARSER.parseFrom(data); } public static OnArenaBattleInfoPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OnArenaBattleInfoPush)PARSER.parseFrom(data, extensionRegistry); } public static OnArenaBattleInfoPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (OnArenaBattleInfoPush)PARSER.parseFrom(data); } public static OnArenaBattleInfoPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OnArenaBattleInfoPush)PARSER.parseFrom(data, extensionRegistry); } public static OnArenaBattleInfoPush parseFrom(InputStream input) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseFrom(input); } public static OnArenaBattleInfoPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseFrom(input, extensionRegistry); } public static OnArenaBattleInfoPush parseDelimitedFrom(InputStream input) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseDelimitedFrom(input); } public static OnArenaBattleInfoPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } static { defaultInstance.initFields(); }
/*      */     public static OnArenaBattleInfoPush parseFrom(CodedInputStream input) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseFrom(input); }
/*      */     public static OnArenaBattleInfoPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleInfoPush)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static Builder newBuilder() { return Builder.create(); }
/*      */     public Builder newBuilderForType() { return newBuilder(); }
/*      */     public static Builder newBuilder(OnArenaBattleInfoPush prototype) { return newBuilder().mergeFrom(prototype); }
/*      */     public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent);
/*      */       return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements ArenaHandler.OnArenaBattleInfoPushOrBuilder {
/*      */       private int bitField0_; private int s2CCode_; private int s2CKillCount_; private int s2CIndex_; private int s2CScore_; private List<ArenaHandler.ArenaBattleScore> s2CScores_; private RepeatedFieldBuilder<ArenaHandler.ArenaBattleScore, ArenaHandler.ArenaBattleScore.Builder, ArenaHandler.ArenaBattleScoreOrBuilder> s2CScoresBuilder_; private int s2CPlayerCount_; private List<ArenaHandler.ArenaBattleScore> s2CKillCountList_; private RepeatedFieldBuilder<ArenaHandler.ArenaBattleScore, ArenaHandler.ArenaBattleScore.Builder, ArenaHandler.ArenaBattleScoreOrBuilder> s2CKillCountListBuilder_; public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleInfoPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleInfoPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaHandler.OnArenaBattleInfoPush.class, Builder.class); } private Builder() {
...
/* 7739 */     private static final OnArenaBattleEndPush defaultInstance = new OnArenaBattleEndPush(true); private final UnknownFieldSet unknownFields; private OnArenaBattleEndPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private OnArenaBattleEndPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static OnArenaBattleEndPush getDefaultInstance() { return defaultInstance; } public OnArenaBattleEndPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private OnArenaBattleEndPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.outtime_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleEndPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleEndPush_fieldAccessorTable.ensureFieldAccessorsInitialized(OnArenaBattleEndPush.class, Builder.class); } public static Parser<OnArenaBattleEndPush> PARSER = (Parser<OnArenaBattleEndPush>)new AbstractParser<OnArenaBattleEndPush>() { public ArenaHandler.OnArenaBattleEndPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new ArenaHandler.OnArenaBattleEndPush(input, extensionRegistry); } }
/* 7740 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int OUTTIME_FIELD_NUMBER = 2; private int outtime_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<OnArenaBattleEndPush> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasOuttime() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); } public int getOuttime() { return this.outtime_; } private void initFields() { this.s2CCode_ = 0; this.outtime_ = 0; }
...
/*      */         return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  if (!hasOuttime()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; }
...
/*      */         output.writeInt32(2, this.outtime_);  getUnknownFields().writeTo(output); }
...
/*      */         size += CodedOutputStream.computeInt32Size(2, this.outtime_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; }
/*      */     protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); }
/*      */     public static OnArenaBattleEndPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (OnArenaBattleEndPush)PARSER.parseFrom(data); }
/*      */     public static OnArenaBattleEndPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OnArenaBattleEndPush)PARSER.parseFrom(data, extensionRegistry); }
/*      */     public static OnArenaBattleEndPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (OnArenaBattleEndPush)PARSER.parseFrom(data); }
/*      */     public static OnArenaBattleEndPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (OnArenaBattleEndPush)PARSER.parseFrom(data, extensionRegistry); }
/*      */     public static OnArenaBattleEndPush parseFrom(InputStream input) throws IOException { return (OnArenaBattleEndPush)PARSER.parseFrom(input); }
/*      */     public static OnArenaBattleEndPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleEndPush)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static OnArenaBattleEndPush parseDelimitedFrom(InputStream input) throws IOException { return (OnArenaBattleEndPush)PARSER.parseDelimitedFrom(input); }
/*      */     public static OnArenaBattleEndPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleEndPush)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*      */     public static OnArenaBattleEndPush parseFrom(CodedInputStream input) throws IOException { return (OnArenaBattleEndPush)PARSER.parseFrom(input); }
/*      */     public static OnArenaBattleEndPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (OnArenaBattleEndPush)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static Builder newBuilder() { return Builder.create(); }
/*      */     public Builder newBuilderForType() { return newBuilder(); }
/*      */     public static Builder newBuilder(OnArenaBattleEndPush prototype) { return newBuilder().mergeFrom(prototype); }
...
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements ArenaHandler.OnArenaBattleEndPushOrBuilder { private int bitField0_; private int s2CCode_; private int outtime_;
/*      */       public static final Descriptors.Descriptor getDescriptor() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleEndPush_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleEndPush_fieldAccessorTable.ensureFieldAccessorsInitialized(ArenaHandler.OnArenaBattleEndPush.class, Builder.class); }
/*      */       private Builder() { maybeForceBuilderInitialization(); }
/*      */       private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); }
/*      */       private void maybeForceBuilderInitialization() { if (ArenaHandler.OnArenaBattleEndPush.alwaysUseFieldBuilders); }
/*      */       private static Builder create() { return new Builder(); }
/*      */       public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.outtime_ = 0; this.bitField0_ &= 0xFFFFFFFD; return this; }
/*      */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*      */       public Descriptors.Descriptor getDescriptorForType() { return ArenaHandler.internal_static_pomelo_area_OnArenaBattleEndPush_descriptor; }
/*      */       public ArenaHandler.OnArenaBattleEndPush getDefaultInstanceForType() { return ArenaHandler.OnArenaBattleEndPush.getDefaultInstance(); }
/*      */       public ArenaHandler.OnArenaBattleEndPush build() { ArenaHandler.OnArenaBattleEndPush result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; }
/*      */       public ArenaHandler.OnArenaBattleEndPush buildPartial() { ArenaHandler.OnArenaBattleEndPush result = new ArenaHandler.OnArenaBattleEndPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
/*      */           to_bitField0_ |= 0x1;  result.s2CCode_ = this.s2CCode_; if ((from_bitField0_ & 0x2) == 2)
/*      */           to_bitField0_ |= 0x2;  result.outtime_ = this.outtime_; result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*      */       public Builder mergeFrom(Message other) { if (other instanceof ArenaHandler.OnArenaBattleEndPush)
/*      */           return mergeFrom((ArenaHandler.OnArenaBattleEndPush)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(ArenaHandler.OnArenaBattleEndPush other) { if (other == ArenaHandler.OnArenaBattleEndPush.getDefaultInstance())
/*      */           return this;  if (other.hasS2CCode())
/*      */           setS2CCode(other.getS2CCode());  if (other.hasOuttime())
/*      */           setOuttime(other.getOuttime());  mergeUnknownFields(other.getUnknownFields()); return this; }
/*      */       public final boolean isInitialized() { if (!hasS2CCode())
/*      */           return false;  if (!hasOuttime())
/*      */           return false;  return true; }
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { ArenaHandler.OnArenaBattleEndPush parsedMessage = null; try { parsedMessage = (ArenaHandler.OnArenaBattleEndPush)ArenaHandler.OnArenaBattleEndPush.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (ArenaHandler.OnArenaBattleEndPush)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null)
/*      */             mergeFrom(parsedMessage);  }
/*      */          return this; }
...
/*      */ 
/*      */     
/* 7849 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 7853 */           ArenaHandler.descriptor = root;
/* 7854 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 7858 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 7860 */           Common.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 7863 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ArenaInfoRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 7864 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ArenaInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ArenaInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7869 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ArenaInfoResponse_descriptor = getDescriptor().getMessageTypes().get(1);
/* 7870 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ArenaInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ArenaInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CSingleRank", "S2CTotalRank", "S2CSingleReward", "S2CTotalReward", "S2CCurrentTotalRank", "S2CCurrentTotalScore", "S2CSeasonEndTime" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7875 */   private static final Descriptors.Descriptor internal_static_pomelo_area_EnterArenaAreaRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 7876 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_EnterArenaAreaRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_EnterArenaAreaRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7881 */   private static final Descriptors.Descriptor internal_static_pomelo_area_EnterArenaAreaResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 7882 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_EnterArenaAreaResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_EnterArenaAreaResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7887 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LeaveArenaAreaRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 7888 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LeaveArenaAreaRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LeaveArenaAreaRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7893 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LeaveArenaAreaResponse_descriptor = getDescriptor().getMessageTypes().get(5);
/* 7894 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LeaveArenaAreaResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LeaveArenaAreaResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7899 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ArenaRewardRequest_descriptor = getDescriptor().getMessageTypes().get(6);
/* 7900 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ArenaRewardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ArenaRewardRequest_descriptor, new String[] { "C2SType" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7905 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ArenaRewardResponse_descriptor = getDescriptor().getMessageTypes().get(7);
/* 7906 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ArenaRewardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ArenaRewardResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7911 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ArenaBattleScore_descriptor = getDescriptor().getMessageTypes().get(8);
/* 7912 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ArenaBattleScore_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ArenaBattleScore_descriptor, new String[] { "Name", "Score", "Pro", "Id" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7917 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OnArenaBattleInfoPush_descriptor = getDescriptor().getMessageTypes().get(9);
/* 7918 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OnArenaBattleInfoPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OnArenaBattleInfoPush_descriptor, new String[] { "S2CCode", "S2CKillCount", "S2CIndex", "S2CScore", "S2CScores", "S2CPlayerCount", "S2CKillCountList" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7923 */   private static final Descriptors.Descriptor internal_static_pomelo_area_OnArenaBattleEndPush_descriptor = getDescriptor().getMessageTypes().get(10);
/* 7924 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_OnArenaBattleEndPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_OnArenaBattleEndPush_descriptor, new String[] { "S2CCode", "Outtime" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 7928 */     Common.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\ArenaHandler.class
