...
public final class GiftOnlineHandler {
    ...
    public static final class GetOnLineGiftRequest
        ...
        private static final GetOnLineGiftRequest defaultInstance = new GetOnLineGiftRequest(true);
        private final UnknownFieldSet unknownFields;

        private GetOnLineGiftRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
        ...
        private GetOnLineGiftRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
        ...
        private GetOnLineGiftRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetOnLineGiftRequest.class, Builder.class);
        }

        public static Parser<GetOnLineGiftRequest> PARSER = (Parser<GetOnLineGiftRequest>) new AbstractParser<GetOnLineGiftRequest>() {
            public GiftOnlineHandler.GetOnLineGiftRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new GiftOnlineHandler.GetOnLineGiftRequest(input, extensionRegistry);
            }
        };
        ...
        public Parser<GetOnLineGiftRequest> getParserForType() {
            return PARSER;
        }
        ...
        public static GetOnLineGiftRequest parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(data);
        }

        public static GetOnLineGiftRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static GetOnLineGiftRequest parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(data);
        }

        public static GetOnLineGiftRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static GetOnLineGiftRequest parseFrom(InputStream input) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(input);
        }

        public static GetOnLineGiftRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(input, extensionRegistry);
        }

        public static GetOnLineGiftRequest parseDelimitedFrom(InputStream input) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseDelimitedFrom(input);
        }

        public static GetOnLineGiftRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static GetOnLineGiftRequest parseFrom(CodedInputStream input) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(input);
        }

        public static GetOnLineGiftRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftRequest) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(GetOnLineGiftRequest prototype) {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements GiftOnlineHandler.GetOnLineGiftRequestOrBuilder {
            public static final Descriptors.Descriptor getDescriptor() {
                return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftRequest_descriptor;
            }

            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GiftOnlineHandler.GetOnLineGiftRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (GiftOnlineHandler.GetOnLineGiftRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public GiftOnlineHandler.GetOnLineGiftRequest getDefaultInstanceForType() {
                return GiftOnlineHandler.GetOnLineGiftRequest.getDefaultInstance();
            }

            public GiftOnlineHandler.GetOnLineGiftRequest build() {
                GiftOnlineHandler.GetOnLineGiftRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public GiftOnlineHandler.GetOnLineGiftRequest buildPartial() {
                GiftOnlineHandler.GetOnLineGiftRequest result = new GiftOnlineHandler.GetOnLineGiftRequest(this);
                onBuilt();
                return result;
            }

            public Builder mergeFrom(Message other) {
                if (other instanceof GiftOnlineHandler.GetOnLineGiftRequest)
                    return mergeFrom((GiftOnlineHandler.GetOnLineGiftRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(GiftOnlineHandler.GetOnLineGiftRequest other) {
                if (other == GiftOnlineHandler.GetOnLineGiftRequest.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                GiftOnlineHandler.GetOnLineGiftRequest parsedMessage = null;
                try {
                    parsedMessage = (GiftOnlineHandler.GetOnLineGiftRequest) GiftOnlineHandler.GetOnLineGiftRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (GiftOnlineHandler.GetOnLineGiftRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
    ...
    public static final class GiftOnLineStruct
        ...
        private static final GiftOnLineStruct defaultInstance = new GiftOnLineStruct(true);
        private final UnknownFieldSet unknownFields;

        private GiftOnLineStruct(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private GiftOnLineStruct(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private GiftOnLineStruct(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return GiftOnlineHandler.internal_static_pomelo_area_GiftOnLineStruct_fieldAccessorTable.ensureFieldAccessorsInitialized(GiftOnLineStruct.class, Builder.class);
        }

        public static Parser<GiftOnLineStruct> PARSER = (Parser<GiftOnLineStruct>) new AbstractParser<GiftOnLineStruct>() {
            public GiftOnlineHandler.GiftOnLineStruct parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new GiftOnlineHandler.GiftOnLineStruct(input, extensionRegistry);
            }
        };
        ...
        public Parser<GiftOnLineStruct> getParserForType() {
            return PARSER;
        }
    ...
    public static final class GiftOnlineData
        ...
        private static final GiftOnlineData defaultInstance = new GiftOnlineData(true);
        private final UnknownFieldSet unknownFields;

        private GiftOnlineData(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private GiftOnlineData(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private GiftOnlineData(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18:
                            ...
                            this.s2CItems_.add(input.readMessage(GiftOnlineHandler.GiftOnLineStruct.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x2) == 2) this.s2CItems_ = Collections.unmodifiableList(this.s2CItems_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return GiftOnlineHandler.internal_static_pomelo_area_GiftOnlineData_fieldAccessorTable.ensureFieldAccessorsInitialized(GiftOnlineData.class, Builder.class);
        }

        public static Parser<GiftOnlineData> PARSER = (Parser<GiftOnlineData>) new AbstractParser<GiftOnlineData>() {
            public GiftOnlineHandler.GiftOnlineData parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new GiftOnlineHandler.GiftOnlineData(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<GiftOnlineData> getParserForType() {
            return PARSER;
        }
    ...
    public static final class GetOnLineGiftResponse
        ...
        private static final GetOnLineGiftResponse defaultInstance = new GetOnLineGiftResponse(true);
        private final UnknownFieldSet unknownFields;

        private GetOnLineGiftResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private GetOnLineGiftResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private GetOnLineGiftResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ByteString bs;
                    GiftOnlineHandler.GiftOnlineData.Builder subBuilder;
                    int tag = input.readTag();
                    switch (tag) {
                        case 0:
                            done = true;
                        ...
                        case 26:
                            ...
                            this.s2CData_ = (GiftOnlineHandler.GiftOnlineData) input.readMessage(GiftOnlineHandler.GiftOnlineData.PARSER, extensionRegistry);
                            if (subBuilder != null) {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftResponse_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetOnLineGiftResponse.class, Builder.class);
        }

        public static Parser<GetOnLineGiftResponse> PARSER = (Parser<GetOnLineGiftResponse>) new AbstractParser<GetOnLineGiftResponse>() {
            public GiftOnlineHandler.GetOnLineGiftResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new GiftOnlineHandler.GetOnLineGiftResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<GetOnLineGiftResponse> getParserForType() {
            return PARSER;
        }
        ...
        public GiftOnlineHandler.GiftOnlineData getS2CData() {
            return this.s2CData_;
        }

        public GiftOnlineHandler.GiftOnlineDataOrBuilder getS2CDataOrBuilder() {
            return this.s2CData_;
        }
        ...
        private void initFields() {
            this.s2CCode_ = 0;
            this.s2CMsg_ = "";
            this.s2CData_ = GiftOnlineHandler.GiftOnlineData.getDefaultInstance();
        }
        ...
        public static GetOnLineGiftResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(data);
        }

        public static GetOnLineGiftResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static GetOnLineGiftResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(data);
        }

        public static GetOnLineGiftResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(data, extensionRegistry);
        }
        ...
        public static GetOnLineGiftResponse parseFrom(InputStream input) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(input);
        }

        public static GetOnLineGiftResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static GetOnLineGiftResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseDelimitedFrom(input);
        }

        public static GetOnLineGiftResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static GetOnLineGiftResponse parseFrom(CodedInputStream input) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(input);
        }

        public static GetOnLineGiftResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (GetOnLineGiftResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(GetOnLineGiftResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements GiftOnlineHandler.GetOnLineGiftResponseOrBuilder {
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return GiftOnlineHandler.internal_static_pomelo_area_GetOnLineGiftResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GiftOnlineHandler.GetOnLineGiftResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (GiftOnlineHandler.GetOnLineGiftResponse.alwaysUseFieldBuilders) getS2CDataFieldBuilder();
            }
            ...
            public GiftOnlineHandler.GetOnLineGiftResponse getDefaultInstanceForType() {
                return GiftOnlineHandler.GetOnLineGiftResponse.getDefaultInstance();
            }

            public GiftOnlineHandler.GetOnLineGiftResponse build() {
                GiftOnlineHandler.GetOnLineGiftResponse result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public GiftOnlineHandler.GetOnLineGiftResponse buildPartial() {
                GiftOnlineHandler.GetOnLineGiftResponse result = new GiftOnlineHandler.GetOnLineGiftResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                ...
                if (this.s2CDataBuilder_ == null) {
                    ...
                    result.s2CData_ = (GiftOnlineHandler.GiftOnlineData) this.s2CDataBuilder_.build();
                }
                result.bitField0_ = to_bitField0_;
                onBuilt();
                return result;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof GiftOnlineHandler.GetOnLineGiftResponse)
                    return mergeFrom((GiftOnlineHandler.GetOnLineGiftResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(GiftOnlineHandler.GetOnLineGiftResponse other) {
                if (other == GiftOnlineHandler.GetOnLineGiftResponse.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                GiftOnlineHandler.GetOnLineGiftResponse parsedMessage = null;
                try {
                    parsedMessage = (GiftOnlineHandler.GetOnLineGiftResponse) GiftOnlineHandler.GetOnLineGiftResponse.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (GiftOnlineHandler.GetOnLineGiftResponse) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            public Builder clearS2CMsg() {
                this.bitField0_ &= 0xFFFFFFFD;
                this.s2CMsg_ = GiftOnlineHandler.GetOnLineGiftResponse.getDefaultInstance().getS2CMsg();
                onChanged();
                return this;
            }
            ...
            public GiftOnlineHandler.GiftOnlineData getS2CData() {
                ...
                return (GiftOnlineHandler.GiftOnlineData) this.s2CDataBuilder_.getMessage();
            }

            public Builder setS2CData(GiftOnlineHandler.GiftOnlineData value) {
                if (this.s2CDataBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    this.s2CData_ = value;
                    onChanged();
            ...
            public Builder setS2CData(GiftOnlineHandler.GiftOnlineData.Builder builderForValue) {
                if (this.s2CDataBuilder_ == null) {
            ...
            public Builder mergeS2CData(GiftOnlineHandler.GiftOnlineData value) {
                if (this.s2CDataBuilder_ == null) {
                    if ((this.bitField0_ & 0x4) == 4 && this.s2CData_ != GiftOnlineHandler.GiftOnlineData.getDefaultInstance()) {
                        this.s2CData_ = GiftOnlineHandler.GiftOnlineData.newBuilder(this.s2CData_).mergeFrom(value).buildPartial();
                    } else {
                        this.s2CData_ = value;
                    }
                    onChanged();
            ...
            public GiftOnlineHandler.GiftOnlineData.Builder getS2CDataBuilder() {
                this.bitField0_ |= 0x4;
                onChanged();
                return (GiftOnlineHandler.GiftOnlineData.Builder) getS2CDataFieldBuilder().getBuilder();
            }

            public GiftOnlineHandler.GiftOnlineDataOrBuilder getS2CDataOrBuilder() {
                if (this.s2CDataBuilder_ != null)
                    return (GiftOnlineHandler.GiftOnlineDataOrBuilder) this.s2CDataBuilder_.getMessageOrBuilder();
                return this.s2CData_;
            }

            private SingleFieldBuilder<GiftOnlineHandler.GiftOnlineData, GiftOnlineHandler.GiftOnlineData.Builder, GiftOnlineHandler.GiftOnlineDataOrBuilder> getS2CDataFieldBuilder() {
                if (this.s2CDataBuilder_ == null) {
    ...
    static {
        ...
        Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
            public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root) {
                GiftOnlineHandler.descriptor = root;
                return null;
            }
        };
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_area_GetOnLineGiftRequest_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetOnLineGiftRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetOnLineGiftRequest_descriptor, new String[0]);


    private static final Descriptors.Descriptor internal_static_pomelo_area_GiftOnLineStruct_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GiftOnLineStruct_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GiftOnLineStruct_descriptor, new String[]{"TemplateId", "Count", "Quality", "PicId", "Name"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_GiftOnlineData_descriptor = getDescriptor().getMessageTypes().get(2);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GiftOnlineData_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GiftOnlineData_descriptor, new String[]{"S2CTime", "S2CItems"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_GetOnLineGiftResponse_descriptor = getDescriptor().getMessageTypes().get(3);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetOnLineGiftResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetOnLineGiftResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "S2CData"});
