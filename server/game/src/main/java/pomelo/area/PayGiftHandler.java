...
/*      */   {
/*  317 */     private static final FirstPayGiftInfoRequest defaultInstance = new FirstPayGiftInfoRequest(true); private final UnknownFieldSet unknownFields; private FirstPayGiftInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private FirstPayGiftInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static FirstPayGiftInfoRequest getDefaultInstance() { return defaultInstance; } public FirstPayGiftInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private FirstPayGiftInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(FirstPayGiftInfoRequest.class, Builder.class); } public static Parser<FirstPayGiftInfoRequest> PARSER = (Parser<FirstPayGiftInfoRequest>)new AbstractParser<FirstPayGiftInfoRequest>() { public PayGiftHandler.FirstPayGiftInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.FirstPayGiftInfoRequest(input, extensionRegistry); } }
/*  318 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<FirstPayGiftInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/*  754 */     private static final FirstPayGiftData defaultInstance = new FirstPayGiftData(true); public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(FirstPayGiftData prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.FirstPayGiftDataOrBuilder { private int bitField0_; private int isGet_; public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftData_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftData_fieldAccessorTable.ensureFieldAccessorsInitialized(PayGiftHandler.FirstPayGiftData.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (PayGiftHandler.FirstPayGiftData.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.isGet_ = 0; this.bitField0_ &= 0xFFFFFFFE; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftData_descriptor; } public PayGiftHandler.FirstPayGiftData getDefaultInstanceForType() { return PayGiftHandler.FirstPayGiftData.getDefaultInstance(); } public PayGiftHandler.FirstPayGiftData build() { PayGiftHandler.FirstPayGiftData result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public PayGiftHandler.FirstPayGiftData buildPartial() { PayGiftHandler.FirstPayGiftData result = new PayGiftHandler.FirstPayGiftData(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.isGet_ = this.isGet_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof PayGiftHandler.FirstPayGiftData) return mergeFrom((PayGiftHandler.FirstPayGiftData)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(PayGiftHandler.FirstPayGiftData other) { if (other == PayGiftHandler.FirstPayGiftData.getDefaultInstance()) return this;  if (other.hasIsGet()) setIsGet(other.getIsGet());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasIsGet()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { PayGiftHandler.FirstPayGiftData parsedMessage = null; try { parsedMessage = (PayGiftHandler.FirstPayGiftData)PayGiftHandler.FirstPayGiftData.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (PayGiftHandler.FirstPayGiftData)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null)
/*  755 */             mergeFrom(parsedMessage);  }  return this; } public boolean hasIsGet() { return ((this.bitField0_ & 0x1) == 1); } public int getIsGet() { return this.isGet_; } public Builder setIsGet(int value) { this.bitField0_ |= 0x1; this.isGet_ = value; onChanged(); return this; } public Builder clearIsGet() { this.bitField0_ &= 0xFFFFFFFE; this.isGet_ = 0; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/* 1517 */     private static final FirstPayGiftInfoResponse defaultInstance = new FirstPayGiftInfoResponse(true); private final UnknownFieldSet unknownFields; private FirstPayGiftInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private FirstPayGiftInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static FirstPayGiftInfoResponse getDefaultInstance() { return defaultInstance; } public FirstPayGiftInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private FirstPayGiftInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; PayGiftHandler.FirstPayGiftData.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CData_.toBuilder();  this.s2CData_ = (PayGiftHandler.FirstPayGiftData)input.readMessage(PayGiftHandler.FirstPayGiftData.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CData_); this.s2CData_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_FirstPayGiftInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(FirstPayGiftInfoResponse.class, Builder.class); } public static Parser<FirstPayGiftInfoResponse> PARSER = (Parser<FirstPayGiftInfoResponse>)new AbstractParser<FirstPayGiftInfoResponse>() { public PayGiftHandler.FirstPayGiftInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.FirstPayGiftInfoResponse(input, extensionRegistry); } }
/* 1518 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_DATA_FIELD_NUMBER = 3; private PayGiftHandler.FirstPayGiftData s2CData_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<FirstPayGiftInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.FirstPayGiftInfoResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private PayGiftHandler.FirstPayGiftData s2CData_; private SingleFieldBuilder<PayGiftHandler.FirstPayGiftData, PayGiftHandler.FirstPayGiftData.Builder, PayGiftHandler.FirstPayGiftDataOrBuilder> s2CDataBuilder_; public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/* 1830 */   public static final class GetFirstPayGiftRequest extends GeneratedMessage implements GetFirstPayGiftRequestOrBuilder { private static final GetFirstPayGiftRequest defaultInstance = new GetFirstPayGiftRequest(true); private final UnknownFieldSet unknownFields; private GetFirstPayGiftRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetFirstPayGiftRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetFirstPayGiftRequest getDefaultInstance() { return defaultInstance; } public GetFirstPayGiftRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetFirstPayGiftRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_GetFirstPayGiftRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_GetFirstPayGiftRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetFirstPayGiftRequest.class, Builder.class); } public static Parser<GetFirstPayGiftRequest> PARSER = (Parser<GetFirstPayGiftRequest>)new AbstractParser<GetFirstPayGiftRequest>() { public PayGiftHandler.GetFirstPayGiftRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.GetFirstPayGiftRequest(input, extensionRegistry); } }
/* 1831 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetFirstPayGiftRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2392 */     private static final GetFirstPayGiftResponse defaultInstance = new GetFirstPayGiftResponse(true); private final UnknownFieldSet unknownFields; private GetFirstPayGiftResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetFirstPayGiftResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetFirstPayGiftResponse getDefaultInstance() { return defaultInstance; } public GetFirstPayGiftResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetFirstPayGiftResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_GetFirstPayGiftResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_GetFirstPayGiftResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetFirstPayGiftResponse.class, Builder.class); } public static Parser<GetFirstPayGiftResponse> PARSER = (Parser<GetFirstPayGiftResponse>)new AbstractParser<GetFirstPayGiftResponse>() { public PayGiftHandler.GetFirstPayGiftResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.GetFirstPayGiftResponse(input, extensionRegistry); } }
/* 2393 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetFirstPayGiftResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */     
/*      */     public String getS2CMsg() {
/*      */       Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String)
...
/*      */     }
/*      */     
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.GetFirstPayGiftResponseOrBuilder { private int bitField0_;
...
/*      */       } } }
/*      */   
/* 2705 */   public static final class DailyPayGiftInfoRequest extends GeneratedMessage implements DailyPayGiftInfoRequestOrBuilder { private static final DailyPayGiftInfoRequest defaultInstance = new DailyPayGiftInfoRequest(true); private final UnknownFieldSet unknownFields; private DailyPayGiftInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private DailyPayGiftInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static DailyPayGiftInfoRequest getDefaultInstance() { return defaultInstance; } public DailyPayGiftInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private DailyPayGiftInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(DailyPayGiftInfoRequest.class, Builder.class); } public static Parser<DailyPayGiftInfoRequest> PARSER = (Parser<DailyPayGiftInfoRequest>)new AbstractParser<DailyPayGiftInfoRequest>() { public PayGiftHandler.DailyPayGiftInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.DailyPayGiftInfoRequest(input, extensionRegistry); } }
/* 2706 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<DailyPayGiftInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 3260 */     private static final DailyPayGiftData defaultInstance = new DailyPayGiftData(true); protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.DailyPayGiftDataOrBuilder {
/* 3261 */       private int bitField0_; private int giftId_; private int isGet_; public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftData_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftData_fieldAccessorTable.ensureFieldAccessorsInitialized(PayGiftHandler.DailyPayGiftData.class, Builder.class); } private Builder() { maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (PayGiftHandler.DailyPayGiftData.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.giftId_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.isGet_ = 0; this.bitField0_ &= 0xFFFFFFFD; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftData_descriptor; } public PayGiftHandler.DailyPayGiftData getDefaultInstanceForType() { return PayGiftHandler.DailyPayGiftData.getDefaultInstance(); } public PayGiftHandler.DailyPayGiftData build() { PayGiftHandler.DailyPayGiftData result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public PayGiftHandler.DailyPayGiftData buildPartial() { PayGiftHandler.DailyPayGiftData result = new PayGiftHandler.DailyPayGiftData(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.giftId_ = this.giftId_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.isGet_ = this.isGet_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof PayGiftHandler.DailyPayGiftData) return mergeFrom((PayGiftHandler.DailyPayGiftData)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(PayGiftHandler.DailyPayGiftData other) { if (other == PayGiftHandler.DailyPayGiftData.getDefaultInstance()) return this;  if (other.hasGiftId()) setGiftId(other.getGiftId());  if (other.hasIsGet()) setIsGet(other.getIsGet());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasGiftId()) return false;  if (!hasIsGet()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { PayGiftHandler.DailyPayGiftData parsedMessage = null; try { parsedMessage = (PayGiftHandler.DailyPayGiftData)PayGiftHandler.DailyPayGiftData.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (PayGiftHandler.DailyPayGiftData)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasGiftId() { return ((this.bitField0_ & 0x1) == 1); } public int getGiftId() { return this.giftId_; } public Builder setGiftId(int value) { this.bitField0_ |= 0x1; this.giftId_ = value; onChanged(); return this; } public Builder clearGiftId() { this.bitField0_ &= 0xFFFFFFFE; this.giftId_ = 0; onChanged(); return this; } public boolean hasIsGet() { return ((this.bitField0_ & 0x2) == 2); } public int getIsGet() { return this.isGet_; } public Builder setIsGet(int value) { this.bitField0_ |= 0x2; this.isGet_ = value; onChanged(); return this; } public Builder clearIsGet() { this.bitField0_ &= 0xFFFFFFFD; this.isGet_ = 0; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*      */   
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 4524 */     private static final DailyPayGiftInfoResponse defaultInstance = new DailyPayGiftInfoResponse(true); private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<DailyPayGiftInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasS2CDayIndex() { return ((this.bitField0_ & 0x4) == 4); } public int getS2CDayIndex() { return this.s2CDayIndex_; } public boolean hasS2CDailyDiamondCount() { return ((this.bitField0_ & 0x8) == 8); } public int getS2CDailyDiamondCount() { return this.s2CDailyDiamondCount_; } public boolean hasS2CDailyMoneyCount() { return ((this.bitField0_ & 0x10) == 16); } public int getS2CDailyMoneyCount() { return this.s2CDailyMoneyCount_; } public List<PayGiftHandler.DailyPayGiftData> getS2CDataList() { return this.s2CData_; } public List<? extends PayGiftHandler.DailyPayGiftDataOrBuilder> getS2CDataOrBuilderList() { return (List)this.s2CData_; } public int getS2CDataCount() { return this.s2CData_.size(); } public PayGiftHandler.DailyPayGiftData getS2CData(int index) { return this.s2CData_.get(index); } public PayGiftHandler.DailyPayGiftDataOrBuilder getS2CDataOrBuilder(int index) { return this.s2CData_.get(index); } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CDayIndex_ = 0; this.s2CDailyDiamondCount_ = 0; this.s2CDailyMoneyCount_ = 0; this.s2CData_ = Collections.emptyList(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  for (int i = 0; i < getS2CDataCount(); i++) { if (!getS2CData(i).isInitialized()) { this.memoizedIsInitialized = 0; return false; }  }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.s2CDayIndex_);  if ((this.bitField0_ & 0x8) == 8) output.writeInt32(4, this.s2CDailyDiamondCount_);  if ((this.bitField0_ & 0x10) == 16) output.writeInt32(5, this.s2CDailyMoneyCount_);  for (int i = 0; i < this.s2CData_.size(); i++) output.writeMessage(6, (MessageLite)this.s2CData_.get(i));  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.s2CDayIndex_);  if ((this.bitField0_ & 0x8) == 8) size += CodedOutputStream.computeInt32Size(4, this.s2CDailyDiamondCount_);  if ((this.bitField0_ & 0x10) == 16) size += CodedOutputStream.computeInt32Size(5, this.s2CDailyMoneyCount_);  for (int i = 0; i < this.s2CData_.size(); i++) size += CodedOutputStream.computeMessageSize(6, (MessageLite)this.s2CData_.get(i));  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); }
/* 4525 */     static { defaultInstance.initFields(); }
...
/*      */       Builder builder = new Builder(parent);
/*      */       return builder;
/*      */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.DailyPayGiftInfoResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private int s2CDayIndex_; private int s2CDailyDiamondCount_; private int s2CDailyMoneyCount_; private List<PayGiftHandler.DailyPayGiftData> s2CData_; private RepeatedFieldBuilder<PayGiftHandler.DailyPayGiftData, PayGiftHandler.DailyPayGiftData.Builder, PayGiftHandler.DailyPayGiftDataOrBuilder> s2CDataBuilder_; public static final Descriptors.Descriptor getDescriptor() {
/*      */         return PayGiftHandler.internal_static_pomelo_area_DailyPayGiftInfoResponse_descriptor;
/*      */       } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
...
/*      */         return this.s2CDataBuilder_;
/*      */       } } }
/* 4929 */   public static final class GetDailyPayGiftRequest extends GeneratedMessage implements GetDailyPayGiftRequestOrBuilder { private static final GetDailyPayGiftRequest defaultInstance = new GetDailyPayGiftRequest(true); private final UnknownFieldSet unknownFields; private GetDailyPayGiftRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetDailyPayGiftRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetDailyPayGiftRequest getDefaultInstance() { return defaultInstance; } public GetDailyPayGiftRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetDailyPayGiftRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SGiftId_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_GetDailyPayGiftRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_GetDailyPayGiftRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetDailyPayGiftRequest.class, Builder.class); } public static Parser<GetDailyPayGiftRequest> PARSER = (Parser<GetDailyPayGiftRequest>)new AbstractParser<GetDailyPayGiftRequest>() { public PayGiftHandler.GetDailyPayGiftRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new PayGiftHandler.GetDailyPayGiftRequest(input, extensionRegistry); } }
/* 4930 */     ; private int bitField0_; public static final int C2S_GIFTID_FIELD_NUMBER = 1; private int c2SGiftId_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetDailyPayGiftRequest> getParserForType() { return PARSER; } public boolean hasC2SGiftId() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SGiftId() { return this.c2SGiftId_; } private void initFields() { this.c2SGiftId_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 5491 */     private static final GetDailyPayGiftResponse defaultInstance = new GetDailyPayGiftResponse(true); private static final long serialVersionUID = 0L; public Parser<GetDailyPayGiftResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static GetDailyPayGiftResponse parseFrom(ByteString data) throws InvalidProtocolBufferException { return (GetDailyPayGiftResponse)PARSER.parseFrom(data); } public static GetDailyPayGiftResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (GetDailyPayGiftResponse)PARSER.parseFrom(data, extensionRegistry); } public static GetDailyPayGiftResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (GetDailyPayGiftResponse)PARSER.parseFrom(data); } public static GetDailyPayGiftResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (GetDailyPayGiftResponse)PARSER.parseFrom(data, extensionRegistry); } public static GetDailyPayGiftResponse parseFrom(InputStream input) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseFrom(input); } public static GetDailyPayGiftResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseFrom(input, extensionRegistry); } public static GetDailyPayGiftResponse parseDelimitedFrom(InputStream input) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseDelimitedFrom(input); } public static GetDailyPayGiftResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static GetDailyPayGiftResponse parseFrom(CodedInputStream input) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseFrom(input); } public static GetDailyPayGiftResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (GetDailyPayGiftResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); }
/* 5492 */     static { defaultInstance.initFields(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(GetDailyPayGiftResponse prototype) { return newBuilder().mergeFrom(prototype); }
...
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements PayGiftHandler.GetDailyPayGiftResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_;
/*      */       public static final Descriptors.Descriptor getDescriptor() { return PayGiftHandler.internal_static_pomelo_area_GetDailyPayGiftResponse_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return PayGiftHandler.internal_static_pomelo_area_GetDailyPayGiftResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(PayGiftHandler.GetDailyPayGiftResponse.class, Builder.class); }
...
/*      */       private void maybeForceBuilderInitialization() { if (PayGiftHandler.GetDailyPayGiftResponse.alwaysUseFieldBuilders); }
...
/*      */       public Descriptors.Descriptor getDescriptorForType() { return PayGiftHandler.internal_static_pomelo_area_GetDailyPayGiftResponse_descriptor; }
/*      */       public PayGiftHandler.GetDailyPayGiftResponse getDefaultInstanceForType() { return PayGiftHandler.GetDailyPayGiftResponse.getDefaultInstance(); }
/*      */       public PayGiftHandler.GetDailyPayGiftResponse build() { PayGiftHandler.GetDailyPayGiftResponse result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; }
/*      */       public PayGiftHandler.GetDailyPayGiftResponse buildPartial() { PayGiftHandler.GetDailyPayGiftResponse result = new PayGiftHandler.GetDailyPayGiftResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
...
/*      */       public Builder mergeFrom(Message other) { if (other instanceof PayGiftHandler.GetDailyPayGiftResponse)
/*      */           return mergeFrom((PayGiftHandler.GetDailyPayGiftResponse)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(PayGiftHandler.GetDailyPayGiftResponse other) { if (other == PayGiftHandler.GetDailyPayGiftResponse.getDefaultInstance())
...
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { PayGiftHandler.GetDailyPayGiftResponse parsedMessage = null; try {
...
/*      */         } catch (InvalidProtocolBufferException e) {
/*      */           parsedMessage = (PayGiftHandler.GetDailyPayGiftResponse)e.getUnfinishedMessage(); throw e;
/*      */         } finally {
/*      */           if (parsedMessage != null)
/*      */             mergeFrom(parsedMessage); 
/*      */         }  return this; }
...
/*      */       public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = PayGiftHandler.GetDailyPayGiftResponse.getDefaultInstance().getS2CMsg(); onChanged();
/*      */         return this; }
...
/*      */ 
/*      */     
/* 5586 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 5590 */           PayGiftHandler.descriptor = root;
/* 5591 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 5595 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[0], assigner);
/*      */   }
/*      */ 
/*      */   
/* 5599 */   private static final Descriptors.Descriptor internal_static_pomelo_area_FirstPayGiftInfoRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 5600 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_FirstPayGiftInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_FirstPayGiftInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5605 */   private static final Descriptors.Descriptor internal_static_pomelo_area_FirstPayGiftData_descriptor = getDescriptor().getMessageTypes().get(1);
/* 5606 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_FirstPayGiftData_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_FirstPayGiftData_descriptor, new String[] { "IsGet" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5611 */   private static final Descriptors.Descriptor internal_static_pomelo_area_FirstPayGiftInfoResponse_descriptor = getDescriptor().getMessageTypes().get(2);
/* 5612 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_FirstPayGiftInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_FirstPayGiftInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CData" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5617 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetFirstPayGiftRequest_descriptor = getDescriptor().getMessageTypes().get(3);
/* 5618 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetFirstPayGiftRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetFirstPayGiftRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5623 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetFirstPayGiftResponse_descriptor = getDescriptor().getMessageTypes().get(4);
/* 5624 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetFirstPayGiftResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetFirstPayGiftResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5629 */   private static final Descriptors.Descriptor internal_static_pomelo_area_DailyPayGiftInfoRequest_descriptor = getDescriptor().getMessageTypes().get(5);
/* 5630 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_DailyPayGiftInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_DailyPayGiftInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5635 */   private static final Descriptors.Descriptor internal_static_pomelo_area_DailyPayGiftData_descriptor = getDescriptor().getMessageTypes().get(6);
/* 5636 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_DailyPayGiftData_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_DailyPayGiftData_descriptor, new String[] { "GiftId", "IsGet" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5641 */   private static final Descriptors.Descriptor internal_static_pomelo_area_DailyPayGiftInfoResponse_descriptor = getDescriptor().getMessageTypes().get(7);
/* 5642 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_DailyPayGiftInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_DailyPayGiftInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CDayIndex", "S2CDailyDiamondCount", "S2CDailyMoneyCount", "S2CData" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5647 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetDailyPayGiftRequest_descriptor = getDescriptor().getMessageTypes().get(8);
/* 5648 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetDailyPayGiftRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetDailyPayGiftRequest_descriptor, new String[] { "C2SGiftId" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5653 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetDailyPayGiftResponse_descriptor = getDescriptor().getMessageTypes().get(9);
/* 5654 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetDailyPayGiftResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetDailyPayGiftResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\PayGiftHandler.class
