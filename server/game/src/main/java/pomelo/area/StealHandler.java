...
public final class StealHandler {
    ...
    public static final class StealResponse
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 34:
                            ...
                            this.s2CItems_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry));
                            break;
                    }
                }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return StealHandler.internal_static_pomelo_area_StealResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(StealResponse.class, Builder.class);
        }

        public static Parser<StealResponse> PARSER = (Parser<StealResponse>) new AbstractParser<StealResponse>() {
            public StealHandler.StealResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new StealHandler.StealResponse(input, extensionRegistry);
            }
        };
        ...
        private List<ItemOuterClass.MiniItem> s2CItems_;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements StealHandler.StealResponseOrBuilder {
            ...
            private int s2CResult_;
            private List<ItemOuterClass.MiniItem> s2CItems_;
            private RepeatedFieldBuilder<ItemOuterClass.MiniItem, ItemOuterClass.MiniItem.Builder, ItemOuterClass.MiniItemOrBuilder> s2CItemsBuilder_;
    ...
    public static final class StealRequest extends GeneratedMessage implements StealRequestOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return StealHandler.internal_static_pomelo_area_StealRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return StealHandler.internal_static_pomelo_area_StealRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(StealRequest.class, Builder.class);
        }

        public static Parser<StealRequest> PARSER = (Parser<StealRequest>) new AbstractParser<StealRequest>() {
            public StealHandler.StealRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new StealHandler.StealRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements StealHandler.StealRequestOrBuilder {
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return StealHandler.internal_static_pomelo_area_StealRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(StealHandler.StealRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (StealHandler.StealRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public StealHandler.StealRequest getDefaultInstanceForType() {
                return StealHandler.StealRequest.getDefaultInstance();
            }

            public StealHandler.StealRequest build() {
                StealHandler.StealRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public StealHandler.StealRequest buildPartial() {
                StealHandler.StealRequest result = new StealHandler.StealRequest(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof StealHandler.StealRequest) return mergeFrom((StealHandler.StealRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(StealHandler.StealRequest other) {
                if (other == StealHandler.StealRequest.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                StealHandler.StealRequest parsedMessage = null;
                try {
                    parsedMessage = (StealHandler.StealRequest) StealHandler.StealRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (StealHandler.StealRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_area_StealResponse_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_StealResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_StealResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "S2CResult", "S2CItems"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_StealRequest_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_StealRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_StealRequest_descriptor, new String[]{"C2SId"});
