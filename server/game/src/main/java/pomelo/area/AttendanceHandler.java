...
/*       */   {
/*   317 */     private static final GetAttendanceInfoRequest defaultInstance = new GetAttendanceInfoRequest(true); private final UnknownFieldSet unknownFields; private GetAttendanceInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetAttendanceInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetAttendanceInfoRequest getDefaultInstance() { return defaultInstance; } public GetAttendanceInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetAttendanceInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetAttendanceInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetAttendanceInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetAttendanceInfoRequest.class, Builder.class); } public static Parser<GetAttendanceInfoRequest> PARSER = (Parser<GetAttendanceInfoRequest>)new AbstractParser<GetAttendanceInfoRequest>() { public AttendanceHandler.GetAttendanceInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetAttendanceInfoRequest(input, extensionRegistry); } }
/*   318 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetAttendanceInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*   630 */     private static final GetDailyRewardRequest defaultInstance = new GetDailyRewardRequest(true); private final UnknownFieldSet unknownFields; private GetDailyRewardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetDailyRewardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetDailyRewardRequest getDefaultInstance() { return defaultInstance; } public GetDailyRewardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetDailyRewardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetDailyRewardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetDailyRewardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetDailyRewardRequest.class, Builder.class); } public static Parser<GetDailyRewardRequest> PARSER = (Parser<GetDailyRewardRequest>)new AbstractParser<GetDailyRewardRequest>() { public AttendanceHandler.GetDailyRewardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetDailyRewardRequest(input, extensionRegistry); } }
/*   631 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetDailyRewardRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  1035 */     private static final GetCumulativeRewardRequest defaultInstance = new GetCumulativeRewardRequest(true); private final UnknownFieldSet unknownFields; private GetCumulativeRewardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetCumulativeRewardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetCumulativeRewardRequest getDefaultInstance() { return defaultInstance; } public GetCumulativeRewardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetCumulativeRewardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetCumulativeRewardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetCumulativeRewardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetCumulativeRewardRequest.class, Builder.class); } public static Parser<GetCumulativeRewardRequest> PARSER = (Parser<GetCumulativeRewardRequest>)new AbstractParser<GetCumulativeRewardRequest>() { public AttendanceHandler.GetCumulativeRewardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetCumulativeRewardRequest(input, extensionRegistry); } }
/*  1036 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetCumulativeRewardRequest> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } private void initFields() { this.id_ = 0; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  1348 */     private static final GetLuxuryRewardRequest defaultInstance = new GetLuxuryRewardRequest(true); private final UnknownFieldSet unknownFields; private GetLuxuryRewardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetLuxuryRewardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetLuxuryRewardRequest getDefaultInstance() { return defaultInstance; } public GetLuxuryRewardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetLuxuryRewardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetLuxuryRewardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetLuxuryRewardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetLuxuryRewardRequest.class, Builder.class); } public static Parser<GetLuxuryRewardRequest> PARSER = (Parser<GetLuxuryRewardRequest>)new AbstractParser<GetLuxuryRewardRequest>() { public AttendanceHandler.GetLuxuryRewardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetLuxuryRewardRequest(input, extensionRegistry); } }
/*  1349 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetLuxuryRewardRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  1753 */     private static final GetLeftVipRewardRequest defaultInstance = new GetLeftVipRewardRequest(true); private final UnknownFieldSet unknownFields; private GetLeftVipRewardRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetLeftVipRewardRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetLeftVipRewardRequest getDefaultInstance() { return defaultInstance; } public GetLeftVipRewardRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetLeftVipRewardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetLeftVipRewardRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetLeftVipRewardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetLeftVipRewardRequest.class, Builder.class); } public static Parser<GetLeftVipRewardRequest> PARSER = (Parser<GetLeftVipRewardRequest>)new AbstractParser<GetLeftVipRewardRequest>() { public AttendanceHandler.GetLeftVipRewardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetLeftVipRewardRequest(input, extensionRegistry); } }
/*  1754 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetLeftVipRewardRequest> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } private void initFields() { this.id_ = 0; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  2671 */     private static final DailyInfo defaultInstance = new DailyInfo(true); private final UnknownFieldSet unknownFields; private DailyInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private DailyInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static DailyInfo getDefaultInstance() { return defaultInstance; } public DailyInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private DailyInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ItemOuterClass.MiniItem.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break;case 18: subBuilder = null; if ((this.bitField0_ & 0x2) == 2) subBuilder = this.itemList_.toBuilder();  this.itemList_ = (ItemOuterClass.MiniItem)input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.itemList_); this.itemList_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x2; break;case 24: this.bitField0_ |= 0x4; this.vipDoubleLevel_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.state_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_DailyInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_DailyInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(DailyInfo.class, Builder.class); } public static Parser<DailyInfo> PARSER = (Parser<DailyInfo>)new AbstractParser<DailyInfo>() { public AttendanceHandler.DailyInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.DailyInfo(input, extensionRegistry); } }
/*  2672 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; public static final int ITEMLIST_FIELD_NUMBER = 2; private ItemOuterClass.MiniItem itemList_; public static final int VIPDOUBLELEVEL_FIELD_NUMBER = 3; private int vipDoubleLevel_; public static final int STATE_FIELD_NUMBER = 4; private int state_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<DailyInfo> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } public boolean hasItemList() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  3841 */     private static final CumulativeInfo defaultInstance = new CumulativeInfo(true); private final UnknownFieldSet unknownFields; private CumulativeInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private CumulativeInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static CumulativeInfo getDefaultInstance() { return defaultInstance; } public CumulativeInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private CumulativeInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break;case 18: if ((mutable_bitField0_ & 0x2) != 2) { this.itemList_ = new ArrayList<>(); mutable_bitField0_ |= 0x2; }  this.itemList_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break;case 24: this.bitField0_ |= 0x2; this.needCountDay_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x4; this.state_ = input.readInt32(); break;case 42: bs = input.readBytes(); this.bitField0_ |= 0x8; this.boxIcon_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x2) == 2) this.itemList_ = Collections.unmodifiableList(this.itemList_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_CumulativeInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_CumulativeInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(CumulativeInfo.class, Builder.class); } public static Parser<CumulativeInfo> PARSER = (Parser<CumulativeInfo>)new AbstractParser<CumulativeInfo>() { public AttendanceHandler.CumulativeInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.CumulativeInfo(input, extensionRegistry); } }
/*  3842 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; public static final int ITEMLIST_FIELD_NUMBER = 2; private List<ItemOuterClass.MiniItem> itemList_; public static final int NEEDCOUNTDAY_FIELD_NUMBER = 3; private int needCountDay_; public static final int STATE_FIELD_NUMBER = 4; private int state_; public static final int BOXICON_FIELD_NUMBER = 5; private Object boxIcon_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<CumulativeInfo> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } public List<ItemOuterClass.MiniItem> getItemListList() { return this.itemList_; } public List<? extends ItemOuterClass.MiniItemOrBuilder> getItemListOrBuilderList() { return (List)this.itemList_; } public int getItemListCount() { return this.itemList_.size(); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  5124 */     private static final AttendanceInfo defaultInstance = new AttendanceInfo(true); private final UnknownFieldSet unknownFields; private AttendanceInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AttendanceInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AttendanceInfo getDefaultInstance() { return defaultInstance; } public AttendanceInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AttendanceInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.todayState_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.signedCount_ = input.readInt32(); break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.dailyList_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.dailyList_.add(input.readMessage(AttendanceHandler.DailyInfo.PARSER, extensionRegistry)); break;case 34: if ((mutable_bitField0_ & 0x8) != 8) { this.cumulativeList_ = new ArrayList<>(); mutable_bitField0_ |= 0x8; }  this.cumulativeList_.add(input.readMessage(AttendanceHandler.CumulativeInfo.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.dailyList_ = Collections.unmodifiableList(this.dailyList_);  if ((mutable_bitField0_ & 0x8) == 8) this.cumulativeList_ = Collections.unmodifiableList(this.cumulativeList_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_AttendanceInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_AttendanceInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(AttendanceInfo.class, Builder.class); } public static Parser<AttendanceInfo> PARSER = (Parser<AttendanceInfo>)new AbstractParser<AttendanceInfo>() { public AttendanceHandler.AttendanceInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.AttendanceInfo(input, extensionRegistry); } }
/*  5125 */     ; private int bitField0_; public static final int TODAYSTATE_FIELD_NUMBER = 1; private int todayState_; public static final int SIGNEDCOUNT_FIELD_NUMBER = 2; private int signedCount_; public static final int DAILYLIST_FIELD_NUMBER = 3; private List<AttendanceHandler.DailyInfo> dailyList_; public static final int CUMULATIVELIST_FIELD_NUMBER = 4; private List<AttendanceHandler.CumulativeInfo> cumulativeList_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AttendanceInfo> getParserForType() { return PARSER; } public boolean hasTodayState() { return ((this.bitField0_ & 0x1) == 1); } public int getTodayState() { return this.todayState_; } public boolean hasSignedCount() { return ((this.bitField0_ & 0x2) == 2); } public int getSignedCount() { return this.signedCount_; } public List<AttendanceHandler.DailyInfo> getDailyListList() { return this.dailyList_; } public List<? extends AttendanceHandler.DailyInfoOrBuilder> getDailyListOrBuilderList() { return (List)this.dailyList_; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  5925 */     private static final LuxuryInfo defaultInstance = new LuxuryInfo(true); private final UnknownFieldSet unknownFields; private LuxuryInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LuxuryInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LuxuryInfo getDefaultInstance() { return defaultInstance; } public LuxuryInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LuxuryInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: if ((mutable_bitField0_ & 0x1) != 1) { this.itemList_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.itemList_.add(input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry)); break;case 16: this.bitField0_ |= 0x1; this.state_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.itemList_ = Collections.unmodifiableList(this.itemList_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_LuxuryInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_LuxuryInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(LuxuryInfo.class, Builder.class); } public static Parser<LuxuryInfo> PARSER = (Parser<LuxuryInfo>)new AbstractParser<LuxuryInfo>() { public AttendanceHandler.LuxuryInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.LuxuryInfo(input, extensionRegistry); } }
/*  5926 */     ; private int bitField0_; public static final int ITEMLIST_FIELD_NUMBER = 1; private List<ItemOuterClass.MiniItem> itemList_; public static final int STATE_FIELD_NUMBER = 2; private int state_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LuxuryInfo> getParserForType() { return PARSER; } public List<ItemOuterClass.MiniItem> getItemListList() { return this.itemList_; } public List<? extends ItemOuterClass.MiniItemOrBuilder> getItemListOrBuilderList() { return (List)this.itemList_; } public int getItemListCount() { return this.itemList_.size(); } public ItemOuterClass.MiniItem getItemList(int index) { return this.itemList_.get(index); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  6889 */     private static final GetAttendanceInfoResponse defaultInstance = new GetAttendanceInfoResponse(true); private final UnknownFieldSet unknownFields; private GetAttendanceInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetAttendanceInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetAttendanceInfoResponse getDefaultInstance() { return defaultInstance; } public GetAttendanceInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetAttendanceInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; AttendanceHandler.AttendanceInfo.Builder builder; AttendanceHandler.LuxuryInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: builder = null; if ((this.bitField0_ & 0x4) == 4) builder = this.s2CAttendance_.toBuilder();  this.s2CAttendance_ = (AttendanceHandler.AttendanceInfo)input.readMessage(AttendanceHandler.AttendanceInfo.PARSER, extensionRegistry); if (builder != null) { builder.mergeFrom(this.s2CAttendance_); this.s2CAttendance_ = builder.buildPartial(); }  this.bitField0_ |= 0x4; break;case 34: subBuilder = null; if ((this.bitField0_ & 0x8) == 8) subBuilder = this.s2CLuxury_.toBuilder();  this.s2CLuxury_ = (AttendanceHandler.LuxuryInfo)input.readMessage(AttendanceHandler.LuxuryInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CLuxury_); this.s2CLuxury_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x8; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetAttendanceInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetAttendanceInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetAttendanceInfoResponse.class, Builder.class); } public static Parser<GetAttendanceInfoResponse> PARSER = (Parser<GetAttendanceInfoResponse>)new AbstractParser<GetAttendanceInfoResponse>() { public AttendanceHandler.GetAttendanceInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetAttendanceInfoResponse(input, extensionRegistry); } }
/*  6890 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_ATTENDANCE_FIELD_NUMBER = 3; private AttendanceHandler.AttendanceInfo s2CAttendance_; public static final int S2C_LUXURY_FIELD_NUMBER = 4; private AttendanceHandler.LuxuryInfo s2CLuxury_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetAttendanceInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  7652 */     private static final GetDailyRewardResponse defaultInstance = new GetDailyRewardResponse(true); private final UnknownFieldSet unknownFields; private GetDailyRewardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetDailyRewardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetDailyRewardResponse getDefaultInstance() { return defaultInstance; } public GetDailyRewardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetDailyRewardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; AttendanceHandler.AttendanceInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CAttendance_.toBuilder();  this.s2CAttendance_ = (AttendanceHandler.AttendanceInfo)input.readMessage(AttendanceHandler.AttendanceInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CAttendance_); this.s2CAttendance_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetDailyRewardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetDailyRewardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetDailyRewardResponse.class, Builder.class); } public static Parser<GetDailyRewardResponse> PARSER = (Parser<GetDailyRewardResponse>)new AbstractParser<GetDailyRewardResponse>() { public AttendanceHandler.GetDailyRewardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetDailyRewardResponse(input, extensionRegistry); } }
/*  7653 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_ATTENDANCE_FIELD_NUMBER = 3; private AttendanceHandler.AttendanceInfo s2CAttendance_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetDailyRewardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  8415 */     private static final GetCumulativeRewardResponse defaultInstance = new GetCumulativeRewardResponse(true); private final UnknownFieldSet unknownFields; private GetCumulativeRewardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetCumulativeRewardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetCumulativeRewardResponse getDefaultInstance() { return defaultInstance; } public GetCumulativeRewardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetCumulativeRewardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; AttendanceHandler.AttendanceInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CAttendance_.toBuilder();  this.s2CAttendance_ = (AttendanceHandler.AttendanceInfo)input.readMessage(AttendanceHandler.AttendanceInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CAttendance_); this.s2CAttendance_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetCumulativeRewardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetCumulativeRewardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetCumulativeRewardResponse.class, Builder.class); } public static Parser<GetCumulativeRewardResponse> PARSER = (Parser<GetCumulativeRewardResponse>)new AbstractParser<GetCumulativeRewardResponse>() { public AttendanceHandler.GetCumulativeRewardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetCumulativeRewardResponse(input, extensionRegistry); } }
/*  8416 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_ATTENDANCE_FIELD_NUMBER = 3; private AttendanceHandler.AttendanceInfo s2CAttendance_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetCumulativeRewardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  9178 */     private static final GetLuxuryRewardResponse defaultInstance = new GetLuxuryRewardResponse(true); private final UnknownFieldSet unknownFields; private GetLuxuryRewardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetLuxuryRewardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetLuxuryRewardResponse getDefaultInstance() { return defaultInstance; } public GetLuxuryRewardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetLuxuryRewardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; AttendanceHandler.LuxuryInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CLuxury_.toBuilder();  this.s2CLuxury_ = (AttendanceHandler.LuxuryInfo)input.readMessage(AttendanceHandler.LuxuryInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CLuxury_); this.s2CLuxury_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetLuxuryRewardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetLuxuryRewardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetLuxuryRewardResponse.class, Builder.class); } public static Parser<GetLuxuryRewardResponse> PARSER = (Parser<GetLuxuryRewardResponse>)new AbstractParser<GetLuxuryRewardResponse>() { public AttendanceHandler.GetLuxuryRewardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetLuxuryRewardResponse(input, extensionRegistry); } }
/*  9179 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_LUXURY_FIELD_NUMBER = 3; private AttendanceHandler.LuxuryInfo s2CLuxury_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetLuxuryRewardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  9941 */     private static final GetLeftVipRewardResponse defaultInstance = new GetLeftVipRewardResponse(true); private final UnknownFieldSet unknownFields; private GetLeftVipRewardResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetLeftVipRewardResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetLeftVipRewardResponse getDefaultInstance() { return defaultInstance; } public GetLeftVipRewardResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetLeftVipRewardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; AttendanceHandler.AttendanceInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CAttendance_.toBuilder();  this.s2CAttendance_ = (AttendanceHandler.AttendanceInfo)input.readMessage(AttendanceHandler.AttendanceInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CAttendance_); this.s2CAttendance_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_GetLeftVipRewardResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_GetLeftVipRewardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetLeftVipRewardResponse.class, Builder.class); } public static Parser<GetLeftVipRewardResponse> PARSER = (Parser<GetLeftVipRewardResponse>)new AbstractParser<GetLeftVipRewardResponse>() { public AttendanceHandler.GetLeftVipRewardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AttendanceHandler.GetLeftVipRewardResponse(input, extensionRegistry); } }
/*  9942 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_ATTENDANCE_FIELD_NUMBER = 3; private AttendanceHandler.AttendanceInfo s2CAttendance_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetLeftVipRewardResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */ 
/*       */     
/* 10704 */     private static final LuxuryRewardPush defaultInstance = new LuxuryRewardPush(true); public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasS2CLuxury() { return ((this.bitField0_ & 0x4) == 4); } public AttendanceHandler.LuxuryInfo getS2CLuxury() { return this.s2CLuxury_; } public AttendanceHandler.LuxuryInfoOrBuilder getS2CLuxuryOrBuilder() { return this.s2CLuxury_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.getDefaultInstance(); } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  if (hasS2CLuxury() && !getS2CLuxury().isInitialized()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeMessage(3, (MessageLite)this.s2CLuxury_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4)
/* 10705 */         size += CodedOutputStream.computeMessageSize(3, (MessageLite)this.s2CLuxury_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static LuxuryRewardPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (LuxuryRewardPush)PARSER.parseFrom(data); } public static LuxuryRewardPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (LuxuryRewardPush)PARSER.parseFrom(data, extensionRegistry); } public static LuxuryRewardPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (LuxuryRewardPush)PARSER.parseFrom(data); } public static LuxuryRewardPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (LuxuryRewardPush)PARSER.parseFrom(data, extensionRegistry); } public static LuxuryRewardPush parseFrom(InputStream input) throws IOException { return (LuxuryRewardPush)PARSER.parseFrom(input); } public static LuxuryRewardPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LuxuryRewardPush)PARSER.parseFrom(input, extensionRegistry); } public static LuxuryRewardPush parseDelimitedFrom(InputStream input) throws IOException { return (LuxuryRewardPush)PARSER.parseDelimitedFrom(input); } public static LuxuryRewardPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LuxuryRewardPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static LuxuryRewardPush parseFrom(CodedInputStream input) throws IOException { return (LuxuryRewardPush)PARSER.parseFrom(input); } public static LuxuryRewardPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LuxuryRewardPush)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(LuxuryRewardPush prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } static { defaultInstance.initFields(); } public static final class Builder extends GeneratedMessage.Builder<Builder> implements AttendanceHandler.LuxuryRewardPushOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private AttendanceHandler.LuxuryInfo s2CLuxury_; private SingleFieldBuilder<AttendanceHandler.LuxuryInfo, AttendanceHandler.LuxuryInfo.Builder, AttendanceHandler.LuxuryInfoOrBuilder> s2CLuxuryBuilder_; public static final Descriptors.Descriptor getDescriptor() { return AttendanceHandler.internal_static_pomelo_area_LuxuryRewardPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AttendanceHandler.internal_static_pomelo_area_LuxuryRewardPush_fieldAccessorTable.ensureFieldAccessorsInitialized(AttendanceHandler.LuxuryRewardPush.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.getDefaultInstance(); maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.getDefaultInstance(); maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (AttendanceHandler.LuxuryRewardPush.alwaysUseFieldBuilders)
/*       */           getS2CLuxuryFieldBuilder();  } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; if (this.s2CLuxuryBuilder_ == null) {
/*       */           this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.getDefaultInstance();
/*       */         } else {
/*       */           this.s2CLuxuryBuilder_.clear();
/*       */         }  this.bitField0_ &= 0xFFFFFFFB; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return AttendanceHandler.internal_static_pomelo_area_LuxuryRewardPush_descriptor; } public AttendanceHandler.LuxuryRewardPush getDefaultInstanceForType() { return AttendanceHandler.LuxuryRewardPush.getDefaultInstance(); } public AttendanceHandler.LuxuryRewardPush build() { AttendanceHandler.LuxuryRewardPush result = buildPartial(); if (!result.isInitialized())
/*       */           throw newUninitializedMessageException(result);  return result; } public AttendanceHandler.LuxuryRewardPush buildPartial() { AttendanceHandler.LuxuryRewardPush result = new AttendanceHandler.LuxuryRewardPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
...
/*       */           to_bitField0_ |= 0x4;  if (this.s2CLuxuryBuilder_ == null) {
/*       */           result.s2CLuxury_ = this.s2CLuxury_;
/*       */         } else {
/*       */           result.s2CLuxury_ = (AttendanceHandler.LuxuryInfo)this.s2CLuxuryBuilder_.build();
/*       */         }  result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof AttendanceHandler.LuxuryRewardPush)
/*       */           return mergeFrom((AttendanceHandler.LuxuryRewardPush)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(AttendanceHandler.LuxuryRewardPush other) { if (other == AttendanceHandler.LuxuryRewardPush.getDefaultInstance())
...
/*       */         }  if (other.hasS2CLuxury())
/*       */           mergeS2CLuxury(other.getS2CLuxury());  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CCode())
/*       */           return false;  if (hasS2CLuxury() && !getS2CLuxury().isInitialized())
/*       */           return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { AttendanceHandler.LuxuryRewardPush parsedMessage = null; try {
...
/*       */           throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = AttendanceHandler.LuxuryRewardPush.getDefaultInstance().getS2CMsg(); onChanged();
/*       */         return this; } public Builder setS2CMsgBytes(ByteString value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x2;
/*       */         this.s2CMsg_ = value;
/*       */         onChanged();
/*       */         return this; } public boolean hasS2CLuxury() { return ((this.bitField0_ & 0x4) == 4); } public AttendanceHandler.LuxuryInfo getS2CLuxury() { if (this.s2CLuxuryBuilder_ == null)
/*       */           return this.s2CLuxury_; 
/*       */         return (AttendanceHandler.LuxuryInfo)this.s2CLuxuryBuilder_.getMessage(); } public Builder setS2CLuxury(AttendanceHandler.LuxuryInfo value) { if (this.s2CLuxuryBuilder_ == null) {
/*       */           if (value == null)
/*       */             throw new NullPointerException(); 
/*       */           this.s2CLuxury_ = value;
/*       */           onChanged();
...
/*       */         } 
/*       */         this.bitField0_ |= 0x4;
/*       */         return this; } public Builder setS2CLuxury(AttendanceHandler.LuxuryInfo.Builder builderForValue) { if (this.s2CLuxuryBuilder_ == null) {
/*       */           this.s2CLuxury_ = builderForValue.build();
/*       */           onChanged();
/*       */         } else {
/*       */           this.s2CLuxuryBuilder_.setMessage(builderForValue.build());
/*       */         } 
/*       */         this.bitField0_ |= 0x4;
/*       */         return this; } public Builder mergeS2CLuxury(AttendanceHandler.LuxuryInfo value) { if (this.s2CLuxuryBuilder_ == null) {
/*       */           if ((this.bitField0_ & 0x4) == 4 && this.s2CLuxury_ != AttendanceHandler.LuxuryInfo.getDefaultInstance()) {
/*       */             this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.newBuilder(this.s2CLuxury_).mergeFrom(value).buildPartial();
/*       */           } else {
/*       */             this.s2CLuxury_ = value;
...
/*       */         } 
/*       */         this.bitField0_ |= 0x4;
/*       */         return this; } public Builder clearS2CLuxury() { if (this.s2CLuxuryBuilder_ == null) {
/*       */           this.s2CLuxury_ = AttendanceHandler.LuxuryInfo.getDefaultInstance();
/*       */           onChanged();
/*       */         } else {
/*       */           this.s2CLuxuryBuilder_.clear();
...
/*       */ 
/*       */     
/* 10847 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*       */       {
/*       */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*       */         {
/* 10851 */           AttendanceHandler.descriptor = root;
/* 10852 */           return null;
/*       */         }
/*       */       };
/*       */     
/* 10856 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*       */           
/* 10858 */           Common.getDescriptor(), 
/* 10859 */           ItemOuterClass.getDescriptor() }, assigner);
/*       */   }
/*       */   
/* 10862 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetAttendanceInfoRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 10863 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetAttendanceInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetAttendanceInfoRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10868 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetDailyRewardRequest_descriptor = getDescriptor().getMessageTypes().get(1);
/* 10869 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetDailyRewardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetDailyRewardRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10874 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetCumulativeRewardRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 10875 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetCumulativeRewardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetCumulativeRewardRequest_descriptor, new String[] { "Id" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10880 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetLuxuryRewardRequest_descriptor = getDescriptor().getMessageTypes().get(3);
/* 10881 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetLuxuryRewardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetLuxuryRewardRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10886 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetLeftVipRewardRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 10887 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetLeftVipRewardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetLeftVipRewardRequest_descriptor, new String[] { "Id" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10892 */   private static final Descriptors.Descriptor internal_static_pomelo_area_DailyInfo_descriptor = getDescriptor().getMessageTypes().get(5);
/* 10893 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_DailyInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_DailyInfo_descriptor, new String[] { "Id", "ItemList", "VipDoubleLevel", "State" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10898 */   private static final Descriptors.Descriptor internal_static_pomelo_area_CumulativeInfo_descriptor = getDescriptor().getMessageTypes().get(6);
/* 10899 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_CumulativeInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_CumulativeInfo_descriptor, new String[] { "Id", "ItemList", "NeedCountDay", "State", "BoxIcon" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10904 */   private static final Descriptors.Descriptor internal_static_pomelo_area_AttendanceInfo_descriptor = getDescriptor().getMessageTypes().get(7);
/* 10905 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_AttendanceInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_AttendanceInfo_descriptor, new String[] { "TodayState", "SignedCount", "DailyList", "CumulativeList" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10910 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LuxuryInfo_descriptor = getDescriptor().getMessageTypes().get(8);
/* 10911 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LuxuryInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LuxuryInfo_descriptor, new String[] { "ItemList", "State" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10916 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetAttendanceInfoResponse_descriptor = getDescriptor().getMessageTypes().get(9);
/* 10917 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetAttendanceInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetAttendanceInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CAttendance", "S2CLuxury" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10922 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetDailyRewardResponse_descriptor = getDescriptor().getMessageTypes().get(10);
/* 10923 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetDailyRewardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetDailyRewardResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CAttendance" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10928 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetCumulativeRewardResponse_descriptor = getDescriptor().getMessageTypes().get(11);
/* 10929 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetCumulativeRewardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetCumulativeRewardResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CAttendance" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10934 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetLuxuryRewardResponse_descriptor = getDescriptor().getMessageTypes().get(12);
/* 10935 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetLuxuryRewardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetLuxuryRewardResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CLuxury" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10940 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetLeftVipRewardResponse_descriptor = getDescriptor().getMessageTypes().get(13);
/* 10941 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetLeftVipRewardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetLeftVipRewardResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CAttendance" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10946 */   private static final Descriptors.Descriptor internal_static_pomelo_area_LuxuryRewardPush_descriptor = getDescriptor().getMessageTypes().get(14);
/* 10947 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_LuxuryRewardPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_LuxuryRewardPush_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CLuxury" });
/*       */   private static Descriptors.FileDescriptor descriptor;
/*       */   
/*       */   static {
/* 10951 */     Common.getDescriptor();
/* 10952 */     ItemOuterClass.getDescriptor();
/*       */   }
/*       */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\AttendanceHandler.class
