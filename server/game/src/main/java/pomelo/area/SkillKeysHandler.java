...
public final class SkillKeysHandler {
    ...
    public static final class SkillKey
        ...
        private static final SkillKey defaultInstance = new SkillKey(true);
        private final UnknownFieldSet unknownFields;

        private SkillKey(GeneratedMessage.Builder<?> builder) {
            super(builder);
        ...
        private SkillKey(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
        ...
        private SkillKey(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return SkillKeysHandler.internal_static_pomelo_area_SkillKey_fieldAccessorTable.ensureFieldAccessorsInitialized(SkillKey.class, Builder.class);
        }

        public static Parser<SkillKey> PARSER = (Parser<SkillKey>) new AbstractParser<SkillKey>() {
            public SkillKeysHandler.SkillKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new SkillKeysHandler.SkillKey(input, extensionRegistry);
            }
        };
        ...
        public Parser<SkillKey> getParserForType() {
            return PARSER;
        }
    ...
    public static final class SaveSkillKeysRequest
        ...
        private static final SaveSkillKeysRequest defaultInstance = new SaveSkillKeysRequest(true);
        private final UnknownFieldSet unknownFields;

        private SaveSkillKeysRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private SaveSkillKeysRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private SaveSkillKeysRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
                    ...
                    switch (tag) {
                        ...
                        case 10:
                            if ((mutable_bitField0_ & 0x1) != 1) {
                                this.s2CSkillKeys_ = new ArrayList<>();
                                mutable_bitField0_ |= 0x1;
                            }
                            this.s2CSkillKeys_.add(input.readMessage(SkillKeysHandler.SkillKey.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return SkillKeysHandler.internal_static_pomelo_area_SaveSkillKeysRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(SaveSkillKeysRequest.class, Builder.class);
        }

        public static Parser<SaveSkillKeysRequest> PARSER = (Parser<SaveSkillKeysRequest>) new AbstractParser<SaveSkillKeysRequest>() {
            public SkillKeysHandler.SaveSkillKeysRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new SkillKeysHandler.SaveSkillKeysRequest(input, extensionRegistry);
            }
        };
    ...
    public static final class SaveSkillKeysResponse
        ...
        private static final SaveSkillKeysResponse defaultInstance = new SaveSkillKeysResponse(true);
        private final UnknownFieldSet unknownFields;

        private SaveSkillKeysResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private SaveSkillKeysResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private SaveSkillKeysResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return SkillKeysHandler.internal_static_pomelo_area_SaveSkillKeysResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(SaveSkillKeysResponse.class, Builder.class);
        }

        public static Parser<SaveSkillKeysResponse> PARSER = (Parser<SaveSkillKeysResponse>) new AbstractParser<SaveSkillKeysResponse>() {
            public SkillKeysHandler.SaveSkillKeysResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new SkillKeysHandler.SaveSkillKeysResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<SaveSkillKeysResponse> getParserForType() {
            return PARSER;
        }
    ...
    public static final class SkillKeyUpdatePush
        ...
        private static final SkillKeyUpdatePush defaultInstance = new SkillKeyUpdatePush(true);
        private final UnknownFieldSet unknownFields;

        private SkillKeyUpdatePush(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private SkillKeyUpdatePush(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private SkillKeyUpdatePush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18:
                            ...
                            this.s2CData_.add(input.readMessage(Common.SkillKeyStruct.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return SkillKeysHandler.internal_static_pomelo_area_SkillKeyUpdatePush_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return SkillKeysHandler.internal_static_pomelo_area_SkillKeyUpdatePush_fieldAccessorTable.ensureFieldAccessorsInitialized(SkillKeyUpdatePush.class, Builder.class);
        }

        public static Parser<SkillKeyUpdatePush> PARSER = (Parser<SkillKeyUpdatePush>) new AbstractParser<SkillKeyUpdatePush>() {
            public SkillKeysHandler.SkillKeyUpdatePush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new SkillKeysHandler.SkillKeyUpdatePush(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int S2C_CODE_FIELD_NUMBER = 1;
        ...
        public Parser<SkillKeyUpdatePush> getParserForType() {
            return PARSER;
        }
        ...
        public List<Common.SkillKeyStruct> getS2CDataList() {
            return this.s2CData_;
        }

        public List<? extends Common.SkillKeyStructOrBuilder> getS2CDataOrBuilderList() {
        ...
        public Common.SkillKeyStruct getS2CData(int index) {
            return this.s2CData_.get(index);
        }

        public Common.SkillKeyStructOrBuilder getS2CDataOrBuilder(int index) {
            return (Common.SkillKeyStructOrBuilder) this.s2CData_.get(index);
        }
        ...
        public static SkillKeyUpdatePush parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(data);
        }

        public static SkillKeyUpdatePush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(data, extensionRegistry);
        }

        public static SkillKeyUpdatePush parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(data);
        }

        public static SkillKeyUpdatePush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(data, extensionRegistry);
        }

        public static SkillKeyUpdatePush parseFrom(InputStream input) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(input);
        }

        public static SkillKeyUpdatePush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(input, extensionRegistry);
        }

        public static SkillKeyUpdatePush parseDelimitedFrom(InputStream input) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseDelimitedFrom(input);
        }

        public static SkillKeyUpdatePush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static SkillKeyUpdatePush parseFrom(CodedInputStream input) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(input);
        }

        public static SkillKeyUpdatePush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SkillKeyUpdatePush) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(SkillKeyUpdatePush prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements SkillKeysHandler.SkillKeyUpdatePushOrBuilder {
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return SkillKeysHandler.internal_static_pomelo_area_SkillKeyUpdatePush_fieldAccessorTable.ensureFieldAccessorsInitialized(SkillKeysHandler.SkillKeyUpdatePush.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (SkillKeysHandler.SkillKeyUpdatePush.alwaysUseFieldBuilders) getS2CDataFieldBuilder();
            }
            ...
            public SkillKeysHandler.SkillKeyUpdatePush getDefaultInstanceForType() {
                return SkillKeysHandler.SkillKeyUpdatePush.getDefaultInstance();
            }

            public SkillKeysHandler.SkillKeyUpdatePush build() {
                SkillKeysHandler.SkillKeyUpdatePush result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public SkillKeysHandler.SkillKeyUpdatePush buildPartial() {
                SkillKeysHandler.SkillKeyUpdatePush result = new SkillKeysHandler.SkillKeyUpdatePush(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof SkillKeysHandler.SkillKeyUpdatePush)
                    return mergeFrom((SkillKeysHandler.SkillKeyUpdatePush) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(SkillKeysHandler.SkillKeyUpdatePush other) {
                if (other == SkillKeysHandler.SkillKeyUpdatePush.getDefaultInstance()) return this;
                ...
                if (this.s2CDataBuilder_ == null) {
                    ...
                    if (this.s2CDataBuilder_.isEmpty()) {
                        ...
                        this.s2CData_ = other.s2CData_;
                        this.bitField0_ &= 0xFFFFFFFD;
                        this.s2CDataBuilder_ = SkillKeysHandler.SkillKeyUpdatePush.alwaysUseFieldBuilders ? getS2CDataFieldBuilder() : null;
                    } else {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                SkillKeysHandler.SkillKeyUpdatePush parsedMessage = null;
                try {
                    parsedMessage = (SkillKeysHandler.SkillKeyUpdatePush) SkillKeysHandler.SkillKeyUpdatePush.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (SkillKeysHandler.SkillKeyUpdatePush) e.getUnfinishedMessage();
                    throw e;
                } finally {
            ...
            public Common.SkillKeyStruct getS2CData(int index) {
                ...
                return (Common.SkillKeyStruct) this.s2CDataBuilder_.getMessage(index);
            }

            public Builder setS2CData(int index, Common.SkillKeyStruct value) {
                if (this.s2CDataBuilder_ == null) {
            ...
            public Builder setS2CData(int index, Common.SkillKeyStruct.Builder builderForValue) {
                if (this.s2CDataBuilder_ == null) {
                    ensureS2CDataIsMutable();
            ...
            public Builder addS2CData(Common.SkillKeyStruct value) {
                if (this.s2CDataBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureS2CDataIsMutable();
            ...
            public Builder addS2CData(int index, Common.SkillKeyStruct value) {
                if (this.s2CDataBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureS2CDataIsMutable();
            ...
            public Builder addS2CData(Common.SkillKeyStruct.Builder builderForValue) {
                if (this.s2CDataBuilder_ == null) {
                    ensureS2CDataIsMutable();
            ...
            public Builder addS2CData(int index, Common.SkillKeyStruct.Builder builderForValue) {
                if (this.s2CDataBuilder_ == null) {
                    ensureS2CDataIsMutable();
            ...
            public Builder addAllS2CData(Iterable<? extends Common.SkillKeyStruct> values) {
                if (this.s2CDataBuilder_ == null) {
                    ensureS2CDataIsMutable();
            ...
            public Common.SkillKeyStruct.Builder getS2CDataBuilder(int index) {
                return (Common.SkillKeyStruct.Builder) getS2CDataFieldBuilder().getBuilder(index);
            }

            public Common.SkillKeyStructOrBuilder getS2CDataOrBuilder(int index) {
                if (this.s2CDataBuilder_ == null) return (Common.SkillKeyStructOrBuilder) this.s2CData_.get(index);
                return (Common.SkillKeyStructOrBuilder) this.s2CDataBuilder_.getMessageOrBuilder(index);
            }
            ...
            public Common.SkillKeyStruct.Builder addS2CDataBuilder() {
                return (Common.SkillKeyStruct.Builder) getS2CDataFieldBuilder().addBuilder((GeneratedMessage) Common.SkillKeyStruct.getDefaultInstance());
            }

            public Common.SkillKeyStruct.Builder addS2CDataBuilder(int index) {
                return (Common.SkillKeyStruct.Builder) getS2CDataFieldBuilder().addBuilder(index, (GeneratedMessage) Common.SkillKeyStruct.getDefaultInstance());
            }

            public List<Common.SkillKeyStruct.Builder> getS2CDataBuilderList() {
                return getS2CDataFieldBuilder().getBuilderList();
            }

            private RepeatedFieldBuilder<Common.SkillKeyStruct, Common.SkillKeyStruct.Builder, Common.SkillKeyStructOrBuilder> getS2CDataFieldBuilder() {
                if (this.s2CDataBuilder_ == null) {
    ...
    static {
        ...
        Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
            public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root) {
                SkillKeysHandler.descriptor = root;
                return null;
            }
        };
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_area_SkillKey_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SkillKey_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SkillKey_descriptor, new String[]{"KeyPos", "SkillId"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_SaveSkillKeysRequest_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SaveSkillKeysRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SaveSkillKeysRequest_descriptor, new String[]{"S2CSkillKeys"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_SaveSkillKeysResponse_descriptor = getDescriptor().getMessageTypes().get(2);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SaveSkillKeysResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SaveSkillKeysResponse_descriptor, new String[]{"S2CCode", "S2CMsg"});


    private static final Descriptors.Descriptor internal_static_pomelo_area_SkillKeyUpdatePush_descriptor = getDescriptor().getMessageTypes().get(3);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SkillKeyUpdatePush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SkillKeyUpdatePush_descriptor, new String[]{"S2CCode", "S2CData"});
