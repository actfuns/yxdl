...
/*      */   {
/*  317 */     private static final GetGuildShopInfoRequest defaultInstance = new GetGuildShopInfoRequest(true); private final UnknownFieldSet unknownFields; private GetGuildShopInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetGuildShopInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetGuildShopInfoRequest getDefaultInstance() { return defaultInstance; } public GetGuildShopInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetGuildShopInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_GetGuildShopInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_GetGuildShopInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetGuildShopInfoRequest.class, Builder.class); } public static Parser<GetGuildShopInfoRequest> PARSER = (Parser<GetGuildShopInfoRequest>)new AbstractParser<GetGuildShopInfoRequest>() { public GuildShopHandler.GetGuildShopInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.GetGuildShopInfoRequest(input, extensionRegistry); } }
/*  318 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetGuildShopInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*  714 */     private static final ExchangeShopItemRequest defaultInstance = new ExchangeShopItemRequest(true); private final UnknownFieldSet unknownFields; private ExchangeShopItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ExchangeShopItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ExchangeShopItemRequest getDefaultInstance() { return defaultInstance; } public ExchangeShopItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ExchangeShopItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ExchangeShopItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ExchangeShopItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ExchangeShopItemRequest.class, Builder.class); } public static Parser<ExchangeShopItemRequest> PARSER = (Parser<ExchangeShopItemRequest>)new AbstractParser<ExchangeShopItemRequest>() { public GuildShopHandler.ExchangeShopItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ExchangeShopItemRequest(input, extensionRegistry); } }
/*  715 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ExchangeShopItemRequest> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } private void initFields() { this.id_ = 0; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1277 */     private static final ShopMoneyInfo defaultInstance = new ShopMoneyInfo(true); private final UnknownFieldSet unknownFields; private ShopMoneyInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ShopMoneyInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ShopMoneyInfo getDefaultInstance() { return defaultInstance; } public ShopMoneyInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ShopMoneyInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.type_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.value_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ShopMoneyInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ShopMoneyInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(ShopMoneyInfo.class, Builder.class); } public static Parser<ShopMoneyInfo> PARSER = (Parser<ShopMoneyInfo>)new AbstractParser<ShopMoneyInfo>() { public GuildShopHandler.ShopMoneyInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ShopMoneyInfo(input, extensionRegistry); } }
/* 1278 */     ; private int bitField0_; public static final int TYPE_FIELD_NUMBER = 1; private int type_; public static final int VALUE_FIELD_NUMBER = 2; private int value_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ShopMoneyInfo> getParserForType() { return PARSER; } public boolean hasType() { return ((this.bitField0_ & 0x1) == 1); } public int getType() { return this.type_; } public boolean hasValue() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1816 */     private static final ShopCondition defaultInstance = new ShopCondition(true); private final UnknownFieldSet unknownFields; private ShopCondition(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ShopCondition(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ShopCondition getDefaultInstance() { return defaultInstance; } public ShopCondition getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ShopCondition(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.type_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.number_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ShopCondition_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ShopCondition_fieldAccessorTable.ensureFieldAccessorsInitialized(ShopCondition.class, Builder.class); } public static Parser<ShopCondition> PARSER = (Parser<ShopCondition>)new AbstractParser<ShopCondition>() { public GuildShopHandler.ShopCondition parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ShopCondition(input, extensionRegistry); } }
/* 1817 */     ; private int bitField0_; public static final int TYPE_FIELD_NUMBER = 1; private int type_; public static final int NUMBER_FIELD_NUMBER = 2; private int number_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ShopCondition> getParserForType() { return PARSER; } public boolean hasType() { return ((this.bitField0_ & 0x1) == 1); } public int getType() { return this.type_; } public boolean hasNumber() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4122 */     private static final ExchangeItem defaultInstance = new ExchangeItem(true); private final UnknownFieldSet unknownFields; private ExchangeItem(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ExchangeItem(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ExchangeItem getDefaultInstance() { return defaultInstance; } public ExchangeItem getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ExchangeItem(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString byteString1; ItemOuterClass.MiniItem.Builder subBuilder; ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break;case 18: byteString1 = input.readBytes(); this.bitField0_ |= 0x2; this.itemShowName_ = byteString1; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.item_.toBuilder();  this.item_ = (ItemOuterClass.MiniItem)input.readMessage(ItemOuterClass.MiniItem.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.item_); this.item_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break;case 32: this.bitField0_ |= 0x8; this.isBind_ = input.readInt32(); break;case 42: bs = input.readBytes(); this.bitField0_ |= 0x10; this.itemDes_ = bs; break;case 50: if ((mutable_bitField0_ & 0x20) != 32) { this.needMoney_ = new ArrayList<>(); mutable_bitField0_ |= 0x20; }  this.needMoney_.add(input.readMessage(GuildShopHandler.ShopMoneyInfo.PARSER, extensionRegistry)); break;case 56: this.bitField0_ |= 0x20; this.state_ = input.readInt32(); break;case 66: if ((mutable_bitField0_ & 0x80) != 128) { this.condition_ = new ArrayList<>(); mutable_bitField0_ |= 0x80; }  this.condition_.add(input.readMessage(GuildShopHandler.ShopCondition.PARSER, extensionRegistry)); break;case 72: this.bitField0_ |= 0x40; this.meetCondition_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x20) == 32) this.needMoney_ = Collections.unmodifiableList(this.needMoney_);  if ((mutable_bitField0_ & 0x80) == 128) this.condition_ = Collections.unmodifiableList(this.condition_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ExchangeItem_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ExchangeItem_fieldAccessorTable.ensureFieldAccessorsInitialized(ExchangeItem.class, Builder.class); } public static Parser<ExchangeItem> PARSER = (Parser<ExchangeItem>)new AbstractParser<ExchangeItem>() { public GuildShopHandler.ExchangeItem parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ExchangeItem(input, extensionRegistry); } }
/* 4123 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; public static final int ITEMSHOWNAME_FIELD_NUMBER = 2; private Object itemShowName_; public static final int ITEM_FIELD_NUMBER = 3; private ItemOuterClass.MiniItem item_; public static final int ISBIND_FIELD_NUMBER = 4; private int isBind_; public static final int ITEMDES_FIELD_NUMBER = 5; static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 5613 */     private static final ShopInfo defaultInstance = new ShopInfo(true); private final UnknownFieldSet unknownFields; private ShopInfo(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ShopInfo(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ShopInfo getDefaultInstance() { return defaultInstance; } public ShopInfo getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ShopInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int length, limit, tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: if ((mutable_bitField0_ & 0x1) != 1) { this.todayItems_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.todayItems_.add(input.readMessage(GuildShopHandler.ExchangeItem.PARSER, extensionRegistry)); break;case 18: if ((mutable_bitField0_ & 0x2) != 2) { this.nextItems_ = new ArrayList<>(); mutable_bitField0_ |= 0x2; }  this.nextItems_.add(input.readMessage(GuildShopHandler.ExchangeItem.PARSER, extensionRegistry)); break;case 24: if ((mutable_bitField0_ & 0x4) != 4) { this.refreshTime_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.refreshTime_.add(Integer.valueOf(input.readInt32())); break;case 26: length = input.readRawVarint32(); limit = input.pushLimit(length); if ((mutable_bitField0_ & 0x4) != 4 && input.getBytesUntilLimit() > 0) { this.refreshTime_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  while (input.getBytesUntilLimit() > 0) this.refreshTime_.add(Integer.valueOf(input.readInt32()));  input.popLimit(limit); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.todayItems_ = Collections.unmodifiableList(this.todayItems_);  if ((mutable_bitField0_ & 0x2) == 2) this.nextItems_ = Collections.unmodifiableList(this.nextItems_);  if ((mutable_bitField0_ & 0x4) == 4) this.refreshTime_ = Collections.unmodifiableList(this.refreshTime_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ShopInfo_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ShopInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(ShopInfo.class, Builder.class); } public static Parser<ShopInfo> PARSER = (Parser<ShopInfo>)new AbstractParser<ShopInfo>() { public GuildShopHandler.ShopInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ShopInfo(input, extensionRegistry); } }
/* 5614 */     ; public static final int TODAYITEMS_FIELD_NUMBER = 1; private List<GuildShopHandler.ExchangeItem> todayItems_; public static final int NEXTITEMS_FIELD_NUMBER = 2; private List<GuildShopHandler.ExchangeItem> nextItems_; public static final int REFRESHTIME_FIELD_NUMBER = 3; private List<Integer> refreshTime_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ShopInfo> getParserForType() { return PARSER; } public List<GuildShopHandler.ExchangeItem> getTodayItemsList() { return this.todayItems_; } public List<? extends GuildShopHandler.ExchangeItemOrBuilder> getTodayItemsOrBuilderList() { return (List)this.todayItems_; } public int getTodayItemsCount() { return this.todayItems_.size(); } public GuildShopHandler.ExchangeItem getTodayItems(int index) { return this.todayItems_.get(index); } public GuildShopHandler.ExchangeItemOrBuilder getTodayItemsOrBuilder(int index) { return this.todayItems_.get(index); } public List<GuildShopHandler.ExchangeItem> getNextItemsList() { return this.nextItems_; } public List<? extends GuildShopHandler.ExchangeItemOrBuilder> getNextItemsOrBuilderList() { return (List)this.nextItems_; } static { defaultInstance.initFields(); }
/*      */ 
/*      */     
...
/*      */   {
/* 6376 */     private static final GetGuildShopInfoResponse defaultInstance = new GetGuildShopInfoResponse(true); private final UnknownFieldSet unknownFields; private GetGuildShopInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetGuildShopInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetGuildShopInfoResponse getDefaultInstance() { return defaultInstance; } public GetGuildShopInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetGuildShopInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; GuildShopHandler.ShopInfo.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CShopInfo_.toBuilder();  this.s2CShopInfo_ = (GuildShopHandler.ShopInfo)input.readMessage(GuildShopHandler.ShopInfo.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CShopInfo_); this.s2CShopInfo_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_GetGuildShopInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_GetGuildShopInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetGuildShopInfoResponse.class, Builder.class); } public static Parser<GetGuildShopInfoResponse> PARSER = (Parser<GetGuildShopInfoResponse>)new AbstractParser<GetGuildShopInfoResponse>() { public GuildShopHandler.GetGuildShopInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.GetGuildShopInfoResponse(input, extensionRegistry); } }
/* 6377 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_SHOPINFO_FIELD_NUMBER = 3; private GuildShopHandler.ShopInfo s2CShopInfo_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetGuildShopInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 7126 */     private static final ExchangeShopItemResponse defaultInstance = new ExchangeShopItemResponse(true); private final UnknownFieldSet unknownFields; private ExchangeShopItemResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private ExchangeShopItemResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static ExchangeShopItemResponse getDefaultInstance() { return defaultInstance; } public ExchangeShopItemResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private ExchangeShopItemResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.s2CId_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.s2CState_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ExchangeShopItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ExchangeShopItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ExchangeShopItemResponse.class, Builder.class); } public static Parser<ExchangeShopItemResponse> PARSER = (Parser<ExchangeShopItemResponse>)new AbstractParser<ExchangeShopItemResponse>() { public GuildShopHandler.ExchangeShopItemResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new GuildShopHandler.ExchangeShopItemResponse(input, extensionRegistry); } }
/* 7127 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_ID_FIELD_NUMBER = 3; private int s2CId_; public static final int S2C_STATE_FIELD_NUMBER = 4; private int s2CState_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<ExchangeShopItemResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/* 7798 */     private static final ShopRefreshPush defaultInstance = new ShopRefreshPush(true);
/* 7799 */     public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public boolean hasType() { return ((this.bitField0_ & 0x4) == 4); } public int getType() { return this.type_; } private void initFields() { this.s2CCode_ = 0; this.s2CMsg_ = ""; this.type_ = 0; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasS2CCode()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) output.writeBytes(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.type_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.s2CCode_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeBytesSize(2, getS2CMsgBytes());  if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.type_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static ShopRefreshPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (ShopRefreshPush)PARSER.parseFrom(data); } public static ShopRefreshPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ShopRefreshPush)PARSER.parseFrom(data, extensionRegistry); } public static ShopRefreshPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (ShopRefreshPush)PARSER.parseFrom(data); } public static ShopRefreshPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (ShopRefreshPush)PARSER.parseFrom(data, extensionRegistry); } public static ShopRefreshPush parseFrom(InputStream input) throws IOException { return (ShopRefreshPush)PARSER.parseFrom(input); } public static ShopRefreshPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ShopRefreshPush)PARSER.parseFrom(input, extensionRegistry); } public static ShopRefreshPush parseDelimitedFrom(InputStream input) throws IOException { return (ShopRefreshPush)PARSER.parseDelimitedFrom(input); } public static ShopRefreshPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ShopRefreshPush)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static ShopRefreshPush parseFrom(CodedInputStream input) throws IOException { return (ShopRefreshPush)PARSER.parseFrom(input); } public static ShopRefreshPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (ShopRefreshPush)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(ShopRefreshPush prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } static { defaultInstance.initFields(); }
...
/*      */       private Object s2CMsg_;
/*      */       private int type_;
/*      */       public static final Descriptors.Descriptor getDescriptor() { return GuildShopHandler.internal_static_pomelo_area_ShopRefreshPush_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return GuildShopHandler.internal_static_pomelo_area_ShopRefreshPush_fieldAccessorTable.ensureFieldAccessorsInitialized(GuildShopHandler.ShopRefreshPush.class, Builder.class); }
...
/*      */       private void maybeForceBuilderInitialization() { if (GuildShopHandler.ShopRefreshPush.alwaysUseFieldBuilders); }
/*      */       private static Builder create() { return new Builder(); }
/*      */       public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; this.type_ = 0; this.bitField0_ &= 0xFFFFFFFB; return this; }
/*      */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*      */       public Descriptors.Descriptor getDescriptorForType() { return GuildShopHandler.internal_static_pomelo_area_ShopRefreshPush_descriptor; }
/*      */       public GuildShopHandler.ShopRefreshPush getDefaultInstanceForType() { return GuildShopHandler.ShopRefreshPush.getDefaultInstance(); }
/*      */       public GuildShopHandler.ShopRefreshPush build() { GuildShopHandler.ShopRefreshPush result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; }
/*      */       public GuildShopHandler.ShopRefreshPush buildPartial() { GuildShopHandler.ShopRefreshPush result = new GuildShopHandler.ShopRefreshPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
...
/*      */           to_bitField0_ |= 0x4;  result.type_ = this.type_; result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*      */       public Builder mergeFrom(Message other) { if (other instanceof GuildShopHandler.ShopRefreshPush)
/*      */           return mergeFrom((GuildShopHandler.ShopRefreshPush)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(GuildShopHandler.ShopRefreshPush other) { if (other == GuildShopHandler.ShopRefreshPush.getDefaultInstance())
...
/*      */          if (other.hasType())
/*      */           setType(other.getType());  mergeUnknownFields(other.getUnknownFields()); return this; }
/*      */       public final boolean isInitialized() { if (!hasS2CCode())
/*      */           return false;  return true; }
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { GuildShopHandler.ShopRefreshPush parsedMessage = null; try { parsedMessage = (GuildShopHandler.ShopRefreshPush)GuildShopHandler.ShopRefreshPush.PARSER.parsePartialFrom(input, extensionRegistry); }
/*      */         catch (InvalidProtocolBufferException e)
/*      */         { parsedMessage = (GuildShopHandler.ShopRefreshPush)e.getUnfinishedMessage(); throw e; }
/*      */         finally
/*      */         { if (parsedMessage != null)
/*      */             mergeFrom(parsedMessage);  }
/*      */          return this; }
...
/*      */ 
/*      */     
/* 7890 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 7894 */           GuildShopHandler.descriptor = root;
/* 7895 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 7899 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 7901 */           ItemOuterClass.getDescriptor(), 
/* 7902 */           Common.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 7905 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetGuildShopInfoRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 7906 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetGuildShopInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetGuildShopInfoRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7911 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ExchangeShopItemRequest_descriptor = getDescriptor().getMessageTypes().get(1);
/* 7912 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ExchangeShopItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ExchangeShopItemRequest_descriptor, new String[] { "Id" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7917 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ShopMoneyInfo_descriptor = getDescriptor().getMessageTypes().get(2);
/* 7918 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ShopMoneyInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ShopMoneyInfo_descriptor, new String[] { "Type", "Value" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7923 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ShopCondition_descriptor = getDescriptor().getMessageTypes().get(3);
/* 7924 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ShopCondition_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ShopCondition_descriptor, new String[] { "Type", "Number" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7929 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ExchangeItem_descriptor = getDescriptor().getMessageTypes().get(4);
/* 7930 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ExchangeItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ExchangeItem_descriptor, new String[] { "Id", "ItemShowName", "Item", "IsBind", "ItemDes", "NeedMoney", "State", "Condition", "MeetCondition" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7935 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ShopInfo_descriptor = getDescriptor().getMessageTypes().get(5);
/* 7936 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ShopInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ShopInfo_descriptor, new String[] { "TodayItems", "NextItems", "RefreshTime" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7941 */   private static final Descriptors.Descriptor internal_static_pomelo_area_GetGuildShopInfoResponse_descriptor = getDescriptor().getMessageTypes().get(6);
/* 7942 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_GetGuildShopInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_GetGuildShopInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CShopInfo" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7947 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ExchangeShopItemResponse_descriptor = getDescriptor().getMessageTypes().get(7);
/* 7948 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ExchangeShopItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ExchangeShopItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CId", "S2CState" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 7953 */   private static final Descriptors.Descriptor internal_static_pomelo_area_ShopRefreshPush_descriptor = getDescriptor().getMessageTypes().get(8);
/* 7954 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_ShopRefreshPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_ShopRefreshPush_descriptor, new String[] { "S2CCode", "S2CMsg", "Type" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 7958 */     ItemOuterClass.getDescriptor();
/* 7959 */     Common.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\GuildShopHandler.class
