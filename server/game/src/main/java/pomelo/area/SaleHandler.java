...
/* 1339 */     private static final BuyItem defaultInstance = new BuyItem(true); public static final int ITEM_FIELD_NUMBER = 4; private ItemOuterClass.MiniItem item_; public static final int MONEYTYPE_FIELD_NUMBER = 5; private int moneyType_; public static final int NEEDMONEY_FIELD_NUMBER = 6; private int needMoney_; public static final int MAXGROUPCOUNT_FIELD_NUMBER = 7; private int maxGroupCount_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BuyItem> getParserForType() { return PARSER; } public boolean hasTypeId() { return ((this.bitField0_ & 0x1) == 1); } public int getTypeId() { return this.typeId_; } public boolean hasItemId() { return ((this.bitField0_ & 0x2) == 2); } public int getItemId() { return this.itemId_; }
/* 1340 */     static { defaultInstance.initFields(); }
/*      */     
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements SaleHandler.BuyItemOrBuilder { private int bitField0_; private int typeId_; private int itemId_; private Object itemShowName_; private ItemOuterClass.MiniItem item_; private SingleFieldBuilder<ItemOuterClass.MiniItem, ItemOuterClass.MiniItem.Builder, ItemOuterClass.MiniItemOrBuilder> itemBuilder_; private int moneyType_; private int needMoney_; private int maxGroupCount_;
/*      */       public static final Descriptors.Descriptor getDescriptor() {
/*      */         return SaleHandler.internal_static_pomelo_area_BuyItem_descriptor;
/*      */       }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
...
/*      */       } } }
/*      */   
/* 1894 */   public static final class SellGrid extends GeneratedMessage implements SellGridOrBuilder { private static final SellGrid defaultInstance = new SellGrid(true); private final UnknownFieldSet unknownFields; private SellGrid(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SellGrid(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SellGrid getDefaultInstance() { return defaultInstance; } public SellGrid getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SellGrid(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.index_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.num_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_SellGrid_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_SellGrid_fieldAccessorTable.ensureFieldAccessorsInitialized(SellGrid.class, Builder.class); } public static Parser<SellGrid> PARSER = (Parser<SellGrid>)new AbstractParser<SellGrid>() { public SaleHandler.SellGrid parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.SellGrid(input, extensionRegistry); } }
/* 1895 */     ; private int bitField0_; public static final int INDEX_FIELD_NUMBER = 1; private int index_; public static final int NUM_FIELD_NUMBER = 2; private int num_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SellGrid> getParserForType() { return PARSER; } public boolean hasIndex() { return ((this.bitField0_ & 0x1) == 1); } public int getIndex() { return this.index_; } public boolean hasNum() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2373 */     private static final BuyPageRequest defaultInstance = new BuyPageRequest(true); private final UnknownFieldSet unknownFields; private BuyPageRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BuyPageRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BuyPageRequest getDefaultInstance() { return defaultInstance; } public BuyPageRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BuyPageRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int length, limit, tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: if ((mutable_bitField0_ & 0x1) != 1) { this.c2SSellIndex_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.c2SSellIndex_.add(Integer.valueOf(input.readInt32())); break;case 10: length = input.readRawVarint32(); limit = input.pushLimit(length); if ((mutable_bitField0_ & 0x1) != 1 && input.getBytesUntilLimit() > 0) { this.c2SSellIndex_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  while (input.getBytesUntilLimit() > 0) this.c2SSellIndex_.add(Integer.valueOf(input.readInt32()));  input.popLimit(limit); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.c2SSellIndex_ = Collections.unmodifiableList(this.c2SSellIndex_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_BuyPageRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_BuyPageRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BuyPageRequest.class, Builder.class); } public static Parser<BuyPageRequest> PARSER = (Parser<BuyPageRequest>)new AbstractParser<BuyPageRequest>() { public SaleHandler.BuyPageRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.BuyPageRequest(input, extensionRegistry); } }
/* 2374 */     ; public static final int C2S_SELLINDEX_FIELD_NUMBER = 1; private List<Integer> c2SSellIndex_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BuyPageRequest> getParserForType() { return PARSER; } public List<Integer> getC2SSellIndexList() { return this.c2SSellIndex_; } public int getC2SSellIndexCount() { return this.c2SSellIndex_.size(); } public int getC2SSellIndex(int index) { return ((Integer)this.c2SSellIndex_.get(index)).intValue(); } private void initFields() { this.c2SSellIndex_ = Collections.emptyList(); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 3419 */     private static final BuyPageResponse defaultInstance = new BuyPageResponse(true); private final UnknownFieldSet unknownFields; private BuyPageResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BuyPageResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BuyPageResponse getDefaultInstance() { return defaultInstance; } public BuyPageResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BuyPageResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CBuyItems_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CBuyItems_.add(input.readMessage(SaleHandler.BuyItem.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CBuyItems_ = Collections.unmodifiableList(this.s2CBuyItems_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_BuyPageResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_BuyPageResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(BuyPageResponse.class, Builder.class); } public static Parser<BuyPageResponse> PARSER = (Parser<BuyPageResponse>)new AbstractParser<BuyPageResponse>() { public SaleHandler.BuyPageResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.BuyPageResponse(input, extensionRegistry); } }
/* 3420 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 4100 */     private static final BuyItemRequest defaultInstance = new BuyItemRequest(true); private final UnknownFieldSet unknownFields; private BuyItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BuyItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BuyItemRequest getDefaultInstance() { return defaultInstance; } public BuyItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BuyItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2STypeId_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SItemId_ = input.readInt32(); break;case 24: this.bitField0_ |= 0x4; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_BuyItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_BuyItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BuyItemRequest.class, Builder.class); } public static Parser<BuyItemRequest> PARSER = (Parser<BuyItemRequest>)new AbstractParser<BuyItemRequest>() { public SaleHandler.BuyItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.BuyItemRequest(input, extensionRegistry); } }
/* 4101 */     ; private int bitField0_; public static final int C2S_TYPEID_FIELD_NUMBER = 1; private int c2STypeId_; public static final int C2S_ITEMID_FIELD_NUMBER = 2; private int c2SItemId_; public static final int C2S_NUM_FIELD_NUMBER = 3; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BuyItemRequest> getParserForType() { return PARSER; } public boolean hasC2STypeId() { return ((this.bitField0_ & 0x1) == 1); } public int getC2STypeId() { return this.c2STypeId_; } public boolean hasC2SItemId() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 4662 */     private static final BuyItemResponse defaultInstance = new BuyItemResponse(true); private final UnknownFieldSet unknownFields; private BuyItemResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BuyItemResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BuyItemResponse getDefaultInstance() { return defaultInstance; } public BuyItemResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BuyItemResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_BuyItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_BuyItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(BuyItemResponse.class, Builder.class); } public static Parser<BuyItemResponse> PARSER = (Parser<BuyItemResponse>)new AbstractParser<BuyItemResponse>() { public SaleHandler.BuyItemResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.BuyItemResponse(input, extensionRegistry); } }
/* 4663 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BuyItemResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5527 */     private static final AutoBuyItemByCodeRequest defaultInstance = new AutoBuyItemByCodeRequest(true); private final UnknownFieldSet unknownFields; private AutoBuyItemByCodeRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AutoBuyItemByCodeRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AutoBuyItemByCodeRequest getDefaultInstance() { return defaultInstance; } public AutoBuyItemByCodeRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AutoBuyItemByCodeRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int length; ByteString bs; int limit, tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: if ((mutable_bitField0_ & 0x1) != 1) { this.c2STypeId_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.c2STypeId_.add(Integer.valueOf(input.readInt32())); break;case 10: length = input.readRawVarint32(); limit = input.pushLimit(length); if ((mutable_bitField0_ & 0x1) != 1 && input.getBytesUntilLimit() > 0) { this.c2STypeId_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  while (input.getBytesUntilLimit() > 0) this.c2STypeId_.add(Integer.valueOf(input.readInt32()));  input.popLimit(limit); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x1; this.c2SItemCode_ = bs; break;case 24: this.bitField0_ |= 0x2; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.c2STypeId_ = Collections.unmodifiableList(this.c2STypeId_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_AutoBuyItemByCodeRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_AutoBuyItemByCodeRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(AutoBuyItemByCodeRequest.class, Builder.class); } public static Parser<AutoBuyItemByCodeRequest> PARSER = (Parser<AutoBuyItemByCodeRequest>)new AbstractParser<AutoBuyItemByCodeRequest>() { public SaleHandler.AutoBuyItemByCodeRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.AutoBuyItemByCodeRequest(input, extensionRegistry); } }
/* 5528 */     ; private int bitField0_; public static final int C2S_TYPEID_FIELD_NUMBER = 1; private List<Integer> c2STypeId_; public static final int C2S_ITEMCODE_FIELD_NUMBER = 2; private Object c2SItemCode_; public static final int C2S_NUM_FIELD_NUMBER = 3; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AutoBuyItemByCodeRequest> getParserForType() { return PARSER; } public List<Integer> getC2STypeIdList() { return this.c2STypeId_; } public int getC2STypeIdCount() { return this.c2STypeId_.size(); } public int getC2STypeId(int index) { return ((Integer)this.c2STypeId_.get(index)).intValue(); } public boolean hasC2SItemCode() { return ((this.bitField0_ & 0x1) == 1); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 6309 */     private static final AutoBuyItemByCodeResponse defaultInstance = new AutoBuyItemByCodeResponse(true); private final UnknownFieldSet unknownFields; private AutoBuyItemByCodeResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AutoBuyItemByCodeResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AutoBuyItemByCodeResponse getDefaultInstance() { return defaultInstance; } public AutoBuyItemByCodeResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AutoBuyItemByCodeResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 24: this.bitField0_ |= 0x4; this.s2CNotEnoughGold_ = input.readInt32(); break;case 32: this.bitField0_ |= 0x8; this.s2CNeedGold_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_AutoBuyItemByCodeResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_AutoBuyItemByCodeResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(AutoBuyItemByCodeResponse.class, Builder.class); } public static Parser<AutoBuyItemByCodeResponse> PARSER = (Parser<AutoBuyItemByCodeResponse>)new AbstractParser<AutoBuyItemByCodeResponse>() { public SaleHandler.AutoBuyItemByCodeResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.AutoBuyItemByCodeResponse(input, extensionRegistry); } }
/* 6310 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_NOTENOUGHGOLD_FIELD_NUMBER = 3; private int s2CNotEnoughGold_; public static final int S2C_NEEDGOLD_FIELD_NUMBER = 4; private int s2CNeedGold_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AutoBuyItemByCodeResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 7117 */     private static final SellItemsRequest defaultInstance = new SellItemsRequest(true); private final UnknownFieldSet unknownFields; private SellItemsRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SellItemsRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SellItemsRequest getDefaultInstance() { return defaultInstance; } public SellItemsRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SellItemsRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: if ((mutable_bitField0_ & 0x1) != 1) { this.c2SSellGrids_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.c2SSellGrids_.add(input.readMessage(SaleHandler.SellGrid.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.c2SSellGrids_ = Collections.unmodifiableList(this.c2SSellGrids_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_SellItemsRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_SellItemsRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(SellItemsRequest.class, Builder.class); } public static Parser<SellItemsRequest> PARSER = (Parser<SellItemsRequest>)new AbstractParser<SellItemsRequest>() { public SaleHandler.SellItemsRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.SellItemsRequest(input, extensionRegistry); } }
/* 7118 */     ; public static final int C2S_SELLGRIDS_FIELD_NUMBER = 1; private List<SaleHandler.SellGrid> c2SSellGrids_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SellItemsRequest> getParserForType() { return PARSER; } public List<SaleHandler.SellGrid> getC2SSellGridsList() { return this.c2SSellGrids_; } public List<? extends SaleHandler.SellGridOrBuilder> getC2SSellGridsOrBuilderList() { return (List)this.c2SSellGrids_; } public int getC2SSellGridsCount() { return this.c2SSellGrids_.size(); } public SaleHandler.SellGrid getC2SSellGrids(int index) { return this.c2SSellGrids_.get(index); } public SaleHandler.SellGridOrBuilder getC2SSellGridsOrBuilder(int index) { return this.c2SSellGrids_.get(index); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 7679 */     private static final SellItemsResponse defaultInstance = new SellItemsResponse(true); private final UnknownFieldSet unknownFields; private SellItemsResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SellItemsResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SellItemsResponse getDefaultInstance() { return defaultInstance; } public SellItemsResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SellItemsResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_SellItemsResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_SellItemsResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(SellItemsResponse.class, Builder.class); } public static Parser<SellItemsResponse> PARSER = (Parser<SellItemsResponse>)new AbstractParser<SellItemsResponse>() { public SaleHandler.SellItemsResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.SellItemsResponse(input, extensionRegistry); } }
/* 7680 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SellItemsResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 8242 */     private static final RebuyItemRequest defaultInstance = new RebuyItemRequest(true); private final UnknownFieldSet unknownFields; private RebuyItemRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private RebuyItemRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static RebuyItemRequest getDefaultInstance() { return defaultInstance; } public RebuyItemRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private RebuyItemRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SGridIndex_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.c2SNum_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_RebuyItemRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_RebuyItemRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RebuyItemRequest.class, Builder.class); } public static Parser<RebuyItemRequest> PARSER = (Parser<RebuyItemRequest>)new AbstractParser<RebuyItemRequest>() { public SaleHandler.RebuyItemRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new SaleHandler.RebuyItemRequest(input, extensionRegistry); } }
/* 8243 */     ; private int bitField0_; public static final int C2S_GRIDINDEX_FIELD_NUMBER = 1; private int c2SGridIndex_; public static final int C2S_NUM_FIELD_NUMBER = 2; private int c2SNum_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<RebuyItemRequest> getParserForType() { return PARSER; } public boolean hasC2SGridIndex() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SGridIndex() { return this.c2SGridIndex_; } public boolean hasC2SNum() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */     
/*      */     public int getC2SNum() {
...
/*      */     }
/*      */     
/* 8804 */     private static final RebuyItemResponse defaultInstance = new RebuyItemResponse(true); public static RebuyItemResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (RebuyItemResponse)PARSER.parseFrom(data, extensionRegistry); } public static RebuyItemResponse parseFrom(byte[] data) throws InvalidProtocolBufferException { return (RebuyItemResponse)PARSER.parseFrom(data); } public static RebuyItemResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (RebuyItemResponse)PARSER.parseFrom(data, extensionRegistry); } public static RebuyItemResponse parseFrom(InputStream input) throws IOException { return (RebuyItemResponse)PARSER.parseFrom(input); } public static RebuyItemResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RebuyItemResponse)PARSER.parseFrom(input, extensionRegistry); } public static RebuyItemResponse parseDelimitedFrom(InputStream input) throws IOException { return (RebuyItemResponse)PARSER.parseDelimitedFrom(input); } public static RebuyItemResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RebuyItemResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static RebuyItemResponse parseFrom(CodedInputStream input) throws IOException { return (RebuyItemResponse)PARSER.parseFrom(input); } public static RebuyItemResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RebuyItemResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(RebuyItemResponse prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent);
/* 8805 */       return builder; } static { defaultInstance.initFields(); } public static final class Builder extends GeneratedMessage.Builder<Builder> implements SaleHandler.RebuyItemResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; public static final Descriptors.Descriptor getDescriptor() { return SaleHandler.internal_static_pomelo_area_RebuyItemResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return SaleHandler.internal_static_pomelo_area_RebuyItemResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(SaleHandler.RebuyItemResponse.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (SaleHandler.RebuyItemResponse.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return SaleHandler.internal_static_pomelo_area_RebuyItemResponse_descriptor; } public SaleHandler.RebuyItemResponse getDefaultInstanceForType() { return SaleHandler.RebuyItemResponse.getDefaultInstance(); } public SaleHandler.RebuyItemResponse build() { SaleHandler.RebuyItemResponse result = buildPartial(); if (!result.isInitialized())
/*      */           throw newUninitializedMessageException(result);  return result; } public SaleHandler.RebuyItemResponse buildPartial() { SaleHandler.RebuyItemResponse result = new SaleHandler.RebuyItemResponse(this); int from_bitField0_ = this.bitField0_;
/*      */         int to_bitField0_ = 0;
/*      */         if ((from_bitField0_ & 0x1) == 1)
/*      */           to_bitField0_ |= 0x1; 
/*      */         result.s2CCode_ = this.s2CCode_;
...
/*      */         result.bitField0_ = to_bitField0_;
/*      */         onBuilt();
/*      */         return result; } public Builder mergeFrom(Message other) { if (other instanceof SaleHandler.RebuyItemResponse)
/*      */           return mergeFrom((SaleHandler.RebuyItemResponse)other); 
/*      */         super.mergeFrom(other);
/*      */         return this; } public Builder mergeFrom(SaleHandler.RebuyItemResponse other) { if (other == SaleHandler.RebuyItemResponse.getDefaultInstance())
/*      */           return this; 
/*      */         if (other.hasS2CCode())
/*      */           setS2CCode(other.getS2CCode()); 
/*      */         if (other.hasS2CMsg()) {
...
/*      */           return false; 
/*      */         return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { SaleHandler.RebuyItemResponse parsedMessage = null;
/*      */         try {
...
/*      */ 
/*      */     
/* 8916 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 8920 */           SaleHandler.descriptor = root;
/* 8921 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 8925 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 8927 */           ItemOuterClass.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 8930 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyItem_descriptor = getDescriptor().getMessageTypes().get(0);
/* 8931 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyItem_descriptor, new String[] { "TypeId", "ItemId", "ItemShowName", "Item", "MoneyType", "NeedMoney", "MaxGroupCount" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8936 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SellGrid_descriptor = getDescriptor().getMessageTypes().get(1);
/* 8937 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SellGrid_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SellGrid_descriptor, new String[] { "Index", "Num" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8942 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyPageRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 8943 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyPageRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyPageRequest_descriptor, new String[] { "C2SSellIndex" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8948 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyPageResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 8949 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyPageResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyPageResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CBuyItems" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8954 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyItemRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 8955 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyItemRequest_descriptor, new String[] { "C2STypeId", "C2SItemId", "C2SNum" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8960 */   private static final Descriptors.Descriptor internal_static_pomelo_area_BuyItemResponse_descriptor = getDescriptor().getMessageTypes().get(5);
/* 8961 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_BuyItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_BuyItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8966 */   private static final Descriptors.Descriptor internal_static_pomelo_area_AutoBuyItemByCodeRequest_descriptor = getDescriptor().getMessageTypes().get(6);
/* 8967 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_AutoBuyItemByCodeRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_AutoBuyItemByCodeRequest_descriptor, new String[] { "C2STypeId", "C2SItemCode", "C2SNum" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8972 */   private static final Descriptors.Descriptor internal_static_pomelo_area_AutoBuyItemByCodeResponse_descriptor = getDescriptor().getMessageTypes().get(7);
/* 8973 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_AutoBuyItemByCodeResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_AutoBuyItemByCodeResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CNotEnoughGold", "S2CNeedGold" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8978 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SellItemsRequest_descriptor = getDescriptor().getMessageTypes().get(8);
/* 8979 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SellItemsRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SellItemsRequest_descriptor, new String[] { "C2SSellGrids" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8984 */   private static final Descriptors.Descriptor internal_static_pomelo_area_SellItemsResponse_descriptor = getDescriptor().getMessageTypes().get(9);
/* 8985 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_SellItemsResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_SellItemsResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8990 */   private static final Descriptors.Descriptor internal_static_pomelo_area_RebuyItemRequest_descriptor = getDescriptor().getMessageTypes().get(10);
/* 8991 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_RebuyItemRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_RebuyItemRequest_descriptor, new String[] { "C2SGridIndex", "C2SNum" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 8996 */   private static final Descriptors.Descriptor internal_static_pomelo_area_RebuyItemResponse_descriptor = getDescriptor().getMessageTypes().get(11);
/* 8997 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_area_RebuyItemResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_area_RebuyItemResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 9001 */     ItemOuterClass.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\area\SaleHandler.class
