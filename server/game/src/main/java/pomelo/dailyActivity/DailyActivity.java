...
public final class DailyActivity {
    ...
    public static final class DailyInfo
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 16:
                            this.bitField0_ |= 0x2;
                            this.curNum_ = input.readInt32();
                            break;
                        case 24:
                            this.bitField0_ |= 0x4;
                            this.maxNum_ = input.readInt32();
                            break;
                        case 32:
                            this.bitField0_ |= 0x8;
                            this.perDegree_ = input.readInt32();
                            break;
                        case 40:
                ...
                if ((mutable_bitField0_ & 0x80) == 128) this.awardItem_ = Collections.unmodifiableList(this.awardItem_);
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return DailyActivity.internal_static_pomelo_dailyActivity_DailyInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(DailyInfo.class, Builder.class);
        }

        public static Parser<DailyInfo> PARSER = (Parser<DailyInfo>) new AbstractParser<DailyInfo>() {
            public DailyActivity.DailyInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new DailyActivity.DailyInfo(input, extensionRegistry);
            }
        };
    ...
    public static final class DegreeInfo
        ...
        private static final DegreeInfo defaultInstance = new DegreeInfo(true);
        private final UnknownFieldSet unknownFields;

        private DegreeInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private DegreeInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private DegreeInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 16:
                            this.bitField0_ |= 0x2;
                            this.needDegree_ = input.readInt32();
                            break;
                        case 24:
                            this.bitField0_ |= 0x4;
                ...
                if ((mutable_bitField0_ & 0x8) == 8) this.awardItem_ = Collections.unmodifiableList(this.awardItem_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return DailyActivity.internal_static_pomelo_dailyActivity_DegreeInfo_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return DailyActivity.internal_static_pomelo_dailyActivity_DegreeInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(DegreeInfo.class, Builder.class);
        }

        public static Parser<DegreeInfo> PARSER = (Parser<DegreeInfo>) new AbstractParser<DegreeInfo>() {
            public DailyActivity.DegreeInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new DailyActivity.DegreeInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int ID_FIELD_NUMBER = 1;
        ...
        public Parser<DegreeInfo> getParserForType() {
            return PARSER;
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.needDegree_);
            if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.state_);
            for (int i = 0; i < this.awardItem_.size(); i++)
                output.writeMessage(4, (MessageLite) this.awardItem_.get(i));
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.needDegree_);
            if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.state_);
            for (int i = 0; i < this.awardItem_.size(); i++)
                size += CodedOutputStream.computeMessageSize(4, (MessageLite) this.awardItem_.get(i));
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public static DegreeInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (DegreeInfo) PARSER.parseFrom(data);
        }

        public static DegreeInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (DegreeInfo) PARSER.parseFrom(data, extensionRegistry);
        }
        ...
        public static DegreeInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (DegreeInfo) PARSER.parseFrom(data);
        }

        public static DegreeInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (DegreeInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static DegreeInfo parseFrom(InputStream input) throws IOException {
            return (DegreeInfo) PARSER.parseFrom(input);
        }

        public static DegreeInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (DegreeInfo) PARSER.parseFrom(input, extensionRegistry);
        }

        public static DegreeInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (DegreeInfo) PARSER.parseDelimitedFrom(input);
        }

        public static DegreeInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (DegreeInfo) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static DegreeInfo parseFrom(CodedInputStream input) throws IOException {
            return (DegreeInfo) PARSER.parseFrom(input);
        }

        public static DegreeInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (DegreeInfo) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(DegreeInfo prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements DailyActivity.DegreeInfoOrBuilder {
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DailyActivity.internal_static_pomelo_dailyActivity_DegreeInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(DailyActivity.DegreeInfo.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (DailyActivity.DegreeInfo.alwaysUseFieldBuilders) getAwardItemFieldBuilder();
            }
            ...
            public DailyActivity.DegreeInfo getDefaultInstanceForType() {
                return DailyActivity.DegreeInfo.getDefaultInstance();
            }

            public DailyActivity.DegreeInfo build() {
                DailyActivity.DegreeInfo result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public DailyActivity.DegreeInfo buildPartial() {
                DailyActivity.DegreeInfo result = new DailyActivity.DegreeInfo(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
                result.id_ = this.id_;
                if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;
                result.needDegree_ = this.needDegree_;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof DailyActivity.DegreeInfo) return mergeFrom((DailyActivity.DegreeInfo) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(DailyActivity.DegreeInfo other) {
                if (other == DailyActivity.DegreeInfo.getDefaultInstance()) return this;
                if (other.hasId()) setId(other.getId());
                if (other.hasNeedDegree()) setNeedDegree(other.getNeedDegree());
                ...
                if (this.awardItemBuilder_ == null) {
                    ...
                    if (this.awardItemBuilder_.isEmpty()) {
                        ...
                        this.awardItem_ = other.awardItem_;
                        this.bitField0_ &= 0xFFFFFFF7;
                        this.awardItemBuilder_ = DailyActivity.DegreeInfo.alwaysUseFieldBuilders ? getAwardItemFieldBuilder() : null;
                    } else {
                        this.awardItemBuilder_.addAllMessages(other.awardItem_);
                    }
                }
            ...
            public final boolean isInitialized() {
                ...
                for (int i = 0; i < getAwardItemCount(); i++) {
                    if (!getAwardItem(i).isInitialized()) return false;
                }
                return true;
            }

            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                DailyActivity.DegreeInfo parsedMessage = null;
                try {
                    parsedMessage = (DailyActivity.DegreeInfo) DailyActivity.DegreeInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (DailyActivity.DegreeInfo) e.getUnfinishedMessage();
                    throw e;
                } finally {
            ...
            public List<ItemOuterClass.ItemDetail> getAwardItemList() {
                if (this.awardItemBuilder_ == null) return Collections.unmodifiableList(this.awardItem_);
                return this.awardItemBuilder_.getMessageList();
            }

            public int getAwardItemCount() {
                if (this.awardItemBuilder_ == null) return this.awardItem_.size();
                return this.awardItemBuilder_.getCount();
            }

            public ItemOuterClass.ItemDetail getAwardItem(int index) {
                if (this.awardItemBuilder_ == null) return this.awardItem_.get(index);
                return (ItemOuterClass.ItemDetail) this.awardItemBuilder_.getMessage(index);
            }
            ...
            public List<? extends ItemOuterClass.ItemDetailOrBuilder> getAwardItemOrBuilderList() {
                if (this.awardItemBuilder_ != null) return this.awardItemBuilder_.getMessageOrBuilderList();
                return (List) Collections.unmodifiableList(this.awardItem_);
            }
            ...
            private RepeatedFieldBuilder<ItemOuterClass.ItemDetail, ItemOuterClass.ItemDetail.Builder, ItemOuterClass.ItemDetailOrBuilder> getAwardItemFieldBuilder() {
                if (this.awardItemBuilder_ == null) {
                    this.awardItemBuilder_ = new RepeatedFieldBuilder(this.awardItem_, ((this.bitField0_ & 0x8) == 8), getParentForChildren(), isClean());
                    this.awardItem_ = null;
                }
                return this.awardItemBuilder_;
            }
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_dailyActivity_DailyInfo_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_dailyActivity_DailyInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_dailyActivity_DailyInfo_descriptor, new String[]{"Id", "CurNum", "MaxNum", "PerDegree", "LvLimit", "OpenPeriod", "IsOver", "AwardItem"});


    private static final Descriptors.Descriptor internal_static_pomelo_dailyActivity_DegreeInfo_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_dailyActivity_DegreeInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_dailyActivity_DegreeInfo_descriptor, new String[]{"Id", "NeedDegree", "State", "AwardItem"});
