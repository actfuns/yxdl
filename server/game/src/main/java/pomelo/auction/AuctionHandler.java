...
/*       */   {
/*   325 */     private static final SyncAuctionInfoRequest defaultInstance = new SyncAuctionInfoRequest(true); private final UnknownFieldSet unknownFields; private SyncAuctionInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SyncAuctionInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SyncAuctionInfoRequest getDefaultInstance() { return defaultInstance; } public SyncAuctionInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SyncAuctionInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_SyncAuctionInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_SyncAuctionInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(SyncAuctionInfoRequest.class, Builder.class); } public static Parser<SyncAuctionInfoRequest> PARSER = (Parser<SyncAuctionInfoRequest>)new AbstractParser<SyncAuctionInfoRequest>() { public AuctionHandler.SyncAuctionInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.SyncAuctionInfoRequest(input, extensionRegistry); } }
/*   326 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SyncAuctionInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*   895 */     private static final SyncAuctionInfoResponse defaultInstance = new SyncAuctionInfoResponse(true); private final UnknownFieldSet unknownFields; private SyncAuctionInfoResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private SyncAuctionInfoResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static SyncAuctionInfoResponse getDefaultInstance() { return defaultInstance; } public SyncAuctionInfoResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private SyncAuctionInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_SyncAuctionInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_SyncAuctionInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(SyncAuctionInfoResponse.class, Builder.class); } public static Parser<SyncAuctionInfoResponse> PARSER = (Parser<SyncAuctionInfoResponse>)new AbstractParser<SyncAuctionInfoResponse>() { public AuctionHandler.SyncAuctionInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.SyncAuctionInfoResponse(input, extensionRegistry); } }
/*   896 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<SyncAuctionInfoResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } static { defaultInstance.initFields(); }
/*       */ 
/*       */     
...
/*       */     }
/*       */     
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.SyncAuctionInfoResponseOrBuilder { private int bitField0_;
...
/*       */   }
/*       */   
/*  1216 */   public static final class CancelSyncAuctionInfoRequest extends GeneratedMessage implements CancelSyncAuctionInfoRequestOrBuilder { private static final CancelSyncAuctionInfoRequest defaultInstance = new CancelSyncAuctionInfoRequest(true); private final UnknownFieldSet unknownFields; private CancelSyncAuctionInfoRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private CancelSyncAuctionInfoRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static CancelSyncAuctionInfoRequest getDefaultInstance() { return defaultInstance; } public CancelSyncAuctionInfoRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private CancelSyncAuctionInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_CancelSyncAuctionInfoRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_CancelSyncAuctionInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(CancelSyncAuctionInfoRequest.class, Builder.class); } public static Parser<CancelSyncAuctionInfoRequest> PARSER = (Parser<CancelSyncAuctionInfoRequest>)new AbstractParser<CancelSyncAuctionInfoRequest>() { public AuctionHandler.CancelSyncAuctionInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.CancelSyncAuctionInfoRequest(input, extensionRegistry); } }
/*  1217 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<CancelSyncAuctionInfoRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */ 
/*       */     
/*  1786 */     private static final CancelSyncAuctionInfoResponse defaultInstance = new CancelSyncAuctionInfoResponse(true); public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(CancelSyncAuctionInfoResponse prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.CancelSyncAuctionInfoResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionHandler.CancelSyncAuctionInfoResponse.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (AuctionHandler.CancelSyncAuctionInfoResponse.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return AuctionHandler.internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_descriptor; } public AuctionHandler.CancelSyncAuctionInfoResponse getDefaultInstanceForType() { return AuctionHandler.CancelSyncAuctionInfoResponse.getDefaultInstance(); } public AuctionHandler.CancelSyncAuctionInfoResponse build() { AuctionHandler.CancelSyncAuctionInfoResponse result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public AuctionHandler.CancelSyncAuctionInfoResponse buildPartial() { AuctionHandler.CancelSyncAuctionInfoResponse result = new AuctionHandler.CancelSyncAuctionInfoResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.s2CCode_ = this.s2CCode_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.s2CMsg_ = this.s2CMsg_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof AuctionHandler.CancelSyncAuctionInfoResponse) return mergeFrom((AuctionHandler.CancelSyncAuctionInfoResponse)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(AuctionHandler.CancelSyncAuctionInfoResponse other) { if (other == AuctionHandler.CancelSyncAuctionInfoResponse.getDefaultInstance()) return this;  if (other.hasS2CCode()) setS2CCode(other.getS2CCode());  if (other.hasS2CMsg()) { this.bitField0_ |= 0x2; this.s2CMsg_ = other.s2CMsg_; onChanged(); }  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CCode()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { AuctionHandler.CancelSyncAuctionInfoResponse parsedMessage = null; try { parsedMessage = (AuctionHandler.CancelSyncAuctionInfoResponse)AuctionHandler.CancelSyncAuctionInfoResponse.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (AuctionHandler.CancelSyncAuctionInfoResponse)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public Builder setS2CCode(int value) { this.bitField0_ |= 0x1; this.s2CCode_ = value; onChanged(); return this; } public Builder clearS2CCode() { this.bitField0_ &= 0xFFFFFFFE; this.s2CCode_ = 0; onChanged(); return this; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (!(ref instanceof String)) { ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; }  return (String)ref; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public Builder setS2CMsg(String value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = AuctionHandler.CancelSyncAuctionInfoResponse.getDefaultInstance().getS2CMsg(); onChanged(); return this; } public Builder setS2CMsgBytes(ByteString value) { if (value == null)
/*  1787 */           throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*       */   
/*       */   }
/*       */ 
/*       */ 
...
/*       */ 
/*       */     
/*  3356 */     private static final AuctionItem defaultInstance = new AuctionItem(true); private Object source_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionItem> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public String getId() { Object ref = this.id_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.id_ = s;  return s; } public ByteString getIdBytes() { Object ref = this.id_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b; return b; }  return (ByteString)ref; } public boolean hasDetail() { return ((this.bitField0_ & 0x2) == 2); } public ItemOuterClass.ItemDetail getDetail() { return this.detail_; } public ItemOuterClass.ItemDetailOrBuilder getDetailOrBuilder() { return (ItemOuterClass.ItemDetailOrBuilder)this.detail_; } public boolean hasState() { return ((this.bitField0_ & 0x4) == 4); } public int getState() { return this.state_; } public boolean hasTimeleft() { return ((this.bitField0_ & 0x8) == 8); } public int getTimeleft() { return this.timeleft_; } public boolean hasCurPrice() { return ((this.bitField0_ & 0x10) == 16); } public int getCurPrice() { return this.curPrice_; } public boolean hasMaxPrice() { return ((this.bitField0_ & 0x20) == 32); } public int getMaxPrice() { return this.maxPrice_; } public boolean hasSelf() { return ((this.bitField0_ & 0x40) == 64); } public boolean getSelf() { return this.self_; } public boolean hasNum() { return ((this.bitField0_ & 0x80) == 128); } public int getNum() { return this.num_; } public boolean hasSource() { return ((this.bitField0_ & 0x100) == 256); } public String getSource() { Object ref = this.source_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.source_ = s;  return s; } public ByteString getSourceBytes() { Object ref = this.source_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.source_ = b; return b; }  return (ByteString)ref; } private void initFields() { this.id_ = ""; this.detail_ = ItemOuterClass.ItemDetail.getDefaultInstance(); this.state_ = 0; this.timeleft_ = 0; this.curPrice_ = 0; this.maxPrice_ = 0; this.self_ = false; this.num_ = 0; this.source_ = ""; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasId()) { this.memoizedIsInitialized = 0; return false; }  if (!hasDetail()) { this.memoizedIsInitialized = 0; return false; }  if (!hasState()) { this.memoizedIsInitialized = 0; return false; }  if (!getDetail().isInitialized()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; }
/*  3357 */     static { defaultInstance.initFields(); } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize();
/*       */       if ((this.bitField0_ & 0x1) == 1)
...
/*       */       size += getUnknownFields().getSerializedSize();
/*       */       this.memoizedSerializedSize = size;
/*       */       return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static AuctionItem parseFrom(ByteString data) throws InvalidProtocolBufferException { return (AuctionItem)PARSER.parseFrom(data); } public static AuctionItem parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (AuctionItem)PARSER.parseFrom(data, extensionRegistry); } public static AuctionItem parseFrom(byte[] data) throws InvalidProtocolBufferException { return (AuctionItem)PARSER.parseFrom(data); } public static AuctionItem parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (AuctionItem)PARSER.parseFrom(data, extensionRegistry); } public static AuctionItem parseFrom(InputStream input) throws IOException { return (AuctionItem)PARSER.parseFrom(input); } public static AuctionItem parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionItem)PARSER.parseFrom(input, extensionRegistry); } public static AuctionItem parseDelimitedFrom(InputStream input) throws IOException { return (AuctionItem)PARSER.parseDelimitedFrom(input); } public static AuctionItem parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionItem)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static AuctionItem parseFrom(CodedInputStream input) throws IOException {
...
/*       */       Builder builder = new Builder(parent);
/*       */       return builder;
/*       */     } public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.AuctionItemOrBuilder { private int bitField0_; private Object id_; private ItemOuterClass.ItemDetail detail_; private SingleFieldBuilder<ItemOuterClass.ItemDetail, ItemOuterClass.ItemDetail.Builder, ItemOuterClass.ItemDetailOrBuilder> detailBuilder_; private int state_; private int timeleft_; private int curPrice_; private int maxPrice_; private boolean self_; private int num_; private Object source_; public static final Descriptors.Descriptor getDescriptor() {
/*       */         return AuctionHandler.internal_static_pomelo_auction_AuctionItem_descriptor;
/*       */       } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
...
/*       */         return this;
/*       */       } } }
/*  3801 */   public static final class AuctionListRequest extends GeneratedMessage implements AuctionListRequestOrBuilder { private static final AuctionListRequest defaultInstance = new AuctionListRequest(true); private final UnknownFieldSet unknownFields; private AuctionListRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionListRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionListRequest getDefaultInstance() { return defaultInstance; } public AuctionListRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionListRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.c2SType_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionListRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionListRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionListRequest.class, Builder.class); } public static Parser<AuctionListRequest> PARSER = (Parser<AuctionListRequest>)new AbstractParser<AuctionListRequest>() { public AuctionHandler.AuctionListRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionListRequest(input, extensionRegistry); } }
/*  3802 */     ; private int bitField0_; public static final int C2S_TYPE_FIELD_NUMBER = 1; private int c2SType_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionListRequest> getParserForType() { return PARSER; } public boolean hasC2SType() { return ((this.bitField0_ & 0x1) == 1); } public int getC2SType() { return this.c2SType_; } private void initFields() { this.c2SType_ = 0; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  4845 */     private static final AuctionListResponse defaultInstance = new AuctionListResponse(true); private final UnknownFieldSet unknownFields; private AuctionListResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionListResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionListResponse getDefaultInstance() { return defaultInstance; } public AuctionListResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionListResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CData_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CData_.add(input.readMessage(AuctionHandler.AuctionItem.PARSER, extensionRegistry)); break;case 32: this.bitField0_ |= 0x4; this.s2CBonus_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CData_ = Collections.unmodifiableList(this.s2CData_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionListResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionListResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionListResponse.class, Builder.class); } public static Parser<AuctionListResponse> PARSER = (Parser<AuctionListResponse>)new AbstractParser<AuctionListResponse>() { public AuctionHandler.AuctionListResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionListResponse(input, extensionRegistry); } }
/*  4846 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_DATA_FIELD_NUMBER = 3; private List<AuctionHandler.AuctionItem> s2CData_; public static final int S2C_BONUS_FIELD_NUMBER = 4; private int s2CBonus_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionListResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  5503 */     private static final AuctionRequest defaultInstance = new AuctionRequest(true); private final UnknownFieldSet unknownFields; private AuctionRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionRequest getDefaultInstance() { return defaultInstance; } public AuctionRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.itemId_ = bs; break;case 16: this.bitField0_ |= 0x2; this.price_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionRequest.class, Builder.class); } public static Parser<AuctionRequest> PARSER = (Parser<AuctionRequest>)new AbstractParser<AuctionRequest>() { public AuctionHandler.AuctionRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionRequest(input, extensionRegistry); } }
/*  5504 */     ; private int bitField0_; public static final int ITEMID_FIELD_NUMBER = 1; private Object itemId_; public static final int PRICE_FIELD_NUMBER = 2; private int price_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionRequest> getParserForType() { return PARSER; } public boolean hasItemId() { return ((this.bitField0_ & 0x1) == 1); } public String getItemId() { Object ref = this.itemId_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.itemId_ = s;  return s; } public ByteString getItemIdBytes() { Object ref = this.itemId_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.itemId_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */     
...
/*       */     }
/*       */     
/*  6065 */     private static final AuctionResponse defaultInstance = new AuctionResponse(true); public static AuctionResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionResponse)PARSER.parseFrom(input, extensionRegistry); } public static AuctionResponse parseDelimitedFrom(InputStream input) throws IOException { return (AuctionResponse)PARSER.parseDelimitedFrom(input); } public static AuctionResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionResponse)PARSER.parseDelimitedFrom(input, extensionRegistry); } public static AuctionResponse parseFrom(CodedInputStream input) throws IOException { return (AuctionResponse)PARSER.parseFrom(input); } public static AuctionResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionResponse)PARSER.parseFrom(input, extensionRegistry); } public static Builder newBuilder() { return Builder.create(); } public Builder newBuilderForType() { return newBuilder(); } public static Builder newBuilder(AuctionResponse prototype) { return newBuilder().mergeFrom(prototype); } public Builder toBuilder() { return newBuilder(this); } protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent); return builder; } public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.AuctionResponseOrBuilder {
/*  6066 */       private int bitField0_; private int s2CCode_; private Object s2CMsg_; public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionHandler.AuctionResponse.class, Builder.class); } private Builder() { this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.s2CMsg_ = ""; maybeForceBuilderInitialization(); } private void maybeForceBuilderInitialization() { if (AuctionHandler.AuctionResponse.alwaysUseFieldBuilders); } private static Builder create() { return new Builder(); } public Builder clear() { super.clear(); this.s2CCode_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.s2CMsg_ = ""; this.bitField0_ &= 0xFFFFFFFD; return this; } public Builder clone() { return create().mergeFrom(buildPartial()); } public Descriptors.Descriptor getDescriptorForType() { return AuctionHandler.internal_static_pomelo_auction_AuctionResponse_descriptor; } public AuctionHandler.AuctionResponse getDefaultInstanceForType() { return AuctionHandler.AuctionResponse.getDefaultInstance(); } public AuctionHandler.AuctionResponse build() { AuctionHandler.AuctionResponse result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; } public AuctionHandler.AuctionResponse buildPartial() { AuctionHandler.AuctionResponse result = new AuctionHandler.AuctionResponse(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;  result.s2CCode_ = this.s2CCode_; if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;  result.s2CMsg_ = this.s2CMsg_; result.bitField0_ = to_bitField0_; onBuilt(); return result; } public Builder mergeFrom(Message other) { if (other instanceof AuctionHandler.AuctionResponse) return mergeFrom((AuctionHandler.AuctionResponse)other);  super.mergeFrom(other); return this; } public Builder mergeFrom(AuctionHandler.AuctionResponse other) { if (other == AuctionHandler.AuctionResponse.getDefaultInstance()) return this;  if (other.hasS2CCode()) setS2CCode(other.getS2CCode());  if (other.hasS2CMsg()) { this.bitField0_ |= 0x2; this.s2CMsg_ = other.s2CMsg_; onChanged(); }  mergeUnknownFields(other.getUnknownFields()); return this; } public final boolean isInitialized() { if (!hasS2CCode()) return false;  return true; } public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { AuctionHandler.AuctionResponse parsedMessage = null; try { parsedMessage = (AuctionHandler.AuctionResponse)AuctionHandler.AuctionResponse.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (AuctionHandler.AuctionResponse)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null) mergeFrom(parsedMessage);  }  return this; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public Builder setS2CCode(int value) { this.bitField0_ |= 0x1; this.s2CCode_ = value; onChanged(); return this; } public Builder clearS2CCode() { this.bitField0_ &= 0xFFFFFFFE; this.s2CCode_ = 0; onChanged(); return this; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (!(ref instanceof String)) { ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; }  return (String)ref; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } public Builder setS2CMsg(String value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } public Builder clearS2CMsg() { this.bitField0_ &= 0xFFFFFFFD; this.s2CMsg_ = AuctionHandler.AuctionResponse.getDefaultInstance().getS2CMsg(); onChanged(); return this; } public Builder setS2CMsgBytes(ByteString value) { if (value == null) throw new NullPointerException();  this.bitField0_ |= 0x2; this.s2CMsg_ = value; onChanged(); return this; } } static { defaultInstance.initFields(); }
/*       */   
/*       */   }
/*       */ 
/*       */ 
...
/*       */   {
/*  7235 */     private static final AuctionLog defaultInstance = new AuctionLog(true); private final UnknownFieldSet unknownFields; private AuctionLog(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionLog(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionLog getDefaultInstance() { return defaultInstance; } public AuctionLog getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionLog(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.id_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.time_ = bs; break;case 26: bs = input.readBytes(); this.bitField0_ |= 0x4; this.role1_ = bs; break;case 34: bs = input.readBytes(); this.bitField0_ |= 0x8; this.item_ = bs; break;case 40: this.bitField0_ |= 0x10; this.num_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionLog_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionLog_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionLog.class, Builder.class); } public static Parser<AuctionLog> PARSER = (Parser<AuctionLog>)new AbstractParser<AuctionLog>() { public AuctionHandler.AuctionLog parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionLog(input, extensionRegistry); } }
/*  7236 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private int id_; public static final int TIME_FIELD_NUMBER = 2; private Object time_; public static final int ROLE1_FIELD_NUMBER = 3; private Object role1_; public static final int ITEM_FIELD_NUMBER = 4; private Object item_; public static final int NUM_FIELD_NUMBER = 5; private int num_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionLog> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public int getId() { return this.id_; } public boolean hasTime() { return ((this.bitField0_ & 0x2) == 2); } public String getTime() { Object ref = this.time_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.time_ = s;  return s; } static { defaultInstance.initFields(); } public ByteString getTimeBytes() { Object ref = this.time_;
/*       */       if (ref instanceof String) {
/*       */         ByteString b = ByteString.copyFromUtf8((String)ref);
/*       */         this.time_ = b;
/*       */         return b;
/*       */       } 
/*       */       return (ByteString)ref; } public boolean hasRole1() { return ((this.bitField0_ & 0x4) == 4); } public String getRole1() { Object ref = this.role1_;
/*       */       if (ref instanceof String)
/*       */         return (String)ref; 
/*       */       ByteString bs = (ByteString)ref;
/*       */       String s = bs.toStringUtf8();
/*       */       if (bs.isValidUtf8())
/*       */         this.role1_ = s; 
/*       */       return s; } public ByteString getRole1Bytes() { Object ref = this.role1_;
/*       */       if (ref instanceof String) {
/*       */         ByteString b = ByteString.copyFromUtf8((String)ref);
/*       */         this.role1_ = b;
/*       */         return b;
/*       */       } 
/*       */       return (ByteString)ref; }
/*       */     public boolean hasItem() { return ((this.bitField0_ & 0x8) == 8); }
/*       */     public String getItem() { Object ref = this.item_;
/*       */       if (ref instanceof String)
/*       */         return (String)ref; 
/*       */       ByteString bs = (ByteString)ref;
/*       */       String s = bs.toStringUtf8();
...
/*       */         this.item_ = s; 
/*       */       return s; }
/*       */     public ByteString getItemBytes() { Object ref = this.item_;
/*       */       if (ref instanceof String) {
/*       */         ByteString b = ByteString.copyFromUtf8((String)ref);
/*       */         this.item_ = b;
/*       */         return b;
/*       */       } 
/*       */       return (ByteString)ref; }
/*       */     public boolean hasNum() { return ((this.bitField0_ & 0x10) == 16); }
/*       */     public int getNum() { return this.num_; }
/*       */     private void initFields() { this.id_ = 0;
/*       */       this.time_ = "";
/*       */       this.role1_ = "";
/*       */       this.item_ = "";
/*       */       this.num_ = 0; }
...
/*       */     public static AuctionLog parseFrom(ByteString data) throws InvalidProtocolBufferException { return (AuctionLog)PARSER.parseFrom(data); }
/*       */     public static AuctionLog parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (AuctionLog)PARSER.parseFrom(data, extensionRegistry); }
/*       */     public static AuctionLog parseFrom(byte[] data) throws InvalidProtocolBufferException { return (AuctionLog)PARSER.parseFrom(data); }
/*       */     public static AuctionLog parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (AuctionLog)PARSER.parseFrom(data, extensionRegistry); }
/*       */     public static AuctionLog parseFrom(InputStream input) throws IOException { return (AuctionLog)PARSER.parseFrom(input); }
/*       */     public static AuctionLog parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionLog)PARSER.parseFrom(input, extensionRegistry); }
/*       */     public static AuctionLog parseDelimitedFrom(InputStream input) throws IOException { return (AuctionLog)PARSER.parseDelimitedFrom(input); }
/*       */     public static AuctionLog parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionLog)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*       */     public static AuctionLog parseFrom(CodedInputStream input) throws IOException { return (AuctionLog)PARSER.parseFrom(input); }
/*       */     public static AuctionLog parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (AuctionLog)PARSER.parseFrom(input, extensionRegistry); }
/*       */     public static Builder newBuilder() { return Builder.create(); }
/*       */     public Builder newBuilderForType() { return newBuilder(); }
/*       */     public static Builder newBuilder(AuctionLog prototype) { return newBuilder().mergeFrom(prototype); }
/*       */     public Builder toBuilder() { return newBuilder(this); }
/*       */     protected Builder newBuilderForType(GeneratedMessage.BuilderParent parent) { Builder builder = new Builder(parent);
/*       */       return builder; }
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.AuctionLogOrBuilder { private int bitField0_; private int id_; private Object time_; private Object role1_; private Object item_; private int num_;
/*       */       public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionLog_descriptor; }
/*       */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionLog_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionHandler.AuctionLog.class, Builder.class); }
/*       */       private Builder() { this.time_ = "";
/*       */         this.role1_ = "";
/*       */         this.item_ = "";
/*       */         maybeForceBuilderInitialization(); }
...
/*       */         this.item_ = "";
/*       */         maybeForceBuilderInitialization(); }
/*       */       private void maybeForceBuilderInitialization() { if (AuctionHandler.AuctionLog.alwaysUseFieldBuilders); }
...
/*       */       public Descriptors.Descriptor getDescriptorForType() { return AuctionHandler.internal_static_pomelo_auction_AuctionLog_descriptor; }
/*       */       public AuctionHandler.AuctionLog getDefaultInstanceForType() { return AuctionHandler.AuctionLog.getDefaultInstance(); }
/*       */       public AuctionHandler.AuctionLog build() { AuctionHandler.AuctionLog result = buildPartial();
/*       */         if (!result.isInitialized())
/*       */           throw newUninitializedMessageException(result); 
/*       */         return result; }
/*       */       public AuctionHandler.AuctionLog buildPartial() { AuctionHandler.AuctionLog result = new AuctionHandler.AuctionLog(this);
/*       */         int from_bitField0_ = this.bitField0_;
/*       */         int to_bitField0_ = 0;
/*       */         if ((from_bitField0_ & 0x1) == 1)
/*       */           to_bitField0_ |= 0x1; 
...
/*       */         onBuilt();
/*       */         return result; }
/*       */       public Builder mergeFrom(Message other) { if (other instanceof AuctionHandler.AuctionLog)
/*       */           return mergeFrom((AuctionHandler.AuctionLog)other); 
/*       */         super.mergeFrom(other);
/*       */         return this; }
/*       */       public Builder mergeFrom(AuctionHandler.AuctionLog other) { if (other == AuctionHandler.AuctionLog.getDefaultInstance())
/*       */           return this; 
/*       */         if (other.hasId())
/*       */           setId(other.getId()); 
/*       */         if (other.hasTime()) {
...
/*       */           return false; 
/*       */         return true; }
/*       */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { AuctionHandler.AuctionLog parsedMessage = null;
/*       */         try {
...
/*       */         onChanged();
/*       */         return this; }
/*       */       public boolean hasTime() { return ((this.bitField0_ & 0x2) == 2); }
...
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder clearTime() { this.bitField0_ &= 0xFFFFFFFD;
...
/*       */         onChanged();
/*       */         return this; }
/*       */       public boolean hasRole1() { return ((this.bitField0_ & 0x4) == 4); }
/*       */       public String getRole1() { Object ref = this.role1_;
/*       */         if (!(ref instanceof String)) {
/*       */           ByteString bs = (ByteString)ref;
/*       */           String s = bs.toStringUtf8();
/*       */           if (bs.isValidUtf8())
...
/*       */         } 
/*       */         return (String)ref; }
/*       */       public ByteString getRole1Bytes() { Object ref = this.role1_;
/*       */         if (ref instanceof String) {
/*       */           ByteString b = ByteString.copyFromUtf8((String)ref);
/*       */           this.role1_ = b;
/*       */           return b;
/*       */         } 
/*       */         return (ByteString)ref; }
/*       */       public Builder setRole1(String value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x4;
/*       */         this.role1_ = value;
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder clearRole1() { this.bitField0_ &= 0xFFFFFFFB;
/*       */         this.role1_ = AuctionHandler.AuctionLog.getDefaultInstance().getRole1();
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder setRole1Bytes(ByteString value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x4;
/*       */         this.role1_ = value;
/*       */         onChanged();
...
/*       */         } 
/*       */         return (ByteString)ref; }
/*       */       public Builder setItem(String value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x8;
/*       */         this.item_ = value;
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder clearItem() { this.bitField0_ &= 0xFFFFFFF7;
/*       */         this.item_ = AuctionHandler.AuctionLog.getDefaultInstance().getItem();
/*       */         onChanged();
/*       */         return this; }
/*       */       public Builder setItemBytes(ByteString value) { if (value == null)
/*       */           throw new NullPointerException(); 
/*       */         this.bitField0_ |= 0x8;
/*       */         this.item_ = value;
/*       */         onChanged();
...
/*       */         return this;
/*       */       } } }
/*  7556 */   public static final class AuctionLogRequest extends GeneratedMessage implements AuctionLogRequestOrBuilder { private static final AuctionLogRequest defaultInstance = new AuctionLogRequest(true); private final UnknownFieldSet unknownFields; private AuctionLogRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionLogRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionLogRequest getDefaultInstance() { return defaultInstance; } public AuctionLogRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionLogRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionLogRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionLogRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionLogRequest.class, Builder.class); } public static Parser<AuctionLogRequest> PARSER = (Parser<AuctionLogRequest>)new AbstractParser<AuctionLogRequest>() { public AuctionHandler.AuctionLogRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionLogRequest(input, extensionRegistry); } }
/*  7557 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionLogRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  8490 */     private static final AuctionLogResponse defaultInstance = new AuctionLogResponse(true); private final UnknownFieldSet unknownFields; private AuctionLogResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionLogResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionLogResponse getDefaultInstance() { return defaultInstance; } public AuctionLogResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionLogResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CLog_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CLog_.add(input.readMessage(AuctionHandler.AuctionLog.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CLog_ = Collections.unmodifiableList(this.s2CLog_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionLogResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionLogResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionLogResponse.class, Builder.class); } public static Parser<AuctionLogResponse> PARSER = (Parser<AuctionLogResponse>)new AbstractParser<AuctionLogResponse>() { public AuctionHandler.AuctionLogResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionLogResponse(input, extensionRegistry); } }
/*  8491 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_LOG_FIELD_NUMBER = 3; private List<AuctionHandler.AuctionLog> s2CLog_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionLogResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */     
...
/*       */   {
/*  9082 */     private static final AuctionItemPush defaultInstance = new AuctionItemPush(true); private final UnknownFieldSet unknownFields; private AuctionItemPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AuctionItemPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AuctionItemPush getDefaultInstance() { return defaultInstance; } public AuctionItemPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AuctionItemPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { AuctionHandler.AuctionItem.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: subBuilder = null; if ((this.bitField0_ & 0x1) == 1) subBuilder = this.s2CItem_.toBuilder();  this.s2CItem_ = (AuctionHandler.AuctionItem)input.readMessage(AuctionHandler.AuctionItem.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CItem_); this.s2CItem_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x1; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AuctionItemPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AuctionItemPush_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionItemPush.class, Builder.class); } public static Parser<AuctionItemPush> PARSER = (Parser<AuctionItemPush>)new AbstractParser<AuctionItemPush>() { public AuctionHandler.AuctionItemPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AuctionItemPush(input, extensionRegistry); } }
/*  9083 */     ; private int bitField0_; public static final int S2C_ITEM_FIELD_NUMBER = 1; private AuctionHandler.AuctionItem s2CItem_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AuctionItemPush> getParserForType() { return PARSER; } public boolean hasS2CItem() { return ((this.bitField0_ & 0x1) == 1); } public AuctionHandler.AuctionItem getS2CItem() { return this.s2CItem_; } public AuctionHandler.AuctionItemOrBuilder getS2CItemOrBuilder() { return this.s2CItem_; } static { defaultInstance.initFields(); }
/*       */ 
/*       */ 
/*       */ 
/*       */ 
...
/*       */   {
/*  9891 */     private static final AddAuctionItemPush defaultInstance = new AddAuctionItemPush(true); private final UnknownFieldSet unknownFields; private AddAuctionItemPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private AddAuctionItemPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static AddAuctionItemPush getDefaultInstance() { return defaultInstance; } public AddAuctionItemPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private AddAuctionItemPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: if ((mutable_bitField0_ & 0x1) != 1) { this.s2CItem_ = new ArrayList<>(); mutable_bitField0_ |= 0x1; }  this.s2CItem_.add(input.readMessage(AuctionHandler.AuctionItem.PARSER, extensionRegistry)); break;case 16: this.bitField0_ |= 0x1; this.s2CType_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x1) == 1) this.s2CItem_ = Collections.unmodifiableList(this.s2CItem_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_AddAuctionItemPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_AddAuctionItemPush_fieldAccessorTable.ensureFieldAccessorsInitialized(AddAuctionItemPush.class, Builder.class); } public static Parser<AddAuctionItemPush> PARSER = (Parser<AddAuctionItemPush>)new AbstractParser<AddAuctionItemPush>() { public AuctionHandler.AddAuctionItemPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.AddAuctionItemPush(input, extensionRegistry); } }
/*  9892 */     ; private int bitField0_; public static final int S2C_ITEM_FIELD_NUMBER = 1; private List<AuctionHandler.AuctionItem> s2CItem_; public static final int S2C_TYPE_FIELD_NUMBER = 2; private int s2CType_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<AddAuctionItemPush> getParserForType() { return PARSER; } public List<AuctionHandler.AuctionItem> getS2CItemList() { return this.s2CItem_; } public List<? extends AuctionHandler.AuctionItemOrBuilder> getS2CItemOrBuilderList() { return (List)this.s2CItem_; } public int getS2CItemCount() { return this.s2CItem_.size(); } public AuctionHandler.AuctionItem getS2CItem(int index) { return this.s2CItem_.get(index); } static { defaultInstance.initFields(); }
/*       */ 
/*       */     
...
/*       */   {
/* 10383 */     private static final RemoveAuctionItemPush defaultInstance = new RemoveAuctionItemPush(true); private final UnknownFieldSet unknownFields; private RemoveAuctionItemPush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private RemoveAuctionItemPush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static RemoveAuctionItemPush getDefaultInstance() { return defaultInstance; } public RemoveAuctionItemPush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private RemoveAuctionItemPush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.id_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_RemoveAuctionItemPush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_RemoveAuctionItemPush_fieldAccessorTable.ensureFieldAccessorsInitialized(RemoveAuctionItemPush.class, Builder.class); } public static Parser<RemoveAuctionItemPush> PARSER = (Parser<RemoveAuctionItemPush>)new AbstractParser<RemoveAuctionItemPush>() { public AuctionHandler.RemoveAuctionItemPush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new AuctionHandler.RemoveAuctionItemPush(input, extensionRegistry); } }
/* 10384 */     ; private int bitField0_; public static final int ID_FIELD_NUMBER = 1; private Object id_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<RemoveAuctionItemPush> getParserForType() { return PARSER; } public boolean hasId() { return ((this.bitField0_ & 0x1) == 1); } public String getId() { Object ref = this.id_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.id_ = s;  return s; } public ByteString getIdBytes() { Object ref = this.id_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); } private void initFields() { this.id_ = ""; }
...
/*       */         output.writeBytes(1, getIdBytes());  getUnknownFields().writeTo(output); }
/*       */     public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1)
/*       */         return size;  size = 0; if ((this.bitField0_ & 0x1) == 1)
/*       */         size += CodedOutputStream.computeBytesSize(1, getIdBytes());  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; }
/*       */     protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); }
/*       */     public static RemoveAuctionItemPush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (RemoveAuctionItemPush)PARSER.parseFrom(data); }
/*       */     public static RemoveAuctionItemPush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (RemoveAuctionItemPush)PARSER.parseFrom(data, extensionRegistry); }
/*       */     public static RemoveAuctionItemPush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (RemoveAuctionItemPush)PARSER.parseFrom(data); }
/*       */     public static RemoveAuctionItemPush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (RemoveAuctionItemPush)PARSER.parseFrom(data, extensionRegistry); }
/*       */     public static RemoveAuctionItemPush parseFrom(InputStream input) throws IOException { return (RemoveAuctionItemPush)PARSER.parseFrom(input); }
/*       */     public static RemoveAuctionItemPush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RemoveAuctionItemPush)PARSER.parseFrom(input, extensionRegistry); }
/*       */     public static RemoveAuctionItemPush parseDelimitedFrom(InputStream input) throws IOException { return (RemoveAuctionItemPush)PARSER.parseDelimitedFrom(input); }
/*       */     public static RemoveAuctionItemPush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RemoveAuctionItemPush)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*       */     public static RemoveAuctionItemPush parseFrom(CodedInputStream input) throws IOException { return (RemoveAuctionItemPush)PARSER.parseFrom(input); }
/*       */     public static RemoveAuctionItemPush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (RemoveAuctionItemPush)PARSER.parseFrom(input, extensionRegistry); }
/*       */     public static Builder newBuilder() { return Builder.create(); }
/*       */     public Builder newBuilderForType() { return newBuilder(); }
/*       */     public static Builder newBuilder(RemoveAuctionItemPush prototype) { return newBuilder().mergeFrom(prototype); }
/*       */     public Builder toBuilder() { return newBuilder(this); }
...
/*       */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements AuctionHandler.RemoveAuctionItemPushOrBuilder { private int bitField0_; private Object id_;
/*       */       public static final Descriptors.Descriptor getDescriptor() { return AuctionHandler.internal_static_pomelo_auction_RemoveAuctionItemPush_descriptor; }
/*       */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return AuctionHandler.internal_static_pomelo_auction_RemoveAuctionItemPush_fieldAccessorTable.ensureFieldAccessorsInitialized(AuctionHandler.RemoveAuctionItemPush.class, Builder.class); }
/*       */       private Builder() { this.id_ = ""; maybeForceBuilderInitialization(); }
/*       */       private Builder(GeneratedMessage.BuilderParent parent) { super(parent); this.id_ = ""; maybeForceBuilderInitialization(); }
/*       */       private void maybeForceBuilderInitialization() { if (AuctionHandler.RemoveAuctionItemPush.alwaysUseFieldBuilders); }
/*       */       private static Builder create() { return new Builder(); }
/*       */       public Builder clear() { super.clear(); this.id_ = ""; this.bitField0_ &= 0xFFFFFFFE; return this; }
/*       */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*       */       public Descriptors.Descriptor getDescriptorForType() { return AuctionHandler.internal_static_pomelo_auction_RemoveAuctionItemPush_descriptor; }
/*       */       public AuctionHandler.RemoveAuctionItemPush getDefaultInstanceForType() { return AuctionHandler.RemoveAuctionItemPush.getDefaultInstance(); }
/*       */       public AuctionHandler.RemoveAuctionItemPush build() { AuctionHandler.RemoveAuctionItemPush result = buildPartial(); if (!result.isInitialized())
/*       */           throw newUninitializedMessageException(result);  return result; }
/*       */       public AuctionHandler.RemoveAuctionItemPush buildPartial() { AuctionHandler.RemoveAuctionItemPush result = new AuctionHandler.RemoveAuctionItemPush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
/*       */           to_bitField0_ |= 0x1;  result.id_ = this.id_; result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*       */       public Builder mergeFrom(Message other) { if (other instanceof AuctionHandler.RemoveAuctionItemPush)
/*       */           return mergeFrom((AuctionHandler.RemoveAuctionItemPush)other);  super.mergeFrom(other); return this; }
/*       */       public Builder mergeFrom(AuctionHandler.RemoveAuctionItemPush other) { if (other == AuctionHandler.RemoveAuctionItemPush.getDefaultInstance())
...
/*       */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { AuctionHandler.RemoveAuctionItemPush parsedMessage = null; try {
...
/*       */         } catch (InvalidProtocolBufferException e) {
/*       */           parsedMessage = (AuctionHandler.RemoveAuctionItemPush)e.getUnfinishedMessage(); throw e;
/*       */         } finally {
/*       */           if (parsedMessage != null)
/*       */             mergeFrom(parsedMessage); 
/*       */         }  return this; }
...
/*       */           ByteString b = ByteString.copyFromUtf8((String)ref); this.id_ = b;
/*       */           return b;
/*       */         } 
/*       */         return (ByteString)ref; }
...
/*       */ 
/*       */     
/* 10522 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*       */       {
/*       */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*       */         {
/* 10526 */           AuctionHandler.descriptor = root;
/* 10527 */           return null;
/*       */         }
/*       */       };
/*       */     
/* 10531 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*       */           
/* 10533 */           Common.getDescriptor(), 
/* 10534 */           ItemOuterClass.getDescriptor() }, assigner);
/*       */   }
/*       */   
/* 10537 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_SyncAuctionInfoRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 10538 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_SyncAuctionInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_SyncAuctionInfoRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10543 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_SyncAuctionInfoResponse_descriptor = getDescriptor().getMessageTypes().get(1);
/* 10544 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_SyncAuctionInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_SyncAuctionInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10549 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_CancelSyncAuctionInfoRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 10550 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_CancelSyncAuctionInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_CancelSyncAuctionInfoRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10555 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 10556 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_CancelSyncAuctionInfoResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10561 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionItem_descriptor = getDescriptor().getMessageTypes().get(4);
/* 10562 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionItem_descriptor, new String[] { "Id", "Detail", "State", "Timeleft", "CurPrice", "MaxPrice", "Self", "Num", "Source" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10567 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionListRequest_descriptor = getDescriptor().getMessageTypes().get(5);
/* 10568 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionListRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionListRequest_descriptor, new String[] { "C2SType" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10573 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionListResponse_descriptor = getDescriptor().getMessageTypes().get(6);
/* 10574 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionListResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionListResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CData", "S2CBonus" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10579 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionRequest_descriptor = getDescriptor().getMessageTypes().get(7);
/* 10580 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionRequest_descriptor, new String[] { "ItemId", "Price" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10585 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionResponse_descriptor = getDescriptor().getMessageTypes().get(8);
/* 10586 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionResponse_descriptor, new String[] { "S2CCode", "S2CMsg" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10591 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionLog_descriptor = getDescriptor().getMessageTypes().get(9);
/* 10592 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionLog_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionLog_descriptor, new String[] { "Id", "Time", "Role1", "Item", "Num" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10597 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionLogRequest_descriptor = getDescriptor().getMessageTypes().get(10);
/* 10598 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionLogRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionLogRequest_descriptor, new String[0]);
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10603 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionLogResponse_descriptor = getDescriptor().getMessageTypes().get(11);
/* 10604 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionLogResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionLogResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CLog" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10609 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AuctionItemPush_descriptor = getDescriptor().getMessageTypes().get(12);
/* 10610 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AuctionItemPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AuctionItemPush_descriptor, new String[] { "S2CItem" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10615 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_AddAuctionItemPush_descriptor = getDescriptor().getMessageTypes().get(13);
/* 10616 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_AddAuctionItemPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_AddAuctionItemPush_descriptor, new String[] { "S2CItem", "S2CType" });
/*       */ 
/*       */ 
/*       */ 
/*       */   
/* 10621 */   private static final Descriptors.Descriptor internal_static_pomelo_auction_RemoveAuctionItemPush_descriptor = getDescriptor().getMessageTypes().get(14);
/* 10622 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_auction_RemoveAuctionItemPush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_auction_RemoveAuctionItemPush_descriptor, new String[] { "Id" });
/*       */   private static Descriptors.FileDescriptor descriptor;
/*       */   
/*       */   static {
/* 10626 */     Common.getDescriptor();
/* 10627 */     ItemOuterClass.getDescriptor();
/*       */   }
/*       */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\auction\AuctionHandler.class
