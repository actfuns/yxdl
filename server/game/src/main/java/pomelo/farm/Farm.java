...
public final class Farm {
    ...
    public static final class Block
        ...
        private Block(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 16:
                            this.bitField0_ |= 0x2;
                            this.blockState_ = input.readInt32();
                            break;
                        case 26:
                            bs = input.readBytes();
                            this.bitField0_ |= 0x4;
                        ...
                        case 32:
                            this.bitField0_ |= 0x8;
                            this.seedState_ = input.readInt32();
                            break;
                        case 40:
                        ...
                        case 48:
                            ...
                            this.harvestTime_ = input.readInt64();
                            break;
                        case 56:
                            this.bitField0_ |= 0x40;
                            this.protectEndTime_ = input.readInt64();
                            break;
                    }
                }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_Block_fieldAccessorTable.ensureFieldAccessorsInitialized(Block.class, Builder.class);
        }

        public static Parser<Block> PARSER = (Parser<Block>) new AbstractParser<Block>() {
            public Farm.Block parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.Block(input, extensionRegistry);
            }
        };
    ...
    public static final class Seed
        ...
        private static final Seed defaultInstance = new Seed(true);
        private final UnknownFieldSet unknownFields;

        private Seed(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private Seed(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return Farm.internal_static_pomelo_farm_Seed_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_Seed_fieldAccessorTable.ensureFieldAccessorsInitialized(Seed.class, Builder.class);
        }

        public static Parser<Seed> PARSER = (Parser<Seed>) new AbstractParser<Seed>() {
            public Farm.Seed parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.Seed(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            getSerializedSize();
            if ((this.bitField0_ & 0x1) == 1) output.writeBytes(1, getSeedCodeBytes());
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeBytesSize(1, getSeedCodeBytes());
        ...
        public static Seed parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (Seed) PARSER.parseFrom(data);
        }

        public static Seed parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (Seed) PARSER.parseFrom(data, extensionRegistry);
        }

        public static Seed parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (Seed) PARSER.parseFrom(data);
        }

        public static Seed parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (Seed) PARSER.parseFrom(data, extensionRegistry);
        }

        public static Seed parseFrom(InputStream input) throws IOException {
            return (Seed) PARSER.parseFrom(input);
        }

        public static Seed parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (Seed) PARSER.parseFrom(input, extensionRegistry);
        }

        public static Seed parseDelimitedFrom(InputStream input) throws IOException {
            return (Seed) PARSER.parseDelimitedFrom(input);
        }

        public static Seed parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (Seed) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static Seed parseFrom(CodedInputStream input) throws IOException {
            return (Seed) PARSER.parseFrom(input);
        }

        public static Seed parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (Seed) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(Seed prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements Farm.SeedOrBuilder {
            private int bitField0_;
            private Object seedCode_;
            private int num_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return Farm.internal_static_pomelo_farm_Seed_fieldAccessorTable.ensureFieldAccessorsInitialized(Farm.Seed.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (Farm.Seed.alwaysUseFieldBuilders) ;
            }
            ...
            public Farm.Seed getDefaultInstanceForType() {
                return Farm.Seed.getDefaultInstance();
            }

            public Farm.Seed build() {
                Farm.Seed result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public Farm.Seed buildPartial() {
                Farm.Seed result = new Farm.Seed(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof Farm.Seed) return mergeFrom((Farm.Seed) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(Farm.Seed other) {
                if (other == Farm.Seed.getDefaultInstance()) return this;
                if (other.hasSeedCode()) {
                    this.bitField0_ |= 0x1;
                    this.seedCode_ = other.seedCode_;
                    onChanged();
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                Farm.Seed parsedMessage = null;
                try {
                    parsedMessage = (Farm.Seed) Farm.Seed.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (Farm.Seed) e.getUnfinishedMessage();
                    throw e;
                } finally {
            ...
            public Builder clearSeedCode() {
                this.bitField0_ &= 0xFFFFFFFE;
                this.seedCode_ = Farm.Seed.getDefaultInstance().getSeedCode();
                onChanged();
                return this;
            }
    ...
    public static final class Product
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return Farm.internal_static_pomelo_farm_Product_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_Product_fieldAccessorTable.ensureFieldAccessorsInitialized(Product.class, Builder.class);
        }

        public static Parser<Product> PARSER = (Parser<Product>) new AbstractParser<Product>() {
            public Farm.Product parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.Product(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            getSerializedSize();
            if ((this.bitField0_ & 0x1) == 1) output.writeBytes(1, getProductCodeBytes());
            if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.num_);
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if (size != -1) return size;
            size = 0;
            if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeBytesSize(1, getProductCodeBytes());
            if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.num_);
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements Farm.ProductOrBuilder {
            private int bitField0_;
            private Object productCode_;
            private int num_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return Farm.internal_static_pomelo_farm_Product_fieldAccessorTable.ensureFieldAccessorsInitialized(Farm.Product.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (Farm.Product.alwaysUseFieldBuilders) ;
            }
            ...
            public Farm.Product getDefaultInstanceForType() {
                return Farm.Product.getDefaultInstance();
            }

            public Farm.Product build() {
                Farm.Product result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public Farm.Product buildPartial() {
                Farm.Product result = new Farm.Product(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof Farm.Product) return mergeFrom((Farm.Product) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(Farm.Product other) {
                if (other == Farm.Product.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                Farm.Product parsedMessage = null;
                try {
                    parsedMessage = (Farm.Product) Farm.Product.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (Farm.Product) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            public Builder clearProductCode() {
                this.bitField0_ &= 0xFFFFFFFE;
                this.productCode_ = Farm.Product.getDefaultInstance().getProductCode();
                onChanged();
                return this;
            }
    ...
    public static final class RecordInfo
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 16:
                            this.bitField0_ |= 0x2;
                            this.recordTimeStamp_ = input.readInt64();
                            break;
                        case 26:
                            bs = input.readBytes();
                            if ((mutable_bitField0_ & 0x4) != 4) {
                                this.recordParams_ = (LazyStringList) new LazyStringArrayList();
                                mutable_bitField0_ |= 0x4;
                            }
                            this.recordParams_.add(bs);
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x4) == 4) this.recordParams_ = this.recordParams_.getUnmodifiableView();
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return Farm.internal_static_pomelo_farm_RecordInfo_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_RecordInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RecordInfo.class, Builder.class);
        }

        public static Parser<RecordInfo> PARSER = (Parser<RecordInfo>) new AbstractParser<RecordInfo>() {
            public Farm.RecordInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.RecordInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        private LazyStringList recordParams_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        private static final long serialVersionUID = 0L;
        ...
        public ProtocolStringList getRecordParamsList() {
            return (ProtocolStringList) this.recordParams_;
        }

        public int getRecordParamsCount() {
            return this.recordParams_.size();
        }

        public String getRecordParams(int index) {
            return (String) this.recordParams_.get(index);
        }

        public ByteString getRecordParamsBytes(int index) {
            return this.recordParams_.getByteString(index);
        }

        private void initFields() {
            this.recordType_ = 0;
            this.recordTimeStamp_ = 0L;
            this.recordParams_ = LazyStringArrayList.EMPTY;
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            getSerializedSize();
            if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.recordType_);
            if ((this.bitField0_ & 0x2) == 2) output.writeInt64(2, this.recordTimeStamp_);
            for (int i = 0; i < this.recordParams_.size(); i++)
                output.writeBytes(3, this.recordParams_.getByteString(i));
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if (size != -1) return size;
            size = 0;
            if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.recordType_);
            if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt64Size(2, this.recordTimeStamp_);
            int dataSize = 0;
            for (int i = 0; i < this.recordParams_.size(); i++)
                dataSize += CodedOutputStream.computeBytesSizeNoTag(this.recordParams_.getByteString(i));
            size += dataSize;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements Farm.RecordInfoOrBuilder {
            private int bitField0_;
            private int recordType_;
            private long recordTimeStamp_;
            private LazyStringList recordParams_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return Farm.internal_static_pomelo_farm_RecordInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(Farm.RecordInfo.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (Farm.RecordInfo.alwaysUseFieldBuilders) ;
            }
            ...
            public Farm.RecordInfo getDefaultInstanceForType() {
                return Farm.RecordInfo.getDefaultInstance();
            }

            public Farm.RecordInfo build() {
                Farm.RecordInfo result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public Farm.RecordInfo buildPartial() {
                Farm.RecordInfo result = new Farm.RecordInfo(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
                result.recordType_ = this.recordType_;
                if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;
                result.recordTimeStamp_ = this.recordTimeStamp_;
                if ((this.bitField0_ & 0x4) == 4) {
                    this.recordParams_ = this.recordParams_.getUnmodifiableView();
                    this.bitField0_ &= 0xFFFFFFFB;
                }
                result.recordParams_ = this.recordParams_;
                result.bitField0_ = to_bitField0_;
                onBuilt();
                return result;
            }
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof Farm.RecordInfo) return mergeFrom((Farm.RecordInfo) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(Farm.RecordInfo other) {
                if (other == Farm.RecordInfo.getDefaultInstance()) return this;
                if (other.hasRecordType()) setRecordType(other.getRecordType());
                if (other.hasRecordTimeStamp()) setRecordTimeStamp(other.getRecordTimeStamp());
                if (!other.recordParams_.isEmpty()) {
                    if (this.recordParams_.isEmpty()) {
                        this.recordParams_ = other.recordParams_;
                        this.bitField0_ &= 0xFFFFFFFB;
                    } else {
                        ensureRecordParamsIsMutable();
                        this.recordParams_.addAll((Collection) other.recordParams_);
                    }
                    onChanged();
                }
                mergeUnknownFields(other.getUnknownFields());
            ...
            public final boolean isInitialized() {
                if (!hasRecordType()) return false;
                if (!hasRecordTimeStamp()) return false;
                return true;
            }

            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                Farm.RecordInfo parsedMessage = null;
                try {
                    parsedMessage = (Farm.RecordInfo) Farm.RecordInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (Farm.RecordInfo) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            private void ensureRecordParamsIsMutable() {
                if ((this.bitField0_ & 0x4) != 4) {
                    this.recordParams_ = (LazyStringList) new LazyStringArrayList(this.recordParams_);
                    this.bitField0_ |= 0x4;
                }
            }

            public ProtocolStringList getRecordParamsList() {
                return (ProtocolStringList) this.recordParams_.getUnmodifiableView();
            }
            ...
            public Builder setRecordParams(int index, String value) {
                if (value == null) throw new NullPointerException();
                ensureRecordParamsIsMutable();
                this.recordParams_.set(index, value);
                onChanged();
                return this;
            }

            public Builder addRecordParams(String value) {
                if (value == null) throw new NullPointerException();
                ensureRecordParamsIsMutable();
                this.recordParams_.add(value);
                onChanged();
                return this;
            }

            public Builder addAllRecordParams(Iterable<String> values) {
                ensureRecordParamsIsMutable();
                AbstractMessageLite.Builder.addAll(values, (Collection) this.recordParams_);
                onChanged();
                return this;
            }
            ...
            public Builder addRecordParamsBytes(ByteString value) {
                if (value == null) throw new NullPointerException();
                ensureRecordParamsIsMutable();
                this.recordParams_.add(value);
                onChanged();
    ...
    public static final class PlayerSummary
        ...
        private static final PlayerSummary defaultInstance = new PlayerSummary(true);
        private final UnknownFieldSet unknownFields;

        private PlayerSummary(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private PlayerSummary(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private PlayerSummary(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 32:
                            this.bitField0_ |= 0x8;
                            this.farmLv_ = input.readInt32();
                            break;
                        case 40:
                            this.bitField0_ |= 0x10;
                            this.canSow_ = input.readBool();
                            break;
                        case 48:
                            this.bitField0_ |= 0x20;
                            this.canSteal_ = input.readBool();
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_PlayerSummary_fieldAccessorTable.ensureFieldAccessorsInitialized(PlayerSummary.class, Builder.class);
        }

        public static Parser<PlayerSummary> PARSER = (Parser<PlayerSummary>) new AbstractParser<PlayerSummary>() {
            public Farm.PlayerSummary parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.PlayerSummary(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<PlayerSummary> getParserForType() {
            return PARSER;
        }
    ...
    public static final class PlayerInfo
        ...
        private PlayerInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ByteString bs;
                    Farm.PlayerSummary.Builder subBuilder;
                    int tag = input.readTag();
                    switch (tag) {
                        case 0:
                            done = true;
                        ...
                        case 18:
                            subBuilder = null;
                            if ((this.bitField0_ & 0x2) == 2) subBuilder = this.playerSummary_.toBuilder();
                            this.playerSummary_ = (Farm.PlayerSummary) input.readMessage(Farm.PlayerSummary.PARSER, extensionRegistry);
                            if (subBuilder != null) {
                                subBuilder.mergeFrom(this.playerSummary_);
                                this.playerSummary_ = subBuilder.buildPartial();
                            }
                            this.bitField0_ |= 0x2;
                            break;
                        case 26:
                            if ((mutable_bitField0_ & 0x4) != 4) {
                                this.blockLs_ = new ArrayList<>();
                                mutable_bitField0_ |= 0x4;
                            }
                            this.blockLs_.add(input.readMessage(Farm.Block.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x4) == 4) this.blockLs_ = Collections.unmodifiableList(this.blockLs_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_PlayerInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(PlayerInfo.class, Builder.class);
        }

        public static Parser<PlayerInfo> PARSER = (Parser<PlayerInfo>) new AbstractParser<PlayerInfo>() {
            public Farm.PlayerInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.PlayerInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int PLAYERID_FIELD_NUMBER = 1;
    ...
    public static final class ShopItemInfo
        ...
        private static final ShopItemInfo defaultInstance = new ShopItemInfo(true);
        private final UnknownFieldSet unknownFields;

        private ShopItemInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private ShopItemInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private ShopItemInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 16:
                            this.bitField0_ |= 0x2;
                            this.changeNumCurrent_ = input.readInt32();
                            break;
                        case 24:
                            this.bitField0_ |= 0x4;
                            this.changeNumMax_ = input.readInt32();
                            break;
                        case 34:
                            if ((mutable_bitField0_ & 0x8) != 8) {
                                this.need_ = new ArrayList<>();
                                mutable_bitField0_ |= 0x8;
                            }
                            this.need_.add(input.readMessage(Common.KeyValueStruct.PARSER, extensionRegistry));
                            break;
                        case 42:
                            ...
                            this.award_.add(input.readMessage(Common.KeyValueStruct.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x8) == 8) this.need_ = Collections.unmodifiableList(this.need_);
                if ((mutable_bitField0_ & 0x10) == 16) this.award_ = Collections.unmodifiableList(this.award_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return Farm.internal_static_pomelo_farm_ShopItemInfo_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return Farm.internal_static_pomelo_farm_ShopItemInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(ShopItemInfo.class, Builder.class);
        }

        public static Parser<ShopItemInfo> PARSER = (Parser<ShopItemInfo>) new AbstractParser<ShopItemInfo>() {
            public Farm.ShopItemInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Farm.ShopItemInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<ShopItemInfo> getParserForType() {
            return PARSER;
        }
        ...
        public int getChangeNumMax() {
            return this.changeNumMax_;
        }

        public List<Common.KeyValueStruct> getNeedList() {
            return this.need_;
        }

        public List<? extends Common.KeyValueStructOrBuilder> getNeedOrBuilderList() {
            return (List) this.need_;
        }

        public int getNeedCount() {
            return this.need_.size();
        }

        public Common.KeyValueStruct getNeed(int index) {
            return this.need_.get(index);
        }

        public Common.KeyValueStructOrBuilder getNeedOrBuilder(int index) {
            return (Common.KeyValueStructOrBuilder) this.need_.get(index);
        }

        public List<Common.KeyValueStruct> getAwardList() {
            return this.award_;
        }

        public List<? extends Common.KeyValueStructOrBuilder> getAwardOrBuilderList() {
        ...
        public Common.KeyValueStruct getAward(int index) {
            return this.award_.get(index);
        }

        public Common.KeyValueStructOrBuilder getAwardOrBuilder(int index) {
            return (Common.KeyValueStructOrBuilder) this.award_.get(index);
        }

        private void initFields() {
            this.itemId_ = 0;
            this.changeNumCurrent_ = 0;
            this.changeNumMax_ = 0;
            this.need_ = Collections.emptyList();
        ...
        public final boolean isInitialized() {
            ...
            int i;
            for (i = 0; i < getNeedCount(); i++) {
                if (!getNeed(i).isInitialized()) {
                    this.memoizedIsInitialized = 0;
                    return false;
                }
            }
            for (i = 0; i < getAwardCount(); i++) {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.changeNumCurrent_);
            if ((this.bitField0_ & 0x4) == 4) output.writeInt32(3, this.changeNumMax_);
            int i;
            for (i = 0; i < this.need_.size(); i++) output.writeMessage(4, (MessageLite) this.need_.get(i));
            for (i = 0; i < this.award_.size(); i++) output.writeMessage(5, (MessageLite) this.award_.get(i));
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.changeNumCurrent_);
            if ((this.bitField0_ & 0x4) == 4) size += CodedOutputStream.computeInt32Size(3, this.changeNumMax_);
            int i;
            for (i = 0; i < this.need_.size(); i++)
                size += CodedOutputStream.computeMessageSize(4, (MessageLite) this.need_.get(i));
            for (i = 0; i < this.award_.size(); i++)
                size += CodedOutputStream.computeMessageSize(5, (MessageLite) this.award_.get(i));
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public static ShopItemInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (ShopItemInfo) PARSER.parseFrom(data);
        }

        public static ShopItemInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (ShopItemInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static ShopItemInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (ShopItemInfo) PARSER.parseFrom(data);
        }

        public static ShopItemInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (ShopItemInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static ShopItemInfo parseFrom(InputStream input) throws IOException {
            return (ShopItemInfo) PARSER.parseFrom(input);
        }

        public static ShopItemInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ShopItemInfo) PARSER.parseFrom(input, extensionRegistry);
        }

        public static ShopItemInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (ShopItemInfo) PARSER.parseDelimitedFrom(input);
        }

        public static ShopItemInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ShopItemInfo) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static ShopItemInfo parseFrom(CodedInputStream input) throws IOException {
            return (ShopItemInfo) PARSER.parseFrom(input);
        }

        public static ShopItemInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (ShopItemInfo) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(ShopItemInfo prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements Farm.ShopItemInfoOrBuilder {
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return Farm.internal_static_pomelo_farm_ShopItemInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(Farm.ShopItemInfo.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (Farm.ShopItemInfo.alwaysUseFieldBuilders) {
                    getNeedFieldBuilder();
            ...
            public Builder clear() {
                ...
                this.changeNumMax_ = 0;
                this.bitField0_ &= 0xFFFFFFFB;
                if (this.needBuilder_ == null) {
                    this.need_ = Collections.emptyList();
                    this.bitField0_ &= 0xFFFFFFF7;
                } else {
                    this.needBuilder_.clear();
                }
            ...
            public Farm.ShopItemInfo getDefaultInstanceForType() {
                return Farm.ShopItemInfo.getDefaultInstance();
            }

            public Farm.ShopItemInfo build() {
                Farm.ShopItemInfo result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }
            ...
            public Farm.ShopItemInfo buildPartial() {
                ...
                if ((from_bitField0_ & 0x2) == 2) to_bitField0_ |= 0x2;
                result.changeNumCurrent_ = this.changeNumCurrent_;
                if ((from_bitField0_ & 0x4) == 4) to_bitField0_ |= 0x4;
                result.changeNumMax_ = this.changeNumMax_;
                if (this.needBuilder_ == null) {
                    if ((this.bitField0_ & 0x8) == 8) {
                        this.need_ = Collections.unmodifiableList(this.need_);
                        this.bitField0_ &= 0xFFFFFFF7;
                    }
                    result.need_ = this.need_;
                } else {
                    result.need_ = this.needBuilder_.build();
                }
                if (this.awardBuilder_ == null) {
                    if ((this.bitField0_ & 0x10) == 16) {
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof Farm.ShopItemInfo) return mergeFrom((Farm.ShopItemInfo) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(Farm.ShopItemInfo other) {
                if (other == Farm.ShopItemInfo.getDefaultInstance()) return this;
                if (other.hasItemId()) setItemId(other.getItemId());
                if (other.hasChangeNumCurrent()) setChangeNumCurrent(other.getChangeNumCurrent());
                if (other.hasChangeNumMax()) setChangeNumMax(other.getChangeNumMax());
                if (this.needBuilder_ == null) {
                    if (!other.need_.isEmpty()) {
                        if (this.need_.isEmpty()) {
                            this.need_ = other.need_;
                            this.bitField0_ &= 0xFFFFFFF7;
                        } else {
                            ensureNeedIsMutable();
                            this.need_.addAll(other.need_);
                        }
                        onChanged();
                    }
                } else if (!other.need_.isEmpty()) {
                    if (this.needBuilder_.isEmpty()) {
                        this.needBuilder_.dispose();
                        this.needBuilder_ = null;
                        this.need_ = other.need_;
                        this.bitField0_ &= 0xFFFFFFF7;
                        this.needBuilder_ = Farm.ShopItemInfo.alwaysUseFieldBuilders ? getNeedFieldBuilder() : null;
                    } else {
                        this.needBuilder_.addAllMessages(other.need_);
                    }
                }
                if (this.awardBuilder_ == null) {
                    ...
                    if (this.awardBuilder_.isEmpty()) {
                        ...
                        this.award_ = other.award_;
                        this.bitField0_ &= 0xFFFFFFEF;
                        this.awardBuilder_ = Farm.ShopItemInfo.alwaysUseFieldBuilders ? getAwardFieldBuilder() : null;
                    } else {
            ...
            public final boolean isInitialized() {
                ...
                if (!hasChangeNumCurrent()) return false;
                if (!hasChangeNumMax()) return false;
                int i;
                for (i = 0; i < getNeedCount(); i++) {
                    if (!getNeed(i).isInitialized()) return false;
                }
                for (i = 0; i < getAwardCount(); i++) {
                    if (!getAward(i).isInitialized()) return false;
                }
                return true;
            }

            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                Farm.ShopItemInfo parsedMessage = null;
                try {
                    parsedMessage = (Farm.ShopItemInfo) Farm.ShopItemInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (Farm.ShopItemInfo) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            private void ensureNeedIsMutable() {
                if ((this.bitField0_ & 0x8) != 8) {
                    this.need_ = new ArrayList<>(this.need_);
                    this.bitField0_ |= 0x8;
                }
            }

            public List<Common.KeyValueStruct> getNeedList() {
                if (this.needBuilder_ == null) return Collections.unmodifiableList(this.need_);
                return this.needBuilder_.getMessageList();
            }

            public int getNeedCount() {
                if (this.needBuilder_ == null) return this.need_.size();
                return this.needBuilder_.getCount();
            }

            public Common.KeyValueStruct getNeed(int index) {
                if (this.needBuilder_ == null) return this.need_.get(index);
                return (Common.KeyValueStruct) this.needBuilder_.getMessage(index);
            }

            public Builder setNeed(int index, Common.KeyValueStruct value) {
                if (this.needBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureNeedIsMutable();
                    this.need_.set(index, value);
                    onChanged();
                } else {
                    this.needBuilder_.setMessage(index, (GeneratedMessage) value);
                }
                return this;
            }

            public Builder setNeed(int index, Common.KeyValueStruct.Builder builderForValue) {
                if (this.needBuilder_ == null) {
                    ensureNeedIsMutable();
                    this.need_.set(index, builderForValue.build());
                    onChanged();
                } else {
                    this.needBuilder_.setMessage(index, (GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addNeed(Common.KeyValueStruct value) {
                if (this.needBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureNeedIsMutable();
                    this.need_.add(value);
                    onChanged();
                } else {
                    this.needBuilder_.addMessage((GeneratedMessage) value);
                }
                return this;
            }

            public Builder addNeed(int index, Common.KeyValueStruct value) {
                if (this.needBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureNeedIsMutable();
                    this.need_.add(index, value);
                    onChanged();
                } else {
                    this.needBuilder_.addMessage(index, (GeneratedMessage) value);
                }
                return this;
            }

            public Builder addNeed(Common.KeyValueStruct.Builder builderForValue) {
                if (this.needBuilder_ == null) {
                    ensureNeedIsMutable();
                    this.need_.add(builderForValue.build());
                    onChanged();
                } else {
                    this.needBuilder_.addMessage((GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addNeed(int index, Common.KeyValueStruct.Builder builderForValue) {
                if (this.needBuilder_ == null) {
                    ensureNeedIsMutable();
                    this.need_.add(index, builderForValue.build());
                    onChanged();
                } else {
                    this.needBuilder_.addMessage(index, (GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addAllNeed(Iterable<? extends Common.KeyValueStruct> values) {
                if (this.needBuilder_ == null) {
                    ensureNeedIsMutable();
                    AbstractMessageLite.Builder.addAll(values, this.need_);
                    onChanged();
                } else {
                    this.needBuilder_.addAllMessages(values);
                }
                return this;
            }
            ...
            public Builder removeNeed(int index) {
                if (this.needBuilder_ == null) {
                    ensureNeedIsMutable();
                    this.need_.remove(index);
                    onChanged();
                } else {
                    this.needBuilder_.remove(index);
                }
                return this;
            }

            public Common.KeyValueStruct.Builder getNeedBuilder(int index) {
                return (Common.KeyValueStruct.Builder) getNeedFieldBuilder().getBuilder(index);
            }

            public Common.KeyValueStructOrBuilder getNeedOrBuilder(int index) {
                if (this.needBuilder_ == null) return (Common.KeyValueStructOrBuilder) this.need_.get(index);
                return (Common.KeyValueStructOrBuilder) this.needBuilder_.getMessageOrBuilder(index);
            }

            public List<? extends Common.KeyValueStructOrBuilder> getNeedOrBuilderList() {
                if (this.needBuilder_ != null) return this.needBuilder_.getMessageOrBuilderList();
                return (List) Collections.unmodifiableList(this.need_);
            }

            public Common.KeyValueStruct.Builder addNeedBuilder() {
                return (Common.KeyValueStruct.Builder) getNeedFieldBuilder().addBuilder((GeneratedMessage) Common.KeyValueStruct.getDefaultInstance());
            }

            public Common.KeyValueStruct.Builder addNeedBuilder(int index) {
                return (Common.KeyValueStruct.Builder) getNeedFieldBuilder().addBuilder(index, (GeneratedMessage) Common.KeyValueStruct.getDefaultInstance());
            }

            public List<Common.KeyValueStruct.Builder> getNeedBuilderList() {
                return getNeedFieldBuilder().getBuilderList();
            }

            private RepeatedFieldBuilder<Common.KeyValueStruct, Common.KeyValueStruct.Builder, Common.KeyValueStructOrBuilder> getNeedFieldBuilder() {
                if (this.needBuilder_ == null) {
                    this.needBuilder_ = new RepeatedFieldBuilder(this.need_, ((this.bitField0_ & 0x8) == 8), getParentForChildren(), isClean());
                    this.need_ = null;
                }
                return this.needBuilder_;
            }
            ...
            public List<Common.KeyValueStruct> getAwardList() {
                if (this.awardBuilder_ == null) return Collections.unmodifiableList(this.award_);
                return this.awardBuilder_.getMessageList();
            }

            public int getAwardCount() {
                if (this.awardBuilder_ == null) return this.award_.size();
                return this.awardBuilder_.getCount();
            }

            public Common.KeyValueStruct getAward(int index) {
                if (this.awardBuilder_ == null) return this.award_.get(index);
                return (Common.KeyValueStruct) this.awardBuilder_.getMessage(index);
            }

            public Builder setAward(int index, Common.KeyValueStruct value) {
                if (this.awardBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureAwardIsMutable();
                    ...
                    this.awardBuilder_.setMessage(index, (GeneratedMessage) value);
                }
                return this;
            }

            public Builder setAward(int index, Common.KeyValueStruct.Builder builderForValue) {
                if (this.awardBuilder_ == null) {
                    ensureAwardIsMutable();
                    this.award_.set(index, builderForValue.build());
                    onChanged();
                } else {
                    this.awardBuilder_.setMessage(index, (GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addAward(Common.KeyValueStruct value) {
                if (this.awardBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureAwardIsMutable();
                    ...
                    this.awardBuilder_.addMessage((GeneratedMessage) value);
                }
                return this;
            }

            public Builder addAward(int index, Common.KeyValueStruct value) {
                if (this.awardBuilder_ == null) {
                    if (value == null) throw new NullPointerException();
                    ensureAwardIsMutable();
                    ...
                    this.awardBuilder_.addMessage(index, (GeneratedMessage) value);
                }
                return this;
            }

            public Builder addAward(Common.KeyValueStruct.Builder builderForValue) {
                if (this.awardBuilder_ == null) {
                    ensureAwardIsMutable();
                    this.award_.add(builderForValue.build());
                    onChanged();
                } else {
                    this.awardBuilder_.addMessage((GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addAward(int index, Common.KeyValueStruct.Builder builderForValue) {
                if (this.awardBuilder_ == null) {
                    ensureAwardIsMutable();
                    this.award_.add(index, builderForValue.build());
                    onChanged();
                } else {
                    this.awardBuilder_.addMessage(index, (GeneratedMessage) builderForValue.build());
                }
                return this;
            }

            public Builder addAllAward(Iterable<? extends Common.KeyValueStruct> values) {
                if (this.awardBuilder_ == null) {
                    ensureAwardIsMutable();
            ...
            public Common.KeyValueStruct.Builder getAwardBuilder(int index) {
                return (Common.KeyValueStruct.Builder) getAwardFieldBuilder().getBuilder(index);
            }

            public Common.KeyValueStructOrBuilder getAwardOrBuilder(int index) {
                if (this.awardBuilder_ == null) return (Common.KeyValueStructOrBuilder) this.award_.get(index);
                return (Common.KeyValueStructOrBuilder) this.awardBuilder_.getMessageOrBuilder(index);
            }

            public List<? extends Common.KeyValueStructOrBuilder> getAwardOrBuilderList() {
                if (this.awardBuilder_ != null) return this.awardBuilder_.getMessageOrBuilderList();
                return (List) Collections.unmodifiableList(this.award_);
            }

            public Common.KeyValueStruct.Builder addAwardBuilder() {
                return (Common.KeyValueStruct.Builder) getAwardFieldBuilder().addBuilder((GeneratedMessage) Common.KeyValueStruct.getDefaultInstance());
            }

            public Common.KeyValueStruct.Builder addAwardBuilder(int index) {
                return (Common.KeyValueStruct.Builder) getAwardFieldBuilder().addBuilder(index, (GeneratedMessage) Common.KeyValueStruct.getDefaultInstance());
            }

            public List<Common.KeyValueStruct.Builder> getAwardBuilderList() {
                return getAwardFieldBuilder().getBuilderList();
            }

            private RepeatedFieldBuilder<Common.KeyValueStruct, Common.KeyValueStruct.Builder, Common.KeyValueStructOrBuilder> getAwardFieldBuilder() {
                if (this.awardBuilder_ == null) {
                    this.awardBuilder_ = new RepeatedFieldBuilder(this.award_, ((this.bitField0_ & 0x10) == 16), getParentForChildren(), isClean());
                    this.award_ = null;
                }
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_farm_Block_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_Block_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_Block_descriptor, new String[]{"BlockId", "BlockState", "SeedCode", "SeedState", "CultivateType", "HarvestTime", "ProtectEndTime"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_Seed_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_Seed_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_Seed_descriptor, new String[]{"SeedCode", "Num"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_Product_descriptor = getDescriptor().getMessageTypes().get(2);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_Product_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_Product_descriptor, new String[]{"ProductCode", "Num"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_RecordInfo_descriptor = getDescriptor().getMessageTypes().get(3);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_RecordInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_RecordInfo_descriptor, new String[]{"RecordType", "RecordTimeStamp", "RecordParams"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_PlayerSummary_descriptor = getDescriptor().getMessageTypes().get(4);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_PlayerSummary_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_PlayerSummary_descriptor, new String[]{"PlayerId", "RoleName", "Lv", "FarmLv", "CanSow", "CanSteal"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_PlayerInfo_descriptor = getDescriptor().getMessageTypes().get(5);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_PlayerInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_PlayerInfo_descriptor, new String[]{"PlayerId", "PlayerSummary", "BlockLs"});


    private static final Descriptors.Descriptor internal_static_pomelo_farm_ShopItemInfo_descriptor = getDescriptor().getMessageTypes().get(6);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_farm_ShopItemInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_farm_ShopItemInfo_descriptor, new String[]{"ItemId", "ChangeNumCurrent", "ChangeNumMax", "Need", "Award"});
