...
public final class ActivityRevelryHandler {
    ...
    public static final class RevelryColumnInfo
        ...
        private static final RevelryColumnInfo defaultInstance = new RevelryColumnInfo(true);
        private final UnknownFieldSet unknownFields;

        private RevelryColumnInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
        ...
        private RevelryColumnInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
        ...
        private RevelryColumnInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryColumnInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryColumnInfo.class, Builder.class);
        }

        public static Parser<RevelryColumnInfo> PARSER = (Parser<RevelryColumnInfo>) new AbstractParser<RevelryColumnInfo>() {
            public ActivityRevelryHandler.RevelryColumnInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryColumnInfo(input, extensionRegistry);
            }
        };
        ...
        public Parser<RevelryColumnInfo> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryTodayInfo
        ...
        private static final RevelryTodayInfo defaultInstance = new RevelryTodayInfo(true);
        private final UnknownFieldSet unknownFields;

        private RevelryTodayInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryTodayInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryTodayInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18:
                            ...
                            this.column_.add(input.readMessage(ActivityRevelryHandler.RevelryColumnInfo.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x2) == 2) this.column_ = Collections.unmodifiableList(this.column_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryTodayInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryTodayInfo.class, Builder.class);
        }

        public static Parser<RevelryTodayInfo> PARSER = (Parser<RevelryTodayInfo>) new AbstractParser<RevelryTodayInfo>() {
            public ActivityRevelryHandler.RevelryTodayInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryTodayInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<RevelryTodayInfo> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryTabInfo
        ...
        private static final RevelryTabInfo defaultInstance = new RevelryTabInfo(true);
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.today_.size(); i++) output.writeMessage(2, (MessageLite) this.today_.get(i));
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < this.today_.size(); i++)
                size += CodedOutputStream.computeMessageSize(2, (MessageLite) this.today_.get(i));
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public static RevelryTabInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryTabInfo) PARSER.parseFrom(data);
        }

        public static RevelryTabInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryTabInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryTabInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryTabInfo) PARSER.parseFrom(data);
        }

        public static RevelryTabInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryTabInfo) PARSER.parseFrom(data, extensionRegistry);
        }
    ...
    public static final class KingExchange
        ...
        private static final KingExchange defaultInstance = new KingExchange(true);
        private final UnknownFieldSet unknownFields;

        private KingExchange(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private KingExchange(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private KingExchange(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 32:
                            this.bitField0_ |= 0x8;
                            this.item1Num_ = input.readInt32();
                            break;
                        case 42:
                            bs = input.readBytes();
                            this.bitField0_ |= 0x10;
                        ...
                        case 48:
                            this.bitField0_ |= 0x20;
                            this.item2Num_ = input.readInt32();
                            break;
                        case 58:
                            bs = input.readBytes();
                        ...
                        case 72:
                            ...
                            this.showType_ = input.readInt32();
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_KingExchange_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_KingExchange_fieldAccessorTable.ensureFieldAccessorsInitialized(KingExchange.class, Builder.class);
        }

        public static Parser<KingExchange> PARSER = (Parser<KingExchange>) new AbstractParser<KingExchange>() {
            public ActivityRevelryHandler.KingExchange parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.KingExchange(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<KingExchange> getParserForType() {
            return PARSER;
        }
        ...
        public String getTabName() {
            Object ref = this.tabName_;
            if (ref instanceof String) return (String) ref;
            ByteString bs = (ByteString) ref;
            String s = bs.toStringUtf8();
            if (bs.isValidUtf8()) this.tabName_ = s;
            return s;
        }
        ...
        public String getItem1Code() {
            Object ref = this.item1Code_;
            if (ref instanceof String) return (String) ref;
            ByteString bs = (ByteString) ref;
            String s = bs.toStringUtf8();
            if (bs.isValidUtf8()) this.item1Code_ = s;
            return s;
        }

        public ByteString getItem1CodeBytes() {
            Object ref = this.item1Code_;
            if (ref instanceof String) {
                ByteString b = ByteString.copyFromUtf8((String) ref);
                this.item1Code_ = b;
        ...
        public String getItem2Code() {
            Object ref = this.item2Code_;
            if (ref instanceof String) return (String) ref;
            ByteString bs = (ByteString) ref;
            String s = bs.toStringUtf8();
            if (bs.isValidUtf8()) this.item2Code_ = s;
            return s;
        }

        public ByteString getItem2CodeBytes() {
            Object ref = this.item2Code_;
            if (ref instanceof String) {
                ByteString b = ByteString.copyFromUtf8((String) ref);
                this.item2Code_ = b;
        ...
        public String getAvatarId() {
            Object ref = this.avatarId_;
            if (ref instanceof String) return (String) ref;
            ByteString bs = (ByteString) ref;
            String s = bs.toStringUtf8();
            if (bs.isValidUtf8()) this.avatarId_ = s;
            return s;
        }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 0x2) == 2)
                size += CodedOutputStream.computeBytesSize(2, getTabNameBytes());
            if ((this.bitField0_ & 0x4) == 4)
                size += CodedOutputStream.computeBytesSize(3, getItem1CodeBytes());
            if ((this.bitField0_ & 0x8) == 8)
                size += CodedOutputStream.computeInt32Size(4, this.item1Num_);
            if ((this.bitField0_ & 0x10) == 16)
                size += CodedOutputStream.computeBytesSize(5, getItem2CodeBytes());
            if ((this.bitField0_ & 0x20) == 32)
                size += CodedOutputStream.computeInt32Size(6, this.item2Num_);
            if ((this.bitField0_ & 0x40) == 64)
                size += CodedOutputStream.computeBytesSize(7, getAvatarIdBytes());
            if ((this.bitField0_ & 0x80) == 128)
                size += CodedOutputStream.computeBytesSize(8, getTipBytes());
            if ((this.bitField0_ & 0x100) == 256)
                size += CodedOutputStream.computeInt32Size(9, this.showType_);
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public static KingExchange parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (KingExchange) PARSER.parseFrom(data);
        }

        public static KingExchange parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (KingExchange) PARSER.parseFrom(data, extensionRegistry);
        }

        public static KingExchange parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (KingExchange) PARSER.parseFrom(data);
        }

        public static KingExchange parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (KingExchange) PARSER.parseFrom(data, extensionRegistry);
        }

        public static KingExchange parseFrom(InputStream input) throws IOException {
            return (KingExchange) PARSER.parseFrom(input);
        }

        public static KingExchange parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (KingExchange) PARSER.parseFrom(input, extensionRegistry);
        }

        public static KingExchange parseDelimitedFrom(InputStream input) throws IOException {
            return (KingExchange) PARSER.parseDelimitedFrom(input);
        }

        public static KingExchange parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (KingExchange) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static KingExchange parseFrom(CodedInputStream input) throws IOException {
            return (KingExchange) PARSER.parseFrom(input);
        }

        public static KingExchange parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (KingExchange) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(KingExchange prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.KingExchangeOrBuilder {
            private int bitField0_;
            private int tabId_;
            private Object tabName_;
            private Object item1Code_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_KingExchange_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.KingExchange.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.KingExchange.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.KingExchange getDefaultInstanceForType() {
                return ActivityRevelryHandler.KingExchange.getDefaultInstance();
            }

            public ActivityRevelryHandler.KingExchange build() {
                ActivityRevelryHandler.KingExchange result = buildPartial();
                if (!result.isInitialized())
                    throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.KingExchange buildPartial() {
                ActivityRevelryHandler.KingExchange result = new ActivityRevelryHandler.KingExchange(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1)
                    to_bitField0_ |= 0x1;
                ...
                if ((from_bitField0_ & 0x2) == 2)
                    to_bitField0_ |= 0x2;
                result.tabName_ = this.tabName_;
                if ((from_bitField0_ & 0x4) == 4)
                    to_bitField0_ |= 0x4;
                result.item1Code_ = this.item1Code_;
                if ((from_bitField0_ & 0x8) == 8)
                    to_bitField0_ |= 0x8;
                result.item1Num_ = this.item1Num_;
                if ((from_bitField0_ & 0x10) == 16)
                    to_bitField0_ |= 0x10;
                result.item2Code_ = this.item2Code_;
                if ((from_bitField0_ & 0x20) == 32)
                    to_bitField0_ |= 0x20;
                result.item2Num_ = this.item2Num_;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.KingExchange)
                    return mergeFrom((ActivityRevelryHandler.KingExchange) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.KingExchange other) {
                if (other == ActivityRevelryHandler.KingExchange.getDefaultInstance())
                    return this;
                if (other.hasTabId())
                ...
                if (other.hasItem1Code()) {
                    this.bitField0_ |= 0x4;
                    this.item1Code_ = other.item1Code_;
                    onChanged();
                }
                ...
                if (other.hasItem2Code()) {
                    this.bitField0_ |= 0x10;
                    this.item2Code_ = other.item2Code_;
                    onChanged();
                }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.KingExchange parsedMessage = null;
                try {
            ...
            public Builder setTabName(String value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x2;
                this.tabName_ = value;
            ...
            public Builder setTabNameBytes(ByteString value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x2;
                this.tabName_ = value;
            ...
            public Builder setItem1Code(String value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x4;
            ...
            public Builder setItem1CodeBytes(ByteString value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x4;
                this.item1Code_ = value;
            ...
            public Builder setItem2Code(String value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x10;
            ...
            public Builder setItem2CodeBytes(ByteString value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x10;
                this.item2Code_ = value;
            ...
            public Builder setAvatarIdBytes(ByteString value) {
                if (value == null)
                    throw new NullPointerException();
                this.bitField0_ |= 0x40;
                this.avatarId_ = value;
    ...
    public static final class RevelryGetColumnRequest extends GeneratedMessage implements RevelryGetColumnRequestOrBuilder {
        private static final RevelryGetColumnRequest defaultInstance = new RevelryGetColumnRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryGetColumnRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryGetColumnRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryGetColumnRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder();
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetColumnRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetColumnRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryGetColumnRequest.class, Builder.class);
        }

        public static Parser<RevelryGetColumnRequest> PARSER = (Parser<RevelryGetColumnRequest>) new AbstractParser<RevelryGetColumnRequest>() {
            public ActivityRevelryHandler.RevelryGetColumnRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryGetColumnRequest(input, extensionRegistry);
            }
        };
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        ...
        public Parser<RevelryGetColumnRequest> getParserForType() {
            return PARSER;
        }
        ...
        public static RevelryGetColumnRequest parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(data);
        }

        public static RevelryGetColumnRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryGetColumnRequest parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(data);
        }

        public static RevelryGetColumnRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryGetColumnRequest parseFrom(InputStream input) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(input);
        }

        public static RevelryGetColumnRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryGetColumnRequest parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryGetColumnRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryGetColumnRequest parseFrom(CodedInputStream input) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(input);
        }

        public static RevelryGetColumnRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetColumnRequest) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryGetColumnRequest prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryGetColumnRequestOrBuilder {
            public static final Descriptors.Descriptor getDescriptor() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetColumnRequest_descriptor;
            }

            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetColumnRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryGetColumnRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryGetColumnRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryGetColumnRequest getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryGetColumnRequest.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryGetColumnRequest build() {
                ActivityRevelryHandler.RevelryGetColumnRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryGetColumnRequest buildPartial() {
                ActivityRevelryHandler.RevelryGetColumnRequest result = new ActivityRevelryHandler.RevelryGetColumnRequest(this);
                onBuilt();
                return result;
            }

            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryGetColumnRequest)
                    return mergeFrom((ActivityRevelryHandler.RevelryGetColumnRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryGetColumnRequest other) {
                if (other == ActivityRevelryHandler.RevelryGetColumnRequest.getDefaultInstance()) return this;
                mergeUnknownFields(other.getUnknownFields());
                return this;
            }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryGetColumnRequest parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryGetColumnRequest) ActivityRevelryHandler.RevelryGetColumnRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryGetColumnRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
    ...
    public static final class RevelryGetColumnResponse
        ...
        private static final RevelryGetColumnResponse defaultInstance = new RevelryGetColumnResponse(true);
        private final UnknownFieldSet unknownFields;

        private RevelryGetColumnResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryGetColumnResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryGetColumnResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 26:
                            ...
                            this.info_.add(input.readMessage(ActivityRevelryHandler.RevelryTabInfo.PARSER, extensionRegistry));
                            break;
                        case 34:
                            if ((mutable_bitField0_ & 0x8) != 8) {
                                this.exchange_ = new ArrayList<>();
                                mutable_bitField0_ |= 0x8;
                            }
                            this.exchange_.add(input.readMessage(ActivityRevelryHandler.KingExchange.PARSER, extensionRegistry));
                            break;
                        case 40:
                            this.bitField0_ |= 0x4;
                            this.selectedIndex_ = input.readInt32();
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x4) == 4) this.info_ = Collections.unmodifiableList(this.info_);
                if ((mutable_bitField0_ & 0x8) == 8) this.exchange_ = Collections.unmodifiableList(this.exchange_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetColumnResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryGetColumnResponse.class, Builder.class);
        }

        public static Parser<RevelryGetColumnResponse> PARSER = (Parser<RevelryGetColumnResponse>) new AbstractParser<RevelryGetColumnResponse>() {
            public ActivityRevelryHandler.RevelryGetColumnResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryGetColumnResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<RevelryGetColumnResponse> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryRankInfo
        ...
        private static final RevelryRankInfo defaultInstance = new RevelryRankInfo(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRankInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRankInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRankInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                if ((mutable_bitField0_ & 0x1) == 1) this.contents_ = this.contents_.getUnmodifiableView();
                if ((mutable_bitField0_ & 0x2) == 2) this.avatars_ = Collections.unmodifiableList(this.avatars_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRankInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRankInfo.class, Builder.class);
        }

        public static Parser<RevelryRankInfo> PARSER = (Parser<RevelryRankInfo>) new AbstractParser<RevelryRankInfo>() {
            public ActivityRevelryHandler.RevelryRankInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRankInfo(input, extensionRegistry);
            }
        };
        ...
        public Parser<RevelryRankInfo> getParserForType() {
            return PARSER;
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRankInfoOrBuilder {
            private int bitField0_;
            private LazyStringList contents_;
            private List<Common.Avatar> avatars_;
    ...
    public static final class RevelryAwardInfo extends GeneratedMessage implements RevelryAwardInfoOrBuilder {
        private final UnknownFieldSet unknownFields;
        ...
        public static Parser<RevelryAwardInfo> PARSER = (Parser<RevelryAwardInfo>) new AbstractParser<RevelryAwardInfo>() {
            public ActivityRevelryHandler.RevelryAwardInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        private static final RevelryAwardInfo defaultInstance = new RevelryAwardInfo(true);
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.itemcount_);
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.itemcount_);
            size += getUnknownFields().getSerializedSize();
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public static RevelryAwardInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryAwardInfo) PARSER.parseFrom(data);
        }

        public static RevelryAwardInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryAwardInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryAwardInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryAwardInfo) PARSER.parseFrom(data);
        }

        public static RevelryAwardInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryAwardInfo) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryAwardInfo parseFrom(InputStream input) throws IOException {
            return (RevelryAwardInfo) PARSER.parseFrom(input);
        }

        public static RevelryAwardInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryAwardInfo) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryAwardInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryAwardInfo) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryAwardInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryAwardInfo) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryAwardInfo parseFrom(CodedInputStream input) throws IOException {
            return (RevelryAwardInfo) PARSER.parseFrom(input);
        }

        public static RevelryAwardInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryAwardInfo) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryAwardInfo prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryAwardInfoOrBuilder {
            private int bitField0_;
            private Object itemcode_;
            private int itemcount_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryAwardInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryAwardInfo.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryAwardInfo.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryAwardInfo getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryAwardInfo.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryAwardInfo build() {
                ActivityRevelryHandler.RevelryAwardInfo result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryAwardInfo buildPartial() {
                ActivityRevelryHandler.RevelryAwardInfo result = new ActivityRevelryHandler.RevelryAwardInfo(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryAwardInfo)
                    return mergeFrom((ActivityRevelryHandler.RevelryAwardInfo) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryAwardInfo other) {
                if (other == ActivityRevelryHandler.RevelryAwardInfo.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryAwardInfo parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryAwardInfo) ActivityRevelryHandler.RevelryAwardInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryAwardInfo) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            public Builder clearItemcode() {
                this.bitField0_ &= 0xFFFFFFFE;
                this.itemcode_ = ActivityRevelryHandler.RevelryAwardInfo.getDefaultInstance().getItemcode();
                onChanged();
                return this;
            }
    ...
    public static final class RevelryConfigInfo
        ...
        private static final RevelryConfigInfo defaultInstance = new RevelryConfigInfo(true);
        private final UnknownFieldSet unknownFields;

        private RevelryConfigInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryConfigInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryConfigInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                boolean done = false;
                while (!done) {
                    ActivityRevelryHandler.RevelryRankInfo.Builder subBuilder;
                    int tag = input.readTag();
                    switch (tag) {
                        case 0:
                            done = true;
                        ...
                        case 26:
                            ...
                            this.award_.add(input.readMessage(ActivityRevelryHandler.RevelryAwardInfo.PARSER, extensionRegistry));
                            break;
                        case 34:
                            subBuilder = null;
                            if ((this.bitField0_ & 0x4) == 4) subBuilder = this.player_.toBuilder();
                            this.player_ = (ActivityRevelryHandler.RevelryRankInfo) input.readMessage(ActivityRevelryHandler.RevelryRankInfo.PARSER, extensionRegistry);
                            if (subBuilder != null) {
                ...
                if ((mutable_bitField0_ & 0x4) == 4) this.award_ = Collections.unmodifiableList(this.award_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryConfigInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryConfigInfo.class, Builder.class);
        }

        public static Parser<RevelryConfigInfo> PARSER = (Parser<RevelryConfigInfo>) new AbstractParser<RevelryConfigInfo>() {
            public ActivityRevelryHandler.RevelryConfigInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryConfigInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        private List<ActivityRevelryHandler.RevelryAwardInfo> award_;
        public static final int PLAYER_FIELD_NUMBER = 4;
        private ActivityRevelryHandler.RevelryRankInfo player_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        private static final long serialVersionUID = 0L;

        public Parser<RevelryConfigInfo> getParserForType() {
            return PARSER;
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryConfigInfoOrBuilder {
            ...
            private int maxRank_;
            private List<ActivityRevelryHandler.RevelryAwardInfo> award_;
            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryAwardInfo, ActivityRevelryHandler.RevelryAwardInfo.Builder, ActivityRevelryHandler.RevelryAwardInfoOrBuilder> awardBuilder_;
            private ActivityRevelryHandler.RevelryRankInfo player_;
            private SingleFieldBuilder<ActivityRevelryHandler.RevelryRankInfo, ActivityRevelryHandler.RevelryRankInfo.Builder, ActivityRevelryHandler.RevelryRankInfoOrBuilder> playerBuilder_;
    ...
    public static final class RevelryGetRankInfoRequest extends GeneratedMessage implements RevelryGetRankInfoRequestOrBuilder {
        private static final RevelryGetRankInfoRequest defaultInstance = new RevelryGetRankInfoRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryGetRankInfoRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryGetRankInfoRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryGetRankInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetRankInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryGetRankInfoRequest.class, Builder.class);
        }

        public static Parser<RevelryGetRankInfoRequest> PARSER = (Parser<RevelryGetRankInfoRequest>) new AbstractParser<RevelryGetRankInfoRequest>() {
            public ActivityRevelryHandler.RevelryGetRankInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryGetRankInfoRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int ID_FIELD_NUMBER = 1;
        ...
        public Parser<RevelryGetRankInfoRequest> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryGetRankInfoResponse
        ...
        private static final RevelryGetRankInfoResponse defaultInstance = new RevelryGetRankInfoResponse(true);
        private final UnknownFieldSet unknownFields;

        private RevelryGetRankInfoResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryGetRankInfoResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryGetRankInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 34:
                            ...
                            this.config_.add(input.readMessage(ActivityRevelryHandler.RevelryConfigInfo.PARSER, extensionRegistry));
                            break;
                        case 42:
                            subBuilder = null;
                            if ((this.bitField0_ & 0x8) == 8) subBuilder = this.self_.toBuilder();
                            this.self_ = (ActivityRevelryHandler.RevelryRankInfo) input.readMessage(ActivityRevelryHandler.RevelryRankInfo.PARSER, extensionRegistry);
                            if (subBuilder != null) {
                                subBuilder.mergeFrom(this.self_);
                                this.self_ = subBuilder.buildPartial();
                            }
                            this.bitField0_ |= 0x8;
                            break;
                        case 48:
                            this.bitField0_ |= 0x10;
                            this.selfRank_ = input.readInt32();
                            break;
                        case 58:
                            bs = input.readBytes();
                            this.bitField0_ |= 0x20;
                ...
                if ((mutable_bitField0_ & 0x8) == 8) this.config_ = Collections.unmodifiableList(this.config_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetRankInfoResponse_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetRankInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryGetRankInfoResponse.class, Builder.class);
        }

        public static Parser<RevelryGetRankInfoResponse> PARSER = (Parser<RevelryGetRankInfoResponse>) new AbstractParser<RevelryGetRankInfoResponse>() {
            public ActivityRevelryHandler.RevelryGetRankInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryGetRankInfoResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int S2C_CODE_FIELD_NUMBER = 1;
        ...
        private List<ActivityRevelryHandler.RevelryConfigInfo> config_;
        public static final int SELF_FIELD_NUMBER = 5;
        private ActivityRevelryHandler.RevelryRankInfo self_;
        ...
        public Parser<RevelryGetRankInfoResponse> getParserForType() {
            return PARSER;
        }
        ...
        public int getRankKey() {
            return this.rankKey_;
        }

        public List<ActivityRevelryHandler.RevelryConfigInfo> getConfigList() {
            return this.config_;
        }

        public List<? extends ActivityRevelryHandler.RevelryConfigInfoOrBuilder> getConfigOrBuilderList() {
            return (List) this.config_;
        }
        ...
        public ActivityRevelryHandler.RevelryConfigInfo getConfig(int index) {
            return this.config_.get(index);
        }

        public ActivityRevelryHandler.RevelryConfigInfoOrBuilder getConfigOrBuilder(int index) {
            return this.config_.get(index);
        }
        ...
        public ActivityRevelryHandler.RevelryRankInfo getSelf() {
            return this.self_;
        }

        public ActivityRevelryHandler.RevelryRankInfoOrBuilder getSelfOrBuilder() {
            return this.self_;
        }
        ...
        public static RevelryGetRankInfoResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(data);
        }

        public static RevelryGetRankInfoResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryGetRankInfoResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(data);
        }

        public static RevelryGetRankInfoResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryGetRankInfoResponse parseFrom(InputStream input) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(input);
        }

        public static RevelryGetRankInfoResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryGetRankInfoResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryGetRankInfoResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryGetRankInfoResponse parseFrom(CodedInputStream input) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(input);
        }

        public static RevelryGetRankInfoResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryGetRankInfoResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryGetRankInfoResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryGetRankInfoResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            private int rankKey_;
            private List<ActivityRevelryHandler.RevelryConfigInfo> config_;
            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryConfigInfo, ActivityRevelryHandler.RevelryConfigInfo.Builder, ActivityRevelryHandler.RevelryConfigInfoOrBuilder> configBuilder_;
            private ActivityRevelryHandler.RevelryRankInfo self_;
            private SingleFieldBuilder<ActivityRevelryHandler.RevelryRankInfo, ActivityRevelryHandler.RevelryRankInfo.Builder, ActivityRevelryHandler.RevelryRankInfoOrBuilder> selfBuilder_;
            private int selfRank_;
            private Object title_;
            private int timeleft_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryGetRankInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryGetRankInfoResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryGetRankInfoResponse.alwaysUseFieldBuilders) {
            ...
            public ActivityRevelryHandler.RevelryGetRankInfoResponse getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryGetRankInfoResponse.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryGetRankInfoResponse build() {
                ActivityRevelryHandler.RevelryGetRankInfoResponse result = buildPartial();
                if (!result.isInitialized())
                    throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryGetRankInfoResponse buildPartial() {
                ActivityRevelryHandler.RevelryGetRankInfoResponse result = new ActivityRevelryHandler.RevelryGetRankInfoResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1)
                    to_bitField0_ |= 0x1;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryGetRankInfoResponse)
                    return mergeFrom((ActivityRevelryHandler.RevelryGetRankInfoResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryGetRankInfoResponse other) {
                if (other == ActivityRevelryHandler.RevelryGetRankInfoResponse.getDefaultInstance())
                    return this;
                if (other.hasS2CCode())
                    setS2CCode(other.getS2CCode());
                if (other.hasS2CMsg()) {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryGetRankInfoResponse parsedMessage = null;
                try {
            ...
            public Builder setConfig(int index, ActivityRevelryHandler.RevelryConfigInfo value) {
                if (this.configBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureConfigIsMutable();
            ...
            public Builder setConfig(int index, ActivityRevelryHandler.RevelryConfigInfo.Builder builderForValue) {
                if (this.configBuilder_ == null) {
                    ensureConfigIsMutable();
            ...
            public Builder addConfig(ActivityRevelryHandler.RevelryConfigInfo value) {
                if (this.configBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureConfigIsMutable();
            ...
            public Builder addConfig(int index, ActivityRevelryHandler.RevelryConfigInfo value) {
                if (this.configBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureConfigIsMutable();
            ...
            public Builder addConfig(ActivityRevelryHandler.RevelryConfigInfo.Builder builderForValue) {
                if (this.configBuilder_ == null) {
                    ensureConfigIsMutable();
            ...
            public Builder addConfig(int index, ActivityRevelryHandler.RevelryConfigInfo.Builder builderForValue) {
                if (this.configBuilder_ == null) {
                    ensureConfigIsMutable();
            ...
            public Builder addAllConfig(Iterable<? extends ActivityRevelryHandler.RevelryConfigInfo> values) {
                if (this.configBuilder_ == null) {
                    ensureConfigIsMutable();
            ...
            public ActivityRevelryHandler.RevelryConfigInfo.Builder getConfigBuilder(int index) {
                return (ActivityRevelryHandler.RevelryConfigInfo.Builder) getConfigFieldBuilder().getBuilder(index);
            }
            ...
            public ActivityRevelryHandler.RevelryConfigInfo.Builder addConfigBuilder() {
                return (ActivityRevelryHandler.RevelryConfigInfo.Builder) getConfigFieldBuilder().addBuilder(ActivityRevelryHandler.RevelryConfigInfo.getDefaultInstance());
            }

            public ActivityRevelryHandler.RevelryConfigInfo.Builder addConfigBuilder(int index) {
                return (ActivityRevelryHandler.RevelryConfigInfo.Builder) getConfigFieldBuilder().addBuilder(index, ActivityRevelryHandler.RevelryConfigInfo.getDefaultInstance());
            }

            public List<ActivityRevelryHandler.RevelryConfigInfo.Builder> getConfigBuilderList() {
                return getConfigFieldBuilder().getBuilderList();
            }

            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryConfigInfo, ActivityRevelryHandler.RevelryConfigInfo.Builder, ActivityRevelryHandler.RevelryConfigInfoOrBuilder> getConfigFieldBuilder() {
                if (this.configBuilder_ == null) {
            ...
            public Builder setSelf(ActivityRevelryHandler.RevelryRankInfo value) {
                if (this.selfBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    this.self_ = value;
            ...
            public Builder setSelf(ActivityRevelryHandler.RevelryRankInfo.Builder builderForValue) {
                if (this.selfBuilder_ == null) {
            ...
            public Builder mergeSelf(ActivityRevelryHandler.RevelryRankInfo value) {
                if (this.selfBuilder_ == null) {
            ...
            public ActivityRevelryHandler.RevelryRankInfo.Builder getSelfBuilder() {
                this.bitField0_ |= 0x10;
                onChanged();
            ...
            private SingleFieldBuilder<ActivityRevelryHandler.RevelryRankInfo, ActivityRevelryHandler.RevelryRankInfo.Builder, ActivityRevelryHandler.RevelryRankInfoOrBuilder> getSelfFieldBuilder() {
                if (this.selfBuilder_ == null) {
    ...
    public static final class RevelryExchangeRequest extends GeneratedMessage implements RevelryExchangeRequestOrBuilder {
        private static final RevelryExchangeRequest defaultInstance = new RevelryExchangeRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryExchangeRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryExchangeRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryExchangeRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryExchangeRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryExchangeRequest.class, Builder.class);
        }

        public static Parser<RevelryExchangeRequest> PARSER = (Parser<RevelryExchangeRequest>) new AbstractParser<RevelryExchangeRequest>() {
            public ActivityRevelryHandler.RevelryExchangeRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryExchangeRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int ID_FIELD_NUMBER = 1;
        ...
        public Parser<RevelryExchangeRequest> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryExchangeResponse
        ...
        private static final RevelryExchangeResponse defaultInstance = new RevelryExchangeResponse(true);
        ...
        public static RevelryExchangeResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryExchangeResponse) PARSER.parseFrom(data);
        }

        public static RevelryExchangeResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryExchangeResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryExchangeResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryExchangeResponse) PARSER.parseFrom(data);
        }

        public static RevelryExchangeResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryExchangeResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryExchangeResponse parseFrom(InputStream input) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseFrom(input);
        }

        public static RevelryExchangeResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryExchangeResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryExchangeResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryExchangeResponse parseFrom(CodedInputStream input) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseFrom(input);
        }

        public static RevelryExchangeResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryExchangeResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryExchangeResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryExchangeResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryExchangeResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryExchangeResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryExchangeResponse.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryExchangeResponse getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryExchangeResponse.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryExchangeResponse build() {
                ActivityRevelryHandler.RevelryExchangeResponse result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryExchangeResponse buildPartial() {
                ActivityRevelryHandler.RevelryExchangeResponse result = new ActivityRevelryHandler.RevelryExchangeResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
                result.s2CCode_ = this.s2CCode_;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryExchangeResponse)
                    return mergeFrom((ActivityRevelryHandler.RevelryExchangeResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryExchangeResponse other) {
                if (other == ActivityRevelryHandler.RevelryExchangeResponse.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryExchangeResponse parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryExchangeResponse) ActivityRevelryHandler.RevelryExchangeResponse.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryExchangeResponse) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
            ...
            public Builder clearS2CMsg() {
                this.bitField0_ &= 0xFFFFFFFD;
                this.s2CMsg_ = ActivityRevelryHandler.RevelryExchangeResponse.getDefaultInstance().getS2CMsg();
                onChanged();
                return this;
            }
    ...
    public static final class RevelryRechargeColumn
        ...
        private static final RevelryRechargeColumn defaultInstance = new RevelryRechargeColumn(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeColumn(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeColumn(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeColumn(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeColumn_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeColumn.class, Builder.class);
        }

        public static Parser<RevelryRechargeColumn> PARSER = (Parser<RevelryRechargeColumn>) new AbstractParser<RevelryRechargeColumn>() {
            public ActivityRevelryHandler.RevelryRechargeColumn parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeColumn(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<RevelryRechargeColumn> getParserForType() {
            return PARSER;
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeColumnOrBuilder {
            private int bitField0_;
            private int day_;
            private Object name_;
    ...
    public static final class RevelryRechargeGetColumnRequest extends GeneratedMessage implements RevelryRechargeGetColumnRequestOrBuilder {
        private static final RevelryRechargeGetColumnRequest defaultInstance = new RevelryRechargeGetColumnRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeGetColumnRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeGetColumnRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeGetColumnRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder();
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeGetColumnRequest.class, Builder.class);
        }

        public static Parser<RevelryRechargeGetColumnRequest> PARSER = (Parser<RevelryRechargeGetColumnRequest>) new AbstractParser<RevelryRechargeGetColumnRequest>() {
            public ActivityRevelryHandler.RevelryRechargeGetColumnRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeGetColumnRequest(input, extensionRegistry);
            }
        };
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        ...
        public Parser<RevelryRechargeGetColumnRequest> getParserForType() {
            return PARSER;
        }
        ...
        public static RevelryRechargeGetColumnRequest parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetColumnRequest parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryRechargeGetColumnRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(CodedInputStream input) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetColumnRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnRequest) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryRechargeGetColumnRequest prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeGetColumnRequestOrBuilder {
            public static final Descriptors.Descriptor getDescriptor() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_descriptor;
            }

            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryRechargeGetColumnRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryRechargeGetColumnRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryRechargeGetColumnRequest getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryRechargeGetColumnRequest.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryRechargeGetColumnRequest build() {
                ActivityRevelryHandler.RevelryRechargeGetColumnRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryRechargeGetColumnRequest buildPartial() {
                ActivityRevelryHandler.RevelryRechargeGetColumnRequest result = new ActivityRevelryHandler.RevelryRechargeGetColumnRequest(this);
                onBuilt();
                return result;
            }

            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryRechargeGetColumnRequest)
                    return mergeFrom((ActivityRevelryHandler.RevelryRechargeGetColumnRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryRechargeGetColumnRequest other) {
                if (other == ActivityRevelryHandler.RevelryRechargeGetColumnRequest.getDefaultInstance()) return this;
                mergeUnknownFields(other.getUnknownFields());
                return this;
            }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryRechargeGetColumnRequest parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeGetColumnRequest) ActivityRevelryHandler.RevelryRechargeGetColumnRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeGetColumnRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
    ...
    public static final class RevelryRechargeGetColumnResponse
        ...
        private static final RevelryRechargeGetColumnResponse defaultInstance = new RevelryRechargeGetColumnResponse(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeGetColumnResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeGetColumnResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeGetColumnResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 58:
                            ...
                            this.column_.add(input.readMessage(ActivityRevelryHandler.RevelryRechargeColumn.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
                ...
                if ((mutable_bitField0_ & 0x40) == 64) this.column_ = Collections.unmodifiableList(this.column_);
                this.unknownFields = unknownFields.build();
                makeExtensionsImmutable();
            }
        }
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeGetColumnResponse.class, Builder.class);
        }

        public static Parser<RevelryRechargeGetColumnResponse> PARSER = (Parser<RevelryRechargeGetColumnResponse>) new AbstractParser<RevelryRechargeGetColumnResponse>() {
            public ActivityRevelryHandler.RevelryRechargeGetColumnResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeGetColumnResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int S2C_CODE_FIELD_NUMBER = 1;
        ...
        private List<ActivityRevelryHandler.RevelryRechargeColumn> column_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        private static final long serialVersionUID = 0L;

        public Parser<RevelryRechargeGetColumnResponse> getParserForType() {
            return PARSER;
        }
        ...
        public List<ActivityRevelryHandler.RevelryRechargeColumn> getColumnList() {
            return this.column_;
        }
        ...
        public ActivityRevelryHandler.RevelryRechargeColumn getColumn(int index) {
            return this.column_.get(index);
        }
        ...
        public static RevelryRechargeGetColumnResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetColumnResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryRechargeGetColumnResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(CodedInputStream input) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetColumnResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetColumnResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryRechargeGetColumnResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeGetColumnResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            private Object beginTime_;
            ...
            private int today_;
            private List<ActivityRevelryHandler.RevelryRechargeColumn> column_;
            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryRechargeColumn, ActivityRevelryHandler.RevelryRechargeColumn.Builder, ActivityRevelryHandler.RevelryRechargeColumnOrBuilder> columnBuilder_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryRechargeGetColumnResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryRechargeGetColumnResponse.alwaysUseFieldBuilders)
                    getColumnFieldBuilder();
            }
            ...
            public ActivityRevelryHandler.RevelryRechargeGetColumnResponse getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryRechargeGetColumnResponse.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryRechargeGetColumnResponse build() {
                ActivityRevelryHandler.RevelryRechargeGetColumnResponse result = buildPartial();
                if (!result.isInitialized())
                    throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryRechargeGetColumnResponse buildPartial() {
                ActivityRevelryHandler.RevelryRechargeGetColumnResponse result = new ActivityRevelryHandler.RevelryRechargeGetColumnResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1)
                    to_bitField0_ |= 0x1;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryRechargeGetColumnResponse)
                    return mergeFrom((ActivityRevelryHandler.RevelryRechargeGetColumnResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryRechargeGetColumnResponse other) {
                if (other == ActivityRevelryHandler.RevelryRechargeGetColumnResponse.getDefaultInstance())
                    return this;
                if (other.hasS2CCode())
                    setS2CCode(other.getS2CCode());
                if (other.hasS2CMsg()) {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryRechargeGetColumnResponse parsedMessage = null;
                try {
            ...
            public Builder setColumn(int index, ActivityRevelryHandler.RevelryRechargeColumn value) {
                if (this.columnBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureColumnIsMutable();
            ...
            public Builder setColumn(int index, ActivityRevelryHandler.RevelryRechargeColumn.Builder builderForValue) {
                if (this.columnBuilder_ == null) {
                    ensureColumnIsMutable();
                    this.column_.set(index, builderForValue.build());
                    onChanged();
            ...
            public Builder addColumn(ActivityRevelryHandler.RevelryRechargeColumn value) {
                if (this.columnBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureColumnIsMutable();
            ...
            public Builder addColumn(int index, ActivityRevelryHandler.RevelryRechargeColumn value) {
                if (this.columnBuilder_ == null) {
                    if (value == null)
                        throw new NullPointerException();
                    ensureColumnIsMutable();
            ...
            public Builder addColumn(ActivityRevelryHandler.RevelryRechargeColumn.Builder builderForValue) {
                if (this.columnBuilder_ == null) {
                    ensureColumnIsMutable();
                    this.column_.add(builderForValue.build());
                    onChanged();
            ...
            public Builder addColumn(int index, ActivityRevelryHandler.RevelryRechargeColumn.Builder builderForValue) {
                if (this.columnBuilder_ == null) {
                    ensureColumnIsMutable();
                    this.column_.add(index, builderForValue.build());
                    onChanged();
    ...
    public static final class RevelryRechargeItem extends GeneratedMessage implements RevelryRechargeItemOrBuilder {
        private static final RevelryRechargeItem defaultInstance = new RevelryRechargeItem(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeItem(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeItem(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeItem(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeItem_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeItem.class, Builder.class);
        }

        public static Parser<RevelryRechargeItem> PARSER = (Parser<RevelryRechargeItem>) new AbstractParser<RevelryRechargeItem>() {
            public ActivityRevelryHandler.RevelryRechargeItem parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeItem(input, extensionRegistry);
            }
        };
        private int bitField0_;
        ...
        public Parser<RevelryRechargeItem> getParserForType() {
            return PARSER;
        }
    ...
    public static final class RevelryRechargeAwardInfo
        ...
        private static final RevelryRechargeAwardInfo defaultInstance = new RevelryRechargeAwardInfo(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeAwardInfo(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeAwardInfo(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeAwardInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18:
                            ...
                            this.item_.add(input.readMessage(ActivityRevelryHandler.RevelryRechargeItem.PARSER, extensionRegistry));
                            break;
                        case 24:
                            this.bitField0_ |= 0x2;
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeAwardInfo.class, Builder.class);
        }

        public static Parser<RevelryRechargeAwardInfo> PARSER = (Parser<RevelryRechargeAwardInfo>) new AbstractParser<RevelryRechargeAwardInfo>() {
            public ActivityRevelryHandler.RevelryRechargeAwardInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeAwardInfo(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int ID_FIELD_NUMBER = 1;
        ...
        private List<ActivityRevelryHandler.RevelryRechargeItem> item_;
        ...
        public Parser<RevelryRechargeAwardInfo> getParserForType() {
            return PARSER;
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeAwardInfoOrBuilder {
            private int bitField0_;
            private int id_;
            private List<ActivityRevelryHandler.RevelryRechargeItem> item_;
            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryRechargeItem, ActivityRevelryHandler.RevelryRechargeItem.Builder, ActivityRevelryHandler.RevelryRechargeItemOrBuilder> itemBuilder_;
            private int state_;
            private int currNum_;
            private int needNum_;
    ...
    public static final class RevelryRechargeGetInfoRequest extends GeneratedMessage implements RevelryRechargeGetInfoRequestOrBuilder {
        private static final RevelryRechargeGetInfoRequest defaultInstance = new RevelryRechargeGetInfoRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeGetInfoRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeGetInfoRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeGetInfoRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeGetInfoRequest.class, Builder.class);
        }

        public static Parser<RevelryRechargeGetInfoRequest> PARSER = (Parser<RevelryRechargeGetInfoRequest>) new AbstractParser<RevelryRechargeGetInfoRequest>() {
            public ActivityRevelryHandler.RevelryRechargeGetInfoRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeGetInfoRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int DAY_FIELD_NUMBER = 1;
        ...
        public Parser<RevelryRechargeGetInfoRequest> getParserForType() {
            return PARSER;
        }
        ...
        public static RevelryRechargeGetInfoRequest parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetInfoRequest parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryRechargeGetInfoRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(CodedInputStream input) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeGetInfoRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeGetInfoRequest) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryRechargeGetInfoRequest prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeGetInfoRequestOrBuilder {
            private int bitField0_;
            private int day_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryRechargeGetInfoRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryRechargeGetInfoRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryRechargeGetInfoRequest getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryRechargeGetInfoRequest.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryRechargeGetInfoRequest build() {
                ActivityRevelryHandler.RevelryRechargeGetInfoRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryRechargeGetInfoRequest buildPartial() {
                ActivityRevelryHandler.RevelryRechargeGetInfoRequest result = new ActivityRevelryHandler.RevelryRechargeGetInfoRequest(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
                result.day_ = this.day_;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryRechargeGetInfoRequest)
                    return mergeFrom((ActivityRevelryHandler.RevelryRechargeGetInfoRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryRechargeGetInfoRequest other) {
                if (other == ActivityRevelryHandler.RevelryRechargeGetInfoRequest.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryRechargeGetInfoRequest parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeGetInfoRequest) ActivityRevelryHandler.RevelryRechargeGetInfoRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeGetInfoRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
    ...
    public static final class RevelryRechargeGetInfoResponse
        ...
        private static final RevelryRechargeGetInfoResponse defaultInstance = new RevelryRechargeGetInfoResponse(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeGetInfoResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeGetInfoResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeGetInfoResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 26:
                            ...
                            this.info_.add(input.readMessage(ActivityRevelryHandler.RevelryRechargeAwardInfo.PARSER, extensionRegistry));
                            break;
                    }
                }
            } catch (InvalidProtocolBufferException e) {
        ...
        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeGetInfoResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeGetInfoResponse.class, Builder.class);
        }

        public static Parser<RevelryRechargeGetInfoResponse> PARSER = (Parser<RevelryRechargeGetInfoResponse>) new AbstractParser<RevelryRechargeGetInfoResponse>() {
            public ActivityRevelryHandler.RevelryRechargeGetInfoResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeGetInfoResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int S2C_CODE_FIELD_NUMBER = 1;
        ...
        private Object s2CMsg_;
        public static final int INFO_FIELD_NUMBER = 3;
        private List<ActivityRevelryHandler.RevelryRechargeAwardInfo> info_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        private static final long serialVersionUID = 0L;

        public Parser<RevelryRechargeGetInfoResponse> getParserForType() {
            return PARSER;
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeGetInfoResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            private List<ActivityRevelryHandler.RevelryRechargeAwardInfo> info_;
            private RepeatedFieldBuilder<ActivityRevelryHandler.RevelryRechargeAwardInfo, ActivityRevelryHandler.RevelryRechargeAwardInfo.Builder, ActivityRevelryHandler.RevelryRechargeAwardInfoOrBuilder> infoBuilder_;
    ...
    public static final class RevelryRechargeAwardRequest extends GeneratedMessage implements RevelryRechargeAwardRequestOrBuilder {
        private static final RevelryRechargeAwardRequest defaultInstance = new RevelryRechargeAwardRequest(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeAwardRequest(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeAwardRequest(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeAwardRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardRequest_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeAwardRequest.class, Builder.class);
        }

        public static Parser<RevelryRechargeAwardRequest> PARSER = (Parser<RevelryRechargeAwardRequest>) new AbstractParser<RevelryRechargeAwardRequest>() {
            public ActivityRevelryHandler.RevelryRechargeAwardRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeAwardRequest(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int ID_FIELD_NUMBER = 1;
        ...
        public Parser<RevelryRechargeAwardRequest> getParserForType() {
            return PARSER;
        }
        ...
        public static RevelryRechargeAwardRequest parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeAwardRequest parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeAwardRequest parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(data);
        }

        public static RevelryRechargeAwardRequest parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeAwardRequest parseFrom(InputStream input) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeAwardRequest parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryRechargeAwardRequest parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryRechargeAwardRequest parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryRechargeAwardRequest parseFrom(CodedInputStream input) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(input);
        }

        public static RevelryRechargeAwardRequest parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardRequest) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryRechargeAwardRequest prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeAwardRequestOrBuilder {
            private int bitField0_;
            private int id_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryRechargeAwardRequest.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryRechargeAwardRequest.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryRechargeAwardRequest getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryRechargeAwardRequest.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryRechargeAwardRequest build() {
                ActivityRevelryHandler.RevelryRechargeAwardRequest result = buildPartial();
                if (!result.isInitialized()) throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryRechargeAwardRequest buildPartial() {
                ActivityRevelryHandler.RevelryRechargeAwardRequest result = new ActivityRevelryHandler.RevelryRechargeAwardRequest(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1) to_bitField0_ |= 0x1;
                result.id_ = this.id_;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryRechargeAwardRequest)
                    return mergeFrom((ActivityRevelryHandler.RevelryRechargeAwardRequest) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryRechargeAwardRequest other) {
                if (other == ActivityRevelryHandler.RevelryRechargeAwardRequest.getDefaultInstance()) return this;
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryRechargeAwardRequest parsedMessage = null;
                try {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeAwardRequest) ActivityRevelryHandler.RevelryRechargeAwardRequest.PARSER.parsePartialFrom(input, extensionRegistry);
                } catch (InvalidProtocolBufferException e) {
                    parsedMessage = (ActivityRevelryHandler.RevelryRechargeAwardRequest) e.getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) mergeFrom(parsedMessage);
                }
    ...
    public static final class RevelryRechargeAwardResponse
        ...
        private static final RevelryRechargeAwardResponse defaultInstance = new RevelryRechargeAwardResponse(true);
        private final UnknownFieldSet unknownFields;

        private RevelryRechargeAwardResponse(GeneratedMessage.Builder<?> builder) {
            super(builder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = builder.getUnknownFields();
        ...
        private RevelryRechargeAwardResponse(boolean noInit) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = UnknownFieldSet.getDefaultInstance();
        }
        ...
        private RevelryRechargeAwardResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardResponse_descriptor;
        }

        protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
            return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(RevelryRechargeAwardResponse.class, Builder.class);
        }

        public static Parser<RevelryRechargeAwardResponse> PARSER = (Parser<RevelryRechargeAwardResponse>) new AbstractParser<RevelryRechargeAwardResponse>() {
            public ActivityRevelryHandler.RevelryRechargeAwardResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new ActivityRevelryHandler.RevelryRechargeAwardResponse(input, extensionRegistry);
            }
        };
        private int bitField0_;
        public static final int S2C_CODE_FIELD_NUMBER = 1;
        ...
        public Parser<RevelryRechargeAwardResponse> getParserForType() {
            return PARSER;
        }
        ...
        public static RevelryRechargeAwardResponse parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(data);
        }

        public static RevelryRechargeAwardResponse parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeAwardResponse parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(data);
        }

        public static RevelryRechargeAwardResponse parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(data, extensionRegistry);
        }

        public static RevelryRechargeAwardResponse parseFrom(InputStream input) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(input);
        }

        public static RevelryRechargeAwardResponse parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(input, extensionRegistry);
        }

        public static RevelryRechargeAwardResponse parseDelimitedFrom(InputStream input) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseDelimitedFrom(input);
        }

        public static RevelryRechargeAwardResponse parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseDelimitedFrom(input, extensionRegistry);
        }

        public static RevelryRechargeAwardResponse parseFrom(CodedInputStream input) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(input);
        }

        public static RevelryRechargeAwardResponse parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (RevelryRechargeAwardResponse) PARSER.parseFrom(input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(RevelryRechargeAwardResponse prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ActivityRevelryHandler.RevelryRechargeAwardResponseOrBuilder {
            private int bitField0_;
            private int s2CCode_;
            private Object s2CMsg_;
            ...
            protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ActivityRevelryHandler.internal_static_pomelo_revelry_RevelryRechargeAwardResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(ActivityRevelryHandler.RevelryRechargeAwardResponse.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (ActivityRevelryHandler.RevelryRechargeAwardResponse.alwaysUseFieldBuilders) ;
            }
            ...
            public ActivityRevelryHandler.RevelryRechargeAwardResponse getDefaultInstanceForType() {
                return ActivityRevelryHandler.RevelryRechargeAwardResponse.getDefaultInstance();
            }

            public ActivityRevelryHandler.RevelryRechargeAwardResponse build() {
                ActivityRevelryHandler.RevelryRechargeAwardResponse result = buildPartial();
                if (!result.isInitialized())
                    throw newUninitializedMessageException(result);
                return result;
            }

            public ActivityRevelryHandler.RevelryRechargeAwardResponse buildPartial() {
                ActivityRevelryHandler.RevelryRechargeAwardResponse result = new ActivityRevelryHandler.RevelryRechargeAwardResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) == 1)
                    to_bitField0_ |= 0x1;
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof ActivityRevelryHandler.RevelryRechargeAwardResponse)
                    return mergeFrom((ActivityRevelryHandler.RevelryRechargeAwardResponse) other);
                super.mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(ActivityRevelryHandler.RevelryRechargeAwardResponse other) {
                if (other == ActivityRevelryHandler.RevelryRechargeAwardResponse.getDefaultInstance())
                    return this;
                if (other.hasS2CCode())
                    setS2CCode(other.getS2CCode());
                if (other.hasS2CMsg()) {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ActivityRevelryHandler.RevelryRechargeAwardResponse parsedMessage = null;
                try {
    ...
    static {
        ...
        Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
            public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root) {
                ActivityRevelryHandler.descriptor = root;
                return null;
            }
        };
    ...
    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryColumnInfo_descriptor = getDescriptor().getMessageTypes().get(0);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryColumnInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryColumnInfo_descriptor, new String[]{"Id", "Name", "Label", "Goto1", "Goto2", "Tip"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryTodayInfo_descriptor = getDescriptor().getMessageTypes().get(1);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryTodayInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryTodayInfo_descriptor, new String[]{"Name", "Column"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryTabInfo_descriptor = getDescriptor().getMessageTypes().get(2);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryTabInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryTabInfo_descriptor, new String[]{"Name", "Today"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_KingExchange_descriptor = getDescriptor().getMessageTypes().get(3);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_KingExchange_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_KingExchange_descriptor, new String[]{"TabId", "TabName", "Item1Code", "Item1Num", "Item2Code", "Item2Num", "AvatarId", "Tip", "ShowType"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryGetColumnRequest_descriptor = getDescriptor().getMessageTypes().get(4);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryGetColumnRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryGetColumnRequest_descriptor, new String[0]);


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryGetColumnResponse_descriptor = getDescriptor().getMessageTypes().get(5);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryGetColumnResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryGetColumnResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "Info", "Exchange", "SelectedIndex"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRankInfo_descriptor = getDescriptor().getMessageTypes().get(6);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRankInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRankInfo_descriptor, new String[]{"Contents", "Avatars"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryAwardInfo_descriptor = getDescriptor().getMessageTypes().get(7);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryAwardInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryAwardInfo_descriptor, new String[]{"Itemcode", "Itemcount"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryConfigInfo_descriptor = getDescriptor().getMessageTypes().get(8);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryConfigInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryConfigInfo_descriptor, new String[]{"MinRank", "MaxRank", "Award", "Player"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryGetRankInfoRequest_descriptor = getDescriptor().getMessageTypes().get(9);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryGetRankInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryGetRankInfoRequest_descriptor, new String[]{"Id"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryGetRankInfoResponse_descriptor = getDescriptor().getMessageTypes().get(10);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryGetRankInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryGetRankInfoResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "RankKey", "Config", "Self", "SelfRank", "Title", "Timeleft"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryExchangeRequest_descriptor = getDescriptor().getMessageTypes().get(11);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryExchangeRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryExchangeRequest_descriptor, new String[]{"Id", "Num"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryExchangeResponse_descriptor = getDescriptor().getMessageTypes().get(12);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryExchangeResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryExchangeResponse_descriptor, new String[]{"S2CCode", "S2CMsg"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeColumn_descriptor = getDescriptor().getMessageTypes().get(13);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeColumn_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeColumn_descriptor, new String[]{"Day", "Name"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_descriptor = getDescriptor().getMessageTypes().get(14);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeGetColumnRequest_descriptor, new String[0]);


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_descriptor = getDescriptor().getMessageTypes().get(15);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeGetColumnResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "BeginTime", "EndTime", "Describe", "Today", "Column"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeItem_descriptor = getDescriptor().getMessageTypes().get(16);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeItem_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeItem_descriptor, new String[]{"Code", "GroupCount"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeAwardInfo_descriptor = getDescriptor().getMessageTypes().get(17);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeAwardInfo_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeAwardInfo_descriptor, new String[]{"Id", "Item", "State", "CurrNum", "NeedNum"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_descriptor = getDescriptor().getMessageTypes().get(18);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeGetInfoRequest_descriptor, new String[]{"Day"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeGetInfoResponse_descriptor = getDescriptor().getMessageTypes().get(19);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeGetInfoResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeGetInfoResponse_descriptor, new String[]{"S2CCode", "S2CMsg", "Info"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeAwardRequest_descriptor = getDescriptor().getMessageTypes().get(20);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeAwardRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeAwardRequest_descriptor, new String[]{"Id"});


    private static final Descriptors.Descriptor internal_static_pomelo_revelry_RevelryRechargeAwardResponse_descriptor = getDescriptor().getMessageTypes().get(21);
    private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_revelry_RevelryRechargeAwardResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_revelry_RevelryRechargeAwardResponse_descriptor, new String[]{"S2CCode", "S2CMsg"});
