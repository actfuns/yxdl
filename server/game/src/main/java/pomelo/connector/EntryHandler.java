...
/*      */   {
/*  325 */     private static final GetSysTimeRequest defaultInstance = new GetSysTimeRequest(true); private final UnknownFieldSet unknownFields; private GetSysTimeRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetSysTimeRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetSysTimeRequest getDefaultInstance() { return defaultInstance; } public GetSysTimeRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetSysTimeRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag)) done = true;  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_GetSysTimeRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_GetSysTimeRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(GetSysTimeRequest.class, Builder.class); } public static Parser<GetSysTimeRequest> PARSER = (Parser<GetSysTimeRequest>)new AbstractParser<GetSysTimeRequest>() { public EntryHandler.GetSysTimeRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.GetSysTimeRequest(input, extensionRegistry); } }
/*  326 */     ; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetSysTimeRequest> getParserForType() { return PARSER; } private void initFields() {} public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); getUnknownFields().writeTo(output); } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 1060 */     private static final GetSysTimeResponse defaultInstance = new GetSysTimeResponse(true); private final UnknownFieldSet unknownFields; private GetSysTimeResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private GetSysTimeResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static GetSysTimeResponse getDefaultInstance() { return defaultInstance; } public GetSysTimeResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private GetSysTimeResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CTime_ = bs; break;case 26: bs = input.readBytes(); this.bitField0_ |= 0x4; this.s2CMsg_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_GetSysTimeResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_GetSysTimeResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(GetSysTimeResponse.class, Builder.class); } public static Parser<GetSysTimeResponse> PARSER = (Parser<GetSysTimeResponse>)new AbstractParser<GetSysTimeResponse>() { public EntryHandler.GetSysTimeResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.GetSysTimeResponse(input, extensionRegistry); } }
/* 1061 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_TIME_FIELD_NUMBER = 2; private Object s2CTime_; public static final int S2C_MSG_FIELD_NUMBER = 3; private Object s2CMsg_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<GetSysTimeResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CTime() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CTime() { Object ref = this.s2CTime_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CTime_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 2501 */     private static final EntryRequest defaultInstance = new EntryRequest(true); private final UnknownFieldSet unknownFields; private EntryRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private EntryRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static EntryRequest getDefaultInstance() { return defaultInstance; } public EntryRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private EntryRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.c2SUid_ = bs; break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.c2SToken_ = bs; break;case 24: this.bitField0_ |= 0x4; this.c2SLogicServerId_ = input.readInt32(); break;case 34: bs = input.readBytes(); this.bitField0_ |= 0x8; this.c2SDeviceMac_ = bs; break;case 40: this.bitField0_ |= 0x10; this.c2SDeviceType_ = input.readInt32(); break;case 50: bs = input.readBytes(); this.bitField0_ |= 0x20; this.c2SClientRegion_ = bs; break;case 58: bs = input.readBytes(); this.bitField0_ |= 0x40; this.c2SClientChannel_ = bs; break;case 66: bs = input.readBytes(); this.bitField0_ |= 0x80; this.c2SClientVersion_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_EntryRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_EntryRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(EntryRequest.class, Builder.class); } public static Parser<EntryRequest> PARSER = (Parser<EntryRequest>)new AbstractParser<EntryRequest>() { public EntryHandler.EntryRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.EntryRequest(input, extensionRegistry); } }
/* 2502 */     ; private int bitField0_; public static final int C2S_UID_FIELD_NUMBER = 1; private Object c2SUid_; public static final int C2S_TOKEN_FIELD_NUMBER = 2; private Object c2SToken_; public static final int C2S_LOGICSERVERID_FIELD_NUMBER = 3; private int c2SLogicServerId_; public static final int C2S_DEVICEMAC_FIELD_NUMBER = 4; private Object c2SDeviceMac_; public static final int C2S_DEVICETYPE_FIELD_NUMBER = 5; private int c2SDeviceType_; public static final int C2S_CLIENTREGION_FIELD_NUMBER = 6; private Object c2SClientRegion_; public static final int C2S_CLIENTCHANNEL_FIELD_NUMBER = 7; private Object c2SClientChannel_; public static final int C2S_CLIENTVERSION_FIELD_NUMBER = 8; private Object c2SClientVersion_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<EntryRequest> getParserForType() { return PARSER; } public boolean hasC2SUid() { return ((this.bitField0_ & 0x1) == 1); } public String getC2SUid() { Object ref = this.c2SUid_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.c2SUid_ = s;  return s; } public ByteString getC2SUidBytes() { Object ref = this.c2SUid_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.c2SUid_ = b; return b; }  return (ByteString)ref; } public boolean hasC2SToken() { return ((this.bitField0_ & 0x2) == 2); } public String getC2SToken() { Object ref = this.c2SToken_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.c2SToken_ = s;  return s; } public ByteString getC2STokenBytes() { Object ref = this.c2SToken_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.c2SToken_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 3435 */     private static final EntryResponse defaultInstance = new EntryResponse(true); private final UnknownFieldSet unknownFields; private EntryResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private EntryResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static EntryResponse getDefaultInstance() { return defaultInstance; } public EntryResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private EntryResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: if ((mutable_bitField0_ & 0x4) != 4) { this.s2CPlayers_ = new ArrayList<>(); mutable_bitField0_ |= 0x4; }  this.s2CPlayers_.add(input.readMessage(PlayerOuterClass.PlayerBasic.PARSER, extensionRegistry)); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { if ((mutable_bitField0_ & 0x4) == 4) this.s2CPlayers_ = Collections.unmodifiableList(this.s2CPlayers_);  this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_EntryResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_EntryResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(EntryResponse.class, Builder.class); } public static Parser<EntryResponse> PARSER = (Parser<EntryResponse>)new AbstractParser<EntryResponse>() { public EntryHandler.EntryResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.EntryResponse(input, extensionRegistry); } }
/* 3436 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_PLAYERS_FIELD_NUMBER = 3; private List<PlayerOuterClass.PlayerBasic> s2CPlayers_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<EntryResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } public ByteString getS2CMsgBytes() { Object ref = this.s2CMsg_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.s2CMsg_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */     
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements EntryHandler.EntryResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private List<PlayerOuterClass.PlayerBasic> s2CPlayers_; private RepeatedFieldBuilder<PlayerOuterClass.PlayerBasic, PlayerOuterClass.PlayerBasic.Builder, PlayerOuterClass.PlayerBasicOrBuilder> s2CPlayersBuilder_;
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/*      */   
/* 3919 */   public static final class BindPlayerRequest extends GeneratedMessage implements BindPlayerRequestOrBuilder { private static final BindPlayerRequest defaultInstance = new BindPlayerRequest(true); private final UnknownFieldSet unknownFields; private BindPlayerRequest(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BindPlayerRequest(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BindPlayerRequest getDefaultInstance() { return defaultInstance; } public BindPlayerRequest getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BindPlayerRequest(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 10: bs = input.readBytes(); this.bitField0_ |= 0x1; this.c2SPlayerId_ = bs; break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_BindPlayerRequest_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_BindPlayerRequest_fieldAccessorTable.ensureFieldAccessorsInitialized(BindPlayerRequest.class, Builder.class); } public static Parser<BindPlayerRequest> PARSER = (Parser<BindPlayerRequest>)new AbstractParser<BindPlayerRequest>() { public EntryHandler.BindPlayerRequest parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.BindPlayerRequest(input, extensionRegistry); } }
/* 3920 */     ; private int bitField0_; public static final int C2S_PLAYERID_FIELD_NUMBER = 1; private Object c2SPlayerId_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BindPlayerRequest> getParserForType() { return PARSER; } public boolean hasC2SPlayerId() { return ((this.bitField0_ & 0x1) == 1); } public String getC2SPlayerId() { Object ref = this.c2SPlayerId_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.c2SPlayerId_ = s;  return s; } public ByteString getC2SPlayerIdBytes() { Object ref = this.c2SPlayerId_; if (ref instanceof String) { ByteString b = ByteString.copyFromUtf8((String)ref); this.c2SPlayerId_ = b; return b; }  return (ByteString)ref; } static { defaultInstance.initFields(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/* 5090 */     private static final BindPlayerResponse defaultInstance = new BindPlayerResponse(true); private final UnknownFieldSet unknownFields; private BindPlayerResponse(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private BindPlayerResponse(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static BindPlayerResponse getDefaultInstance() { return defaultInstance; } public BindPlayerResponse getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private BindPlayerResponse(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { ByteString bs; PlayerOuterClass.Player.Builder subBuilder; int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.s2CCode_ = input.readInt32(); break;case 18: bs = input.readBytes(); this.bitField0_ |= 0x2; this.s2CMsg_ = bs; break;case 26: subBuilder = null; if ((this.bitField0_ & 0x4) == 4) subBuilder = this.s2CPlayer_.toBuilder();  this.s2CPlayer_ = (PlayerOuterClass.Player)input.readMessage(PlayerOuterClass.Player.PARSER, extensionRegistry); if (subBuilder != null) { subBuilder.mergeFrom(this.s2CPlayer_); this.s2CPlayer_ = subBuilder.buildPartial(); }  this.bitField0_ |= 0x4; break;case 32: this.bitField0_ |= 0x8; this.s2CSceneType_ = input.readInt32(); break;case 40: this.bitField0_ |= 0x10; this.s2CSceneUseAgent_ = input.readInt32(); break;case 48: this.bitField0_ |= 0x20; this.s2CChangePkType_ = input.readInt32(); break;case 56: this.bitField0_ |= 0x40; this.s2CRideMount_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_BindPlayerResponse_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_BindPlayerResponse_fieldAccessorTable.ensureFieldAccessorsInitialized(BindPlayerResponse.class, Builder.class); } public static Parser<BindPlayerResponse> PARSER = (Parser<BindPlayerResponse>)new AbstractParser<BindPlayerResponse>() { public EntryHandler.BindPlayerResponse parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.BindPlayerResponse(input, extensionRegistry); } }
/* 5091 */     ; private int bitField0_; public static final int S2C_CODE_FIELD_NUMBER = 1; private int s2CCode_; public static final int S2C_MSG_FIELD_NUMBER = 2; private Object s2CMsg_; public static final int S2C_PLAYER_FIELD_NUMBER = 3; private PlayerOuterClass.Player s2CPlayer_; public static final int S2C_SCENETYPE_FIELD_NUMBER = 4; private int s2CSceneType_; public static final int S2C_SCENEUSEAGENT_FIELD_NUMBER = 5; private int s2CSceneUseAgent_; public static final int S2C_CHANGEPKTYPE_FIELD_NUMBER = 6; private int s2CChangePkType_; public static final int S2C_RIDEMOUNT_FIELD_NUMBER = 7; private int s2CRideMount_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<BindPlayerResponse> getParserForType() { return PARSER; } public boolean hasS2CCode() { return ((this.bitField0_ & 0x1) == 1); } public int getS2CCode() { return this.s2CCode_; } public boolean hasS2CMsg() { return ((this.bitField0_ & 0x2) == 2); } public String getS2CMsg() { Object ref = this.s2CMsg_; if (ref instanceof String) return (String)ref;  ByteString bs = (ByteString)ref; String s = bs.toStringUtf8(); if (bs.isValidUtf8()) this.s2CMsg_ = s;  return s; } static { defaultInstance.initFields(); }
/*      */     
/*      */     public ByteString getS2CMsgBytes() {
/*      */       Object ref = this.s2CMsg_;
/*      */       if (ref instanceof String) {
...
/*      */       return builder;
/*      */     }
/*      */     public static final class Builder extends GeneratedMessage.Builder<Builder> implements EntryHandler.BindPlayerResponseOrBuilder { private int bitField0_; private int s2CCode_; private Object s2CMsg_; private PlayerOuterClass.Player s2CPlayer_; private SingleFieldBuilder<PlayerOuterClass.Player, PlayerOuterClass.Player.Builder, PlayerOuterClass.PlayerOrBuilder> s2CPlayerBuilder_; private int s2CSceneType_; private int s2CSceneUseAgent_; private int s2CChangePkType_; private int s2CRideMount_;
/*      */       public static final Descriptors.Descriptor getDescriptor() {
...
/*      */       } } }
/*      */   
/* 5645 */   public static final class LoginQueuePush extends GeneratedMessage implements LoginQueuePushOrBuilder { private static final LoginQueuePush defaultInstance = new LoginQueuePush(true); private final UnknownFieldSet unknownFields; private LoginQueuePush(GeneratedMessage.Builder<?> builder) { super(builder); this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = builder.getUnknownFields(); } private LoginQueuePush(boolean noInit) { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; this.unknownFields = UnknownFieldSet.getDefaultInstance(); } public static LoginQueuePush getDefaultInstance() { return defaultInstance; } public LoginQueuePush getDefaultInstanceForType() { return defaultInstance; } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private LoginQueuePush(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this.memoizedIsInitialized = -1; this.memoizedSerializedSize = -1; initFields(); int mutable_bitField0_ = 0; UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; break;case 8: this.bitField0_ |= 0x1; this.num_ = input.readInt32(); break;case 16: this.bitField0_ |= 0x2; this.time_ = input.readInt32(); break; }  }  } catch (InvalidProtocolBufferException e) { throw e.setUnfinishedMessage(this); } catch (IOException e) { throw (new InvalidProtocolBufferException(e.getMessage())).setUnfinishedMessage(this); } finally { this.unknownFields = unknownFields.build(); makeExtensionsImmutable(); }  } public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_LoginQueuePush_descriptor; } protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_LoginQueuePush_fieldAccessorTable.ensureFieldAccessorsInitialized(LoginQueuePush.class, Builder.class); } public static Parser<LoginQueuePush> PARSER = (Parser<LoginQueuePush>)new AbstractParser<LoginQueuePush>() { public EntryHandler.LoginQueuePush parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return new EntryHandler.LoginQueuePush(input, extensionRegistry); } }
/* 5646 */     ; private int bitField0_; public static final int NUM_FIELD_NUMBER = 1; private int num_; public static final int TIME_FIELD_NUMBER = 2; private int time_; private byte memoizedIsInitialized; private int memoizedSerializedSize; private static final long serialVersionUID = 0L; public Parser<LoginQueuePush> getParserForType() { return PARSER; } public boolean hasNum() { return ((this.bitField0_ & 0x1) == 1); } public int getNum() { return this.num_; } public boolean hasTime() { return ((this.bitField0_ & 0x2) == 2); } public int getTime() { return this.time_; } private void initFields() { this.num_ = 0; this.time_ = 0; } public final boolean isInitialized() { byte isInitialized = this.memoizedIsInitialized; if (isInitialized == 1) return true;  if (isInitialized == 0) return false;  if (!hasNum()) { this.memoizedIsInitialized = 0; return false; }  if (!hasTime()) { this.memoizedIsInitialized = 0; return false; }  this.memoizedIsInitialized = 1; return true; } public void writeTo(CodedOutputStream output) throws IOException { getSerializedSize(); if ((this.bitField0_ & 0x1) == 1) output.writeInt32(1, this.num_);  if ((this.bitField0_ & 0x2) == 2) output.writeInt32(2, this.time_);  getUnknownFields().writeTo(output); } public int getSerializedSize() { int size = this.memoizedSerializedSize; if (size != -1) return size;  size = 0; if ((this.bitField0_ & 0x1) == 1) size += CodedOutputStream.computeInt32Size(1, this.num_);  if ((this.bitField0_ & 0x2) == 2) size += CodedOutputStream.computeInt32Size(2, this.time_);  size += getUnknownFields().getSerializedSize(); this.memoizedSerializedSize = size; return size; } protected Object writeReplace() throws ObjectStreamException { return super.writeReplace(); } public static LoginQueuePush parseFrom(ByteString data) throws InvalidProtocolBufferException { return (LoginQueuePush)PARSER.parseFrom(data); } public static LoginQueuePush parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (LoginQueuePush)PARSER.parseFrom(data, extensionRegistry); } public static LoginQueuePush parseFrom(byte[] data) throws InvalidProtocolBufferException { return (LoginQueuePush)PARSER.parseFrom(data); } public static LoginQueuePush parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { return (LoginQueuePush)PARSER.parseFrom(data, extensionRegistry); } public static LoginQueuePush parseFrom(InputStream input) throws IOException { return (LoginQueuePush)PARSER.parseFrom(input); } static { defaultInstance.initFields(); }
/*      */     public static LoginQueuePush parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LoginQueuePush)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static LoginQueuePush parseDelimitedFrom(InputStream input) throws IOException { return (LoginQueuePush)PARSER.parseDelimitedFrom(input); }
/*      */     public static LoginQueuePush parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LoginQueuePush)PARSER.parseDelimitedFrom(input, extensionRegistry); }
/*      */     public static LoginQueuePush parseFrom(CodedInputStream input) throws IOException { return (LoginQueuePush)PARSER.parseFrom(input); }
/*      */     public static LoginQueuePush parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { return (LoginQueuePush)PARSER.parseFrom(input, extensionRegistry); }
/*      */     public static Builder newBuilder() { return Builder.create(); }
/*      */     public Builder newBuilderForType() { return newBuilder(); }
/*      */     public static Builder newBuilder(LoginQueuePush prototype) { return newBuilder().mergeFrom(prototype); }
...
/*      */       private int num_;
/*      */       private int time_;
/*      */       public static final Descriptors.Descriptor getDescriptor() { return EntryHandler.internal_static_pomelo_connector_LoginQueuePush_descriptor; }
/*      */       protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() { return EntryHandler.internal_static_pomelo_connector_LoginQueuePush_fieldAccessorTable.ensureFieldAccessorsInitialized(EntryHandler.LoginQueuePush.class, Builder.class); }
/*      */       private Builder() { maybeForceBuilderInitialization(); }
/*      */       private Builder(GeneratedMessage.BuilderParent parent) { super(parent); maybeForceBuilderInitialization(); }
/*      */       private void maybeForceBuilderInitialization() { if (EntryHandler.LoginQueuePush.alwaysUseFieldBuilders); }
/*      */       private static Builder create() { return new Builder(); }
/*      */       public Builder clear() { super.clear(); this.num_ = 0; this.bitField0_ &= 0xFFFFFFFE; this.time_ = 0; this.bitField0_ &= 0xFFFFFFFD; return this; }
/*      */       public Builder clone() { return create().mergeFrom(buildPartial()); }
/*      */       public Descriptors.Descriptor getDescriptorForType() { return EntryHandler.internal_static_pomelo_connector_LoginQueuePush_descriptor; }
/*      */       public EntryHandler.LoginQueuePush getDefaultInstanceForType() { return EntryHandler.LoginQueuePush.getDefaultInstance(); }
/*      */       public EntryHandler.LoginQueuePush build() { EntryHandler.LoginQueuePush result = buildPartial(); if (!result.isInitialized()) throw newUninitializedMessageException(result);  return result; }
/*      */       public EntryHandler.LoginQueuePush buildPartial() { EntryHandler.LoginQueuePush result = new EntryHandler.LoginQueuePush(this); int from_bitField0_ = this.bitField0_; int to_bitField0_ = 0; if ((from_bitField0_ & 0x1) == 1)
/*      */           to_bitField0_ |= 0x1;  result.num_ = this.num_; if ((from_bitField0_ & 0x2) == 2)
/*      */           to_bitField0_ |= 0x2;  result.time_ = this.time_; result.bitField0_ = to_bitField0_; onBuilt(); return result; }
/*      */       public Builder mergeFrom(Message other) { if (other instanceof EntryHandler.LoginQueuePush)
/*      */           return mergeFrom((EntryHandler.LoginQueuePush)other);  super.mergeFrom(other); return this; }
/*      */       public Builder mergeFrom(EntryHandler.LoginQueuePush other) { if (other == EntryHandler.LoginQueuePush.getDefaultInstance())
/*      */           return this;  if (other.hasNum())
/*      */           setNum(other.getNum());  if (other.hasTime())
/*      */           setTime(other.getTime());  mergeUnknownFields(other.getUnknownFields()); return this; }
/*      */       public final boolean isInitialized() { if (!hasNum())
/*      */           return false;  if (!hasTime())
/*      */           return false;  return true; }
/*      */       public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException { EntryHandler.LoginQueuePush parsedMessage = null; try { parsedMessage = (EntryHandler.LoginQueuePush)EntryHandler.LoginQueuePush.PARSER.parsePartialFrom(input, extensionRegistry); } catch (InvalidProtocolBufferException e) { parsedMessage = (EntryHandler.LoginQueuePush)e.getUnfinishedMessage(); throw e; } finally { if (parsedMessage != null)
/*      */             mergeFrom(parsedMessage);  }  return this; }
/*      */       public boolean hasNum() { return ((this.bitField0_ & 0x1) == 1); }
/*      */       public int getNum() { return this.num_; }
/*      */       public Builder setNum(int value) { this.bitField0_ |= 0x1; this.num_ = value; onChanged(); return this; }
/*      */       public Builder clearNum() { this.bitField0_ &= 0xFFFFFFFE; this.num_ = 0; onChanged(); return this; } public boolean hasTime() { return ((this.bitField0_ & 0x2) == 2); } public int getTime() { return this.time_; } public Builder setTime(int value) { this.bitField0_ |= 0x2; this.time_ = value; onChanged(); return this; } public Builder clearTime() { this.bitField0_ &= 0xFFFFFFFD; this.time_ = 0; onChanged(); return this; } } }
/* 5690 */    public static Descriptors.FileDescriptor getDescriptor() { return descriptor; }
/*      */ 
/*      */ 
/*      */   
/*      */   static {
/* 5695 */     String[] descriptorData = { "\n\022entryHandler.proto\022\020pomelo.connector\032\fcommon.proto\032\fplayer.proto\"\023\n\021GetSysTimeRequest\"I\n\022GetSysTimeResponse\022\020\n\bs2c_code\030\001 \002(\005\022\020\n\bs2c_time\030\002 \002(\t\022\017\n\007s2c_msg\030\003 \001(\t\"Ì\001\n\fEntryRequest\022\017\n\007c2s_uid\030\001 \002(\t\022\021\n\tc2s_token\030\002 \002(\t\022\031\n\021c2s_logicServerId\030\003 \002(\005\022\025\n\rc2s_deviceMac\030\004 \001(\t\022\026\n\016c2s_deviceType\030\005 \001(\005\022\030\n\020c2s_clientRegion\030\006 \001(\t\022\031\n\021c2s_clientChannel\030\007 \001(\t\022\031\n\021c2s_clientVersion\030\b \001(\t\"c\n\rEntryResponse\022\020\n\bs2c_code\030\001", " \002(\005\022\017\n\007s2c_msg\030\002 \001(\t\022/\n\013s2c_players\030\003 \003(\0132\032.pomelo.player.PlayerBasic\")\n\021BindPlayerRequest\022\024\n\fc2s_playerId\030\001 \002(\t\"Å\001\n\022BindPlayerResponse\022\020\n\bs2c_code\030\001 \002(\005\022\017\n\007s2c_msg\030\002 \001(\t\022)\n\ns2c_player\030\003 \001(\0132\025.pomelo.player.Player\022\025\n\rs2c_sceneType\030\004 \001(\005\022\031\n\021s2c_sceneUseAgent\030\005 \001(\005\022\030\n\020s2c_changePkType\030\006 \001(\005\022\025\n\rs2c_rideMount\030\007 \001(\005\"+\n\016LoginQueuePush\022\013\n\003num\030\001 \002(\005\022\f\n\004time\030\002 \002(\0052\002\n\fentryHandler\022O\n\fentryRequest\022\036.pomelo", ".connector.EntryRequest\032\037.pomelo.connector.EntryResponse\022^\n\021bindPlayerRequest\022#.pomelo.connector.BindPlayerRequest\032$.pomelo.connector.BindPlayerResponse\022^\n\021getSysTimeRequest\022#.pomelo.connector.GetSysTimeRequest\032$.pomelo.connector.GetSysTimeResponse2M\n\tentryPush\022@\n\016loginQueuePush\022 .pomelo.connector.LoginQueuePush\032\f.pomelo.Void" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 5726 */     Descriptors.FileDescriptor.InternalDescriptorAssigner assigner = new Descriptors.FileDescriptor.InternalDescriptorAssigner()
/*      */       {
/*      */         public ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor root)
/*      */         {
/* 5730 */           EntryHandler.descriptor = root;
/* 5731 */           return null;
/*      */         }
/*      */       };
/*      */     
/* 5735 */     Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] {
/*      */           
/* 5737 */           Common.getDescriptor(), 
/* 5738 */           PlayerOuterClass.getDescriptor() }, assigner);
/*      */   }
/*      */   
/* 5741 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_GetSysTimeRequest_descriptor = getDescriptor().getMessageTypes().get(0);
/* 5742 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_GetSysTimeRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_GetSysTimeRequest_descriptor, new String[0]);
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5747 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_GetSysTimeResponse_descriptor = getDescriptor().getMessageTypes().get(1);
/* 5748 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_GetSysTimeResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_GetSysTimeResponse_descriptor, new String[] { "S2CCode", "S2CTime", "S2CMsg" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5753 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_EntryRequest_descriptor = getDescriptor().getMessageTypes().get(2);
/* 5754 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_EntryRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_EntryRequest_descriptor, new String[] { "C2SUid", "C2SToken", "C2SLogicServerId", "C2SDeviceMac", "C2SDeviceType", "C2SClientRegion", "C2SClientChannel", "C2SClientVersion" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5759 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_EntryResponse_descriptor = getDescriptor().getMessageTypes().get(3);
/* 5760 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_EntryResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_EntryResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CPlayers" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5765 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_BindPlayerRequest_descriptor = getDescriptor().getMessageTypes().get(4);
/* 5766 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_BindPlayerRequest_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_BindPlayerRequest_descriptor, new String[] { "C2SPlayerId" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5771 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_BindPlayerResponse_descriptor = getDescriptor().getMessageTypes().get(5);
/* 5772 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_BindPlayerResponse_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_BindPlayerResponse_descriptor, new String[] { "S2CCode", "S2CMsg", "S2CPlayer", "S2CSceneType", "S2CSceneUseAgent", "S2CChangePkType", "S2CRideMount" });
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 5777 */   private static final Descriptors.Descriptor internal_static_pomelo_connector_LoginQueuePush_descriptor = getDescriptor().getMessageTypes().get(6);
/* 5778 */   private static GeneratedMessage.FieldAccessorTable internal_static_pomelo_connector_LoginQueuePush_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(internal_static_pomelo_connector_LoginQueuePush_descriptor, new String[] { "Num", "Time" });
/*      */   private static Descriptors.FileDescriptor descriptor;
/*      */   
/*      */   static {
/* 5782 */     Common.getDescriptor();
/* 5783 */     PlayerOuterClass.getDescriptor();
/*      */   }
/*      */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\pomelo\connector\EntryHandler.class
