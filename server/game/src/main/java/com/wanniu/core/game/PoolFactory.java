...
/* 37 */     Thread t = new Thread(r, this.namePrefix + this.threadNumber.getAndIncrement());
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\com\wanniu\core\game\PoolFactory.class
