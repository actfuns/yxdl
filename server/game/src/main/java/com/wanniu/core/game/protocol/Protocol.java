...
/*     */       } else {
/*  46 */         codes = new byte[] { (byte)(0xE0 | charCode >> 12), (byte)(0x80 | (charCode & 0xFC0) >> 6), (byte)(0x80 | charCode & 0x3F) };
/*     */       } 
/*     */       
...
/*  70 */         offset += 2;
/*     */       } else {
/*  72 */         charCode = ((bytes[offset] & 0xF) << 12) + ((bytes[offset + 1] & 0x3F) << 6) + (bytes[offset + 2] & 0x3F);
/*     */         
/*  74 */         offset += 3;
/*     */       } 
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\com\wanniu\core\game\protocol\Protocol.class
