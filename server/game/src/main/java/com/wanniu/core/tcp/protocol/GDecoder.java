...
/*    */ {
/* 20 */   private static int __RESPONSE_MAX_LEN = GConfig.getInstance().getInt("game.response.maxlen", GGlobal.__RESPONSE_MAX_LEN);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/* 41 */       Out.warn(new Object[] { "包体长度错误：" + len + " 句柄：" + 
/* 42 */             header.getTypeHexString() + session.remoteAddress() });
/* 43 */       session.close();
/*    */       
/*    */       return;
/*    */     } 
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\com\wanniu\core\tcp\protocol\GDecoder.class
