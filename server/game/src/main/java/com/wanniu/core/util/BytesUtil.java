...
public final class BytesUtil {
    public static long bytes2long(byte[] bytes) {
        return (bytes[7] & 0xFF | (bytes[6] & 0xFF) << 8 | (bytes[5] & 0xFF) << 16 | (bytes[4] & 0xFF) << 24 | (bytes[3] & 0xFF) << 32 | (bytes[2] & 0xFF) << 40 | (bytes[1] & 0xFF) << 48 | (bytes[0] & 0xFF) << 56);
    }
    ...
    public static byte[] short2bytes(long n) {
        return new byte[]{(byte) (int) (n >>> 8L & 0xFFL), (byte) (int) (n & 0xFFL)};
    }
    ...
    public static byte[] object2bytes(Serializable obj) {
        ...
        try {
            ...
            Out.error(new Object[]{"BytesUtil object2bytes", e});
        }
        return bytes;
    }
    ...
    public static <T extends Serializable> T bytes2object(byte[] bytes) {
        ...
        try {
            ...
            Out.error(new Object[]{"BytesUtil bytes2object", e});
        }
    ...
    public static byte[] zip(byte[] data) {
        ...
        try {
            ...
            try {
                ...
                Out.error(new Object[]{"BytesUtil zip", e});
            }
        }
        return b;
    }
    ...
    public static byte[] unZip(byte[] data) {
        ...
        try {
            ...
            try {
                ...
                Out.error(new Object[]{"BytesUtil unZip", e});
            }
        }
        return b;
    }
    ...
    public static void clean(ByteBuffer byteBuffer) {
        if (byteBuffer.isDirect()) {
            try {
                ...
                Out.error(new Object[]{"BytesUtil clean", e});
            }
        }
    }
