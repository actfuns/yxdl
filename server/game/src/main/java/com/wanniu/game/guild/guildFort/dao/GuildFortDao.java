...
public class GuildFortDao {
    ...
    public static List<GuildFortReportPO> getReports() {
        String str = (String) GameDao.get(String.valueOf(GWorld.__SERVER_ID), ConstsTR.guildFortReportTR.value, String.class);
    ...
    public static GuildFortPO getFort(int fortId) {
        ...
        return (GuildFortPO) GameDao.get(String.valueOf(GWorld.__SERVER_ID), key, GuildFortPO.class);
    }
}
