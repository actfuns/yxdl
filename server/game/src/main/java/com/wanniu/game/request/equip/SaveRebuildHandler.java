...
public class SaveRebuildHandler
    ...
    public PomeloResponse request() throws Exception {
        ...
        EquipHandler.SaveRebuildRequest req = EquipHandler.SaveRebuildRequest.parseFrom(this.pak.getRemaingBytes());
        final String equipId = req.getEquipId();

        return new PomeloResponse() {
            protected void write() throws IOException {
                EquipHandler.SaveRebuildResponse.Builder res = EquipHandler.SaveRebuildResponse.newBuilder();
