...
/* 20 */     return RankType.HP.getRedisKey(logicServerId, season);
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 27 */     info.setHp(((Integer)value[0]).intValue());
/*    */ 
/*    */     
/* 30 */     String key = getRedisKey(GWorld.__SERVER_ID);
/* 31 */     updateRank(key, info.getHp(), player.getId());
/*    */   }
/*    */ 
/*    */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\com\wanniu\game\rank\handler\PlayerHpRankHandler.class
