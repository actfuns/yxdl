...
public class BiTestMain {
    ...
    static class RideTrain {
        public String id;
        public String op;
        public List<BiTestMain.Item> consume = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        try {
            String response = (new HttpRequester()).sendPost("http://dev.6543.cn:8380/app_dev.php/api/open/report", params).getContent();
