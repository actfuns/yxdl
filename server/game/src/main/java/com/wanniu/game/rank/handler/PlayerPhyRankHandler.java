...
/* 20 */     return RankType.PHY.getRedisKey(logicServerId, season);
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 27 */     info.setPhy(((Integer)value[0]).intValue());
/*    */ 
/*    */     
/* 30 */     String key = getRedisKey(GWorld.__SERVER_ID);
/* 31 */     updateRank(key, info.getPhy(), player.getId());
/*    */   }
/*    */ 
/*    */   
...
/* Location:              D:\Yxdl\xmds-server\mmoarpg-game.jar!\com\wanniu\game\rank\handler\PlayerPhyRankHandler.class
